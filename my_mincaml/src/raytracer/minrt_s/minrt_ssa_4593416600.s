	.data
min_caml_Ta79686:	space 1
min_caml_Ta79691:	space 1
min_caml_Tt79673:	space 11
min_caml_Tt79732:	space 2
min_caml_Tt79745:	space 4
...
# B205
	...
	lw x17, 0(x15)
	li x18, -1
	bne	x17, x18, shadow_check_one_or_matrix_beqelse_b207
# B206
	mv x5, zero
	ret
shadow_check_one_or_matrix_beqelse_b207:
# B207
	la x19, min_caml_objects
	li x20, 2
	li x21, 3
	lui x22, 260096
	la x23, min_caml_and_net
	lui x24, 779469
	addi x24, x24, -819
	lui x25, 246333
	addi x25, x25, 1802
	la x26, min_caml_light
	bne	x17, x100, shadow_check_one_or_matrix_beqelse_b209
# B208
	mv x17, x10
...
# B209
	...
	lw x17, 0(x4)
	lw x31, 1(x27)
	bne	x31, x10, shadow_check_one_or_matrix_beqelse_b211
# B210
	lw x31, 0(x11)
	lw x32, 0(x17)
	fsub x32, x32, x28
	...
	lw x34, 1(x34)
	fle x33, x34, x33
	bne	x33, zero, shadow_check_one_or_matrix_beqelse_b217
# B213
	lw x33, 2(x31)
	fmul x33, x32, x33
	fadd x33, x33, x30
...
# B215
	...
	mv x34, x33
# B216
	bne	x34, zero, shadow_check_one_or_matrix_beqelse_b218
...
# B217
	...
	lw x34, 0(x34)
	fle x33, x34, x33
	bne	x33, zero, shadow_check_one_or_matrix_beqelse_b224
# B220
	lw x33, 2(x31)
	fmul x33, x32, x33
	fadd x33, x33, x30
...
# B222
	...
	mv x34, x33
# B223
	bne	x34, zero, shadow_check_one_or_matrix_beqelse_b225
...
# B227
	...
	lw x27, 1(x27)
	fle x27, x27, x28
	bne	x27, zero, shadow_check_one_or_matrix_beqelse_b231
# B229
	lw x17, 5(x17)
	feq x17, x17, zero
	xori x17, x17, 1
	mv x27, x17
# B230
	bne	x27, zero, shadow_check_one_or_matrix_beqelse_b232
...
# B211
	bne	x31, x20, shadow_check_one_or_matrix_beqelse_b234
# B233
	lw x27, 0(x17)
	fle x27, zero, x27
	bne	x27, zero, shadow_check_one_or_matrix_beqelse_b251
# B236
	lw x27, 1(x17)
	fmul x27, x27, x28
	lw x28, 2(x17)
...
# B234
	lw x31, 0(x17)
	feq x32, x31, zero
	bne	x32, zero, shadow_check_one_or_matrix_beqelse_b251
# B237
	lw x32, 1(x17)
	fmul x32, x32, x28
	lw x33, 2(x17)
	...
	fadd x33, x33, x34
	lw x34, 3(x27)
	bne	x34, zero, shadow_check_one_or_matrix_beqelse_b240
# B239
	mv x28, x33
...
# B241
	lw x29, 1(x27)
	bne	x29, x21, shadow_check_one_or_matrix_beqelse_b244
# B242
	fsub x28, x28, x22
...
# B244
	...
	fsub x28, x29, x28
	fle x29, x28, zero
	bne	x29, zero, shadow_check_one_or_matrix_beqelse_b251
# B246
	lw x27, 6(x27)
	fsqrt x28, x28
	bne	x27, zero, shadow_check_one_or_matrix_beqelse_b248
# B247
	fsub x27, x32, x28
	lw x17, 4(x17)
	fmul x17, x27, x17
...
# B250
	bne	x17, zero, shadow_check_one_or_matrix_beqelse_b252
...
# B252
	lw x17, 0(x13)
	fle x17, x14, x17
	beq	x17, zero, shadow_check_one_or_matrix_bneelse_b254
# B253
	addi x16, x16, 1
	j shadow_check_one_or_matrix_cont_b342 # adhoc jump(2)
...
# B255
	lw x17, 0(x27)
	beq	x17, x18, shadow_check_one_or_matrix_bneelse_b339
# B257
	add x4, x23, x17
	lw x17, 0(x4)
	addi x28, x17, 0
...
# B258
	lw x17, 0(x29)
	beq	x17, x18, shadow_check_one_or_matrix_bneelse_b336
# B260
	lw x17, 0(x29)
	add x4, x19, x17
	lw x28, 0(x4)
	...
	lw x34, 0(x4)
	lw x35, 1(x28)
	bne	x35, x10, shadow_check_one_or_matrix_beqelse_b262
# B261
	lw x35, 0(x11)
	lw x36, 0(x34)
	fsub x36, x36, x31
	...
	lw x38, 1(x38)
	fle x37, x38, x37
	bne	x37, zero, shadow_check_one_or_matrix_beqelse_b268
# B264
	lw x37, 2(x35)
	fmul x37, x36, x37
	fadd x37, x37, x33
...
# B266
	...
	mv x38, x37
# B267
	bne	x38, zero, shadow_check_one_or_matrix_beqelse_b269
...
# B268
	...
	lw x38, 0(x38)
	fle x37, x38, x37
	bne	x37, zero, shadow_check_one_or_matrix_beqelse_b275
# B271
	lw x37, 2(x35)
	fmul x37, x36, x37
	fadd x37, x37, x33
...
# B273
	...
	mv x38, x37
# B274
	bne	x38, zero, shadow_check_one_or_matrix_beqelse_b276
...
# B275
	...
	lw x36, 0(x36)
	fle x31, x36, x31
	bne	x31, zero, shadow_check_one_or_matrix_beqelse_b282
# B278
	lw x31, 1(x35)
	fmul x31, x33, x31
	fadd x31, x31, x32
	...
	lw x28, 1(x28)
	fle x28, x28, x31
	bne	x28, zero, shadow_check_one_or_matrix_beqelse_b282
# B280
	lw x28, 5(x34)
	feq x28, x28, zero
	xori x28, x28, 1
...
# B262
	bne	x35, x20, shadow_check_one_or_matrix_beqelse_b285
# B284
	lw x28, 0(x34)
	fle x28, zero, x28
	beq	x28, zero, shadow_check_one_or_matrix_bneelse_b287
# B286
	lw x31, 0(x13)
	j shadow_check_one_or_matrix_cont_b302 # adhoc jump(2)
...
# B285
	lw x35, 0(x34)
	feq x36, x35, zero
	bne	x36, zero, shadow_check_one_or_matrix_beqelse_b289
# B288
	lw x36, 1(x34)
	fmul x36, x36, x31
	lw x37, 2(x34)
	...
	fadd x37, x37, x38
	lw x38, 3(x28)
	bne	x38, zero, shadow_check_one_or_matrix_beqelse_b291
# B290
	mv x31, x37
...
# B292
	lw x32, 1(x28)
	bne	x32, x21, shadow_check_one_or_matrix_beqelse_b295
# B293
	fsub x31, x31, x22
...
# B295
	...
	fsub x31, x32, x31
	fle x32, x31, zero
	beq	x32, zero, shadow_check_one_or_matrix_bneelse_b297
# B296
	lw x31, 0(x13)
	j shadow_check_one_or_matrix_cont_b302 # adhoc jump(2)
...
# B297
	lw x28, 6(x28)
	fsqrt x31, x31
	bne	x28, zero, shadow_check_one_or_matrix_beqelse_b299
# B298
	fsub x28, x36, x31
	lw x31, 4(x34)
	fmul x28, x28, x31
...
# B301
	lw x31, 0(x13)
	bne	x28, zero, shadow_check_one_or_matrix_beqelse_b303
...
# B304
	addi x29, x29, 1
	bne	x28, zero, shadow_check_one_or_matrix_beqelse_b306
...
# B309
	lw x17, 0(x33)
	bne	x17, x18, shadow_check_one_or_matrix_beqelse_b311
# B310
	mv x28, x10
# B332
	bne	x28, zero, shadow_check_one_or_matrix_beqelse_b334
	j shadow_check_one_or_matrix_cont_b333 # adhoc jump(3)
shadow_check_one_or_matrix_beqelse_b334:
# B334
	mv x17, x10
# B335
	bne	x17, zero, shadow_check_one_or_matrix_beqelse_b337
	j shadow_check_one_or_matrix_cont_b336 # adhoc jump(3)
shadow_check_one_or_matrix_beqelse_b337:
# B337
	mv x28, x10
# B338
	bne	x28, zero, shadow_check_one_or_matrix_beqelse_b340
...
# B341
	addi x16, x16, 1
	bne	x17, zero, shadow_check_one_or_matrix_beqelse_b343
...
# B344
	lw x15, 0(x17)
	beq	x15, x18, shadow_check_one_or_matrix_bneelse_b428
# B346
	add x4, x23, x15
	lw x15, 0(x4)
	addi x27, x15, 0
...
# B347
	lw x15, 0(x28)
	beq	x15, x18, shadow_check_one_or_matrix_bneelse_b425
# B349
	lw x15, 0(x28)
	add x4, x19, x15
	lw x27, 0(x4)
	...
	lw x33, 0(x4)
	lw x34, 1(x27)
	bne	x34, x10, shadow_check_one_or_matrix_beqelse_b351
# B350
	lw x34, 0(x11)
	lw x35, 0(x33)
	fsub x35, x35, x30
	...
	lw x37, 1(x37)
	fle x36, x37, x36
	bne	x36, zero, shadow_check_one_or_matrix_beqelse_b357
# B353
	lw x36, 2(x34)
	fmul x36, x35, x36
	fadd x36, x36, x32
...
# B355
	...
	mv x37, x36
# B356
	bne	x37, zero, shadow_check_one_or_matrix_beqelse_b358
...
# B357
	...
	lw x37, 0(x37)
	fle x36, x37, x36
	bne	x36, zero, shadow_check_one_or_matrix_beqelse_b364
# B360
	lw x36, 2(x34)
	fmul x36, x35, x36
	fadd x36, x36, x32
...
# B362
	...
	mv x37, x36
# B363
	bne	x37, zero, shadow_check_one_or_matrix_beqelse_b365
...
# B364
	...
	lw x35, 0(x35)
	fle x30, x35, x30
	bne	x30, zero, shadow_check_one_or_matrix_beqelse_b371
# B367
	lw x30, 1(x34)
	fmul x30, x32, x30
	fadd x30, x30, x31
	...
	lw x27, 1(x27)
	fle x27, x27, x30
	bne	x27, zero, shadow_check_one_or_matrix_beqelse_b371
# B369
	lw x27, 5(x33)
	feq x27, x27, zero
	xori x27, x27, 1
	mv x30, x27
# B370
	bne	x30, zero, shadow_check_one_or_matrix_beqelse_b372
...
# B351
	bne	x34, x20, shadow_check_one_or_matrix_beqelse_b374
# B373
	lw x27, 0(x33)
	fle x27, zero, x27
	beq	x27, zero, shadow_check_one_or_matrix_bneelse_b376
# B375
	lw x30, 0(x13)
	j shadow_check_one_or_matrix_cont_b391 # adhoc jump(2)
...
# B374
	lw x34, 0(x33)
	feq x35, x34, zero
	bne	x35, zero, shadow_check_one_or_matrix_beqelse_b378
# B377
	lw x35, 1(x33)
	fmul x35, x35, x30
	lw x36, 2(x33)
	...
	fadd x36, x36, x37
	lw x37, 3(x27)
	bne	x37, zero, shadow_check_one_or_matrix_beqelse_b380
# B379
	mv x30, x36
...
# B381
	lw x31, 1(x27)
	bne	x31, x21, shadow_check_one_or_matrix_beqelse_b384
# B382
	fsub x30, x30, x22
...
# B384
	...
	fsub x30, x31, x30
	fle x31, x30, zero
	beq	x31, zero, shadow_check_one_or_matrix_bneelse_b386
# B385
	lw x30, 0(x13)
	j shadow_check_one_or_matrix_cont_b391 # adhoc jump(2)
...
# B386
	lw x27, 6(x27)
	fsqrt x30, x30
	bne	x27, zero, shadow_check_one_or_matrix_beqelse_b388
# B387
	fsub x27, x35, x30
	lw x30, 4(x33)
	fmul x27, x27, x30
...
# B390
	lw x30, 0(x13)
	bne	x27, zero, shadow_check_one_or_matrix_beqelse_b392
...
# B393
	addi x28, x28, 1
	bne	x27, zero, shadow_check_one_or_matrix_beqelse_b395
...
# B398
	lw x15, 0(x32)
	bne	x15, x18, shadow_check_one_or_matrix_beqelse_b400
# B399
	mv x27, x10
# B421
	bne	x27, zero, shadow_check_one_or_matrix_beqelse_b423
	j shadow_check_one_or_matrix_cont_b422 # adhoc jump(3)
shadow_check_one_or_matrix_beqelse_b423:
# B423
	mv x15, x10
# B424
	bne	x15, zero, shadow_check_one_or_matrix_beqelse_b426
	j shadow_check_one_or_matrix_cont_b425 # adhoc jump(3)
shadow_check_one_or_matrix_beqelse_b426:
# B426
	mv x27, x10
# B427
	bne	x27, zero, shadow_check_one_or_matrix_beqelse_b429
...
# B400
	...
	fsub x31, x35, x31
	lw x36, 1(x15)
	bne	x36, x10, shadow_check_one_or_matrix_beqelse_b402
# B401
	fabs x27, x27
	lw x36, 4(x15)
	lw x36, 0(x36)
	fle x27, x36, x27
	bne	x27, zero, shadow_check_one_or_matrix_beqelse_b408
# B404
	fabs x27, x30
	lw x30, 4(x15)
	lw x30, 1(x30)
...
# B406
	...
	mv x30, x27
# B407
	bne	x30, zero, shadow_check_one_or_matrix_beqelse_b409
...
# B402
	bne	x36, x20, shadow_check_one_or_matrix_beqelse_b411
# B410
	lw x36, 4(x15)
	lw x37, 0(x36)
	fmul x27, x37, x27
...
# B411
	...
	fadd x36, x36, x37
	lw x37, 3(x15)
	bne	x37, zero, shadow_check_one_or_matrix_beqelse_b413
# B412
	mv x27, x36
...
# B414
	lw x30, 1(x15)
	bne	x30, x21, shadow_check_one_or_matrix_beqelse_b417
# B415
	fsub x27, x27, x22
...
# B418
	bne	x15, zero, shadow_check_one_or_matrix_beqelse_b422
# B419
	addi x32, x32, 1
...
# B394
	...
	lw x15, 0(x4)
	lw x15, 6(x15)
	beq	x15, zero, shadow_check_one_or_matrix_bneelse_b425
...
# B311
	...
	fsub x32, x36, x32
	lw x37, 1(x17)
	bne	x37, x10, shadow_check_one_or_matrix_beqelse_b313
# B312
	fabs x28, x28
	lw x37, 4(x17)
	lw x37, 0(x37)
	fle x28, x37, x28
	bne	x28, zero, shadow_check_one_or_matrix_beqelse_b319
# B315
	fabs x28, x31
	lw x31, 4(x17)
	lw x31, 1(x31)
...
# B317
	...
	mv x31, x28
# B318
	bne	x31, zero, shadow_check_one_or_matrix_beqelse_b320
...
# B313
	bne	x37, x20, shadow_check_one_or_matrix_beqelse_b322
# B321
	lw x37, 4(x17)
	lw x38, 0(x37)
	fmul x28, x38, x28
...
# B322
	...
	fadd x37, x37, x38
	lw x38, 3(x17)
	bne	x38, zero, shadow_check_one_or_matrix_beqelse_b324
# B323
	mv x28, x37
...
# B325
	lw x31, 1(x17)
	bne	x31, x21, shadow_check_one_or_matrix_beqelse_b328
# B326
	fsub x28, x28, x22
...
# B329
	bne	x17, zero, shadow_check_one_or_matrix_beqelse_b333
# B330
	addi x33, x33, 1
...
# B305
	...
	lw x17, 0(x4)
	lw x17, 6(x17)
	beq	x17, zero, shadow_check_one_or_matrix_bneelse_b336
...
# B432
	...
	li x13, 1
	li x14, -1
	bne	x10, x14, solve_each_element_beqelse_b434
# B433
	ret
...
# B505
	lw x23, 0(x26)
	bne	x23, x14, solve_each_element_beqelse_b507
# B506
	mv x30, x13
# B528
	bne	x30, zero, solve_each_element_beqelse_b530
...
# B530
	...
	sw x10, 0(x13)
	la x10, min_caml_intsec_rectside
	sw x17, 0(x10)
...
# B507
	...
	fsub x32, x29, x32
	lw x33, 1(x23)
	bne	x33, x13, solve_each_element_beqelse_b509
# B508
	fabs x30, x30
	lw x33, 4(x23)
	lw x33, 0(x33)
	fle x30, x33, x30
	bne	x30, zero, solve_each_element_beqelse_b515
# B511
	fabs x30, x31
	lw x31, 4(x23)
	lw x31, 1(x31)
...
# B513
	...
	mv x31, x30
# B514
	bne	x31, zero, solve_each_element_beqelse_b516
...
# B509
	bne	x33, x20, solve_each_element_beqelse_b518
# B517
	lw x33, 4(x23)
	lw x34, 0(x33)
	fmul x30, x34, x30
...
# B518
	...
	fadd x33, x33, x34
	lw x34, 3(x23)
	bne	x34, zero, solve_each_element_beqelse_b520
# B519
	mv x30, x33
...
# B521
	lw x31, 1(x23)
	bne	x31, x24, solve_each_element_beqelse_b524
# B522
	fsub x30, x30, x25
...
# B525
	bne	x23, zero, solve_each_element_beqelse_b529
# B526
	addi x26, x26, 1
...
# B497
	...
	lw x10, 0(x4)
	lw x10, 6(x10)
	bne	x10, zero, solve_each_element_beqelse_b432
# B499
	ret
...
# B534
	...
	lw x16, 0(x100)
	li x17, -1
	beq	x16, x17, judge_intersection_fast_bneelse_b733
# B536
	la x18, min_caml_and_net
	la x19, min_caml_objects
	li x20, 2
	lui x21, 246333
	addi x21, x21, 1802
	la x22, min_caml_startp_fast
	li x23, 3
	lui x24, 260096
	la x25, min_caml_intersection_point
	la x26, min_caml_intersected_object_id
	la x27, min_caml_intsec_rectside
	bne	x16, x12, judge_intersection_fast_beqelse_b538
# B537
	addi x100, x100, 1
	mv x28, x15
	mv x16, x100
...
# B539
	lw x100, 0(x16)
	beq	x100, x17, judge_intersection_fast_bneelse_b732
# B541
	add x4, x18, x100
	lw x100, 0(x4)
	addi x29, x100, 0
...
# B542
	lw x100, 0(x32)
	lw x29, 0(x30)
	beq	x29, x17, judge_intersection_fast_bneelse_b615
# B544
	add x4, x19, x29
	lw x33, 0(x4)
	lw x34, 10(x33)
	...
	lw x38, 0(x4)
	lw x39, 1(x33)
	bne	x39, x11, judge_intersection_fast_beqelse_b546
# B545
	lw x34, 0(x32)
	lw x39, 0(x38)
	fsub x39, x39, x35
	...
	lw x5, 1(x5)
	fle x40, x5, x40
	bne	x40, zero, judge_intersection_fast_beqelse_b552
# B548
	lw x40, 2(x34)
	fmul x40, x39, x40
	fadd x40, x40, x37
...
# B550
	...
	mv x5, x40
# B551
	bne	x5, zero, judge_intersection_fast_beqelse_b553
...
# B552
	...
	lw x5, 0(x5)
	fle x40, x5, x40
	bne	x40, zero, judge_intersection_fast_beqelse_b559
# B555
	lw x40, 2(x34)
	fmul x40, x39, x40
	fadd x40, x40, x37
...
# B557
	...
	mv x5, x40
# B558
	bne	x5, zero, judge_intersection_fast_beqelse_b560
...
# B562
	...
	lw x33, 1(x33)
	fle x33, x33, x34
	bne	x33, zero, judge_intersection_fast_beqelse_b566
# B564
	lw x33, 5(x38)
	feq x33, x33, zero
	xori x33, x33, 1
	mv x34, x33
# B565
	bne	x34, zero, judge_intersection_fast_beqelse_b567
...
# B546
	bne	x39, x20, judge_intersection_fast_beqelse_b569
# B568
	lw x33, 0(x38)
	fle x33, zero, x33
	beq	x33, zero, judge_intersection_fast_bneelse_b571
# B570
	mv x33, zero
	addi x30, x30, 1
	j judge_intersection_fast_cont_b580 # adhoc jump(2)
...
# B569
	lw x39, 0(x38)
	feq x40, x39, zero
	bne	x40, zero, judge_intersection_fast_beqelse_b573
# B572
	lw x40, 1(x38)
	fmul x35, x40, x35
	lw x40, 2(x38)
	...
	fsub x34, x36, x34
	fle x36, x34, zero
	beq	x36, zero, judge_intersection_fast_bneelse_b575
# B574
	mv x33, zero
	addi x30, x30, 1
	j judge_intersection_fast_cont_b580 # adhoc jump(2)
...
# B575
	lw x33, 6(x33)
	fsqrt x34, x34
	bne	x33, zero, judge_intersection_fast_beqelse_b577
# B576
	fsub x33, x35, x34
	lw x34, 4(x38)
	fmul x33, x33, x34
...
# B579
	addi x30, x30, 1
	bne	x33, zero, judge_intersection_fast_beqelse_b581
...
# B581
	lw x34, 0(x13)
	fle x35, x34, zero
	bne	x35, zero, judge_intersection_fast_beqelse_b614
# B585
	lw x35, 0(x10)
	fle x35, x35, x34
	bne	x35, zero, judge_intersection_fast_beqelse_b614
...
# B588
	lw x37, 0(x38)
	bne	x37, x17, judge_intersection_fast_beqelse_b590
# B589
	mv x6, x11
# B611
	bne	x6, zero, judge_intersection_fast_beqelse_b613
...
# B590
	...
	fsub x66, x5, x66
	lw x67, 1(x37)
	bne	x67, x11, judge_intersection_fast_beqelse_b592
# B591
	fabs x6, x6
	lw x67, 4(x37)
	lw x67, 0(x67)
	fle x6, x67, x6
	bne	x6, zero, judge_intersection_fast_beqelse_b598
# B594
	fabs x6, x65
	lw x65, 4(x37)
	lw x65, 1(x65)
...
# B596
	...
	mv x65, x6
# B597
	bne	x65, zero, judge_intersection_fast_beqelse_b599
...
# B592
	bne	x67, x20, judge_intersection_fast_beqelse_b601
# B600
	lw x67, 4(x37)
	lw x68, 0(x67)
	fmul x6, x68, x6
...
# B601
	...
	fadd x67, x67, x68
	lw x68, 3(x37)
	bne	x68, zero, judge_intersection_fast_beqelse_b603
# B602
	mv x6, x67
...
# B604
	lw x65, 1(x37)
	bne	x65, x23, judge_intersection_fast_beqelse_b607
# B605
	fsub x6, x6, x24
...
# B608
	bne	x37, zero, judge_intersection_fast_beqelse_b612
# B609
	addi x38, x38, 1
...
# B538
	...
	lw x16, 0(x4)
	lw x33, 1(x28)
	bne	x33, x11, judge_intersection_fast_beqelse_b617
# B616
	lw x29, 0(x15)
	lw x33, 0(x16)
	fsub x33, x33, x30
	...
	lw x35, 1(x35)
	fle x34, x35, x34
	bne	x34, zero, judge_intersection_fast_beqelse_b623
# B619
	lw x34, 2(x29)
	fmul x34, x33, x34
	fadd x34, x34, x32
...
# B621
	...
	mv x35, x34
# B622
	bne	x35, zero, judge_intersection_fast_beqelse_b624
...
# B623
	...
	lw x35, 0(x35)
	fle x34, x35, x34
	bne	x34, zero, judge_intersection_fast_beqelse_b630
# B626
	lw x34, 2(x29)
	fmul x34, x33, x34
	fadd x34, x34, x32
...
# B628
	...
	mv x35, x34
# B629
	bne	x35, zero, judge_intersection_fast_beqelse_b631
...
# B630
	...
	lw x33, 0(x33)
	fle x30, x33, x30
	bne	x30, zero, judge_intersection_fast_beqelse_b637
# B633
	lw x29, 1(x29)
	fmul x29, x32, x29
	fadd x29, x29, x31
	...
	lw x28, 1(x28)
	fle x28, x28, x29
	bne	x28, zero, judge_intersection_fast_beqelse_b637
# B635
	lw x16, 5(x16)
	feq x16, x16, zero
	xori x16, x16, 1
	mv x28, x16
# B636
	bne	x28, zero, judge_intersection_fast_beqelse_b638
...
# B617
	bne	x33, x20, judge_intersection_fast_beqelse_b640
# B639
	lw x28, 0(x16)
	fle x28, zero, x28
	bne	x28, zero, judge_intersection_fast_beqelse_b651
# B642
	lw x16, 0(x16)
	lw x28, 3(x29)
	fmul x16, x16, x28
...
# B640
	lw x33, 0(x16)
	feq x34, x33, zero
	bne	x34, zero, judge_intersection_fast_beqelse_b651
# B643
	lw x34, 1(x16)
	fmul x30, x34, x30
	lw x34, 2(x16)
	...
	fsub x29, x31, x29
	fle x31, x29, zero
	bne	x31, zero, judge_intersection_fast_beqelse_b651
# B646
	lw x28, 6(x28)
	fsqrt x29, x29
	bne	x28, zero, judge_intersection_fast_beqelse_b648
# B647
	fsub x28, x30, x29
	lw x16, 4(x16)
	fmul x16, x28, x16
...
# B650
	bne	x16, zero, judge_intersection_fast_beqelse_b652
...
# B652
	...
	lw x28, 0(x10)
	fle x16, x28, x16
	bne	x16, zero, judge_intersection_fast_beqelse_b732
# B654
	addi x100, x100, 1
	mv x28, x15
	mv x16, x100
...
# B658
	lw x100, 0(x32)
	lw x29, 0(x30)
	beq	x29, x17, judge_intersection_fast_bneelse_b731
# B660
	add x4, x19, x29
	lw x33, 0(x4)
	lw x34, 10(x33)
	...
	lw x38, 0(x4)
	lw x39, 1(x33)
	bne	x39, x11, judge_intersection_fast_beqelse_b662
# B661
	lw x34, 0(x32)
	lw x39, 0(x38)
	fsub x39, x39, x35
	...
	lw x5, 1(x5)
	fle x40, x5, x40
	bne	x40, zero, judge_intersection_fast_beqelse_b668
# B664
	lw x40, 2(x34)
	fmul x40, x39, x40
	fadd x40, x40, x37
...
# B666
	...
	mv x5, x40
# B667
	bne	x5, zero, judge_intersection_fast_beqelse_b669
...
# B668
	...
	lw x5, 0(x5)
	fle x40, x5, x40
	bne	x40, zero, judge_intersection_fast_beqelse_b675
# B671
	lw x40, 2(x34)
	fmul x40, x39, x40
	fadd x40, x40, x37
...
# B673
	...
	mv x5, x40
# B674
	bne	x5, zero, judge_intersection_fast_beqelse_b676
...
# B678
	...
	lw x33, 1(x33)
	fle x33, x33, x34
	bne	x33, zero, judge_intersection_fast_beqelse_b682
# B680
	lw x33, 5(x38)
	feq x33, x33, zero
	xori x33, x33, 1
	mv x34, x33
# B681
	bne	x34, zero, judge_intersection_fast_beqelse_b683
...
# B662
	bne	x39, x20, judge_intersection_fast_beqelse_b685
# B684
	lw x33, 0(x38)
	fle x33, zero, x33
	beq	x33, zero, judge_intersection_fast_bneelse_b687
# B686
	mv x33, zero
	addi x30, x30, 1
	j judge_intersection_fast_cont_b696 # adhoc jump(2)
...
# B685
	lw x39, 0(x38)
	feq x40, x39, zero
	bne	x40, zero, judge_intersection_fast_beqelse_b689
# B688
	lw x40, 1(x38)
	fmul x35, x40, x35
	lw x40, 2(x38)
	...
	fsub x34, x36, x34
	fle x36, x34, zero
	beq	x36, zero, judge_intersection_fast_bneelse_b691
# B690
	mv x33, zero
	addi x30, x30, 1
	j judge_intersection_fast_cont_b696 # adhoc jump(2)
...
# B691
	lw x33, 6(x33)
	fsqrt x34, x34
	bne	x33, zero, judge_intersection_fast_beqelse_b693
# B692
	fsub x33, x35, x34
	lw x34, 4(x38)
	fmul x33, x33, x34
...
# B695
	addi x30, x30, 1
	bne	x33, zero, judge_intersection_fast_beqelse_b697
	j judge_intersection_fast_cont_b696 # adhoc jump(3)
judge_intersection_fast_beqelse_b697:
# B697
	lw x34, 0(x13)
	fle x35, x34, zero
	bne	x35, zero, judge_intersection_fast_beqelse_b730
# B701
	lw x35, 0(x10)
	fle x35, x35, x34
	bne	x35, zero, judge_intersection_fast_beqelse_b730
...
# B704
	lw x37, 0(x38)
	bne	x37, x17, judge_intersection_fast_beqelse_b706
# B705
	mv x6, x11
# B727
	bne	x6, zero, judge_intersection_fast_beqelse_b729
...
# B706
	...
	fsub x66, x5, x66
	lw x67, 1(x37)
	bne	x67, x11, judge_intersection_fast_beqelse_b708
# B707
	fabs x6, x6
	lw x67, 4(x37)
	lw x67, 0(x67)
	fle x6, x67, x6
	bne	x6, zero, judge_intersection_fast_beqelse_b714
# B710
	fabs x6, x65
	lw x65, 4(x37)
	lw x65, 1(x65)
...
# B712
	...
	mv x65, x6
# B713
	bne	x65, zero, judge_intersection_fast_beqelse_b715
...
# B708
	bne	x67, x20, judge_intersection_fast_beqelse_b717
# B716
	lw x67, 4(x37)
	lw x68, 0(x67)
	fmul x6, x68, x6
...
# B717
	...
	fadd x67, x67, x68
	lw x68, 3(x37)
	bne	x68, zero, judge_intersection_fast_beqelse_b719
# B718
	mv x6, x67
...
# B720
	lw x65, 1(x37)
	bne	x65, x23, judge_intersection_fast_beqelse_b723
# B721
	fsub x6, x6, x24
...
# B724
	bne	x37, zero, judge_intersection_fast_beqelse_b728
# B725
	addi x38, x38, 1
...
# B830
	...
	lw x100, 0(x10)
	li x117, -1
	la x118, min_caml_and_net
	la x11, min_caml_objects
	li x12, 2
	lui x13, 258048
	li x14, 3
	lui x15, 260096
	beq	x100, x117, trace_ray_bneelse_b908
# B832
...
# B835
	lw x10, 0(x119)
	beq	x10, x117, trace_ray_bneelse_b907
# B837
	add x4, x118, x10
	lw x6, 0(x4)
	mv x7, x120
...
# B1027
	...
	lui x31, 246333
	addi x31, x31, 1802
	beq	x29, x117, trace_ray_bneelse_b1253
# B1029
	bne	x29, x112, trace_ray_beqelse_b1031
# B1030
	mv x29, x111
...
# B1031
	...
	lw x29, 0(x4)
	lw x36, 1(x32)
	bne	x36, x111, trace_ray_beqelse_b1033
# B1032
	lw x36, 0(x23)
	lw x37, 0(x29)
	fsub x37, x37, x33
	...
	lw x39, 1(x39)
	fle x38, x39, x38
	bne	x38, zero, trace_ray_beqelse_b1039
# B1035
	lw x38, 2(x36)
	fmul x38, x37, x38
	fadd x38, x38, x35
...
# B1037
	...
	mv x39, x38
# B1038
	bne	x39, zero, trace_ray_beqelse_b1040
...
# B1039
	...
	lw x39, 0(x39)
	fle x38, x39, x38
	bne	x38, zero, trace_ray_beqelse_b1046
# B1042
	lw x38, 2(x36)
	fmul x38, x37, x38
	fadd x38, x38, x35
...
# B1044
	...
	mv x39, x38
# B1045
	bne	x39, zero, trace_ray_beqelse_b1047
...
# B1049
	...
	lw x32, 1(x32)
	fle x32, x32, x33
	bne	x32, zero, trace_ray_beqelse_b1053
# B1051
	lw x29, 5(x29)
	feq x29, x29, zero
	xori x29, x29, 1
	mv x32, x29
# B1052
	bne	x32, zero, trace_ray_beqelse_b1054
...
# B1033
	bne	x36, x12, trace_ray_beqelse_b1056
# B1055
	lw x32, 0(x29)
	fle x32, zero, x32
	bne	x32, zero, trace_ray_beqelse_b1073
# B1058
	lw x32, 1(x29)
	fmul x32, x32, x33
	lw x33, 2(x29)
...
# B1056
	lw x36, 0(x29)
	feq x37, x36, zero
	bne	x37, zero, trace_ray_beqelse_b1073
# B1059
	lw x37, 1(x29)
	fmul x37, x37, x33
	lw x38, 2(x29)
	...
	fadd x38, x38, x39
	lw x39, 3(x32)
	bne	x39, zero, trace_ray_beqelse_b1062
# B1061
	mv x33, x38
...
# B1063
	lw x34, 1(x32)
	bne	x34, x14, trace_ray_beqelse_b1066
# B1064
	fsub x33, x33, x15
...
# B1066
	...
	fsub x33, x34, x33
	fle x34, x33, zero
	bne	x34, zero, trace_ray_beqelse_b1073
# B1068
	lw x32, 6(x32)
	fsqrt x33, x33
	bne	x32, zero, trace_ray_beqelse_b1070
# B1069
	fsub x32, x37, x33
	lw x29, 4(x29)
	fmul x29, x32, x29
...
# B1072
	bne	x29, zero, trace_ray_beqelse_b1074
...
# B1074
	lw x29, 0(x114)
	fle x29, x100, x29
	beq	x29, zero, trace_ray_bneelse_b1076
# B1075
	addi x28, x28, 1
	j trace_ray_cont_b1164 # adhoc jump(2)
...
# B1077
	lw x29, 0(x32)
	beq	x29, x117, trace_ray_bneelse_b1161
# B1079
	add x4, x118, x29
	lw x29, 0(x4)
	addi x33, x29, 0
...
# B1080
	lw x29, 0(x34)
	beq	x29, x117, trace_ray_bneelse_b1158
# B1082
	lw x29, 0(x34)
	add x4, x11, x29
	lw x33, 0(x4)
	...
	lw x39, 0(x4)
	lw x40, 1(x33)
	bne	x40, x111, trace_ray_beqelse_b1084
# B1083
	lw x40, 0(x23)
	lw x5, 0(x39)
	fsub x5, x5, x36
	...
	lw x65, 1(x65)
	fle x6, x65, x6
	bne	x6, zero, trace_ray_beqelse_b1090
# B1086
	lw x6, 2(x40)
	fmul x6, x5, x6
	fadd x6, x6, x38
...
# B1088
	...
	mv x65, x6
# B1089
	bne	x65, zero, trace_ray_beqelse_b1091
...
# B1090
	...
	lw x65, 0(x65)
	fle x6, x65, x6
	bne	x6, zero, trace_ray_beqelse_b1097
# B1093
	lw x6, 2(x40)
	fmul x6, x5, x6
	fadd x6, x6, x38
...
# B1095
	...
	mv x65, x6
# B1096
	bne	x65, zero, trace_ray_beqelse_b1098
...
# B1097
	...
	lw x5, 0(x5)
	fle x36, x5, x36
	bne	x36, zero, trace_ray_beqelse_b1104
# B1100
	lw x36, 1(x40)
	fmul x36, x38, x36
	fadd x36, x36, x37
	...
	lw x33, 1(x33)
	fle x33, x33, x36
	bne	x33, zero, trace_ray_beqelse_b1104
# B1102
	lw x33, 5(x39)
	feq x33, x33, zero
	xori x33, x33, 1
	mv x36, x33
# B1103
	bne	x36, zero, trace_ray_beqelse_b1105
...
# B1084
	bne	x40, x12, trace_ray_beqelse_b1107
# B1106
	lw x33, 0(x39)
	fle x33, zero, x33
	beq	x33, zero, trace_ray_bneelse_b1109
# B1108
	lw x36, 0(x114)
	j trace_ray_cont_b1124 # adhoc jump(2)
...
# B1107
	lw x40, 0(x39)
	feq x5, x40, zero
	bne	x5, zero, trace_ray_beqelse_b1111
# B1110
	lw x5, 1(x39)
	fmul x5, x5, x36
	lw x6, 2(x39)
	...
	fadd x6, x6, x65
	lw x65, 3(x33)
	bne	x65, zero, trace_ray_beqelse_b1113
# B1112
	mv x36, x6
...
# B1114
	lw x37, 1(x33)
	bne	x37, x14, trace_ray_beqelse_b1117
# B1115
	fsub x36, x36, x15
...
# B1117
	...
	fsub x36, x37, x36
	fle x37, x36, zero
	beq	x37, zero, trace_ray_bneelse_b1119
# B1118
	lw x36, 0(x114)
	j trace_ray_cont_b1124 # adhoc jump(2)
...
# B1119
	lw x33, 6(x33)
	fsqrt x36, x36
	bne	x33, zero, trace_ray_beqelse_b1121
# B1120
	fsub x33, x5, x36
	lw x36, 4(x39)
	fmul x33, x33, x36
...
# B1123
	lw x36, 0(x114)
	bne	x33, zero, trace_ray_beqelse_b1125
...
# B1126
	addi x34, x34, 1
	bne	x33, zero, trace_ray_beqelse_b1128
...
# B1131
	lw x29, 0(x38)
	bne	x29, x117, trace_ray_beqelse_b1133
# B1132
	mv x33, x111
# B1154
	bne	x33, zero, trace_ray_beqelse_b1156
	j trace_ray_cont_b1155 # adhoc jump(3)
trace_ray_beqelse_b1156:
# B1156
	mv x29, x111
# B1157
	bne	x29, zero, trace_ray_beqelse_b1159
	j trace_ray_cont_b1158 # adhoc jump(3)
trace_ray_beqelse_b1159:
# B1159
	mv x33, x111
# B1160
	bne	x33, zero, trace_ray_beqelse_b1162
...
# B1163
	addi x28, x28, 1
	bne	x29, zero, trace_ray_beqelse_b1165
...
# B1166
	lw x19, 0(x29)
	beq	x19, x117, trace_ray_bneelse_b1250
# B1168
	add x4, x118, x19
	lw x19, 0(x4)
	addi x32, x19, 0
...
# B1169
	lw x19, 0(x33)
	beq	x19, x117, trace_ray_bneelse_b1247
# B1171
	lw x19, 0(x33)
	add x4, x11, x19
	lw x32, 0(x4)
	...
	lw x38, 0(x4)
	lw x39, 1(x32)
	bne	x39, x111, trace_ray_beqelse_b1173
# B1172
	lw x39, 0(x23)
	lw x40, 0(x38)
	fsub x40, x40, x35
...
# B1177
	...
	mv x6, x5
# B1178
	bne	x6, zero, trace_ray_beqelse_b1180
...
# B1179
	...
	lw x6, 0(x6)
	fle x5, x6, x5
	bne	x5, zero, trace_ray_beqelse_b1186
# B1182
	lw x5, 2(x39)
	fmul x5, x40, x5
	fadd x5, x5, x37
...
# B1184
	...
	mv x6, x5
# B1185
	bne	x6, zero, trace_ray_beqelse_b1187
...
# B1186
	...
	lw x40, 0(x40)
	fle x35, x40, x35
	bne	x35, zero, trace_ray_beqelse_b1193
# B1189
	lw x35, 1(x39)
	fmul x35, x37, x35
	fadd x35, x35, x36
	...
	lw x32, 1(x32)
	fle x32, x32, x35
	bne	x32, zero, trace_ray_beqelse_b1193
# B1191
	lw x32, 5(x38)
	feq x32, x32, zero
	xori x32, x32, 1
	mv x35, x32
# B1192
	bne	x35, zero, trace_ray_beqelse_b1194
...
# B1173
	bne	x39, x12, trace_ray_beqelse_b1196
# B1195
	lw x32, 0(x38)
	fle x32, zero, x32
	beq	x32, zero, trace_ray_bneelse_b1198
# B1197
	lw x35, 0(x114)
	j trace_ray_cont_b1213 # adhoc jump(2)
...
# B1196
	lw x39, 0(x38)
	feq x40, x39, zero
	bne	x40, zero, trace_ray_beqelse_b1200
# B1199
	lw x40, 1(x38)
	fmul x40, x40, x35
	lw x5, 2(x38)
	...
	fadd x5, x5, x6
	lw x6, 3(x32)
	bne	x6, zero, trace_ray_beqelse_b1202
# B1201
	mv x35, x5
...
# B1203
	lw x36, 1(x32)
	bne	x36, x14, trace_ray_beqelse_b1206
# B1204
	fsub x35, x35, x15
...
# B1206
	...
	fsub x35, x36, x35
	fle x36, x35, zero
	beq	x36, zero, trace_ray_bneelse_b1208
# B1207
	lw x35, 0(x114)
	j trace_ray_cont_b1213 # adhoc jump(2)
...
# B1208
	lw x32, 6(x32)
	fsqrt x35, x35
	bne	x32, zero, trace_ray_beqelse_b1210
# B1209
	fsub x32, x40, x35
	lw x35, 4(x38)
	fmul x32, x32, x35
...
# B1212
	lw x35, 0(x114)
	bne	x32, zero, trace_ray_beqelse_b1214
...
# B1215
	addi x33, x33, 1
	bne	x32, zero, trace_ray_beqelse_b1217
...
# B1220
	lw x19, 0(x37)
	bne	x19, x117, trace_ray_beqelse_b1222
# B1221
	mv x32, x111
# B1243
	bne	x32, zero, trace_ray_beqelse_b1245
...
# B1248
	mv x32, x111
# B1249
	bne	x32, zero, trace_ray_beqelse_b1251
...
# B1261
	bgt	zero, x32, trace_ray_bleelse_b1275
# B1262
	add x4, x11, x32
	lw x28, 0(x4)
	lw x33, 10(x28)
...
# B1276
	bgt	x29, x32, trace_ray_bleelse_b1720
# B1277
	lw x13, 0(x32)
	lw x22, 1(x13)
	sw x109, 0(x108)
...
# B1279
	lw x28, 0(x36)
	lw x38, 0(x28)
	beq	x38, x117, trace_ray_bneelse_b1478
# B1281
	bne	x38, x112, trace_ray_beqelse_b1283
# B1282
	addi x28, x28, 1
	mv x39, x37
	mv x38, x28
...
# B1284
	lw x28, 0(x38)
	beq	x28, x117, trace_ray_bneelse_b1477
# B1286
	add x4, x118, x28
	lw x28, 0(x4)
	addi x40, x28, 0
...
# B1287
	lw x28, 0(x65)
	lw x40, 0(x5)
	beq	x40, x117, trace_ray_bneelse_b1360
# B1289
	add x4, x11, x40
	lw x66, 0(x4)
	lw x67, 10(x66)
	...
	lw x70, 0(x4)
	lw x71, 1(x66)
	bne	x71, x111, trace_ray_beqelse_b1291
# B1290
	lw x67, 0(x65)
	lw x71, 0(x70)
	fsub x71, x71, x68
	...
	lw x73, 1(x73)
	fle x72, x73, x72
	bne	x72, zero, trace_ray_beqelse_b1297
# B1293
	lw x72, 2(x67)
	fmul x72, x71, x72
	fadd x72, x72, x7
...
# B1295
	...
	mv x73, x72
# B1296
	bne	x73, zero, trace_ray_beqelse_b1298
...
# B1297
	...
	lw x73, 0(x73)
	fle x72, x73, x72
	bne	x72, zero, trace_ray_beqelse_b1304
# B1300
	lw x72, 2(x67)
	fmul x72, x71, x72
	fadd x72, x72, x7
...
# B1302
	...
	mv x73, x72
# B1303
	bne	x73, zero, trace_ray_beqelse_b1305
...
# B1307
	...
	lw x66, 1(x66)
	fle x66, x66, x67
	bne	x66, zero, trace_ray_beqelse_b1311
# B1309
	lw x66, 5(x70)
	feq x66, x66, zero
	xori x66, x66, 1
	mv x67, x66
# B1310
	bne	x67, zero, trace_ray_beqelse_b1312
...
# B1291
	bne	x71, x12, trace_ray_beqelse_b1314
# B1313
	lw x66, 0(x70)
	fle x66, zero, x66
	beq	x66, zero, trace_ray_bneelse_b1316
# B1315
	mv x66, zero
	addi x5, x5, 1
	j trace_ray_cont_b1325 # adhoc jump(2)
...
# B1314
	lw x71, 0(x70)
	feq x72, x71, zero
	bne	x72, zero, trace_ray_beqelse_b1318
# B1317
	lw x72, 1(x70)
	fmul x68, x72, x68
	lw x72, 2(x70)
	...
	fsub x67, x69, x67
	fle x69, x67, zero
	beq	x69, zero, trace_ray_bneelse_b1320
# B1319
	mv x66, zero
	addi x5, x5, 1
	j trace_ray_cont_b1325 # adhoc jump(2)
...
# B1320
	lw x66, 6(x66)
	fsqrt x67, x67
	bne	x66, zero, trace_ray_beqelse_b1322
# B1321
	fsub x66, x68, x67
	lw x67, 4(x70)
	fmul x66, x66, x67
...
# B1324
	addi x5, x5, 1
	bne	x66, zero, trace_ray_beqelse_b1326
	j trace_ray_cont_b1325 # adhoc jump(3)
trace_ray_beqelse_b1326:
# B1326
	lw x67, 0(x114)
	fle x68, x67, zero
	bne	x68, zero, trace_ray_beqelse_b1359
# B1330
	lw x68, 0(x108)
	fle x68, x68, x67
	bne	x68, zero, trace_ray_beqelse_b1359
...
# B1333
	lw x7, 0(x70)
	bne	x7, x117, trace_ray_beqelse_b1335
# B1334
	mv x74, x111
# B1356
	bne	x74, zero, trace_ray_beqelse_b1358
...
# B1335
	...
	fsub x76, x73, x76
	lw x77, 1(x7)
	bne	x77, x111, trace_ray_beqelse_b1337
# B1336
	fabs x74, x74
	lw x77, 4(x7)
	lw x77, 0(x77)
	fle x74, x77, x74
	bne	x74, zero, trace_ray_beqelse_b1343
# B1339
	fabs x74, x75
	lw x75, 4(x7)
	lw x75, 1(x75)
...
# B1341
	...
	mv x75, x74
# B1342
	bne	x75, zero, trace_ray_beqelse_b1344
...
# B1337
	bne	x77, x12, trace_ray_beqelse_b1346
# B1345
	lw x77, 4(x7)
	lw x78, 0(x77)
	fmul x74, x78, x74
...
# B1346
	...
	fadd x77, x77, x78
	lw x78, 3(x7)
	bne	x78, zero, trace_ray_beqelse_b1348
# B1347
	mv x74, x77
...
# B1349
	lw x75, 1(x7)
	bne	x75, x14, trace_ray_beqelse_b1352
# B1350
	fsub x74, x74, x15
...
# B1353
	bne	x7, zero, trace_ray_beqelse_b1357
# B1354
	addi x70, x70, 1
...
# B1283
	...
	lw x38, 0(x4)
	lw x66, 1(x39)
	bne	x66, x111, trace_ray_beqelse_b1362
# B1361
	lw x40, 0(x37)
	lw x66, 0(x38)
	fsub x66, x66, x5
	...
	lw x68, 1(x68)
	fle x67, x68, x67
	bne	x67, zero, trace_ray_beqelse_b1368
# B1364
	lw x67, 2(x40)
	fmul x67, x66, x67
	fadd x67, x67, x65
...
# B1366
	...
	mv x68, x67
# B1367
	bne	x68, zero, trace_ray_beqelse_b1369
...
# B1368
	...
	lw x68, 0(x68)
	fle x67, x68, x67
	bne	x67, zero, trace_ray_beqelse_b1375
# B1371
	lw x67, 2(x40)
	fmul x67, x66, x67
	fadd x67, x67, x65
...
# B1373
	...
	mv x68, x67
# B1374
	bne	x68, zero, trace_ray_beqelse_b1376
...
# B1375
	...
	lw x66, 0(x66)
	fle x5, x66, x5
	bne	x5, zero, trace_ray_beqelse_b1382
# B1378
	lw x40, 1(x40)
	fmul x40, x65, x40
	fadd x40, x40, x6
	...
	lw x39, 1(x39)
	fle x39, x39, x40
	bne	x39, zero, trace_ray_beqelse_b1382
# B1380
	lw x38, 5(x38)
	feq x38, x38, zero
	xori x38, x38, 1
	mv x39, x38
# B1381
	bne	x39, zero, trace_ray_beqelse_b1383
...
# B1362
	bne	x66, x12, trace_ray_beqelse_b1385
# B1384
	lw x39, 0(x38)
	fle x39, zero, x39
	bne	x39, zero, trace_ray_beqelse_b1396
# B1387
	lw x38, 0(x38)
	lw x39, 3(x40)
	fmul x38, x38, x39
...
# B1385
	lw x66, 0(x38)
	feq x67, x66, zero
	bne	x67, zero, trace_ray_beqelse_b1396
# B1388
	lw x67, 1(x38)
	fmul x5, x67, x5
	lw x67, 2(x38)
	...
	fsub x40, x6, x40
	fle x6, x40, zero
	bne	x6, zero, trace_ray_beqelse_b1396
# B1391
	lw x39, 6(x39)
	fsqrt x40, x40
	bne	x39, zero, trace_ray_beqelse_b1393
# B1392
	fsub x39, x5, x40
	lw x38, 4(x38)
	fmul x38, x39, x38
...
# B1395
	bne	x38, zero, trace_ray_beqelse_b1397
...
# B1397
	...
	lw x39, 0(x108)
	fle x38, x39, x38
	bne	x38, zero, trace_ray_beqelse_b1477
# B1399
	addi x28, x28, 1
	mv x39, x37
	mv x38, x28
...
# B1403
	lw x28, 0(x65)
	lw x40, 0(x5)
	beq	x40, x117, trace_ray_bneelse_b1476
# B1405
	add x4, x11, x40
	lw x66, 0(x4)
	lw x67, 10(x66)
	...
	lw x70, 0(x4)
	lw x71, 1(x66)
	bne	x71, x111, trace_ray_beqelse_b1407
# B1406
	lw x67, 0(x65)
	lw x71, 0(x70)
	fsub x71, x71, x68
	...
	lw x73, 1(x73)
	fle x72, x73, x72
	bne	x72, zero, trace_ray_beqelse_b1413
# B1409
	lw x72, 2(x67)
	fmul x72, x71, x72
	fadd x72, x72, x7
...
# B1411
	...
	mv x73, x72
# B1412
	bne	x73, zero, trace_ray_beqelse_b1414
...
# B1413
	...
	lw x73, 0(x73)
	fle x72, x73, x72
	bne	x72, zero, trace_ray_beqelse_b1420
# B1416
	lw x72, 2(x67)
	fmul x72, x71, x72
	fadd x72, x72, x7
...
# B1418
	...
	mv x73, x72
# B1419
	bne	x73, zero, trace_ray_beqelse_b1421
...
# B1423
	...
	lw x66, 1(x66)
	fle x66, x66, x67
	bne	x66, zero, trace_ray_beqelse_b1427
# B1425
	lw x66, 5(x70)
	feq x66, x66, zero
	xori x66, x66, 1
	mv x67, x66
# B1426
	bne	x67, zero, trace_ray_beqelse_b1428
...
# B1407
	bne	x71, x12, trace_ray_beqelse_b1430
# B1429
	lw x66, 0(x70)
	fle x66, zero, x66
	beq	x66, zero, trace_ray_bneelse_b1432
# B1431
	mv x66, zero
	addi x5, x5, 1
	j trace_ray_cont_b1441 # adhoc jump(2)
...
# B1430
	lw x71, 0(x70)
	feq x72, x71, zero
	bne	x72, zero, trace_ray_beqelse_b1434
# B1433
	lw x72, 1(x70)
	fmul x68, x72, x68
	lw x72, 2(x70)
	...
	fsub x67, x69, x67
	fle x69, x67, zero
	beq	x69, zero, trace_ray_bneelse_b1436
# B1435
	mv x66, zero
	addi x5, x5, 1
	j trace_ray_cont_b1441 # adhoc jump(2)
...
# B1436
	lw x66, 6(x66)
	fsqrt x67, x67
	bne	x66, zero, trace_ray_beqelse_b1438
# B1437
	fsub x66, x68, x67
	lw x67, 4(x70)
	fmul x66, x66, x67
...
# B1440
	addi x5, x5, 1
	bne	x66, zero, trace_ray_beqelse_b1442
	j trace_ray_cont_b1441 # adhoc jump(3)
trace_ray_beqelse_b1442:
# B1442
	lw x67, 0(x114)
	fle x68, x67, zero
	bne	x68, zero, trace_ray_beqelse_b1475
# B1446
	lw x68, 0(x108)
	fle x68, x68, x67
	bne	x68, zero, trace_ray_beqelse_b1475
...
# B1449
	lw x7, 0(x70)
	bne	x7, x117, trace_ray_beqelse_b1451
# B1450
	mv x74, x111
# B1472
	bne	x74, zero, trace_ray_beqelse_b1474
...
# B1451
	...
	fsub x76, x73, x76
	lw x77, 1(x7)
	bne	x77, x111, trace_ray_beqelse_b1453
# B1452
	fabs x74, x74
	lw x77, 4(x7)
	lw x77, 0(x77)
	fle x74, x77, x74
	bne	x74, zero, trace_ray_beqelse_b1459
# B1455
	fabs x74, x75
	lw x75, 4(x7)
	lw x75, 1(x75)
...
# B1457
	...
	mv x75, x74
# B1458
	bne	x75, zero, trace_ray_beqelse_b1460
...
# B1453
	bne	x77, x12, trace_ray_beqelse_b1462
# B1461
	lw x77, 4(x7)
	lw x78, 0(x77)
	fmul x74, x78, x74
...
# B1462
	...
	fadd x77, x77, x78
	lw x78, 3(x7)
	bne	x78, zero, trace_ray_beqelse_b1464
# B1463
	mv x74, x77
...
# B1465
	lw x75, 1(x7)
	bne	x75, x14, trace_ray_beqelse_b1468
# B1466
	fsub x74, x74, x15
...
# B1469
	bne	x7, zero, trace_ray_beqelse_b1473
# B1470
	addi x70, x70, 1
...
# B1486
	lw x28, 0(x36)
	lw x37, 0(x28)
	beq	x37, x117, trace_ray_bneelse_b1712
# B1488
	bne	x37, x112, trace_ray_beqelse_b1490
# B1489
	mv x37, x111
...
# B1490
	...
	lw x37, 0(x4)
	lw x6, 1(x38)
	bne	x6, x111, trace_ray_beqelse_b1492
# B1491
	lw x6, 0(x23)
	lw x65, 0(x37)
	fsub x65, x65, x39
	...
	lw x67, 1(x67)
	fle x66, x67, x66
	bne	x66, zero, trace_ray_beqelse_b1498
# B1494
	lw x66, 2(x6)
	fmul x66, x65, x66
	fadd x66, x66, x5
...
# B1496
	...
	mv x67, x66
# B1497
	bne	x67, zero, trace_ray_beqelse_b1499
...
# B1498
	...
	lw x67, 0(x67)
	fle x66, x67, x66
	bne	x66, zero, trace_ray_beqelse_b1505
# B1501
	lw x66, 2(x6)
	fmul x66, x65, x66
	fadd x66, x66, x5
...
# B1503
	...
	mv x67, x66
# B1504
	bne	x67, zero, trace_ray_beqelse_b1506
...
# B1508
	...
	lw x38, 1(x38)
	fle x38, x38, x39
	bne	x38, zero, trace_ray_beqelse_b1512
# B1510
	lw x37, 5(x37)
	feq x37, x37, zero
	xori x37, x37, 1
	mv x38, x37
# B1511
	bne	x38, zero, trace_ray_beqelse_b1513
...
# B1492
	bne	x6, x12, trace_ray_beqelse_b1515
# B1514
	lw x38, 0(x37)
	fle x38, zero, x38
	bne	x38, zero, trace_ray_beqelse_b1532
# B1517
	lw x38, 1(x37)
	fmul x38, x38, x39
	lw x39, 2(x37)
...
# B1515
	lw x6, 0(x37)
	feq x65, x6, zero
	bne	x65, zero, trace_ray_beqelse_b1532
# B1518
	lw x65, 1(x37)
	fmul x65, x65, x39
	lw x66, 2(x37)
	...
	fadd x66, x66, x67
	lw x67, 3(x38)
	bne	x67, zero, trace_ray_beqelse_b1521
# B1520
	mv x39, x66
...
# B1522
	lw x40, 1(x38)
	bne	x40, x14, trace_ray_beqelse_b1525
# B1523
	fsub x39, x39, x15
...
# B1525
	...
	fsub x39, x40, x39
	fle x40, x39, zero
	bne	x40, zero, trace_ray_beqelse_b1532
# B1527
	lw x38, 6(x38)
	fsqrt x39, x39
	bne	x38, zero, trace_ray_beqelse_b1529
# B1528
	fsub x38, x65, x39
	lw x37, 4(x37)
	fmul x37, x38, x37
...
# B1531
	bne	x37, zero, trace_ray_beqelse_b1533
...
# B1533
	lw x37, 0(x114)
	fle x37, x100, x37
	beq	x37, zero, trace_ray_bneelse_b1535
# B1534
	addi x36, x36, 1
	j trace_ray_cont_b1623 # adhoc jump(2)
...
# B1536
	lw x37, 0(x38)
	beq	x37, x117, trace_ray_bneelse_b1620
# B1538
	add x4, x118, x37
	lw x37, 0(x4)
	addi x39, x37, 0
...
# B1539
	lw x37, 0(x40)
	beq	x37, x117, trace_ray_bneelse_b1617
# B1541
	lw x37, 0(x40)
	add x4, x11, x37
	lw x39, 0(x4)
	...
	lw x67, 0(x4)
	lw x68, 1(x39)
	bne	x68, x111, trace_ray_beqelse_b1543
# B1542
	lw x68, 0(x23)
	lw x69, 0(x67)
	fsub x69, x69, x6
	...
	lw x70, 1(x70)
	fle x7, x70, x7
	bne	x7, zero, trace_ray_beqelse_b1549
# B1545
	lw x7, 2(x68)
	fmul x7, x69, x7
	fadd x7, x7, x66
...
# B1547
	...
	mv x70, x7
# B1548
	bne	x70, zero, trace_ray_beqelse_b1550
...
# B1549
	...
	lw x70, 0(x70)
	fle x7, x70, x7
	bne	x7, zero, trace_ray_beqelse_b1556
# B1552
	lw x7, 2(x68)
	fmul x7, x69, x7
	fadd x7, x7, x66
...
# B1554
	...
	mv x70, x7
# B1555
	bne	x70, zero, trace_ray_beqelse_b1557
...
# B1556
	...
	lw x69, 0(x69)
	fle x6, x69, x6
	bne	x6, zero, trace_ray_beqelse_b1563
# B1559
	lw x6, 1(x68)
	fmul x6, x66, x6
	fadd x6, x6, x65
	...
	lw x39, 1(x39)
	fle x39, x39, x6
	bne	x39, zero, trace_ray_beqelse_b1563
# B1561
	lw x39, 5(x67)
	feq x39, x39, zero
	xori x39, x39, 1
	mv x6, x39
# B1562
	bne	x6, zero, trace_ray_beqelse_b1564
...
# B1543
	bne	x68, x12, trace_ray_beqelse_b1566
# B1565
	lw x39, 0(x67)
	fle x39, zero, x39
	beq	x39, zero, trace_ray_bneelse_b1568
# B1567
	lw x6, 0(x114)
	j trace_ray_cont_b1583 # adhoc jump(2)
...
# B1566
	lw x68, 0(x67)
	feq x69, x68, zero
	bne	x69, zero, trace_ray_beqelse_b1570
# B1569
	lw x69, 1(x67)
	fmul x69, x69, x6
	lw x7, 2(x67)
	...
	fadd x7, x7, x70
	lw x70, 3(x39)
	bne	x70, zero, trace_ray_beqelse_b1572
# B1571
	mv x6, x7
...
# B1573
	lw x65, 1(x39)
	bne	x65, x14, trace_ray_beqelse_b1576
# B1574
	fsub x6, x6, x15
...
# B1576
	...
	fsub x6, x65, x6
	fle x65, x6, zero
	beq	x65, zero, trace_ray_bneelse_b1578
# B1577
	lw x6, 0(x114)
	j trace_ray_cont_b1583 # adhoc jump(2)
...
# B1578
	lw x39, 6(x39)
	fsqrt x6, x6
	bne	x39, zero, trace_ray_beqelse_b1580
# B1579
	fsub x39, x69, x6
	lw x6, 4(x67)
	fmul x39, x39, x6
...
# B1582
	lw x6, 0(x114)
	bne	x39, zero, trace_ray_beqelse_b1584
...
# B1585
	addi x40, x40, 1
	bne	x39, zero, trace_ray_beqelse_b1587
...
# B1590
	lw x37, 0(x66)
	bne	x37, x117, trace_ray_beqelse_b1592
# B1591
	mv x39, x111
# B1613
	bne	x39, zero, trace_ray_beqelse_b1615
	j trace_ray_cont_b1614 # adhoc jump(3)
trace_ray_beqelse_b1615:
# B1615
	mv x37, x111
# B1616
	bne	x37, zero, trace_ray_beqelse_b1618
	j trace_ray_cont_b1617 # adhoc jump(3)
trace_ray_beqelse_b1618:
# B1618
	mv x39, x111
# B1619
	bne	x39, zero, trace_ray_beqelse_b1621
...
# B1622
	addi x36, x36, 1
	bne	x37, zero, trace_ray_beqelse_b1624
...
# B1625
	lw x28, 0(x37)
	beq	x28, x117, trace_ray_bneelse_b1709
# B1627
	add x4, x118, x28
	lw x28, 0(x4)
	addi x38, x28, 0
...
# B1628
	lw x28, 0(x39)
	beq	x28, x117, trace_ray_bneelse_b1706
# B1630
	lw x28, 0(x39)
	add x4, x11, x28
	lw x38, 0(x4)
	...
	lw x66, 0(x4)
	lw x67, 1(x38)
	bne	x67, x111, trace_ray_beqelse_b1632
# B1631
	lw x67, 0(x23)
	lw x68, 0(x66)
	fsub x68, x68, x5
	...
	lw x7, 1(x7)
	fle x69, x7, x69
	bne	x69, zero, trace_ray_beqelse_b1638
# B1634
	lw x69, 2(x67)
	fmul x69, x68, x69
	fadd x69, x69, x65
...
# B1636
	...
	mv x7, x69
# B1637
	bne	x7, zero, trace_ray_beqelse_b1639
...
# B1638
	...
	lw x7, 0(x7)
	fle x69, x7, x69
	bne	x69, zero, trace_ray_beqelse_b1645
# B1641
	lw x69, 2(x67)
	fmul x69, x68, x69
	fadd x69, x69, x65
...
# B1645
	...
	lw x68, 0(x68)
	fle x5, x68, x5
	bne	x5, zero, trace_ray_beqelse_b1652
# B1648
	lw x5, 1(x67)
	fmul x5, x65, x5
	fadd x5, x5, x6
	...
	lw x38, 1(x38)
	fle x38, x38, x5
	bne	x38, zero, trace_ray_beqelse_b1652
# B1650
	lw x38, 5(x66)
	feq x38, x38, zero
	xori x38, x38, 1
	mv x5, x38
# B1651
	bne	x5, zero, trace_ray_beqelse_b1653
...
# B1632
	bne	x67, x12, trace_ray_beqelse_b1655
# B1654
	lw x38, 0(x66)
	fle x38, zero, x38
	beq	x38, zero, trace_ray_bneelse_b1657
# B1656
	lw x5, 0(x114)
	j trace_ray_cont_b1672 # adhoc jump(2)
...
# B1655
	lw x67, 0(x66)
	feq x68, x67, zero
	bne	x68, zero, trace_ray_beqelse_b1659
# B1658
	lw x68, 1(x66)
	fmul x68, x68, x5
	lw x69, 2(x66)
	...
	fadd x69, x69, x7
	lw x7, 3(x38)
	bne	x7, zero, trace_ray_beqelse_b1661
# B1660
	mv x5, x69
...
# B1662
	lw x6, 1(x38)
	bne	x6, x14, trace_ray_beqelse_b1665
# B1663
	fsub x5, x5, x15
...
# B1665
	...
	fsub x5, x6, x5
	fle x6, x5, zero
	beq	x6, zero, trace_ray_bneelse_b1667
# B1666
	lw x5, 0(x114)
	j trace_ray_cont_b1672 # adhoc jump(2)
...
# B1667
	lw x38, 6(x38)
	fsqrt x5, x5
	bne	x38, zero, trace_ray_beqelse_b1669
# B1668
	fsub x38, x68, x5
	lw x5, 4(x66)
	fmul x38, x38, x5
...
# B1671
	lw x5, 0(x114)
	bne	x38, zero, trace_ray_beqelse_b1673
...
# B1674
	addi x39, x39, 1
	bne	x38, zero, trace_ray_beqelse_b1676
...
# B1679
	lw x28, 0(x65)
	bne	x28, x117, trace_ray_beqelse_b1681
# B1680
	mv x38, x111
# B1702
	bne	x38, zero, trace_ray_beqelse_b1704
...
# B1681
	...
	fsub x6, x68, x6
	lw x69, 1(x28)
	bne	x69, x111, trace_ray_beqelse_b1683
# B1682
	fabs x38, x38
	lw x69, 4(x28)
	lw x69, 0(x69)
	fle x38, x69, x38
	bne	x38, zero, trace_ray_beqelse_b1689
# B1685
	fabs x38, x5
	lw x5, 4(x28)
	lw x5, 1(x5)
...
# B1687
	...
	mv x5, x38
# B1688
	bne	x5, zero, trace_ray_beqelse_b1690
...
# B1683
	bne	x69, x12, trace_ray_beqelse_b1692
# B1691
	lw x69, 4(x28)
	lw x7, 0(x69)
	fmul x38, x7, x38
...
# B1692
	...
	fadd x69, x69, x7
	lw x7, 3(x28)
	bne	x7, zero, trace_ray_beqelse_b1694
# B1693
	mv x38, x69
...
# B1695
	lw x5, 1(x28)
	bne	x5, x14, trace_ray_beqelse_b1698
# B1696
	fsub x38, x38, x15
...
# B1592
	...
	fsub x65, x69, x65
	lw x7, 1(x37)
	bne	x7, x111, trace_ray_beqelse_b1594
# B1593
	fabs x39, x39
	lw x7, 4(x37)
	lw x7, 0(x7)
	fle x39, x7, x39
	bne	x39, zero, trace_ray_beqelse_b1600
# B1596
	fabs x39, x6
	lw x6, 4(x37)
	lw x6, 1(x6)
...
# B1598
	...
	mv x6, x39
# B1599
	bne	x6, zero, trace_ray_beqelse_b1601
...
# B1594
	bne	x7, x12, trace_ray_beqelse_b1603
# B1602
	lw x7, 4(x37)
	lw x70, 0(x7)
	fmul x39, x70, x39
...
# B1603
	...
	fadd x7, x7, x70
	lw x70, 3(x37)
	bne	x70, zero, trace_ray_beqelse_b1605
# B1604
	mv x39, x7
...
# B1606
	lw x6, 1(x37)
	bne	x6, x14, trace_ray_beqelse_b1609
# B1607
	fsub x39, x39, x15
...
# B1610
	bne	x37, zero, trace_ray_beqelse_b1614
# B1611
	addi x66, x66, 1
...
# B1586
	...
	lw x37, 0(x4)
	lw x37, 6(x37)
	beq	x37, zero, trace_ray_bneelse_b1617
...
# B1222
	...
	fsub x36, x40, x36
	lw x5, 1(x19)
	bne	x5, x111, trace_ray_beqelse_b1224
# B1223
	fabs x32, x32
	lw x5, 4(x19)
	lw x5, 0(x5)
	fle x32, x5, x32
	bne	x32, zero, trace_ray_beqelse_b1230
# B1226
	fabs x32, x35
	lw x35, 4(x19)
	lw x35, 1(x35)
...
# B1228
	...
	mv x35, x32
# B1229
	bne	x35, zero, trace_ray_beqelse_b1231
...
# B1224
	bne	x5, x12, trace_ray_beqelse_b1233
# B1232
	lw x5, 4(x19)
	lw x6, 0(x5)
	fmul x32, x6, x32
...
# B1233
	...
	fadd x5, x5, x6
	lw x6, 3(x19)
	bne	x6, zero, trace_ray_beqelse_b1235
# B1234
	mv x32, x5
...
# B1236
	lw x35, 1(x19)
	bne	x35, x14, trace_ray_beqelse_b1239
# B1237
	fsub x32, x32, x15
...
# B1133
	...
	fsub x37, x5, x37
	lw x6, 1(x29)
	bne	x6, x111, trace_ray_beqelse_b1135
# B1134
	fabs x33, x33
	lw x6, 4(x29)
	lw x6, 0(x6)
	fle x33, x6, x33
	bne	x33, zero, trace_ray_beqelse_b1141
# B1137
	fabs x33, x36
	lw x36, 4(x29)
	lw x36, 1(x36)
...
# B1139
	...
	mv x36, x33
# B1140
	bne	x36, zero, trace_ray_beqelse_b1142
...
# B1135
	bne	x6, x12, trace_ray_beqelse_b1144
# B1143
	lw x6, 4(x29)
	lw x65, 0(x6)
	fmul x33, x65, x33
...
# B1144
	...
	fadd x6, x6, x65
	lw x65, 3(x29)
	bne	x65, zero, trace_ray_beqelse_b1146
# B1145
	mv x33, x6
...
# B1147
	lw x36, 1(x29)
	bne	x36, x14, trace_ray_beqelse_b1150
# B1148
	fsub x33, x33, x15
...
# B1151
	bne	x29, zero, trace_ray_beqelse_b1155
# B1152
	addi x38, x38, 1
...
# B1127
	...
	lw x29, 0(x4)
	lw x29, 6(x29)
	beq	x29, zero, trace_ray_bneelse_b1158
...
# B1730
	...
	la x26, min_caml_intersected_object_id
	la x27, min_caml_intsec_rectside
	beq	x17, x18, trace_diffuse_ray_bneelse_b1929
# B1732
	la x28, min_caml_startp_fast
	bne	x17, x13, trace_diffuse_ray_beqelse_b1734
# B1733
	addi x11, x11, 1
	mv x29, x16
	mv x17, x11
...
# B1735
	lw x11, 0(x17)
	beq	x11, x18, trace_diffuse_ray_bneelse_b1928
# B1737
	add x4, x19, x11
	lw x11, 0(x4)
	addi x30, x11, 0
...
# B1738
	lw x11, 0(x33)
	lw x30, 0(x31)
	beq	x30, x18, trace_diffuse_ray_bneelse_b1811
# B1740
	add x4, x20, x30
	lw x34, 0(x4)
	lw x35, 10(x34)
	...
	lw x39, 0(x4)
	lw x40, 1(x34)
	bne	x40, x12, trace_diffuse_ray_beqelse_b1742
# B1741
	lw x35, 0(x33)
	lw x40, 0(x39)
	fsub x40, x40, x36
	...
	lw x66, 1(x66)
	fle x6, x66, x6
	bne	x6, zero, trace_diffuse_ray_beqelse_b1748
# B1744
	lw x6, 2(x35)
	fmul x6, x40, x6
	fadd x6, x6, x38
...
# B1746
	...
	mv x66, x6
# B1747
	bne	x66, zero, trace_diffuse_ray_beqelse_b1749
...
# B1748
	...
	lw x66, 0(x66)
	fle x6, x66, x6
	bne	x6, zero, trace_diffuse_ray_beqelse_b1755
# B1751
	lw x6, 2(x35)
	fmul x6, x40, x6
	fadd x6, x6, x38
...
# B1753
	...
	mv x66, x6
# B1754
	bne	x66, zero, trace_diffuse_ray_beqelse_b1756
...
# B1758
	...
	lw x34, 1(x34)
	fle x34, x34, x35
	bne	x34, zero, trace_diffuse_ray_beqelse_b1762
# B1760
	lw x34, 5(x39)
	feq x34, x34, zero
	xori x34, x34, 1
	mv x35, x34
# B1761
	bne	x35, zero, trace_diffuse_ray_beqelse_b1763
...
# B1742
	bne	x40, x21, trace_diffuse_ray_beqelse_b1765
# B1764
	lw x34, 0(x39)
	fle x34, zero, x34
	beq	x34, zero, trace_diffuse_ray_bneelse_b1767
# B1766
	mv x34, zero
	addi x31, x31, 1
	j trace_diffuse_ray_cont_b1776 # adhoc jump(2)
...
# B1765
	lw x40, 0(x39)
	feq x6, x40, zero
	bne	x6, zero, trace_diffuse_ray_beqelse_b1769
# B1768
	lw x6, 1(x39)
	fmul x36, x6, x36
	lw x6, 2(x39)
	...
	fsub x35, x37, x35
	fle x37, x35, zero
	beq	x37, zero, trace_diffuse_ray_bneelse_b1771
# B1770
	mv x34, zero
	addi x31, x31, 1
	j trace_diffuse_ray_cont_b1776 # adhoc jump(2)
...
# B1771
	lw x34, 6(x34)
	fsqrt x35, x35
	bne	x34, zero, trace_diffuse_ray_beqelse_b1773
# B1772
	fsub x34, x36, x35
	lw x35, 4(x39)
	fmul x34, x34, x35
...
# B1775
	addi x31, x31, 1
	bne	x34, zero, trace_diffuse_ray_beqelse_b1777
...
# B1777
	lw x35, 0(x14)
	fle x36, x35, zero
	bne	x36, zero, trace_diffuse_ray_beqelse_b1810
# B1781
	lw x36, 0(x10)
	fle x36, x36, x35
	bne	x36, zero, trace_diffuse_ray_beqelse_b1810
...
# B1784
	lw x38, 0(x39)
	bne	x38, x18, trace_diffuse_ray_beqelse_b1786
# B1785
	mv x67, x12
# B1807
	bne	x67, zero, trace_diffuse_ray_beqelse_b1809
...
# B1786
	...
	fsub x69, x66, x69
	lw x7, 1(x38)
	bne	x7, x12, trace_diffuse_ray_beqelse_b1788
# B1787
	fabs x67, x67
	lw x7, 4(x38)
	lw x7, 0(x7)
	fle x67, x7, x67
	bne	x67, zero, trace_diffuse_ray_beqelse_b1794
# B1790
	fabs x67, x68
	lw x68, 4(x38)
	lw x68, 1(x68)
...
# B1792
	...
	mv x68, x67
# B1793
	bne	x68, zero, trace_diffuse_ray_beqelse_b1795
...
# B1788
	bne	x7, x21, trace_diffuse_ray_beqelse_b1797
# B1796
	lw x7, 4(x38)
	lw x70, 0(x7)
	fmul x67, x70, x67
...
# B1797
	...
	fadd x7, x7, x70
	lw x70, 3(x38)
	bne	x70, zero, trace_diffuse_ray_beqelse_b1799
# B1798
	mv x67, x7
...
# B1800
	lw x68, 1(x38)
	bne	x68, x23, trace_diffuse_ray_beqelse_b1803
# B1801
	fsub x67, x67, x24
...
# B1804
	bne	x38, zero, trace_diffuse_ray_beqelse_b1808
# B1805
	addi x39, x39, 1
...
# B1734
	...
	lw x17, 0(x4)
	lw x34, 1(x29)
	bne	x34, x12, trace_diffuse_ray_beqelse_b1813
# B1812
	lw x30, 0(x16)
	lw x34, 0(x17)
	fsub x34, x34, x31
	...
	lw x36, 1(x36)
	fle x35, x36, x35
	bne	x35, zero, trace_diffuse_ray_beqelse_b1819
# B1815
	lw x35, 2(x30)
	fmul x35, x34, x35
	fadd x35, x35, x33
...
# B1817
	...
	mv x36, x35
# B1818
	bne	x36, zero, trace_diffuse_ray_beqelse_b1820
...
# B1819
	...
	lw x36, 0(x36)
	fle x35, x36, x35
	bne	x35, zero, trace_diffuse_ray_beqelse_b1826
# B1822
	lw x35, 2(x30)
	fmul x35, x34, x35
	fadd x35, x35, x33
...
# B1824
	...
	mv x36, x35
# B1825
	bne	x36, zero, trace_diffuse_ray_beqelse_b1827
...
# B1826
	...
	lw x34, 0(x34)
	fle x31, x34, x31
	bne	x31, zero, trace_diffuse_ray_beqelse_b1833
# B1829
	lw x30, 1(x30)
	fmul x30, x33, x30
	fadd x30, x30, x32
	...
	lw x29, 1(x29)
	fle x29, x29, x30
	bne	x29, zero, trace_diffuse_ray_beqelse_b1833
# B1831
	lw x17, 5(x17)
	feq x17, x17, zero
	xori x17, x17, 1
	mv x29, x17
# B1832
	bne	x29, zero, trace_diffuse_ray_beqelse_b1834
...
# B1813
	bne	x34, x21, trace_diffuse_ray_beqelse_b1836
# B1835
	lw x29, 0(x17)
	fle x29, zero, x29
	bne	x29, zero, trace_diffuse_ray_beqelse_b1847
# B1838
	lw x17, 0(x17)
	lw x29, 3(x30)
	fmul x17, x17, x29
...
# B1836
	lw x34, 0(x17)
	feq x35, x34, zero
	bne	x35, zero, trace_diffuse_ray_beqelse_b1847
# B1839
	lw x35, 1(x17)
	fmul x31, x35, x31
	lw x35, 2(x17)
	...
	fsub x30, x32, x30
	fle x32, x30, zero
	bne	x32, zero, trace_diffuse_ray_beqelse_b1847
# B1842
	lw x29, 6(x29)
	fsqrt x30, x30
	bne	x29, zero, trace_diffuse_ray_beqelse_b1844
# B1843
	fsub x29, x31, x30
	lw x17, 4(x17)
	fmul x17, x29, x17
...
# B1846
	bne	x17, zero, trace_diffuse_ray_beqelse_b1848
...
# B1848
	...
	lw x29, 0(x10)
	fle x17, x29, x17
	bne	x17, zero, trace_diffuse_ray_beqelse_b1928
# B1850
	addi x11, x11, 1
	mv x29, x16
	mv x17, x11
...
# B1854
	lw x11, 0(x33)
	lw x30, 0(x31)
	beq	x30, x18, trace_diffuse_ray_bneelse_b1927
# B1856
	add x4, x20, x30
	lw x34, 0(x4)
	lw x35, 10(x34)
	...
	lw x39, 0(x4)
	lw x40, 1(x34)
	bne	x40, x12, trace_diffuse_ray_beqelse_b1858
# B1857
	lw x35, 0(x33)
	lw x40, 0(x39)
	fsub x40, x40, x36
	...
	lw x66, 1(x66)
	fle x6, x66, x6
	bne	x6, zero, trace_diffuse_ray_beqelse_b1864
# B1860
	lw x6, 2(x35)
	fmul x6, x40, x6
	fadd x6, x6, x38
...
# B1862
	...
	mv x66, x6
# B1863
	bne	x66, zero, trace_diffuse_ray_beqelse_b1865
...
# B1864
	...
	lw x66, 0(x66)
	fle x6, x66, x6
	bne	x6, zero, trace_diffuse_ray_beqelse_b1871
# B1867
	lw x6, 2(x35)
	fmul x6, x40, x6
	fadd x6, x6, x38
...
# B1869
	...
	mv x66, x6
# B1870
	bne	x66, zero, trace_diffuse_ray_beqelse_b1872
...
# B1874
	...
	lw x34, 1(x34)
	fle x34, x34, x35
	bne	x34, zero, trace_diffuse_ray_beqelse_b1878
# B1876
	lw x34, 5(x39)
	feq x34, x34, zero
	xori x34, x34, 1
	mv x35, x34
# B1877
	bne	x35, zero, trace_diffuse_ray_beqelse_b1879
...
# B1858
	bne	x40, x21, trace_diffuse_ray_beqelse_b1881
# B1880
	lw x34, 0(x39)
	fle x34, zero, x34
	beq	x34, zero, trace_diffuse_ray_bneelse_b1883
# B1882
	mv x34, zero
	addi x31, x31, 1
	j trace_diffuse_ray_cont_b1892 # adhoc jump(2)
...
# B1881
	lw x40, 0(x39)
	feq x6, x40, zero
	bne	x6, zero, trace_diffuse_ray_beqelse_b1885
# B1884
	lw x6, 1(x39)
	fmul x36, x6, x36
	lw x6, 2(x39)
	...
	fsub x35, x37, x35
	fle x37, x35, zero
	beq	x37, zero, trace_diffuse_ray_bneelse_b1887
# B1886
	mv x34, zero
	addi x31, x31, 1
	j trace_diffuse_ray_cont_b1892 # adhoc jump(2)
...
# B1887
	lw x34, 6(x34)
	fsqrt x35, x35
	bne	x34, zero, trace_diffuse_ray_beqelse_b1889
# B1888
	fsub x34, x36, x35
	lw x35, 4(x39)
	fmul x34, x34, x35
...
# B1891
	addi x31, x31, 1
	bne	x34, zero, trace_diffuse_ray_beqelse_b1893
	j trace_diffuse_ray_cont_b1892 # adhoc jump(3)
trace_diffuse_ray_beqelse_b1893:
# B1893
	lw x35, 0(x14)
	fle x36, x35, zero
	bne	x36, zero, trace_diffuse_ray_beqelse_b1926
# B1897
	lw x36, 0(x10)
	fle x36, x36, x35
	bne	x36, zero, trace_diffuse_ray_beqelse_b1926
...
# B1900
	lw x38, 0(x39)
	bne	x38, x18, trace_diffuse_ray_beqelse_b1902
# B1901
	mv x67, x12
# B1923
	bne	x67, zero, trace_diffuse_ray_beqelse_b1925
...
# B1902
	...
	fsub x69, x66, x69
	lw x7, 1(x38)
	bne	x7, x12, trace_diffuse_ray_beqelse_b1904
# B1903
	fabs x67, x67
	lw x7, 4(x38)
	lw x7, 0(x7)
	fle x67, x7, x67
	bne	x67, zero, trace_diffuse_ray_beqelse_b1910
# B1906
	fabs x67, x68
	lw x68, 4(x38)
	lw x68, 1(x68)
...
# B1908
	...
	mv x68, x67
# B1909
	bne	x68, zero, trace_diffuse_ray_beqelse_b1911
...
# B1904
	bne	x7, x21, trace_diffuse_ray_beqelse_b1913
# B1912
	lw x7, 4(x38)
	lw x70, 0(x7)
	fmul x67, x70, x67
...
# B1913
	...
	fadd x7, x7, x70
	lw x70, 3(x38)
	bne	x70, zero, trace_diffuse_ray_beqelse_b1915
# B1914
	mv x67, x7
...
# B1916
	lw x68, 1(x38)
	bne	x68, x23, trace_diffuse_ray_beqelse_b1919
# B1917
	fsub x67, x67, x24
...
# B1920
	bne	x38, zero, trace_diffuse_ray_beqelse_b1924
# B1921
	addi x39, x39, 1
...
# B1936
	bne	x16, x21, trace_diffuse_ray_beqelse_b1943
# B1942
	lw x15, 4(x10)
	lw x15, 0(x15)
	fsub x15, zero, x15
...
# B1955
	bne	x26, zero, trace_diffuse_ray_beqelse_b1958
# B1957
	lui x15, 276464
...
# B1956
	bne	x26, zero, trace_diffuse_ray_beqelse_b1960
# B1959
	mv x15, zero
	j trace_diffuse_ray_cont_b1961 # adhoc jump(2)
...
# B1954
	...
	addi x38, x38, 262
	lui x39, 276464
	bne	x15, x21, trace_diffuse_ray_beqelse_b1963
# B1962
	lw x15, 1(x25)
	lui x26, 256000
	fmul x15, x15, x26
...
# B1976
	xor x15, x15, x26
	fle x26, x31, x27
	bne	x26, zero, trace_diffuse_ray_beqelse_b1978
# B1977
	mv x26, x27
...
# B1963
	lui x40, 263313
	addi x40, x40, -37
	bne	x15, x23, trace_diffuse_ray_beqelse_b1987
# B1986
	lw x15, 0(x25)
	lw x26, 5(x10)
	lw x26, 0(x26)
...
# B2036
	...
	fsub x15, x15, x26
	fle x26, zero, x15
	beq	x26, zero, trace_diffuse_ray_bneelse_b2038
# B2037
	mv x27, x15
...
# B2041
	...
	beq	x27, x18, trace_diffuse_ray_bneelse_b2267
# B2043
	lui x29, 779469
	addi x29, x29, -819
	bne	x27, x13, trace_diffuse_ray_beqelse_b2045
# B2044
	mv x27, x12
...
# B2045
	...
	lw x27, 0(x4)
	lw x34, 1(x30)
	bne	x34, x12, trace_diffuse_ray_beqelse_b2047
# B2046
	lw x34, 0(x15)
	lw x35, 0(x27)
	fsub x35, x35, x31
	...
	lw x37, 1(x37)
	fle x36, x37, x36
	bne	x36, zero, trace_diffuse_ray_beqelse_b2053
# B2049
	lw x36, 2(x34)
	fmul x36, x35, x36
	fadd x36, x36, x33
...
# B2051
	...
	mv x37, x36
# B2052
	bne	x37, zero, trace_diffuse_ray_beqelse_b2054
...
# B2053
	...
	lw x37, 0(x37)
	fle x36, x37, x36
	bne	x36, zero, trace_diffuse_ray_beqelse_b2060
# B2056
	lw x36, 2(x34)
	fmul x36, x35, x36
	fadd x36, x36, x33
...
# B2058
	...
	mv x37, x36
# B2059
	bne	x37, zero, trace_diffuse_ray_beqelse_b2061
...
# B2063
	...
	lw x30, 1(x30)
	fle x30, x30, x31
	bne	x30, zero, trace_diffuse_ray_beqelse_b2067
# B2065
	lw x27, 5(x27)
	feq x27, x27, zero
	xori x27, x27, 1
	mv x30, x27
# B2066
	bne	x30, zero, trace_diffuse_ray_beqelse_b2068
...
# B2047
	bne	x34, x21, trace_diffuse_ray_beqelse_b2070
# B2069
	lw x30, 0(x27)
	fle x30, zero, x30
	bne	x30, zero, trace_diffuse_ray_beqelse_b2087
# B2072
	lw x30, 1(x27)
	fmul x30, x30, x31
	lw x31, 2(x27)
...
# B2070
	lw x34, 0(x27)
	feq x35, x34, zero
	bne	x35, zero, trace_diffuse_ray_beqelse_b2087
# B2073
	lw x35, 1(x27)
	fmul x35, x35, x31
	lw x36, 2(x27)
	...
	fadd x36, x36, x37
	lw x37, 3(x30)
	bne	x37, zero, trace_diffuse_ray_beqelse_b2076
# B2075
	mv x31, x36
...
# B2077
	lw x32, 1(x30)
	bne	x32, x23, trace_diffuse_ray_beqelse_b2080
# B2078
	fsub x31, x31, x24
...
# B2080
	...
	fsub x31, x32, x31
	fle x32, x31, zero
	bne	x32, zero, trace_diffuse_ray_beqelse_b2087
# B2082
	lw x30, 6(x30)
	fsqrt x31, x31
	bne	x30, zero, trace_diffuse_ray_beqelse_b2084
# B2083
	fsub x30, x35, x31
	lw x27, 4(x27)
	fmul x27, x30, x27
...
# B2086
	bne	x27, zero, trace_diffuse_ray_beqelse_b2088
...
# B2088
	lw x27, 0(x14)
	fle x27, x11, x27
	beq	x27, zero, trace_diffuse_ray_bneelse_b2090
# B2089
	addi x26, x26, 1
	j trace_diffuse_ray_cont_b2178 # adhoc jump(2)
...
# B2091
	lw x27, 0(x30)
	beq	x27, x18, trace_diffuse_ray_bneelse_b2175
# B2093
	add x4, x19, x27
	lw x27, 0(x4)
	addi x31, x27, 0
...
# B2094
	lw x27, 0(x32)
	beq	x27, x18, trace_diffuse_ray_bneelse_b2172
# B2096
	lw x27, 0(x32)
	add x4, x20, x27
	lw x31, 0(x4)
	...
	lw x37, 0(x4)
	lw x38, 1(x31)
	bne	x38, x12, trace_diffuse_ray_beqelse_b2098
# B2097
	lw x38, 0(x15)
	lw x39, 0(x37)
	fsub x39, x39, x34
	...
	lw x5, 1(x5)
	fle x40, x5, x40
	bne	x40, zero, trace_diffuse_ray_beqelse_b2104
# B2100
	lw x40, 2(x38)
	fmul x40, x39, x40
	fadd x40, x40, x36
...
# B2102
	...
	mv x5, x40
# B2103
	bne	x5, zero, trace_diffuse_ray_beqelse_b2105
...
# B2104
	...
	lw x5, 0(x5)
	fle x40, x5, x40
	bne	x40, zero, trace_diffuse_ray_beqelse_b2111
# B2107
	lw x40, 2(x38)
	fmul x40, x39, x40
	fadd x40, x40, x36
...
# B2109
	...
	mv x5, x40
# B2110
	bne	x5, zero, trace_diffuse_ray_beqelse_b2112
...
# B2111
	...
	lw x39, 0(x39)
	fle x34, x39, x34
	bne	x34, zero, trace_diffuse_ray_beqelse_b2118
# B2114
	lw x34, 1(x38)
	fmul x34, x36, x34
	fadd x34, x34, x35
	...
	lw x31, 1(x31)
	fle x31, x31, x34
	bne	x31, zero, trace_diffuse_ray_beqelse_b2118
# B2116
	lw x31, 5(x37)
	feq x31, x31, zero
	xori x31, x31, 1
	mv x34, x31
# B2117
	bne	x34, zero, trace_diffuse_ray_beqelse_b2119
...
# B2098
	bne	x38, x21, trace_diffuse_ray_beqelse_b2121
# B2120
	lw x31, 0(x37)
	fle x31, zero, x31
	beq	x31, zero, trace_diffuse_ray_bneelse_b2123
# B2122
	lw x34, 0(x14)
	j trace_diffuse_ray_cont_b2138 # adhoc jump(2)
...
# B2121
	lw x38, 0(x37)
	feq x39, x38, zero
	bne	x39, zero, trace_diffuse_ray_beqelse_b2125
# B2124
	lw x39, 1(x37)
	fmul x39, x39, x34
	lw x40, 2(x37)
	...
	fadd x40, x40, x5
	lw x5, 3(x31)
	bne	x5, zero, trace_diffuse_ray_beqelse_b2127
# B2126
	mv x34, x40
...
# B2128
	lw x35, 1(x31)
	bne	x35, x23, trace_diffuse_ray_beqelse_b2131
# B2129
	fsub x34, x34, x24
...
# B2131
	...
	fsub x34, x35, x34
	fle x35, x34, zero
	beq	x35, zero, trace_diffuse_ray_bneelse_b2133
# B2132
	lw x34, 0(x14)
	j trace_diffuse_ray_cont_b2138 # adhoc jump(2)
...
# B2133
	lw x31, 6(x31)
	fsqrt x34, x34
	bne	x31, zero, trace_diffuse_ray_beqelse_b2135
# B2134
	fsub x31, x39, x34
	lw x34, 4(x37)
	fmul x31, x31, x34
...
# B2137
	lw x34, 0(x14)
	bne	x31, zero, trace_diffuse_ray_beqelse_b2139
...
# B2140
	addi x32, x32, 1
	bne	x31, zero, trace_diffuse_ray_beqelse_b2142
...
# B2145
	lw x27, 0(x36)
	bne	x27, x18, trace_diffuse_ray_beqelse_b2147
# B2146
	mv x31, x12
# B2168
	bne	x31, zero, trace_diffuse_ray_beqelse_b2170
	j trace_diffuse_ray_cont_b2169 # adhoc jump(3)
trace_diffuse_ray_beqelse_b2170:
# B2170
	mv x27, x12
# B2171
	bne	x27, zero, trace_diffuse_ray_beqelse_b2173
	j trace_diffuse_ray_cont_b2172 # adhoc jump(3)
trace_diffuse_ray_beqelse_b2173:
# B2173
	mv x31, x12
# B2174
	bne	x31, zero, trace_diffuse_ray_beqelse_b2176
...
# B2177
	addi x26, x26, 1
	bne	x27, zero, trace_diffuse_ray_beqelse_b2179
...
# B2180
	lw x100, 0(x27)
	beq	x100, x18, trace_diffuse_ray_bneelse_b2264
# B2182
	add x4, x19, x100
	lw x100, 0(x4)
	addi x30, x100, 0
...
# B2183
	lw x100, 0(x31)
	beq	x100, x18, trace_diffuse_ray_bneelse_b2261
# B2185
	lw x100, 0(x31)
	add x4, x20, x100
	lw x30, 0(x4)
	...
	lw x36, 0(x4)
	lw x37, 1(x30)
	bne	x37, x12, trace_diffuse_ray_beqelse_b2187
# B2186
	lw x37, 0(x15)
	lw x38, 0(x36)
	fsub x38, x38, x33
	...
	lw x40, 1(x40)
	fle x39, x40, x39
	bne	x39, zero, trace_diffuse_ray_beqelse_b2193
# B2189
	lw x39, 2(x37)
	fmul x39, x38, x39
	fadd x39, x39, x35
...
# B2191
	...
	mv x40, x39
# B2192
	bne	x40, zero, trace_diffuse_ray_beqelse_b2194
...
# B2193
	...
	lw x40, 0(x40)
	fle x39, x40, x39
	bne	x39, zero, trace_diffuse_ray_beqelse_b2200
# B2196
	lw x39, 2(x37)
	fmul x39, x38, x39
	fadd x39, x39, x35
...
# B2198
	...
	mv x40, x39
# B2199
	bne	x40, zero, trace_diffuse_ray_beqelse_b2201
...
# B2200
	...
	lw x38, 0(x38)
	fle x33, x38, x33
	bne	x33, zero, trace_diffuse_ray_beqelse_b2207
# B2203
	lw x33, 1(x37)
	fmul x33, x35, x33
	fadd x33, x33, x34
	...
	lw x30, 1(x30)
	fle x30, x30, x33
	bne	x30, zero, trace_diffuse_ray_beqelse_b2207
# B2205
	lw x30, 5(x36)
	feq x30, x30, zero
	xori x30, x30, 1
	mv x33, x30
# B2206
	bne	x33, zero, trace_diffuse_ray_beqelse_b2208
...
# B2187
	bne	x37, x21, trace_diffuse_ray_beqelse_b2210
# B2209
	lw x30, 0(x36)
	fle x30, zero, x30
	beq	x30, zero, trace_diffuse_ray_bneelse_b2212
# B2211
	lw x33, 0(x14)
	j trace_diffuse_ray_cont_b2227 # adhoc jump(2)
...
# B2210
	lw x37, 0(x36)
	feq x38, x37, zero
	bne	x38, zero, trace_diffuse_ray_beqelse_b2214
# B2213
	lw x38, 1(x36)
	fmul x38, x38, x33
	lw x39, 2(x36)
	...
	fadd x39, x39, x40
	lw x40, 3(x30)
	bne	x40, zero, trace_diffuse_ray_beqelse_b2216
# B2215
	mv x33, x39
...
# B2217
	lw x34, 1(x30)
	bne	x34, x23, trace_diffuse_ray_beqelse_b2220
# B2218
	fsub x33, x33, x24
...
# B2220
	...
	fsub x33, x34, x33
	fle x34, x33, zero
	beq	x34, zero, trace_diffuse_ray_bneelse_b2222
# B2221
	lw x33, 0(x14)
	j trace_diffuse_ray_cont_b2227 # adhoc jump(2)
...
# B2222
	lw x30, 6(x30)
	fsqrt x33, x33
	bne	x30, zero, trace_diffuse_ray_beqelse_b2224
# B2223
	fsub x30, x38, x33
	lw x33, 4(x36)
	fmul x30, x30, x33
...
# B2226
	lw x33, 0(x14)
	bne	x30, zero, trace_diffuse_ray_beqelse_b2228
...
# B2229
	addi x31, x31, 1
	bne	x30, zero, trace_diffuse_ray_beqelse_b2231
...
# B2234
	lw x100, 0(x35)
	bne	x100, x18, trace_diffuse_ray_beqelse_b2236
# B2235
	mv x30, x12
# B2257
	bne	x30, zero, trace_diffuse_ray_beqelse_b2259
...
# B2262
	mv x30, x12
# B2263
	bne	x30, zero, trace_diffuse_ray_beqelse_b2265
...
# B2236
	...
	fsub x34, x38, x34
	lw x39, 1(x100)
	bne	x39, x12, trace_diffuse_ray_beqelse_b2238
# B2237
	fabs x30, x30
	lw x39, 4(x100)
	lw x39, 0(x39)
	fle x30, x39, x30
	bne	x30, zero, trace_diffuse_ray_beqelse_b2244
# B2240
	fabs x30, x33
	lw x33, 4(x100)
	lw x33, 1(x33)
...
# B2242
	...
	mv x33, x30
# B2243
	bne	x33, zero, trace_diffuse_ray_beqelse_b2245
...
# B2238
	bne	x39, x21, trace_diffuse_ray_beqelse_b2247
# B2246
	lw x39, 4(x100)
	lw x40, 0(x39)
	fmul x30, x40, x30
...
# B2247
	...
	fadd x39, x39, x40
	lw x40, 3(x100)
	bne	x40, zero, trace_diffuse_ray_beqelse_b2249
# B2248
	mv x30, x39
...
# B2250
	lw x33, 1(x100)
	bne	x33, x23, trace_diffuse_ray_beqelse_b2253
# B2251
	fsub x30, x30, x24
...
# B2147
	...
	fsub x35, x39, x35
	lw x40, 1(x27)
	bne	x40, x12, trace_diffuse_ray_beqelse_b2149
# B2148
	fabs x31, x31
	lw x40, 4(x27)
	lw x40, 0(x40)
	fle x31, x40, x31
	bne	x31, zero, trace_diffuse_ray_beqelse_b2155
# B2151
	fabs x31, x34
	lw x34, 4(x27)
	lw x34, 1(x34)
...
# B2153
	...
	mv x34, x31
# B2154
	bne	x34, zero, trace_diffuse_ray_beqelse_b2156
...
# B2149
	bne	x40, x21, trace_diffuse_ray_beqelse_b2158
# B2157
	lw x40, 4(x27)
	lw x5, 0(x40)
	fmul x31, x5, x31
...
# B2158
	...
	fadd x40, x40, x5
	lw x5, 3(x27)
	bne	x5, zero, trace_diffuse_ray_beqelse_b2160
# B2159
	mv x31, x40
...
# B2161
	lw x34, 1(x27)
	bne	x34, x23, trace_diffuse_ray_beqelse_b2164
# B2162
	fsub x31, x31, x24
...
# B2165
	bne	x27, zero, trace_diffuse_ray_beqelse_b2169
# B2166
	addi x36, x36, 1
...
# B2141
	...
	lw x27, 0(x4)
	lw x27, 6(x27)
	beq	x27, zero, trace_diffuse_ray_bneelse_b2172
...
# B2274
	sub x13, x14, x5
	bgt	x5, x14, iter_trace_diffuse_rays_bleelse_b2276
# B2275
	lw x17, 0(x14)
	lw x17, 0(x17)
	lw x18, 0(x17)
	...
	lui x9, 256410
	addi x9, x9, -1638
	la x90, min_caml_light_dirvec
	lui x91, 779469
	addi x91, x91, -819
	la x92, min_caml_light
	la x93, min_caml_diffuse_ray
...
# B2279
	lw x18, 0(x20)
	lw x95, 0(x18)
	beq	x95, x24, iter_trace_diffuse_rays_bneelse_b2478
# B2281
	bne	x95, x22, iter_trace_diffuse_rays_beqelse_b2283
# B2282
	addi x18, x18, 1
	mv x96, x94
	mv x95, x18
...
# B2284
	lw x18, 0(x95)
	beq	x18, x24, iter_trace_diffuse_rays_bneelse_b2477
# B2286
	add x4, x25, x18
	lw x18, 0(x4)
	addi x97, x18, 0
...
# B2287
	lw x18, 0(x101)
	lw x97, 0(x98)
	beq	x97, x24, iter_trace_diffuse_rays_bneelse_b2360
# B2289
	add x4, x26, x97
	lw x102, 0(x4)
	lw x103, 10(x102)
	...
	lw x107, 0(x4)
	lw x108, 1(x102)
	bne	x108, x100, iter_trace_diffuse_rays_beqelse_b2291
# B2290
	lw x103, 0(x101)
	lw x108, 0(x107)
	fsub x108, x108, x104
	...
	lw x110, 1(x110)
	fle x109, x110, x109
	bne	x109, zero, iter_trace_diffuse_rays_beqelse_b2297
# B2293
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B2295
	...
	mv x110, x109
# B2296
	bne	x110, zero, iter_trace_diffuse_rays_beqelse_b2298
...
# B2297
	...
	lw x110, 0(x110)
	fle x109, x110, x109
	bne	x109, zero, iter_trace_diffuse_rays_beqelse_b2304
# B2300
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B2302
	...
	mv x110, x109
# B2303
	bne	x110, zero, iter_trace_diffuse_rays_beqelse_b2305
...
# B2307
	...
	lw x102, 1(x102)
	fle x102, x102, x103
	bne	x102, zero, iter_trace_diffuse_rays_beqelse_b2311
# B2309
	lw x102, 5(x107)
	feq x102, x102, zero
	xori x102, x102, 1
	mv x103, x102
# B2310
	bne	x103, zero, iter_trace_diffuse_rays_beqelse_b2312
...
# B2291
	bne	x108, x12, iter_trace_diffuse_rays_beqelse_b2314
# B2313
	lw x102, 0(x107)
	fle x102, zero, x102
	beq	x102, zero, iter_trace_diffuse_rays_bneelse_b2316
# B2315
	mv x102, zero
	addi x98, x98, 1
	j iter_trace_diffuse_rays_cont_b2325 # adhoc jump(2)
...
# B2314
	lw x108, 0(x107)
	feq x109, x108, zero
	bne	x109, zero, iter_trace_diffuse_rays_beqelse_b2318
# B2317
	lw x109, 1(x107)
	fmul x104, x109, x104
	lw x109, 2(x107)
	...
	fsub x103, x105, x103
	fle x105, x103, zero
	beq	x105, zero, iter_trace_diffuse_rays_bneelse_b2320
# B2319
	mv x102, zero
	addi x98, x98, 1
	j iter_trace_diffuse_rays_cont_b2325 # adhoc jump(2)
...
# B2320
	lw x102, 6(x102)
	fsqrt x103, x103
	bne	x102, zero, iter_trace_diffuse_rays_beqelse_b2322
# B2321
	fsub x102, x104, x103
	lw x103, 4(x107)
	fmul x102, x102, x103
...
# B2324
	addi x98, x98, 1
	bne	x102, zero, iter_trace_diffuse_rays_beqelse_b2326
...
# B2326
	lw x103, 0(x23)
	fle x104, x103, zero
	bne	x104, zero, iter_trace_diffuse_rays_beqelse_b2359
# B2330
	lw x104, 0(x19)
	fle x104, x104, x103
	bne	x104, zero, iter_trace_diffuse_rays_beqelse_b2359
...
# B2333
	lw x106, 0(x107)
	bne	x106, x24, iter_trace_diffuse_rays_beqelse_b2335
# B2334
	mv x111, x100
# B2356
	bne	x111, zero, iter_trace_diffuse_rays_beqelse_b2358
...
# B2335
	...
	fsub x113, x110, x113
	lw x114, 1(x106)
	bne	x114, x100, iter_trace_diffuse_rays_beqelse_b2337
# B2336
	fabs x111, x111
	lw x114, 4(x106)
	lw x114, 0(x114)
	fle x111, x114, x111
	bne	x111, zero, iter_trace_diffuse_rays_beqelse_b2343
# B2339
	fabs x111, x112
	lw x112, 4(x106)
	lw x112, 1(x112)
...
# B2341
	...
	mv x112, x111
# B2342
	bne	x112, zero, iter_trace_diffuse_rays_beqelse_b2344
...
# B2337
	bne	x114, x12, iter_trace_diffuse_rays_beqelse_b2346
# B2345
	lw x114, 4(x106)
	lw x115, 0(x114)
	fmul x111, x115, x111
...
# B2346
	...
	fadd x114, x114, x115
	lw x115, 3(x106)
	bne	x115, zero, iter_trace_diffuse_rays_beqelse_b2348
# B2347
	mv x111, x114
...
# B2349
	lw x112, 1(x106)
	bne	x112, x29, iter_trace_diffuse_rays_beqelse_b2352
# B2350
	fsub x111, x111, x30
...
# B2353
	bne	x106, zero, iter_trace_diffuse_rays_beqelse_b2357
# B2354
	addi x106, x107, 1
	mv x107, x106
...
# B2325
	...
	lw x18, 0(x4)
	lw x18, 6(x18)
	beq	x18, zero, iter_trace_diffuse_rays_bneelse_b2360
...
# B2283
	...
	lw x95, 0(x4)
	lw x102, 1(x96)
	bne	x102, x100, iter_trace_diffuse_rays_beqelse_b2362
# B2361
	lw x97, 0(x94)
	lw x102, 0(x95)
	fsub x102, x102, x98
	...
	lw x104, 1(x104)
	fle x103, x104, x103
	bne	x103, zero, iter_trace_diffuse_rays_beqelse_b2368
# B2364
	lw x103, 2(x97)
	fmul x103, x102, x103
	fadd x103, x103, x101
...
# B2366
	...
	mv x104, x103
# B2367
	bne	x104, zero, iter_trace_diffuse_rays_beqelse_b2369
...
# B2368
	...
	lw x104, 0(x104)
	fle x103, x104, x103
	bne	x103, zero, iter_trace_diffuse_rays_beqelse_b2375
# B2371
	lw x103, 2(x97)
	fmul x103, x102, x103
	fadd x103, x103, x101
...
# B2373
	...
	mv x104, x103
# B2374
	bne	x104, zero, iter_trace_diffuse_rays_beqelse_b2376
...
# B2375
	...
	lw x102, 0(x102)
	fle x98, x102, x98
	bne	x98, zero, iter_trace_diffuse_rays_beqelse_b2382
# B2378
	lw x97, 1(x97)
	fmul x97, x101, x97
	fadd x97, x97, x99
	...
	lw x96, 1(x96)
	fle x96, x96, x97
	bne	x96, zero, iter_trace_diffuse_rays_beqelse_b2382
# B2380
	lw x95, 5(x95)
	feq x95, x95, zero
	xori x95, x95, 1
	mv x96, x95
# B2381
	bne	x96, zero, iter_trace_diffuse_rays_beqelse_b2383
...
# B2362
	bne	x102, x12, iter_trace_diffuse_rays_beqelse_b2385
# B2384
	lw x96, 0(x95)
	fle x96, zero, x96
	bne	x96, zero, iter_trace_diffuse_rays_beqelse_b2396
# B2387
	lw x95, 0(x95)
	lw x96, 3(x97)
	fmul x95, x95, x96
...
# B2385
	lw x102, 0(x95)
	feq x103, x102, zero
	bne	x103, zero, iter_trace_diffuse_rays_beqelse_b2396
# B2388
	lw x103, 1(x95)
	fmul x98, x103, x98
	lw x103, 2(x95)
	...
	fsub x97, x99, x97
	fle x99, x97, zero
	bne	x99, zero, iter_trace_diffuse_rays_beqelse_b2396
# B2391
	lw x96, 6(x96)
	fsqrt x97, x97
	bne	x96, zero, iter_trace_diffuse_rays_beqelse_b2393
# B2392
	fsub x96, x98, x97
	lw x95, 4(x95)
	fmul x95, x96, x95
...
# B2395
	bne	x95, zero, iter_trace_diffuse_rays_beqelse_b2397
...
# B2397
	...
	lw x96, 0(x19)
	fle x95, x96, x95
	bne	x95, zero, iter_trace_diffuse_rays_beqelse_b2477
# B2399
	addi x18, x18, 1
	mv x96, x94
	mv x95, x18
...
# B2403
	lw x18, 0(x101)
	lw x97, 0(x98)
	beq	x97, x24, iter_trace_diffuse_rays_bneelse_b2476
# B2405
	add x4, x26, x97
	lw x102, 0(x4)
	lw x103, 10(x102)
	...
	lw x107, 0(x4)
	lw x108, 1(x102)
	bne	x108, x100, iter_trace_diffuse_rays_beqelse_b2407
# B2406
	lw x103, 0(x101)
	lw x108, 0(x107)
	fsub x108, x108, x104
	...
	lw x110, 1(x110)
	fle x109, x110, x109
	bne	x109, zero, iter_trace_diffuse_rays_beqelse_b2413
# B2409
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B2411
	...
	mv x110, x109
# B2412
	bne	x110, zero, iter_trace_diffuse_rays_beqelse_b2414
...
# B2413
	...
	lw x110, 0(x110)
	fle x109, x110, x109
	bne	x109, zero, iter_trace_diffuse_rays_beqelse_b2420
# B2416
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B2418
	...
	mv x110, x109
# B2419
	bne	x110, zero, iter_trace_diffuse_rays_beqelse_b2421
...
# B2423
	...
	lw x102, 1(x102)
	fle x102, x102, x103
	bne	x102, zero, iter_trace_diffuse_rays_beqelse_b2427
# B2425
	lw x102, 5(x107)
	feq x102, x102, zero
	xori x102, x102, 1
	mv x103, x102
# B2426
	bne	x103, zero, iter_trace_diffuse_rays_beqelse_b2428
...
# B2407
	bne	x108, x12, iter_trace_diffuse_rays_beqelse_b2430
# B2429
	lw x102, 0(x107)
	fle x102, zero, x102
	beq	x102, zero, iter_trace_diffuse_rays_bneelse_b2432
# B2431
	mv x102, zero
	addi x98, x98, 1
	j iter_trace_diffuse_rays_cont_b2441 # adhoc jump(2)
...
# B2430
	lw x108, 0(x107)
	feq x109, x108, zero
	bne	x109, zero, iter_trace_diffuse_rays_beqelse_b2434
# B2433
	lw x109, 1(x107)
	fmul x104, x109, x104
	lw x109, 2(x107)
	...
	fsub x103, x105, x103
	fle x105, x103, zero
	beq	x105, zero, iter_trace_diffuse_rays_bneelse_b2436
# B2435
	mv x102, zero
	addi x98, x98, 1
	j iter_trace_diffuse_rays_cont_b2441 # adhoc jump(2)
...
# B2436
	lw x102, 6(x102)
	fsqrt x103, x103
	bne	x102, zero, iter_trace_diffuse_rays_beqelse_b2438
# B2437
	fsub x102, x104, x103
	lw x103, 4(x107)
	fmul x102, x102, x103
...
# B2442
	lw x103, 0(x23)
	fle x104, x103, zero
	bne	x104, zero, iter_trace_diffuse_rays_beqelse_b2475
# B2446
	lw x104, 0(x19)
	fle x104, x104, x103
	bne	x104, zero, iter_trace_diffuse_rays_beqelse_b2475
...
# B2449
	lw x106, 0(x107)
	bne	x106, x24, iter_trace_diffuse_rays_beqelse_b2451
# B2450
	mv x111, x100
# B2472
	bne	x111, zero, iter_trace_diffuse_rays_beqelse_b2474
...
# B2451
	...
	fsub x113, x110, x113
	lw x114, 1(x106)
	bne	x114, x100, iter_trace_diffuse_rays_beqelse_b2453
# B2452
	fabs x111, x111
	lw x114, 4(x106)
	lw x114, 0(x114)
	fle x111, x114, x111
	bne	x111, zero, iter_trace_diffuse_rays_beqelse_b2459
# B2455
	fabs x111, x112
	lw x112, 4(x106)
	lw x112, 1(x112)
...
# B2457
	...
	mv x112, x111
# B2458
	bne	x112, zero, iter_trace_diffuse_rays_beqelse_b2460
...
# B2453
	bne	x114, x12, iter_trace_diffuse_rays_beqelse_b2462
# B2461
	lw x114, 4(x106)
	lw x115, 0(x114)
	fmul x111, x115, x111
...
# B2462
	...
	fadd x114, x114, x115
	lw x115, 3(x106)
	bne	x115, zero, iter_trace_diffuse_rays_beqelse_b2464
# B2463
	mv x111, x114
...
# B2465
	lw x112, 1(x106)
	bne	x112, x29, iter_trace_diffuse_rays_beqelse_b2468
# B2466
	fsub x111, x111, x30
...
# B2469
	bne	x106, zero, iter_trace_diffuse_rays_beqelse_b2473
# B2470
	addi x106, x107, 1
	mv x107, x106
...
# B2441
	...
	lw x18, 0(x4)
	lw x18, 6(x18)
	beq	x18, zero, iter_trace_diffuse_rays_bneelse_b2476
...
# B2478
	lw x18, 0(x19)
	fle x19, x18, x34
	bne	x19, zero, iter_trace_diffuse_rays_beqelse_b2482
# B2480
	fle x18, x35, x18
	xori x18, x18, 1
	mv x19, x18
# B2481
	bne	x19, zero, iter_trace_diffuse_rays_beqelse_b2483
...
# B2483
	...
	lw x13, 0(x13)
	lw x19, 1(x18)
	bne	x19, x100, iter_trace_diffuse_rays_beqelse_b2485
# B2484
	lw x19, 0(x33)
	sw zero, 0(x36)
	sw zero, 1(x36)
	...
	lw x13, 0(x4)
	feq x20, x13, zero
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b2487
# B2486
	fle x13, x13, zero
	beq	x13, zero, iter_trace_diffuse_rays_bneelse_b2489
# B2488
	lui x13, 784384
...
# B2485
	bne	x19, x12, iter_trace_diffuse_rays_beqelse_b2492
# B2491
	lw x13, 4(x18)
	lw x13, 0(x13)
	fsub x13, zero, x13
...
# B2492
	...
	fmul x33, x20, x33
	lw x35, 3(x18)
	bne	x35, zero, iter_trace_diffuse_rays_beqelse_b2494
# B2493
	sw x28, 0(x36)
	sw x32, 1(x36)
	sw x33, 2(x36)
...
# B2495
	...
	fsqrt x19, x19
	feq x20, x19, zero
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b2497
# B2496
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b2499
# B2498
	fdiv x13, x30, x19
...
# B2501
	...
	lw x19, 2(x19)
	sw x19, 2(x39)
	bne	x13, x100, iter_trace_diffuse_rays_beqelse_b2503
# B2502
	lw x13, 0(x31)
	lw x19, 5(x18)
	lw x19, 0(x19)
	...
	fle x19, x65, x19
	xori x19, x19, 1
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b2505
# B2504
	bne	x19, zero, iter_trace_diffuse_rays_beqelse_b2507
# B2506
	lui x13, 276464
...
# B2505
	bne	x19, zero, iter_trace_diffuse_rays_beqelse_b2509
# B2508
	mv x13, zero
	j iter_trace_diffuse_rays_cont_b2510 # adhoc jump(2)
...
# B2503
	bne	x13, x12, iter_trace_diffuse_rays_beqelse_b2512
# B2511
	lw x13, 1(x31)
	fmul x13, x13, x66
	fle x19, x13, zero
...
# B2513
	fle x32, x20, x28
	bne	x32, zero, iter_trace_diffuse_rays_beqelse_b2516
# B2514
	fmul x28, x28, x68
...
# B2517
	fle x13, x67, x33
	beq	x13, zero, iter_trace_diffuse_rays_bneelse_b2522
# B2519
	fle x13, x33, x35
	fdiv x20, x35, x68
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b2521
# B2520
	fsub x33, x33, x35
	mv x35, x20
...
# B2522
	fle x13, x69, x33
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b2524
# B2523
	mv x20, x33
...
# B2525
	xor x13, x13, x19
	fle x19, x7, x20
	bne	x19, zero, iter_trace_diffuse_rays_beqelse_b2527
# B2526
	mv x19, x20
...
# B2528
	fle x20, x70, x19
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b2530
# B2529
	fmul x20, x19, x19
	fmul x28, x20, x73
	fadd x28, x72, x28
...
# B2531
	fle x20, x19, zero
	beq	x13, x20, iter_trace_diffuse_rays_bneelse_b2533
# B2532
	mv x13, x19
...
# B2512
	bne	x13, x29, iter_trace_diffuse_rays_beqelse_b2536
# B2535
	lw x13, 0(x31)
	lw x19, 5(x18)
	lw x19, 0(x19)
...
# B2537
	fle x28, x19, x20
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b2540
# B2538
	fmul x20, x20, x68
...
# B2541
	fle x13, x67, x32
	beq	x13, zero, iter_trace_diffuse_rays_bneelse_b2546
# B2543
	fle x13, x32, x33
	fdiv x19, x33, x68
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b2545
# B2544
	fsub x32, x32, x33
	mv x33, x19
...
# B2546
	fle x13, x69, x32
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b2548
# B2547
	mv x19, x32
...
# B2549
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b2551
# B2550
	mv x20, x100
...
# B2552
	fle x13, x7, x19
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b2554
...
# B2555
	xor x13, x13, x20
	fle x20, x70, x19
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b2557
...
# B2558
	fle x20, x19, zero
	beq	x13, x20, iter_trace_diffuse_rays_bneelse_b2560
# B2559
	mv x13, x19
...
# B2536
	bne	x13, x79, iter_trace_diffuse_rays_beqelse_b2589
# B2562
	lw x13, 0(x31)
	lw x19, 5(x18)
	lw x19, 0(x19)
	...
	fabs x28, x13
	fle x28, x8, x28
	beq	x28, zero, iter_trace_diffuse_rays_bneelse_b2565
# B2564
	fdiv x13, x19, x13
	fabs x13, x13
	fle x19, x13, zero
	...
	fabs x28, x13
	fle x32, x80, x28
	bne	x32, zero, iter_trace_diffuse_rays_beqelse_b2567
# B2566
	fmul x19, x13, x13
	fmul x28, x19, x86
	fadd x28, x85, x28
...
# B2567
	fle x13, x87, x28
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b2569
# B2568
	fsub x13, x28, x30
	fadd x28, x28, x30
	fdiv x13, x13, x28
...
# B2570
	bne	x19, zero, iter_trace_diffuse_rays_beqelse_b2573
# B2571
	fsub x13, zero, x13
...
# B2574
	...
	fabs x28, x20
	fle x28, x8, x28
	beq	x28, zero, iter_trace_diffuse_rays_bneelse_b2576
# B2575
	fdiv x19, x19, x20
	fabs x19, x19
	fle x20, x19, zero
	...
	fabs x28, x19
	fle x32, x80, x28
	bne	x32, zero, iter_trace_diffuse_rays_beqelse_b2578
# B2577
	fmul x20, x19, x19
	fmul x28, x20, x86
	fadd x28, x85, x28
...
# B2578
	fle x19, x87, x28
	bne	x19, zero, iter_trace_diffuse_rays_beqelse_b2580
# B2579
	fsub x19, x28, x30
	fadd x28, x28, x30
	fdiv x19, x19, x28
...
# B2581
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b2584
# B2582
	fsub x19, zero, x19
...
# B2585
	...
	fsub x13, x13, x19
	fle x19, zero, x13
	beq	x19, zero, iter_trace_diffuse_rays_bneelse_b2587
# B2586
	mv x20, x13
...
# B2590
	lw x13, 0(x19)
	lw x20, 0(x13)
	beq	x20, x24, iter_trace_diffuse_rays_bneelse_b2816
# B2592
	bne	x20, x22, iter_trace_diffuse_rays_beqelse_b2594
# B2593
	mv x20, x100
...
# B2594
	...
	lw x20, 0(x4)
	lw x35, 1(x21)
	bne	x35, x100, iter_trace_diffuse_rays_beqelse_b2596
# B2595
	lw x35, 0(x90)
	lw x37, 0(x20)
	fsub x37, x37, x28
	...
	lw x40, 1(x40)
	fle x38, x40, x38
	bne	x38, zero, iter_trace_diffuse_rays_beqelse_b2602
# B2598
	lw x38, 2(x35)
	fmul x38, x37, x38
	fadd x38, x38, x33
...
# B2600
	...
	mv x40, x38
# B2601
	bne	x40, zero, iter_trace_diffuse_rays_beqelse_b2603
...
# B2602
	...
	lw x40, 0(x40)
	fle x38, x40, x38
	bne	x38, zero, iter_trace_diffuse_rays_beqelse_b2609
# B2605
	lw x38, 2(x35)
	fmul x38, x37, x38
	fadd x38, x38, x33
...
# B2607
	...
	mv x40, x38
# B2608
	bne	x40, zero, iter_trace_diffuse_rays_beqelse_b2610
...
# B2612
	...
	lw x21, 1(x21)
	fle x21, x21, x28
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b2616
# B2614
	lw x20, 5(x20)
	feq x20, x20, zero
	xori x20, x20, 1
	mv x21, x20
# B2615
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b2617
...
# B2596
	bne	x35, x12, iter_trace_diffuse_rays_beqelse_b2619
# B2618
	lw x21, 0(x20)
	fle x21, zero, x21
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b2636
# B2621
	lw x21, 1(x20)
	fmul x21, x21, x28
	lw x28, 2(x20)
...
# B2619
	lw x35, 0(x20)
	feq x37, x35, zero
	bne	x37, zero, iter_trace_diffuse_rays_beqelse_b2636
# B2622
	lw x37, 1(x20)
	fmul x37, x37, x28
	lw x38, 2(x20)
	...
	fadd x38, x38, x40
	lw x40, 3(x21)
	bne	x40, zero, iter_trace_diffuse_rays_beqelse_b2625
# B2624
	mv x28, x38
...
# B2626
	lw x32, 1(x21)
	bne	x32, x29, iter_trace_diffuse_rays_beqelse_b2629
# B2627
	fsub x28, x28, x30
...
# B2631
	lw x21, 6(x21)
	fsqrt x28, x28
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b2633
# B2632
	fsub x21, x37, x28
	lw x20, 4(x20)
	fmul x20, x21, x20
...
# B2635
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b2637
...
# B2637
	lw x20, 0(x23)
	fle x20, x34, x20
	beq	x20, zero, iter_trace_diffuse_rays_bneelse_b2639
# B2638
	addi x19, x19, 1
	j iter_trace_diffuse_rays_cont_b2727 # adhoc jump(2)
...
# B2640
	lw x20, 0(x21)
	beq	x20, x24, iter_trace_diffuse_rays_bneelse_b2724
# B2642
	add x4, x25, x20
	lw x20, 0(x4)
	addi x28, x20, 0
...
# B2643
	lw x20, 0(x32)
	beq	x20, x24, iter_trace_diffuse_rays_bneelse_b2721
# B2645
	lw x20, 0(x32)
	add x4, x26, x20
	lw x28, 0(x4)
	...
	lw x40, 0(x4)
	lw x6, 1(x28)
	bne	x6, x100, iter_trace_diffuse_rays_beqelse_b2647
# B2646
	lw x6, 0(x90)
	lw x65, 0(x40)
	fsub x65, x65, x35
	...
	lw x67, 1(x67)
	fle x66, x67, x66
	bne	x66, zero, iter_trace_diffuse_rays_beqelse_b2653
# B2649
	lw x66, 2(x6)
	fmul x66, x65, x66
	fadd x66, x66, x38
...
# B2651
	...
	mv x67, x66
# B2652
	bne	x67, zero, iter_trace_diffuse_rays_beqelse_b2654
...
# B2653
	...
	lw x67, 0(x67)
	fle x66, x67, x66
	bne	x66, zero, iter_trace_diffuse_rays_beqelse_b2660
# B2656
	lw x66, 2(x6)
	fmul x66, x65, x66
	fadd x66, x66, x38
...
# B2658
	...
	mv x67, x66
# B2659
	bne	x67, zero, iter_trace_diffuse_rays_beqelse_b2661
...
# B2660
	...
	lw x65, 0(x65)
	fle x35, x65, x35
	bne	x35, zero, iter_trace_diffuse_rays_beqelse_b2667
# B2663
	lw x35, 1(x6)
	fmul x35, x38, x35
	fadd x35, x35, x37
	...
	lw x28, 1(x28)
	fle x28, x28, x35
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b2667
# B2665
	lw x28, 5(x40)
	feq x28, x28, zero
	xori x28, x28, 1
	mv x35, x28
# B2666
	bne	x35, zero, iter_trace_diffuse_rays_beqelse_b2668
...
# B2647
	bne	x6, x12, iter_trace_diffuse_rays_beqelse_b2670
# B2669
	lw x28, 0(x40)
	fle x28, zero, x28
	beq	x28, zero, iter_trace_diffuse_rays_bneelse_b2672
# B2671
	lw x35, 0(x23)
	j iter_trace_diffuse_rays_cont_b2687 # adhoc jump(2)
...
# B2670
	lw x6, 0(x40)
	feq x65, x6, zero
	bne	x65, zero, iter_trace_diffuse_rays_beqelse_b2674
# B2673
	lw x65, 1(x40)
	fmul x65, x65, x35
	lw x66, 2(x40)
	...
	fadd x66, x66, x67
	lw x67, 3(x28)
	bne	x67, zero, iter_trace_diffuse_rays_beqelse_b2676
# B2675
	mv x35, x66
...
# B2677
	lw x37, 1(x28)
	bne	x37, x29, iter_trace_diffuse_rays_beqelse_b2680
# B2678
	fsub x35, x35, x30
...
# B2680
	...
	fsub x35, x37, x35
	fle x37, x35, zero
	beq	x37, zero, iter_trace_diffuse_rays_bneelse_b2682
# B2681
	lw x35, 0(x23)
	j iter_trace_diffuse_rays_cont_b2687 # adhoc jump(2)
...
# B2682
	lw x28, 6(x28)
	fsqrt x35, x35
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b2684
# B2683
	fsub x28, x65, x35
	lw x35, 4(x40)
	fmul x28, x28, x35
...
# B2686
	lw x35, 0(x23)
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b2688
...
# B2689
	addi x32, x32, 1
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b2691
...
# B2694
	lw x20, 0(x38)
	bne	x20, x24, iter_trace_diffuse_rays_beqelse_b2696
# B2695
	mv x28, x100
# B2717
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b2719
	j iter_trace_diffuse_rays_cont_b2718 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b2719:
# B2719
	mv x20, x100
# B2720
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b2722
	j iter_trace_diffuse_rays_cont_b2721 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b2722:
# B2722
	mv x28, x100
# B2723
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b2725
...
# B2726
	addi x19, x19, 1
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b2728
...
# B2729
	lw x13, 0(x20)
	beq	x13, x24, iter_trace_diffuse_rays_bneelse_b2813
# B2731
	add x4, x25, x13
	lw x13, 0(x4)
	addi x21, x13, 0
...
# B2732
	lw x13, 0(x28)
	beq	x13, x24, iter_trace_diffuse_rays_bneelse_b2810
# B2734
	lw x13, 0(x28)
	add x4, x26, x13
	lw x21, 0(x4)
	...
	lw x38, 0(x4)
	lw x40, 1(x21)
	bne	x40, x100, iter_trace_diffuse_rays_beqelse_b2736
# B2735
	lw x40, 0(x90)
	lw x6, 0(x38)
	fsub x6, x6, x33
	...
	lw x66, 1(x66)
	fle x65, x66, x65
	bne	x65, zero, iter_trace_diffuse_rays_beqelse_b2742
# B2738
	lw x65, 2(x40)
	fmul x65, x6, x65
	fadd x65, x65, x37
...
# B2740
	...
	mv x66, x65
# B2741
	bne	x66, zero, iter_trace_diffuse_rays_beqelse_b2743
...
# B2742
	...
	lw x66, 0(x66)
	fle x65, x66, x65
	bne	x65, zero, iter_trace_diffuse_rays_beqelse_b2749
# B2745
	lw x65, 2(x40)
	fmul x65, x6, x65
	fadd x65, x65, x37
...
# B2747
	...
	mv x66, x65
# B2748
	bne	x66, zero, iter_trace_diffuse_rays_beqelse_b2750
...
# B2749
	...
	lw x6, 0(x6)
	fle x33, x6, x33
	bne	x33, zero, iter_trace_diffuse_rays_beqelse_b2756
# B2752
	lw x33, 1(x40)
	fmul x33, x37, x33
	fadd x33, x33, x35
	...
	lw x21, 1(x21)
	fle x21, x21, x33
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b2756
# B2754
	lw x21, 5(x38)
	feq x21, x21, zero
	xori x21, x21, 1
	mv x33, x21
# B2755
	bne	x33, zero, iter_trace_diffuse_rays_beqelse_b2757
...
# B2736
	bne	x40, x12, iter_trace_diffuse_rays_beqelse_b2759
# B2758
	lw x21, 0(x38)
	fle x21, zero, x21
	beq	x21, zero, iter_trace_diffuse_rays_bneelse_b2761
# B2760
	lw x33, 0(x23)
	j iter_trace_diffuse_rays_cont_b2776 # adhoc jump(2)
...
# B2759
	lw x40, 0(x38)
	feq x6, x40, zero
	bne	x6, zero, iter_trace_diffuse_rays_beqelse_b2763
# B2762
	lw x6, 1(x38)
	fmul x6, x6, x33
	lw x65, 2(x38)
	...
	fadd x65, x65, x66
	lw x66, 3(x21)
	bne	x66, zero, iter_trace_diffuse_rays_beqelse_b2765
# B2764
	mv x33, x65
...
# B2766
	lw x35, 1(x21)
	bne	x35, x29, iter_trace_diffuse_rays_beqelse_b2769
# B2767
	fsub x33, x33, x30
...
# B2769
	...
	fsub x33, x35, x33
	fle x35, x33, zero
	beq	x35, zero, iter_trace_diffuse_rays_bneelse_b2771
# B2770
	lw x33, 0(x23)
	j iter_trace_diffuse_rays_cont_b2776 # adhoc jump(2)
...
# B2771
	lw x21, 6(x21)
	fsqrt x33, x33
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b2773
# B2772
	fsub x21, x6, x33
	lw x33, 4(x38)
	fmul x21, x21, x33
...
# B2775
	lw x33, 0(x23)
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b2777
...
# B2778
	addi x28, x28, 1
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b2780
...
# B2783
	lw x13, 0(x37)
	bne	x13, x24, iter_trace_diffuse_rays_beqelse_b2785
# B2784
	mv x21, x100
# B2806
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b2808
	j iter_trace_diffuse_rays_cont_b2807 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b2808:
# B2808
	mv x13, x100
# B2809
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b2811
	j iter_trace_diffuse_rays_cont_b2810 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b2811:
# B2811
	mv x21, x100
# B2812
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b2814
...
# B2814
	mv x13, x100
# B2815
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b3363
...
# B2816
	...
	fsub x13, zero, x13
	fle x19, x13, zero
	beq	x19, zero, iter_trace_diffuse_rays_bneelse_b2819
# B2818
	mv x20, zero
...
# B2785
	...
	fsub x35, x6, x35
	lw x65, 1(x13)
	bne	x65, x100, iter_trace_diffuse_rays_beqelse_b2787
# B2786
	fabs x21, x21
	lw x65, 4(x13)
	lw x65, 0(x65)
	fle x21, x65, x21
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b2793
# B2789
	fabs x21, x33
	lw x33, 4(x13)
	lw x33, 1(x33)
...
# B2791
	...
	mv x33, x21
# B2792
	bne	x33, zero, iter_trace_diffuse_rays_beqelse_b2794
...
# B2787
	bne	x65, x12, iter_trace_diffuse_rays_beqelse_b2796
# B2795
	lw x65, 4(x13)
	lw x66, 0(x65)
	fmul x21, x66, x21
...
# B2796
	...
	fadd x65, x65, x66
	lw x66, 3(x13)
	bne	x66, zero, iter_trace_diffuse_rays_beqelse_b2798
# B2797
	mv x21, x65
...
# B2799
	lw x33, 1(x13)
	bne	x33, x29, iter_trace_diffuse_rays_beqelse_b2802
# B2800
	fsub x21, x21, x30
...
# B2803
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b2807
# B2804
	addi x37, x37, 1
...
# B2779
	...
	lw x13, 0(x4)
	lw x13, 6(x13)
	beq	x13, zero, iter_trace_diffuse_rays_bneelse_b2810
...
# B2696
	...
	fsub x37, x65, x37
	lw x66, 1(x20)
	bne	x66, x100, iter_trace_diffuse_rays_beqelse_b2698
# B2697
	fabs x28, x28
	lw x66, 4(x20)
	lw x66, 0(x66)
	fle x28, x66, x28
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b2704
# B2700
	fabs x28, x35
	lw x35, 4(x20)
	lw x35, 1(x35)
...
# B2702
	...
	mv x35, x28
# B2703
	bne	x35, zero, iter_trace_diffuse_rays_beqelse_b2705
...
# B2698
	bne	x66, x12, iter_trace_diffuse_rays_beqelse_b2707
# B2706
	lw x66, 4(x20)
	lw x67, 0(x66)
	fmul x28, x67, x28
...
# B2707
	...
	fadd x66, x66, x67
	lw x67, 3(x20)
	bne	x67, zero, iter_trace_diffuse_rays_beqelse_b2709
# B2708
	mv x28, x66
...
# B2710
	lw x35, 1(x20)
	bne	x35, x29, iter_trace_diffuse_rays_beqelse_b2713
# B2711
	fsub x28, x28, x30
...
# B2714
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b2718
# B2715
	addi x38, x38, 1
...
# B2690
	...
	lw x20, 0(x4)
	lw x20, 6(x20)
	beq	x20, zero, iter_trace_diffuse_rays_bneelse_b2721
...
# B2821
	lw x18, 0(x20)
	lw x95, 0(x18)
	beq	x95, x24, iter_trace_diffuse_rays_bneelse_b3020
# B2823
	bne	x95, x22, iter_trace_diffuse_rays_beqelse_b2825
# B2824
	addi x18, x18, 1
	mv x96, x94
	mv x95, x18
...
# B2826
	lw x18, 0(x95)
	beq	x18, x24, iter_trace_diffuse_rays_bneelse_b3019
# B2828
	add x4, x25, x18
	lw x18, 0(x4)
	addi x97, x18, 0
...
# B2829
	lw x18, 0(x101)
	lw x97, 0(x98)
	beq	x97, x24, iter_trace_diffuse_rays_bneelse_b2902
# B2831
	add x4, x26, x97
	lw x102, 0(x4)
	lw x103, 10(x102)
	...
	lw x107, 0(x4)
	lw x108, 1(x102)
	bne	x108, x100, iter_trace_diffuse_rays_beqelse_b2833
# B2832
	lw x103, 0(x101)
	lw x108, 0(x107)
	fsub x108, x108, x104
	...
	lw x110, 1(x110)
	fle x109, x110, x109
	bne	x109, zero, iter_trace_diffuse_rays_beqelse_b2839
# B2835
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B2837
	...
	mv x110, x109
# B2838
	bne	x110, zero, iter_trace_diffuse_rays_beqelse_b2840
...
# B2839
	...
	lw x110, 0(x110)
	fle x109, x110, x109
	bne	x109, zero, iter_trace_diffuse_rays_beqelse_b2846
# B2842
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B2844
	...
	mv x110, x109
# B2845
	bne	x110, zero, iter_trace_diffuse_rays_beqelse_b2847
...
# B2849
	...
	lw x102, 1(x102)
	fle x102, x102, x103
	bne	x102, zero, iter_trace_diffuse_rays_beqelse_b2853
# B2851
	lw x102, 5(x107)
	feq x102, x102, zero
	xori x102, x102, 1
	mv x103, x102
# B2852
	bne	x103, zero, iter_trace_diffuse_rays_beqelse_b2854
...
# B2833
	bne	x108, x12, iter_trace_diffuse_rays_beqelse_b2856
# B2855
	lw x102, 0(x107)
	fle x102, zero, x102
	beq	x102, zero, iter_trace_diffuse_rays_bneelse_b2858
# B2857
	mv x102, zero
	addi x98, x98, 1
	j iter_trace_diffuse_rays_cont_b2867 # adhoc jump(2)
...
# B2856
	lw x108, 0(x107)
	feq x109, x108, zero
	bne	x109, zero, iter_trace_diffuse_rays_beqelse_b2860
# B2859
	lw x109, 1(x107)
	fmul x104, x109, x104
	lw x109, 2(x107)
	...
	fsub x103, x105, x103
	fle x105, x103, zero
	beq	x105, zero, iter_trace_diffuse_rays_bneelse_b2862
# B2861
	mv x102, zero
	addi x98, x98, 1
	j iter_trace_diffuse_rays_cont_b2867 # adhoc jump(2)
...
# B2862
	lw x102, 6(x102)
	fsqrt x103, x103
	bne	x102, zero, iter_trace_diffuse_rays_beqelse_b2864
# B2863
	fsub x102, x104, x103
	lw x103, 4(x107)
	fmul x102, x102, x103
...
# B2866
	addi x98, x98, 1
	bne	x102, zero, iter_trace_diffuse_rays_beqelse_b2868
	j iter_trace_diffuse_rays_cont_b2867 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b2868:
# B2868
	lw x103, 0(x23)
	fle x104, x103, zero
	bne	x104, zero, iter_trace_diffuse_rays_beqelse_b2901
# B2872
	lw x104, 0(x19)
	fle x104, x104, x103
	bne	x104, zero, iter_trace_diffuse_rays_beqelse_b2901
...
# B2875
	lw x106, 0(x107)
	bne	x106, x24, iter_trace_diffuse_rays_beqelse_b2877
# B2876
	mv x111, x100
# B2898
	bne	x111, zero, iter_trace_diffuse_rays_beqelse_b2900
...
# B2877
	...
	fsub x113, x110, x113
	lw x114, 1(x106)
	bne	x114, x100, iter_trace_diffuse_rays_beqelse_b2879
# B2878
	fabs x111, x111
	lw x114, 4(x106)
	lw x114, 0(x114)
	fle x111, x114, x111
	bne	x111, zero, iter_trace_diffuse_rays_beqelse_b2885
# B2881
	fabs x111, x112
	lw x112, 4(x106)
	lw x112, 1(x112)
...
# B2883
	...
	mv x112, x111
# B2884
	bne	x112, zero, iter_trace_diffuse_rays_beqelse_b2886
...
# B2879
	bne	x114, x12, iter_trace_diffuse_rays_beqelse_b2888
# B2887
	lw x114, 4(x106)
	lw x115, 0(x114)
	fmul x111, x115, x111
...
# B2888
	...
	fadd x114, x114, x115
	lw x115, 3(x106)
	bne	x115, zero, iter_trace_diffuse_rays_beqelse_b2890
# B2889
	mv x111, x114
...
# B2891
	lw x112, 1(x106)
	bne	x112, x29, iter_trace_diffuse_rays_beqelse_b2894
# B2892
	fsub x111, x111, x30
...
# B2895
	bne	x106, zero, iter_trace_diffuse_rays_beqelse_b2899
# B2896
	addi x106, x107, 1
	mv x107, x106
...
# B2867
	...
	lw x18, 0(x4)
	lw x18, 6(x18)
	beq	x18, zero, iter_trace_diffuse_rays_bneelse_b2902
...
# B2825
	...
	lw x95, 0(x4)
	lw x102, 1(x96)
	bne	x102, x100, iter_trace_diffuse_rays_beqelse_b2904
# B2903
	lw x97, 0(x94)
	lw x102, 0(x95)
	fsub x102, x102, x98
	...
	lw x104, 1(x104)
	fle x103, x104, x103
	bne	x103, zero, iter_trace_diffuse_rays_beqelse_b2910
# B2906
	lw x103, 2(x97)
	fmul x103, x102, x103
	fadd x103, x103, x101
...
# B2908
	...
	mv x104, x103
# B2909
	bne	x104, zero, iter_trace_diffuse_rays_beqelse_b2911
...
# B2910
	...
	lw x104, 0(x104)
	fle x103, x104, x103
	bne	x103, zero, iter_trace_diffuse_rays_beqelse_b2917
# B2913
	lw x103, 2(x97)
	fmul x103, x102, x103
	fadd x103, x103, x101
...
# B2915
	...
	mv x104, x103
# B2916
	bne	x104, zero, iter_trace_diffuse_rays_beqelse_b2918
...
# B2917
	...
	lw x102, 0(x102)
	fle x98, x102, x98
	bne	x98, zero, iter_trace_diffuse_rays_beqelse_b2924
# B2920
	lw x97, 1(x97)
	fmul x97, x101, x97
	fadd x97, x97, x99
	...
	lw x96, 1(x96)
	fle x96, x96, x97
	bne	x96, zero, iter_trace_diffuse_rays_beqelse_b2924
# B2922
	lw x95, 5(x95)
	feq x95, x95, zero
	xori x95, x95, 1
	mv x96, x95
# B2923
	bne	x96, zero, iter_trace_diffuse_rays_beqelse_b2925
...
# B2904
	bne	x102, x12, iter_trace_diffuse_rays_beqelse_b2927
# B2926
	lw x96, 0(x95)
	fle x96, zero, x96
	bne	x96, zero, iter_trace_diffuse_rays_beqelse_b2938
# B2929
	lw x95, 0(x95)
	lw x96, 3(x97)
	fmul x95, x95, x96
...
# B2927
	lw x102, 0(x95)
	feq x103, x102, zero
	bne	x103, zero, iter_trace_diffuse_rays_beqelse_b2938
# B2930
	lw x103, 1(x95)
	fmul x98, x103, x98
	lw x103, 2(x95)
	...
	fsub x97, x99, x97
	fle x99, x97, zero
	bne	x99, zero, iter_trace_diffuse_rays_beqelse_b2938
# B2933
	lw x96, 6(x96)
	fsqrt x97, x97
	bne	x96, zero, iter_trace_diffuse_rays_beqelse_b2935
# B2934
	fsub x96, x98, x97
	lw x95, 4(x95)
	fmul x95, x96, x95
...
# B2937
	bne	x95, zero, iter_trace_diffuse_rays_beqelse_b2939
...
# B2939
	...
	lw x96, 0(x19)
	fle x95, x96, x95
	bne	x95, zero, iter_trace_diffuse_rays_beqelse_b3019
# B2941
	addi x18, x18, 1
	mv x96, x94
	mv x95, x18
...
# B2945
	lw x18, 0(x101)
	lw x97, 0(x98)
	beq	x97, x24, iter_trace_diffuse_rays_bneelse_b3018
# B2947
	add x4, x26, x97
	lw x102, 0(x4)
	lw x103, 10(x102)
	...
	lw x107, 0(x4)
	lw x108, 1(x102)
	bne	x108, x100, iter_trace_diffuse_rays_beqelse_b2949
# B2948
	lw x103, 0(x101)
	lw x108, 0(x107)
	fsub x108, x108, x104
	...
	lw x110, 1(x110)
	fle x109, x110, x109
	bne	x109, zero, iter_trace_diffuse_rays_beqelse_b2955
# B2951
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B2953
	...
	mv x110, x109
# B2954
	bne	x110, zero, iter_trace_diffuse_rays_beqelse_b2956
...
# B2955
	...
	lw x110, 0(x110)
	fle x109, x110, x109
	bne	x109, zero, iter_trace_diffuse_rays_beqelse_b2962
# B2958
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B2960
	...
	mv x110, x109
# B2961
	bne	x110, zero, iter_trace_diffuse_rays_beqelse_b2963
...
# B2965
	...
	lw x102, 1(x102)
	fle x102, x102, x103
	bne	x102, zero, iter_trace_diffuse_rays_beqelse_b2969
# B2967
	lw x102, 5(x107)
	feq x102, x102, zero
	xori x102, x102, 1
	mv x103, x102
# B2968
	bne	x103, zero, iter_trace_diffuse_rays_beqelse_b2970
...
# B2949
	bne	x108, x12, iter_trace_diffuse_rays_beqelse_b2972
# B2971
	lw x102, 0(x107)
	fle x102, zero, x102
	beq	x102, zero, iter_trace_diffuse_rays_bneelse_b2974
# B2973
	mv x102, zero
	addi x98, x98, 1
	j iter_trace_diffuse_rays_cont_b2983 # adhoc jump(2)
...
# B2972
	lw x108, 0(x107)
	feq x109, x108, zero
	bne	x109, zero, iter_trace_diffuse_rays_beqelse_b2976
# B2975
	lw x109, 1(x107)
	fmul x104, x109, x104
	lw x109, 2(x107)
	...
	fsub x103, x105, x103
	fle x105, x103, zero
	beq	x105, zero, iter_trace_diffuse_rays_bneelse_b2978
# B2977
	mv x102, zero
	addi x98, x98, 1
	j iter_trace_diffuse_rays_cont_b2983 # adhoc jump(2)
...
# B2978
	lw x102, 6(x102)
	fsqrt x103, x103
	bne	x102, zero, iter_trace_diffuse_rays_beqelse_b2980
# B2979
	fsub x102, x104, x103
	lw x103, 4(x107)
	fmul x102, x102, x103
...
# B2982
	addi x98, x98, 1
	bne	x102, zero, iter_trace_diffuse_rays_beqelse_b2984
	j iter_trace_diffuse_rays_cont_b2983 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b2984:
# B2984
	lw x103, 0(x23)
	fle x104, x103, zero
	bne	x104, zero, iter_trace_diffuse_rays_beqelse_b3017
# B2988
	lw x104, 0(x19)
	fle x104, x104, x103
	bne	x104, zero, iter_trace_diffuse_rays_beqelse_b3017
...
# B2991
	lw x106, 0(x107)
	bne	x106, x24, iter_trace_diffuse_rays_beqelse_b2993
# B2992
	mv x111, x100
# B3014
	bne	x111, zero, iter_trace_diffuse_rays_beqelse_b3016
...
# B2993
	...
	fsub x113, x110, x113
	lw x114, 1(x106)
	bne	x114, x100, iter_trace_diffuse_rays_beqelse_b2995
# B2994
	fabs x111, x111
	lw x114, 4(x106)
	lw x114, 0(x114)
	fle x111, x114, x111
	bne	x111, zero, iter_trace_diffuse_rays_beqelse_b3001
# B2997
	fabs x111, x112
	lw x112, 4(x106)
	lw x112, 1(x112)
...
# B2999
	...
	mv x112, x111
# B3000
	bne	x112, zero, iter_trace_diffuse_rays_beqelse_b3002
...
# B2995
	bne	x114, x12, iter_trace_diffuse_rays_beqelse_b3004
# B3003
	lw x114, 4(x106)
	lw x115, 0(x114)
	fmul x111, x115, x111
...
# B3004
	...
	fadd x114, x114, x115
	lw x115, 3(x106)
	bne	x115, zero, iter_trace_diffuse_rays_beqelse_b3006
# B3005
	mv x111, x114
...
# B3007
	lw x112, 1(x106)
	bne	x112, x29, iter_trace_diffuse_rays_beqelse_b3010
# B3008
	fsub x111, x111, x30
...
# B3011
	bne	x106, zero, iter_trace_diffuse_rays_beqelse_b3015
# B3012
	addi x106, x107, 1
	mv x107, x106
...
# B2983
	...
	lw x18, 0(x4)
	lw x18, 6(x18)
	beq	x18, zero, iter_trace_diffuse_rays_bneelse_b3018
...
# B3020
	lw x18, 0(x19)
	fle x19, x18, x34
	bne	x19, zero, iter_trace_diffuse_rays_beqelse_b3024
# B3022
	fle x18, x35, x18
	xori x18, x18, 1
	mv x19, x18
# B3023
	bne	x19, zero, iter_trace_diffuse_rays_beqelse_b3025
...
# B3025
	...
	lw x13, 0(x13)
	lw x19, 1(x18)
	bne	x19, x100, iter_trace_diffuse_rays_beqelse_b3027
# B3026
	lw x19, 0(x33)
	sw zero, 0(x36)
	sw zero, 1(x36)
	...
	lw x13, 0(x4)
	feq x20, x13, zero
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b3029
# B3028
	fle x13, x13, zero
	beq	x13, zero, iter_trace_diffuse_rays_bneelse_b3031
# B3030
	mv x13, x38
...
# B3027
	bne	x19, x12, iter_trace_diffuse_rays_beqelse_b3034
# B3033
	lw x13, 4(x18)
	lw x13, 0(x13)
	fsub x13, zero, x13
...
# B3034
	...
	fmul x33, x20, x33
	lw x35, 3(x18)
	bne	x35, zero, iter_trace_diffuse_rays_beqelse_b3036
# B3035
	sw x28, 0(x36)
	sw x32, 1(x36)
	sw x33, 2(x36)
...
# B3037
	...
	fsqrt x19, x19
	feq x20, x19, zero
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b3039
# B3038
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b3041
# B3040
	fdiv x13, x30, x19
...
# B3043
	...
	lw x19, 2(x19)
	sw x19, 2(x39)
	bne	x13, x100, iter_trace_diffuse_rays_beqelse_b3045
# B3044
	lw x13, 0(x31)
	lw x19, 5(x18)
	lw x19, 0(x19)
	...
	fle x19, x65, x19
	xori x19, x19, 1
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b3047
# B3046
	bne	x19, zero, iter_trace_diffuse_rays_beqelse_b3049
# B3048
	mv x20, x77
...
# B3047
	bne	x19, zero, iter_trace_diffuse_rays_beqelse_b3051
# B3050
	mv x20, zero
	j iter_trace_diffuse_rays_cont_b3052 # adhoc jump(2)
...
# B3045
	bne	x13, x12, iter_trace_diffuse_rays_beqelse_b3054
# B3053
	lw x13, 1(x31)
	fmul x13, x13, x66
	fle x19, x13, zero
...
# B3055
	fle x32, x20, x28
	bne	x32, zero, iter_trace_diffuse_rays_beqelse_b3058
# B3056
	fmul x28, x28, x68
...
# B3059
	fle x13, x67, x33
	beq	x13, zero, iter_trace_diffuse_rays_bneelse_b3064
# B3061
	fle x13, x33, x35
	fdiv x20, x35, x68
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b3063
# B3062
	fsub x33, x33, x35
	mv x35, x20
...
# B3064
	fle x13, x69, x33
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b3066
# B3065
	mv x20, x33
...
# B3070
	fle x20, x70, x19
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b3072
# B3071
	fmul x20, x19, x19
	fmul x28, x20, x73
	fadd x28, x72, x28
...
# B3073
	fle x20, x19, zero
	beq	x13, x20, iter_trace_diffuse_rays_bneelse_b3075
# B3074
	mv x13, x19
...
# B3054
	bne	x13, x29, iter_trace_diffuse_rays_beqelse_b3078
# B3077
	lw x13, 0(x31)
	lw x19, 5(x18)
	lw x19, 0(x19)
...
# B3079
	fle x28, x19, x20
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b3082
# B3080
	fmul x20, x20, x68
...
# B3083
	fle x13, x67, x32
	beq	x13, zero, iter_trace_diffuse_rays_bneelse_b3088
# B3085
	fle x13, x32, x33
	fdiv x19, x33, x68
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b3087
# B3086
	fsub x32, x32, x33
	mv x33, x19
...
# B3088
	fle x13, x69, x32
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b3090
# B3089
	mv x19, x32
...
# B3091
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b3093
# B3092
	mv x20, x100
...
# B3094
	fle x13, x7, x19
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b3096
...
# B3097
	xor x13, x13, x20
	fle x20, x70, x19
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b3099
...
# B3100
	fle x20, x19, zero
	beq	x13, x20, iter_trace_diffuse_rays_bneelse_b3102
# B3101
	mv x13, x19
...
# B3078
	bne	x13, x79, iter_trace_diffuse_rays_beqelse_b3131
# B3104
	lw x13, 0(x31)
	lw x19, 5(x18)
	lw x19, 0(x19)
	...
	fabs x28, x13
	fle x28, x8, x28
	beq	x28, zero, iter_trace_diffuse_rays_bneelse_b3107
# B3106
	fdiv x13, x19, x13
	fabs x13, x13
	fle x19, x13, zero
	...
	fabs x28, x13
	fle x32, x80, x28
	bne	x32, zero, iter_trace_diffuse_rays_beqelse_b3109
# B3108
	fmul x19, x13, x13
	fmul x28, x19, x86
	fadd x28, x85, x28
...
# B3109
	fle x13, x87, x28
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b3111
# B3110
	fsub x13, x28, x30
	fadd x28, x28, x30
	fdiv x13, x13, x28
...
# B3112
	bne	x19, zero, iter_trace_diffuse_rays_beqelse_b3115
# B3113
	fsub x13, zero, x13
...
# B3116
	...
	fabs x28, x20
	fle x28, x8, x28
	beq	x28, zero, iter_trace_diffuse_rays_bneelse_b3118
# B3117
	fdiv x19, x19, x20
	fabs x19, x19
	fle x20, x19, zero
	...
	fabs x28, x19
	fle x32, x80, x28
	bne	x32, zero, iter_trace_diffuse_rays_beqelse_b3120
# B3119
	fmul x20, x19, x19
	fmul x28, x20, x86
	fadd x28, x85, x28
...
# B3120
	fle x19, x87, x28
	bne	x19, zero, iter_trace_diffuse_rays_beqelse_b3122
# B3121
	fsub x19, x28, x30
	fadd x28, x28, x30
	fdiv x19, x19, x28
...
# B3123
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b3126
# B3124
	fsub x19, zero, x19
...
# B3127
	...
	fsub x13, x13, x19
	fle x19, zero, x13
	beq	x19, zero, iter_trace_diffuse_rays_bneelse_b3129
# B3128
	mv x20, x13
...
# B3132
	lw x13, 0(x19)
	lw x20, 0(x13)
	beq	x20, x24, iter_trace_diffuse_rays_bneelse_b3358
# B3134
	bne	x20, x22, iter_trace_diffuse_rays_beqelse_b3136
# B3135
	mv x20, x100
...
# B3136
	...
	lw x20, 0(x4)
	lw x35, 1(x21)
	bne	x35, x100, iter_trace_diffuse_rays_beqelse_b3138
# B3137
	lw x35, 0(x90)
	lw x37, 0(x20)
	fsub x37, x37, x28
	...
	lw x40, 1(x40)
	fle x38, x40, x38
	bne	x38, zero, iter_trace_diffuse_rays_beqelse_b3144
# B3140
	lw x38, 2(x35)
	fmul x38, x37, x38
	fadd x38, x38, x33
...
# B3142
	...
	mv x40, x38
# B3143
	bne	x40, zero, iter_trace_diffuse_rays_beqelse_b3145
...
# B3144
	...
	lw x40, 0(x40)
	fle x38, x40, x38
	bne	x38, zero, iter_trace_diffuse_rays_beqelse_b3151
# B3147
	lw x38, 2(x35)
	fmul x38, x37, x38
	fadd x38, x38, x33
...
# B3149
	...
	mv x40, x38
# B3150
	bne	x40, zero, iter_trace_diffuse_rays_beqelse_b3152
...
# B3151
	...
	lw x37, 0(x37)
	fle x28, x37, x28
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b3158
# B3154
	lw x28, 1(x35)
	fmul x28, x33, x28
	fadd x28, x28, x32
	...
	lw x21, 1(x21)
	fle x21, x21, x28
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b3158
# B3156
	lw x20, 5(x20)
	feq x20, x20, zero
	xori x20, x20, 1
	mv x21, x20
# B3157
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b3159
...
# B3138
	bne	x35, x12, iter_trace_diffuse_rays_beqelse_b3161
# B3160
	lw x21, 0(x20)
	fle x21, zero, x21
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b3178
# B3163
	lw x21, 1(x20)
	fmul x21, x21, x28
	lw x28, 2(x20)
...
# B3161
	lw x35, 0(x20)
	feq x37, x35, zero
	bne	x37, zero, iter_trace_diffuse_rays_beqelse_b3178
# B3164
	lw x37, 1(x20)
	fmul x37, x37, x28
	lw x38, 2(x20)
	...
	fadd x38, x38, x40
	lw x40, 3(x21)
	bne	x40, zero, iter_trace_diffuse_rays_beqelse_b3167
# B3166
	mv x28, x38
...
# B3168
	lw x32, 1(x21)
	bne	x32, x29, iter_trace_diffuse_rays_beqelse_b3171
# B3169
	fsub x28, x28, x30
...
# B3173
	lw x21, 6(x21)
	fsqrt x28, x28
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b3175
# B3174
	fsub x21, x37, x28
	lw x20, 4(x20)
	fmul x20, x21, x20
...
# B3177
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b3179
...
# B3179
	lw x20, 0(x23)
	fle x20, x34, x20
	beq	x20, zero, iter_trace_diffuse_rays_bneelse_b3181
# B3180
	addi x19, x19, 1
	j iter_trace_diffuse_rays_cont_b3269 # adhoc jump(2)
...
# B3182
	lw x20, 0(x21)
	beq	x20, x24, iter_trace_diffuse_rays_bneelse_b3266
# B3184
	add x4, x25, x20
	lw x20, 0(x4)
	addi x28, x20, 0
...
# B3185
	lw x20, 0(x32)
	beq	x20, x24, iter_trace_diffuse_rays_bneelse_b3263
# B3187
	lw x20, 0(x32)
	add x4, x26, x20
	lw x28, 0(x4)
	...
	lw x40, 0(x4)
	lw x6, 1(x28)
	bne	x6, x100, iter_trace_diffuse_rays_beqelse_b3189
# B3188
	lw x6, 0(x90)
	lw x65, 0(x40)
	fsub x65, x65, x35
	...
	lw x67, 1(x67)
	fle x66, x67, x66
	bne	x66, zero, iter_trace_diffuse_rays_beqelse_b3195
# B3191
	lw x66, 2(x6)
	fmul x66, x65, x66
	fadd x66, x66, x38
...
# B3193
	...
	mv x67, x66
# B3194
	bne	x67, zero, iter_trace_diffuse_rays_beqelse_b3196
...
# B3195
	...
	lw x67, 0(x67)
	fle x66, x67, x66
	bne	x66, zero, iter_trace_diffuse_rays_beqelse_b3202
# B3198
	lw x66, 2(x6)
	fmul x66, x65, x66
	fadd x66, x66, x38
...
# B3200
	...
	mv x67, x66
# B3201
	bne	x67, zero, iter_trace_diffuse_rays_beqelse_b3203
...
# B3202
	...
	lw x65, 0(x65)
	fle x35, x65, x35
	bne	x35, zero, iter_trace_diffuse_rays_beqelse_b3209
# B3205
	lw x35, 1(x6)
	fmul x35, x38, x35
	fadd x35, x35, x37
	...
	lw x28, 1(x28)
	fle x28, x28, x35
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b3209
# B3207
	lw x28, 5(x40)
	feq x28, x28, zero
	xori x28, x28, 1
	mv x35, x28
# B3208
	bne	x35, zero, iter_trace_diffuse_rays_beqelse_b3210
...
# B3189
	bne	x6, x12, iter_trace_diffuse_rays_beqelse_b3212
# B3211
	lw x28, 0(x40)
	fle x28, zero, x28
	beq	x28, zero, iter_trace_diffuse_rays_bneelse_b3214
# B3213
	lw x35, 0(x23)
	j iter_trace_diffuse_rays_cont_b3229 # adhoc jump(2)
...
# B3212
	lw x6, 0(x40)
	feq x65, x6, zero
	bne	x65, zero, iter_trace_diffuse_rays_beqelse_b3216
# B3215
	lw x65, 1(x40)
	fmul x65, x65, x35
	lw x66, 2(x40)
	...
	fadd x66, x66, x67
	lw x67, 3(x28)
	bne	x67, zero, iter_trace_diffuse_rays_beqelse_b3218
# B3217
	mv x35, x66
...
# B3219
	lw x37, 1(x28)
	bne	x37, x29, iter_trace_diffuse_rays_beqelse_b3222
# B3220
	fsub x35, x35, x30
...
# B3222
	...
	fsub x35, x37, x35
	fle x37, x35, zero
	beq	x37, zero, iter_trace_diffuse_rays_bneelse_b3224
# B3223
	lw x35, 0(x23)
	j iter_trace_diffuse_rays_cont_b3229 # adhoc jump(2)
...
# B3224
	lw x28, 6(x28)
	fsqrt x35, x35
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b3226
# B3225
	fsub x28, x65, x35
	lw x35, 4(x40)
	fmul x28, x28, x35
...
# B3228
	lw x35, 0(x23)
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b3230
...
# B3231
	addi x32, x32, 1
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b3233
...
# B3236
	lw x20, 0(x38)
	bne	x20, x24, iter_trace_diffuse_rays_beqelse_b3238
# B3237
	mv x28, x100
# B3259
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b3261
	j iter_trace_diffuse_rays_cont_b3260 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b3261:
# B3261
	mv x20, x100
# B3262
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b3264
	j iter_trace_diffuse_rays_cont_b3263 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b3264:
# B3264
	mv x28, x100
# B3265
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b3267
...
# B3268
	addi x19, x19, 1
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b3270
...
# B3271
	lw x13, 0(x20)
	beq	x13, x24, iter_trace_diffuse_rays_bneelse_b3355
# B3273
	add x4, x25, x13
	lw x13, 0(x4)
	addi x21, x13, 0
...
# B3274
	lw x13, 0(x28)
	beq	x13, x24, iter_trace_diffuse_rays_bneelse_b3352
# B3276
	lw x13, 0(x28)
	add x4, x26, x13
	lw x21, 0(x4)
	...
	lw x38, 0(x4)
	lw x40, 1(x21)
	bne	x40, x100, iter_trace_diffuse_rays_beqelse_b3278
# B3277
	lw x40, 0(x90)
	lw x6, 0(x38)
	fsub x6, x6, x33
	...
	lw x66, 1(x66)
	fle x65, x66, x65
	bne	x65, zero, iter_trace_diffuse_rays_beqelse_b3284
# B3280
	lw x65, 2(x40)
	fmul x65, x6, x65
	fadd x65, x65, x37
...
# B3282
	...
	mv x66, x65
# B3283
	bne	x66, zero, iter_trace_diffuse_rays_beqelse_b3285
...
# B3284
	...
	lw x66, 0(x66)
	fle x65, x66, x65
	bne	x65, zero, iter_trace_diffuse_rays_beqelse_b3291
# B3287
	lw x65, 2(x40)
	fmul x65, x6, x65
	fadd x65, x65, x37
...
# B3289
	...
	mv x66, x65
# B3290
	bne	x66, zero, iter_trace_diffuse_rays_beqelse_b3292
...
# B3291
	...
	lw x6, 0(x6)
	fle x33, x6, x33
	bne	x33, zero, iter_trace_diffuse_rays_beqelse_b3298
# B3294
	lw x33, 1(x40)
	fmul x33, x37, x33
	fadd x33, x33, x35
	...
	lw x21, 1(x21)
	fle x21, x21, x33
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b3298
# B3296
	lw x21, 5(x38)
	feq x21, x21, zero
	xori x21, x21, 1
	mv x33, x21
# B3297
	bne	x33, zero, iter_trace_diffuse_rays_beqelse_b3299
...
# B3278
	bne	x40, x12, iter_trace_diffuse_rays_beqelse_b3301
# B3300
	lw x21, 0(x38)
	fle x21, zero, x21
	beq	x21, zero, iter_trace_diffuse_rays_bneelse_b3303
# B3302
	lw x33, 0(x23)
	j iter_trace_diffuse_rays_cont_b3318 # adhoc jump(2)
...
# B3301
	lw x40, 0(x38)
	feq x6, x40, zero
	bne	x6, zero, iter_trace_diffuse_rays_beqelse_b3305
# B3304
	lw x6, 1(x38)
	fmul x6, x6, x33
	lw x65, 2(x38)
	...
	fadd x65, x65, x66
	lw x66, 3(x21)
	bne	x66, zero, iter_trace_diffuse_rays_beqelse_b3307
# B3306
	mv x33, x65
...
# B3308
	lw x35, 1(x21)
	bne	x35, x29, iter_trace_diffuse_rays_beqelse_b3311
# B3309
	fsub x33, x33, x30
...
# B3311
	...
	fsub x33, x35, x33
	fle x35, x33, zero
	beq	x35, zero, iter_trace_diffuse_rays_bneelse_b3313
# B3312
	lw x33, 0(x23)
	j iter_trace_diffuse_rays_cont_b3318 # adhoc jump(2)
...
# B3313
	lw x21, 6(x21)
	fsqrt x33, x33
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b3315
# B3314
	fsub x21, x6, x33
	lw x33, 4(x38)
	fmul x21, x21, x33
...
# B3317
	lw x33, 0(x23)
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b3319
...
# B3320
	addi x28, x28, 1
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b3322
...
# B3325
	lw x13, 0(x37)
	bne	x13, x24, iter_trace_diffuse_rays_beqelse_b3327
# B3326
	mv x21, x100
# B3348
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b3350
	j iter_trace_diffuse_rays_cont_b3349 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b3350:
# B3350
	mv x13, x100
# B3351
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b3353
	j iter_trace_diffuse_rays_cont_b3352 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b3353:
# B3353
	mv x21, x100
# B3354
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b3356
...
# B3358
	...
	fsub x13, zero, x13
	fle x19, x13, zero
	beq	x19, zero, iter_trace_diffuse_rays_bneelse_b3361
# B3360
	mv x20, zero
...
# B3327
	...
	fsub x35, x6, x35
	lw x65, 1(x13)
	bne	x65, x100, iter_trace_diffuse_rays_beqelse_b3329
# B3328
	fabs x21, x21
	lw x65, 4(x13)
	lw x65, 0(x65)
	fle x21, x65, x21
	bne	x21, zero, iter_trace_diffuse_rays_beqelse_b3335
# B3331
	fabs x21, x33
	lw x33, 4(x13)
	lw x33, 1(x33)
...
# B3333
	...
	mv x33, x21
# B3334
	bne	x33, zero, iter_trace_diffuse_rays_beqelse_b3336
...
# B3329
	bne	x65, x12, iter_trace_diffuse_rays_beqelse_b3338
# B3337
	lw x65, 4(x13)
	lw x66, 0(x65)
	fmul x21, x66, x21
...
# B3338
	...
	fadd x65, x65, x66
	lw x66, 3(x13)
	bne	x66, zero, iter_trace_diffuse_rays_beqelse_b3340
# B3339
	mv x21, x65
...
# B3341
	lw x33, 1(x13)
	bne	x33, x29, iter_trace_diffuse_rays_beqelse_b3344
# B3342
	fsub x21, x21, x30
...
# B3345
	bne	x13, zero, iter_trace_diffuse_rays_beqelse_b3349
# B3346
	addi x37, x37, 1
...
# B3321
	...
	lw x13, 0(x4)
	lw x13, 6(x13)
	beq	x13, zero, iter_trace_diffuse_rays_bneelse_b3352
...
# B3238
	...
	fsub x37, x65, x37
	lw x66, 1(x20)
	bne	x66, x100, iter_trace_diffuse_rays_beqelse_b3240
# B3239
	fabs x28, x28
	lw x66, 4(x20)
	lw x66, 0(x66)
...
# B3244
	...
	mv x35, x28
# B3245
	bne	x35, zero, iter_trace_diffuse_rays_beqelse_b3247
...
# B3240
	bne	x66, x12, iter_trace_diffuse_rays_beqelse_b3249
# B3248
	lw x66, 4(x20)
	lw x67, 0(x66)
	fmul x28, x67, x28
...
# B3249
	...
	fadd x66, x66, x67
	lw x67, 3(x20)
	bne	x67, zero, iter_trace_diffuse_rays_beqelse_b3251
# B3250
	mv x28, x66
...
# B3252
	lw x35, 1(x20)
	bne	x35, x29, iter_trace_diffuse_rays_beqelse_b3255
# B3253
	fsub x28, x28, x30
...
# B3256
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b3260
# B3257
	addi x38, x38, 1
...
# B3232
	...
	lw x20, 0(x4)
	lw x20, 6(x20)
	beq	x20, zero, iter_trace_diffuse_rays_bneelse_b3263
...
# B3381
	sub x17, x18, x5
	bgt	x5, x18, trace_diffuse_rays_bleelse_b3383
# B3382
	lw x21, 0(x18)
	lw x21, 0(x21)
	lw x22, 0(x21)
...
# B3386
	lw x22, 0(x24)
	lw x95, 0(x22)
	beq	x95, x28, trace_diffuse_rays_bneelse_b3585
# B3388
	bne	x95, x26, trace_diffuse_rays_beqelse_b3390
# B3389
	addi x22, x22, 1
	mv x96, x94
	mv x95, x22
...
# B3391
	lw x22, 0(x95)
	beq	x22, x28, trace_diffuse_rays_bneelse_b3584
# B3393
	add x4, x29, x22
	lw x22, 0(x4)
	addi x97, x22, 0
...
# B3394
	lw x22, 0(x101)
	lw x97, 0(x98)
	beq	x97, x28, trace_diffuse_rays_bneelse_b3467
# B3396
	add x4, x12, x97
	lw x102, 0(x4)
	lw x103, 10(x102)
	...
	lw x107, 0(x4)
	lw x108, 1(x102)
	bne	x108, x100, trace_diffuse_rays_beqelse_b3398
# B3397
	lw x103, 0(x101)
	lw x108, 0(x107)
	fsub x108, x108, x104
	...
	lw x110, 1(x110)
	fle x109, x110, x109
	bne	x109, zero, trace_diffuse_rays_beqelse_b3404
# B3400
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B3402
	...
	mv x110, x109
# B3403
	bne	x110, zero, trace_diffuse_rays_beqelse_b3405
...
# B3404
	...
	lw x110, 0(x110)
	fle x109, x110, x109
	bne	x109, zero, trace_diffuse_rays_beqelse_b3411
# B3407
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B3409
	...
	mv x110, x109
# B3410
	bne	x110, zero, trace_diffuse_rays_beqelse_b3412
...
# B3414
	...
	lw x102, 1(x102)
	fle x102, x102, x103
	bne	x102, zero, trace_diffuse_rays_beqelse_b3418
# B3416
	lw x102, 5(x107)
	feq x102, x102, zero
	xori x102, x102, 1
	mv x103, x102
# B3417
	bne	x103, zero, trace_diffuse_rays_beqelse_b3419
...
# B3398
	bne	x108, x11, trace_diffuse_rays_beqelse_b3421
# B3420
	lw x102, 0(x107)
	fle x102, zero, x102
	beq	x102, zero, trace_diffuse_rays_bneelse_b3423
# B3422
	mv x102, zero
	addi x98, x98, 1
	j trace_diffuse_rays_cont_b3432 # adhoc jump(2)
...
# B3421
	lw x108, 0(x107)
	feq x109, x108, zero
	bne	x109, zero, trace_diffuse_rays_beqelse_b3425
# B3424
	lw x109, 1(x107)
	fmul x104, x109, x104
	lw x109, 2(x107)
	...
	fsub x103, x105, x103
	fle x105, x103, zero
	beq	x105, zero, trace_diffuse_rays_bneelse_b3427
# B3426
	mv x102, zero
	addi x98, x98, 1
	j trace_diffuse_rays_cont_b3432 # adhoc jump(2)
...
# B3427
	lw x102, 6(x102)
	fsqrt x103, x103
	bne	x102, zero, trace_diffuse_rays_beqelse_b3429
# B3428
	fsub x102, x104, x103
	lw x103, 4(x107)
	fmul x102, x102, x103
...
# B3431
	addi x98, x98, 1
	bne	x102, zero, trace_diffuse_rays_beqelse_b3433
	j trace_diffuse_rays_cont_b3432 # adhoc jump(3)
trace_diffuse_rays_beqelse_b3433:
# B3433
	lw x103, 0(x27)
	fle x104, x103, zero
	bne	x104, zero, trace_diffuse_rays_beqelse_b3466
# B3437
	lw x104, 0(x23)
	fle x104, x104, x103
	bne	x104, zero, trace_diffuse_rays_beqelse_b3466
...
# B3440
	lw x106, 0(x107)
	bne	x106, x28, trace_diffuse_rays_beqelse_b3442
# B3441
	mv x111, x100
# B3463
	bne	x111, zero, trace_diffuse_rays_beqelse_b3465
...
# B3442
	...
	fsub x113, x110, x113
	lw x114, 1(x106)
	bne	x114, x100, trace_diffuse_rays_beqelse_b3444
# B3443
	fabs x111, x111
	lw x114, 4(x106)
	lw x114, 0(x114)
	fle x111, x114, x111
	bne	x111, zero, trace_diffuse_rays_beqelse_b3450
# B3446
	fabs x111, x112
	lw x112, 4(x106)
	lw x112, 1(x112)
...
# B3448
	...
	mv x112, x111
# B3449
	bne	x112, zero, trace_diffuse_rays_beqelse_b3451
...
# B3444
	bne	x114, x11, trace_diffuse_rays_beqelse_b3453
# B3452
	lw x114, 4(x106)
	lw x115, 0(x114)
	fmul x111, x115, x111
...
# B3453
	...
	fadd x114, x114, x115
	lw x115, 3(x106)
	bne	x115, zero, trace_diffuse_rays_beqelse_b3455
# B3454
	mv x111, x114
...
# B3456
	lw x112, 1(x106)
	bne	x112, x15, trace_diffuse_rays_beqelse_b3459
# B3457
	fsub x111, x111, x16
...
# B3460
	bne	x106, zero, trace_diffuse_rays_beqelse_b3464
# B3461
	addi x106, x107, 1
	mv x107, x106
...
# B3432
	...
	lw x22, 0(x4)
	lw x22, 6(x22)
	beq	x22, zero, trace_diffuse_rays_bneelse_b3467
...
# B3390
	...
	lw x95, 0(x4)
	lw x102, 1(x96)
	bne	x102, x100, trace_diffuse_rays_beqelse_b3469
# B3468
	lw x97, 0(x94)
	lw x102, 0(x95)
	fsub x102, x102, x98
	...
	lw x104, 1(x104)
	fle x103, x104, x103
	bne	x103, zero, trace_diffuse_rays_beqelse_b3475
# B3471
	lw x103, 2(x97)
	fmul x103, x102, x103
	fadd x103, x103, x101
...
# B3473
	...
	mv x104, x103
# B3474
	bne	x104, zero, trace_diffuse_rays_beqelse_b3476
...
# B3475
	...
	lw x104, 0(x104)
	fle x103, x104, x103
	bne	x103, zero, trace_diffuse_rays_beqelse_b3482
# B3478
	lw x103, 2(x97)
	fmul x103, x102, x103
	fadd x103, x103, x101
...
# B3480
	...
	mv x104, x103
# B3481
	bne	x104, zero, trace_diffuse_rays_beqelse_b3483
...
# B3482
	...
	lw x102, 0(x102)
	fle x98, x102, x98
	bne	x98, zero, trace_diffuse_rays_beqelse_b3489
# B3485
	lw x97, 1(x97)
	fmul x97, x101, x97
	fadd x97, x97, x99
	...
	lw x96, 1(x96)
	fle x96, x96, x97
	bne	x96, zero, trace_diffuse_rays_beqelse_b3489
# B3487
	lw x95, 5(x95)
	feq x95, x95, zero
	xori x95, x95, 1
	mv x96, x95
# B3488
	bne	x96, zero, trace_diffuse_rays_beqelse_b3490
...
# B3469
	bne	x102, x11, trace_diffuse_rays_beqelse_b3492
# B3491
	lw x96, 0(x95)
	fle x96, zero, x96
	bne	x96, zero, trace_diffuse_rays_beqelse_b3503
# B3494
	lw x95, 0(x95)
	lw x96, 3(x97)
	fmul x95, x95, x96
...
# B3492
	lw x102, 0(x95)
	feq x103, x102, zero
	bne	x103, zero, trace_diffuse_rays_beqelse_b3503
# B3495
	lw x103, 1(x95)
	fmul x98, x103, x98
	lw x103, 2(x95)
	...
	fsub x97, x99, x97
	fle x99, x97, zero
	bne	x99, zero, trace_diffuse_rays_beqelse_b3503
# B3498
	lw x96, 6(x96)
	fsqrt x97, x97
	bne	x96, zero, trace_diffuse_rays_beqelse_b3500
# B3499
	fsub x96, x98, x97
	lw x95, 4(x95)
	fmul x95, x96, x95
...
# B3502
	bne	x95, zero, trace_diffuse_rays_beqelse_b3504
...
# B3504
	...
	lw x96, 0(x23)
	fle x95, x96, x95
	bne	x95, zero, trace_diffuse_rays_beqelse_b3584
# B3506
	addi x22, x22, 1
	mv x96, x94
	mv x95, x22
...
# B3510
	lw x22, 0(x101)
	lw x97, 0(x98)
	beq	x97, x28, trace_diffuse_rays_bneelse_b3583
# B3512
	add x4, x12, x97
	lw x102, 0(x4)
	lw x103, 10(x102)
	...
	lw x107, 0(x4)
	lw x108, 1(x102)
	bne	x108, x100, trace_diffuse_rays_beqelse_b3514
# B3513
	lw x103, 0(x101)
	lw x108, 0(x107)
	fsub x108, x108, x104
	...
	lw x110, 1(x110)
	fle x109, x110, x109
	bne	x109, zero, trace_diffuse_rays_beqelse_b3520
# B3516
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B3518
	...
	mv x110, x109
# B3519
	bne	x110, zero, trace_diffuse_rays_beqelse_b3521
...
# B3520
	...
	lw x110, 0(x110)
	fle x109, x110, x109
	bne	x109, zero, trace_diffuse_rays_beqelse_b3527
# B3523
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B3525
	...
	mv x110, x109
# B3526
	bne	x110, zero, trace_diffuse_rays_beqelse_b3528
...
# B3530
	...
	lw x102, 1(x102)
	fle x102, x102, x103
	bne	x102, zero, trace_diffuse_rays_beqelse_b3534
# B3532
	lw x102, 5(x107)
	feq x102, x102, zero
	xori x102, x102, 1
	mv x103, x102
# B3533
	bne	x103, zero, trace_diffuse_rays_beqelse_b3535
...
# B3514
	bne	x108, x11, trace_diffuse_rays_beqelse_b3537
# B3536
	lw x102, 0(x107)
	fle x102, zero, x102
	beq	x102, zero, trace_diffuse_rays_bneelse_b3539
# B3538
	mv x102, zero
	addi x98, x98, 1
	j trace_diffuse_rays_cont_b3548 # adhoc jump(2)
...
# B3537
	lw x108, 0(x107)
	feq x109, x108, zero
	bne	x109, zero, trace_diffuse_rays_beqelse_b3541
# B3540
	lw x109, 1(x107)
	fmul x104, x109, x104
	lw x109, 2(x107)
	...
	fsub x103, x105, x103
	fle x105, x103, zero
	beq	x105, zero, trace_diffuse_rays_bneelse_b3543
# B3542
	mv x102, zero
	addi x98, x98, 1
	j trace_diffuse_rays_cont_b3548 # adhoc jump(2)
...
# B3543
	lw x102, 6(x102)
	fsqrt x103, x103
	bne	x102, zero, trace_diffuse_rays_beqelse_b3545
# B3544
	fsub x102, x104, x103
	lw x103, 4(x107)
	fmul x102, x102, x103
...
# B3547
	addi x98, x98, 1
	bne	x102, zero, trace_diffuse_rays_beqelse_b3549
	j trace_diffuse_rays_cont_b3548 # adhoc jump(3)
trace_diffuse_rays_beqelse_b3549:
# B3549
	lw x103, 0(x27)
	fle x104, x103, zero
	bne	x104, zero, trace_diffuse_rays_beqelse_b3582
# B3553
	lw x104, 0(x23)
	fle x104, x104, x103
	bne	x104, zero, trace_diffuse_rays_beqelse_b3582
...
# B3556
	lw x106, 0(x107)
	bne	x106, x28, trace_diffuse_rays_beqelse_b3558
# B3557
	mv x111, x100
# B3579
	bne	x111, zero, trace_diffuse_rays_beqelse_b3581
...
# B3558
	...
	fsub x113, x110, x113
	lw x114, 1(x106)
	bne	x114, x100, trace_diffuse_rays_beqelse_b3560
# B3559
	fabs x111, x111
	lw x114, 4(x106)
	lw x114, 0(x114)
	fle x111, x114, x111
	bne	x111, zero, trace_diffuse_rays_beqelse_b3566
# B3562
	fabs x111, x112
	lw x112, 4(x106)
	lw x112, 1(x112)
...
# B3564
	...
	mv x112, x111
# B3565
	bne	x112, zero, trace_diffuse_rays_beqelse_b3567
...
# B3560
	bne	x114, x11, trace_diffuse_rays_beqelse_b3569
# B3568
	lw x114, 4(x106)
	lw x115, 0(x114)
	fmul x111, x115, x111
...
# B3569
	...
	fadd x114, x114, x115
	lw x115, 3(x106)
	bne	x115, zero, trace_diffuse_rays_beqelse_b3571
# B3570
	mv x111, x114
...
# B3572
	lw x112, 1(x106)
	bne	x112, x15, trace_diffuse_rays_beqelse_b3575
# B3573
	fsub x111, x111, x16
...
# B3576
	bne	x106, zero, trace_diffuse_rays_beqelse_b3580
# B3577
	addi x106, x107, 1
	mv x107, x106
...
# B3548
	...
	lw x22, 0(x4)
	lw x22, 6(x22)
	beq	x22, zero, trace_diffuse_rays_bneelse_b3583
...
# B3585
	lw x22, 0(x23)
	fle x23, x22, x34
	bne	x23, zero, trace_diffuse_rays_beqelse_b3589
# B3587
	fle x22, x35, x22
	xori x22, x22, 1
	mv x23, x22
# B3588
	bne	x23, zero, trace_diffuse_rays_beqelse_b3590
...
# B3590
	...
	lw x17, 0(x17)
	lw x23, 1(x22)
	bne	x23, x100, trace_diffuse_rays_beqelse_b3592
# B3591
	lw x23, 0(x33)
	sw zero, 0(x36)
	sw zero, 1(x36)
	...
	lw x17, 0(x4)
	feq x24, x17, zero
	bne	x24, zero, trace_diffuse_rays_beqelse_b3594
# B3593
	fle x17, x17, zero
	beq	x17, zero, trace_diffuse_rays_bneelse_b3596
# B3595
	lui x17, 784384
...
# B3592
	bne	x23, x11, trace_diffuse_rays_beqelse_b3599
# B3598
	lw x17, 4(x22)
	lw x17, 0(x17)
	fsub x17, zero, x17
...
# B3602
	...
	fsqrt x23, x23
	feq x24, x23, zero
	bne	x24, zero, trace_diffuse_rays_beqelse_b3604
# B3603
	bne	x17, zero, trace_diffuse_rays_beqelse_b3606
# B3605
	fdiv x17, x16, x23
...
# B3608
	...
	lw x23, 2(x23)
	sw x23, 2(x39)
	bne	x17, x100, trace_diffuse_rays_beqelse_b3610
# B3609
	lw x17, 0(x31)
	lw x23, 5(x22)
	lw x23, 0(x23)
	...
	fle x23, x65, x23
	xori x23, x23, 1
	bne	x17, zero, trace_diffuse_rays_beqelse_b3612
# B3611
	bne	x23, zero, trace_diffuse_rays_beqelse_b3614
# B3613
	lui x17, 276464
...
# B3612
	bne	x23, zero, trace_diffuse_rays_beqelse_b3616
# B3615
	mv x17, zero
	j trace_diffuse_rays_cont_b3617 # adhoc jump(2)
...
# B3610
	bne	x17, x11, trace_diffuse_rays_beqelse_b3619
# B3618
	lw x17, 1(x31)
	fmul x17, x17, x66
	fle x23, x17, zero
...
# B3620
	fle x33, x24, x32
	bne	x33, zero, trace_diffuse_rays_beqelse_b3623
# B3621
	fmul x32, x32, x68
...
# B3624
	fle x17, x67, x35
	beq	x17, zero, trace_diffuse_rays_bneelse_b3629
# B3626
	fle x17, x35, x37
	fdiv x24, x37, x68
	bne	x17, zero, trace_diffuse_rays_beqelse_b3628
# B3627
	fsub x35, x35, x37
	mv x37, x24
...
# B3629
	fle x17, x69, x35
	bne	x17, zero, trace_diffuse_rays_beqelse_b3631
# B3630
	mv x24, x35
...
# B3632
	xor x17, x17, x23
	fle x23, x7, x24
	bne	x23, zero, trace_diffuse_rays_beqelse_b3634
# B3633
	mv x23, x24
...
# B3635
	fle x24, x70, x23
	bne	x24, zero, trace_diffuse_rays_beqelse_b3637
# B3636
	fmul x24, x23, x23
	fmul x32, x24, x73
	fadd x32, x72, x32
...
# B3638
	fle x24, x23, zero
	beq	x17, x24, trace_diffuse_rays_bneelse_b3640
# B3639
	mv x17, x23
...
# B3619
	bne	x17, x15, trace_diffuse_rays_beqelse_b3643
# B3642
	lw x17, 0(x31)
	lw x23, 5(x22)
	lw x23, 0(x23)
...
# B3644
	fle x32, x23, x24
	bne	x32, zero, trace_diffuse_rays_beqelse_b3647
# B3645
	fmul x24, x24, x68
...
# B3648
	fle x17, x67, x33
	beq	x17, zero, trace_diffuse_rays_bneelse_b3653
# B3650
	fle x17, x33, x35
	fdiv x23, x35, x68
	bne	x17, zero, trace_diffuse_rays_beqelse_b3652
# B3651
	fsub x33, x33, x35
	mv x35, x23
...
# B3653
	fle x17, x69, x33
	bne	x17, zero, trace_diffuse_rays_beqelse_b3655
# B3654
	mv x23, x33
...
# B3656
	bne	x17, zero, trace_diffuse_rays_beqelse_b3658
# B3657
	mv x24, x100
...
# B3659
	fle x17, x7, x23
	bne	x17, zero, trace_diffuse_rays_beqelse_b3661
...
# B3662
	xor x17, x17, x24
	fle x24, x70, x23
	bne	x24, zero, trace_diffuse_rays_beqelse_b3664
...
# B3665
	fle x24, x23, zero
	beq	x17, x24, trace_diffuse_rays_bneelse_b3667
# B3666
	mv x17, x23
...
# B3643
	bne	x17, x79, trace_diffuse_rays_beqelse_b3696
# B3669
	lw x17, 0(x31)
	lw x23, 5(x22)
	lw x23, 0(x23)
	...
	fabs x32, x17
	fle x32, x8, x32
	beq	x32, zero, trace_diffuse_rays_bneelse_b3672
# B3671
	fdiv x17, x23, x17
	fabs x17, x17
	fle x23, x17, zero
	...
	fabs x32, x17
	fle x33, x80, x32
	bne	x33, zero, trace_diffuse_rays_beqelse_b3674
# B3673
	fmul x23, x17, x17
	fmul x32, x23, x86
	fadd x32, x85, x32
...
# B3674
	fle x17, x87, x32
	bne	x17, zero, trace_diffuse_rays_beqelse_b3676
# B3675
	fsub x17, x32, x16
	fadd x32, x32, x16
	fdiv x17, x17, x32
...
# B3677
	bne	x23, zero, trace_diffuse_rays_beqelse_b3680
# B3678
	fsub x17, zero, x17
...
# B3681
	...
	fabs x32, x24
	fle x32, x8, x32
	beq	x32, zero, trace_diffuse_rays_bneelse_b3683
# B3682
	fdiv x23, x23, x24
	fabs x23, x23
	fle x24, x23, zero
	...
	fabs x32, x23
	fle x33, x80, x32
	bne	x33, zero, trace_diffuse_rays_beqelse_b3685
# B3684
	fmul x24, x23, x23
	fmul x32, x24, x86
	fadd x32, x85, x32
...
# B3685
	fle x23, x87, x32
	bne	x23, zero, trace_diffuse_rays_beqelse_b3687
# B3686
	fsub x23, x32, x16
	fadd x32, x32, x16
	fdiv x23, x23, x32
...
# B3688
	bne	x24, zero, trace_diffuse_rays_beqelse_b3691
# B3689
	fsub x23, zero, x23
...
# B3692
	...
	fsub x17, x17, x23
	fle x23, zero, x17
	beq	x23, zero, trace_diffuse_rays_bneelse_b3694
# B3693
	mv x24, x17
...
# B3697
	lw x17, 0(x23)
	lw x24, 0(x17)
	beq	x24, x28, trace_diffuse_rays_bneelse_b3923
# B3699
	bne	x24, x26, trace_diffuse_rays_beqelse_b3701
# B3700
	mv x24, x100
...
# B3701
	...
	lw x24, 0(x4)
	lw x37, 1(x25)
	bne	x37, x100, trace_diffuse_rays_beqelse_b3703
# B3702
	lw x37, 0(x90)
	lw x38, 0(x24)
	fsub x38, x38, x32
	...
	lw x6, 1(x6)
	fle x40, x6, x40
	bne	x40, zero, trace_diffuse_rays_beqelse_b3709
# B3705
	lw x40, 2(x37)
	fmul x40, x38, x40
	fadd x40, x40, x35
...
# B3707
	...
	mv x6, x40
# B3708
	bne	x6, zero, trace_diffuse_rays_beqelse_b3710
...
# B3709
	...
	lw x6, 0(x6)
	fle x40, x6, x40
	bne	x40, zero, trace_diffuse_rays_beqelse_b3716
# B3712
	lw x40, 2(x37)
	fmul x40, x38, x40
	fadd x40, x40, x35
...
# B3714
	...
	mv x6, x40
# B3715
	bne	x6, zero, trace_diffuse_rays_beqelse_b3717
...
# B3716
	...
	lw x38, 0(x38)
	fle x32, x38, x32
	bne	x32, zero, trace_diffuse_rays_beqelse_b3723
# B3719
	lw x32, 1(x37)
	fmul x32, x35, x32
	fadd x32, x32, x33
	...
	lw x25, 1(x25)
	fle x25, x25, x32
	bne	x25, zero, trace_diffuse_rays_beqelse_b3723
# B3721
	lw x24, 5(x24)
	feq x24, x24, zero
	xori x24, x24, 1
	mv x25, x24
# B3722
	bne	x25, zero, trace_diffuse_rays_beqelse_b3724
...
# B3703
	bne	x37, x11, trace_diffuse_rays_beqelse_b3726
# B3725
	lw x25, 0(x24)
	fle x25, zero, x25
	bne	x25, zero, trace_diffuse_rays_beqelse_b3743
# B3728
	lw x25, 1(x24)
	fmul x25, x25, x32
	lw x32, 2(x24)
...
# B3726
	lw x37, 0(x24)
	feq x38, x37, zero
	bne	x38, zero, trace_diffuse_rays_beqelse_b3743
# B3729
	lw x38, 1(x24)
	fmul x38, x38, x32
	lw x40, 2(x24)
	...
	fadd x40, x40, x6
	lw x6, 3(x25)
	bne	x6, zero, trace_diffuse_rays_beqelse_b3732
# B3731
	mv x32, x40
...
# B3733
	lw x33, 1(x25)
	bne	x33, x15, trace_diffuse_rays_beqelse_b3736
# B3734
	fsub x32, x32, x16
...
# B3738
	lw x25, 6(x25)
	fsqrt x32, x32
	bne	x25, zero, trace_diffuse_rays_beqelse_b3740
# B3739
	fsub x25, x38, x32
	lw x24, 4(x24)
	fmul x24, x25, x24
...
# B3742
	bne	x24, zero, trace_diffuse_rays_beqelse_b3744
...
# B3744
	lw x24, 0(x27)
	fle x24, x34, x24
	beq	x24, zero, trace_diffuse_rays_bneelse_b3746
# B3745
	addi x23, x23, 1
	j trace_diffuse_rays_cont_b3834 # adhoc jump(2)
...
# B3747
	lw x24, 0(x25)
	beq	x24, x28, trace_diffuse_rays_bneelse_b3831
# B3749
	add x4, x29, x24
	lw x24, 0(x4)
	addi x32, x24, 0
...
# B3750
	lw x24, 0(x33)
	beq	x24, x28, trace_diffuse_rays_bneelse_b3828
# B3752
	lw x24, 0(x33)
	add x4, x12, x24
	lw x32, 0(x4)
	...
	lw x6, 0(x4)
	lw x65, 1(x32)
	bne	x65, x100, trace_diffuse_rays_beqelse_b3754
# B3753
	lw x65, 0(x90)
	lw x66, 0(x6)
	fsub x66, x66, x37
	...
	lw x68, 1(x68)
	fle x67, x68, x67
	bne	x67, zero, trace_diffuse_rays_beqelse_b3760
# B3756
	lw x67, 2(x65)
	fmul x67, x66, x67
	fadd x67, x67, x40
...
# B3758
	...
	mv x68, x67
# B3759
	bne	x68, zero, trace_diffuse_rays_beqelse_b3761
...
# B3760
	...
	lw x68, 0(x68)
	fle x67, x68, x67
	bne	x67, zero, trace_diffuse_rays_beqelse_b3767
# B3763
	lw x67, 2(x65)
	fmul x67, x66, x67
	fadd x67, x67, x40
...
# B3765
	...
	mv x68, x67
# B3766
	bne	x68, zero, trace_diffuse_rays_beqelse_b3768
...
# B3767
	...
	lw x66, 0(x66)
	fle x37, x66, x37
	bne	x37, zero, trace_diffuse_rays_beqelse_b3774
# B3770
	lw x37, 1(x65)
	fmul x37, x40, x37
	fadd x37, x37, x38
	...
	lw x32, 1(x32)
	fle x32, x32, x37
	bne	x32, zero, trace_diffuse_rays_beqelse_b3774
# B3772
	lw x32, 5(x6)
	feq x32, x32, zero
	xori x32, x32, 1
	mv x37, x32
# B3773
	bne	x37, zero, trace_diffuse_rays_beqelse_b3775
...
# B3754
	bne	x65, x11, trace_diffuse_rays_beqelse_b3777
# B3776
	lw x32, 0(x6)
	fle x32, zero, x32
	beq	x32, zero, trace_diffuse_rays_bneelse_b3779
# B3778
	lw x37, 0(x27)
	j trace_diffuse_rays_cont_b3794 # adhoc jump(2)
...
# B3777
	lw x65, 0(x6)
	feq x66, x65, zero
	bne	x66, zero, trace_diffuse_rays_beqelse_b3781
# B3780
	lw x66, 1(x6)
	fmul x66, x66, x37
	lw x67, 2(x6)
	...
	fadd x67, x67, x68
	lw x68, 3(x32)
	bne	x68, zero, trace_diffuse_rays_beqelse_b3783
# B3782
	mv x37, x67
...
# B3784
	lw x38, 1(x32)
	bne	x38, x15, trace_diffuse_rays_beqelse_b3787
# B3785
	fsub x37, x37, x16
...
# B3787
	...
	fsub x37, x38, x37
	fle x38, x37, zero
	beq	x38, zero, trace_diffuse_rays_bneelse_b3789
# B3788
	lw x37, 0(x27)
	j trace_diffuse_rays_cont_b3794 # adhoc jump(2)
...
# B3789
	lw x32, 6(x32)
	fsqrt x37, x37
	bne	x32, zero, trace_diffuse_rays_beqelse_b3791
# B3790
	fsub x32, x66, x37
	lw x37, 4(x6)
	fmul x32, x32, x37
...
# B3793
	lw x37, 0(x27)
	bne	x32, zero, trace_diffuse_rays_beqelse_b3795
...
# B3796
	addi x33, x33, 1
	bne	x32, zero, trace_diffuse_rays_beqelse_b3798
...
# B3801
	lw x24, 0(x40)
	bne	x24, x28, trace_diffuse_rays_beqelse_b3803
# B3802
	mv x32, x100
# B3824
	bne	x32, zero, trace_diffuse_rays_beqelse_b3826
	j trace_diffuse_rays_cont_b3825 # adhoc jump(3)
trace_diffuse_rays_beqelse_b3826:
# B3826
	mv x24, x100
# B3827
	bne	x24, zero, trace_diffuse_rays_beqelse_b3829
	j trace_diffuse_rays_cont_b3828 # adhoc jump(3)
trace_diffuse_rays_beqelse_b3829:
# B3829
	mv x32, x100
# B3830
	bne	x32, zero, trace_diffuse_rays_beqelse_b3832
...
# B3833
	addi x23, x23, 1
	bne	x24, zero, trace_diffuse_rays_beqelse_b3835
...
# B3836
	lw x17, 0(x24)
	beq	x17, x28, trace_diffuse_rays_bneelse_b3920
# B3838
	add x4, x29, x17
	lw x17, 0(x4)
	addi x25, x17, 0
...
# B3839
	lw x17, 0(x32)
	beq	x17, x28, trace_diffuse_rays_bneelse_b3917
# B3841
	lw x17, 0(x32)
	add x4, x12, x17
	lw x25, 0(x4)
	...
	lw x40, 0(x4)
	lw x6, 1(x25)
	bne	x6, x100, trace_diffuse_rays_beqelse_b3843
# B3842
	lw x6, 0(x90)
	lw x65, 0(x40)
	fsub x65, x65, x35
	...
	lw x67, 1(x67)
	fle x66, x67, x66
	bne	x66, zero, trace_diffuse_rays_beqelse_b3849
# B3845
	lw x66, 2(x6)
	fmul x66, x65, x66
	fadd x66, x66, x38
...
# B3847
	...
	mv x67, x66
# B3848
	bne	x67, zero, trace_diffuse_rays_beqelse_b3850
...
# B3849
	...
	lw x67, 0(x67)
	fle x66, x67, x66
	bne	x66, zero, trace_diffuse_rays_beqelse_b3856
# B3852
	lw x66, 2(x6)
	fmul x66, x65, x66
	fadd x66, x66, x38
...
# B3854
	...
	mv x67, x66
# B3855
	bne	x67, zero, trace_diffuse_rays_beqelse_b3857
...
# B3856
	...
	lw x65, 0(x65)
	fle x35, x65, x35
	bne	x35, zero, trace_diffuse_rays_beqelse_b3863
# B3859
	lw x35, 1(x6)
	fmul x35, x38, x35
	fadd x35, x35, x37
	...
	lw x25, 1(x25)
	fle x25, x25, x35
	bne	x25, zero, trace_diffuse_rays_beqelse_b3863
# B3861
	lw x25, 5(x40)
	feq x25, x25, zero
	xori x25, x25, 1
	mv x35, x25
# B3862
	bne	x35, zero, trace_diffuse_rays_beqelse_b3864
...
# B3843
	bne	x6, x11, trace_diffuse_rays_beqelse_b3866
# B3865
	lw x25, 0(x40)
	fle x25, zero, x25
	beq	x25, zero, trace_diffuse_rays_bneelse_b3868
# B3867
	lw x35, 0(x27)
	j trace_diffuse_rays_cont_b3883 # adhoc jump(2)
...
# B3866
	lw x6, 0(x40)
	feq x65, x6, zero
	bne	x65, zero, trace_diffuse_rays_beqelse_b3870
# B3869
	lw x65, 1(x40)
	fmul x65, x65, x35
	lw x66, 2(x40)
	...
	fadd x66, x66, x67
	lw x67, 3(x25)
	bne	x67, zero, trace_diffuse_rays_beqelse_b3872
# B3871
	mv x35, x66
...
# B3873
	lw x37, 1(x25)
	bne	x37, x15, trace_diffuse_rays_beqelse_b3876
# B3874
	fsub x35, x35, x16
...
# B3876
	...
	fsub x35, x37, x35
	fle x37, x35, zero
	beq	x37, zero, trace_diffuse_rays_bneelse_b3878
# B3877
	lw x35, 0(x27)
	j trace_diffuse_rays_cont_b3883 # adhoc jump(2)
...
# B3878
	lw x25, 6(x25)
	fsqrt x35, x35
	bne	x25, zero, trace_diffuse_rays_beqelse_b3880
# B3879
	fsub x25, x65, x35
	lw x35, 4(x40)
	fmul x25, x25, x35
...
# B3882
	lw x35, 0(x27)
	bne	x25, zero, trace_diffuse_rays_beqelse_b3884
...
# B3885
	addi x32, x32, 1
	bne	x25, zero, trace_diffuse_rays_beqelse_b3887
...
# B3890
	lw x17, 0(x38)
	bne	x17, x28, trace_diffuse_rays_beqelse_b3892
# B3891
	mv x25, x100
# B3913
	bne	x25, zero, trace_diffuse_rays_beqelse_b3915
	j trace_diffuse_rays_cont_b3914 # adhoc jump(3)
trace_diffuse_rays_beqelse_b3915:
# B3915
	mv x17, x100
# B3916
	bne	x17, zero, trace_diffuse_rays_beqelse_b3918
	j trace_diffuse_rays_cont_b3917 # adhoc jump(3)
trace_diffuse_rays_beqelse_b3918:
# B3918
	mv x25, x100
# B3919
	bne	x25, zero, trace_diffuse_rays_beqelse_b3921
...
# B3921
	mv x17, x100
# B3922
	bne	x17, zero, trace_diffuse_rays_beqelse_b4470
...
# B3923
	...
	fsub x17, zero, x17
	fle x23, x17, zero
	beq	x23, zero, trace_diffuse_rays_bneelse_b3926
# B3925
	mv x24, zero
...
# B3892
	...
	fsub x37, x65, x37
	lw x66, 1(x17)
	bne	x66, x100, trace_diffuse_rays_beqelse_b3894
# B3893
	fabs x25, x25
	lw x66, 4(x17)
	lw x66, 0(x66)
	fle x25, x66, x25
	bne	x25, zero, trace_diffuse_rays_beqelse_b3900
# B3896
	fabs x25, x35
	lw x35, 4(x17)
	lw x35, 1(x35)
...
# B3898
	...
	mv x35, x25
# B3899
	bne	x35, zero, trace_diffuse_rays_beqelse_b3901
...
# B3894
	bne	x66, x11, trace_diffuse_rays_beqelse_b3903
# B3902
	lw x66, 4(x17)
	lw x67, 0(x66)
	fmul x25, x67, x25
...
# B3903
	...
	fadd x66, x66, x67
	lw x67, 3(x17)
	bne	x67, zero, trace_diffuse_rays_beqelse_b3905
# B3904
	mv x25, x66
...
# B3906
	lw x35, 1(x17)
	bne	x35, x15, trace_diffuse_rays_beqelse_b3909
# B3907
	fsub x25, x25, x16
...
# B3910
	bne	x17, zero, trace_diffuse_rays_beqelse_b3914
# B3911
	addi x38, x38, 1
...
# B3886
	...
	lw x17, 0(x4)
	lw x17, 6(x17)
	beq	x17, zero, trace_diffuse_rays_bneelse_b3917
...
# B3803
	...
	fsub x38, x66, x38
	lw x67, 1(x24)
	bne	x67, x100, trace_diffuse_rays_beqelse_b3805
# B3804
	fabs x32, x32
	lw x67, 4(x24)
	lw x67, 0(x67)
	fle x32, x67, x32
	bne	x32, zero, trace_diffuse_rays_beqelse_b3811
# B3807
	fabs x32, x37
	lw x37, 4(x24)
	lw x37, 1(x37)
...
# B3809
	...
	mv x37, x32
# B3810
	bne	x37, zero, trace_diffuse_rays_beqelse_b3812
...
# B3805
	bne	x67, x11, trace_diffuse_rays_beqelse_b3814
# B3813
	lw x67, 4(x24)
	lw x68, 0(x67)
	fmul x32, x68, x32
...
# B3814
	...
	fadd x67, x67, x68
	lw x68, 3(x24)
	bne	x68, zero, trace_diffuse_rays_beqelse_b3816
# B3815
	mv x32, x67
...
# B3817
	lw x37, 1(x24)
	bne	x37, x15, trace_diffuse_rays_beqelse_b3820
# B3818
	fsub x32, x32, x16
...
# B3821
	bne	x24, zero, trace_diffuse_rays_beqelse_b3825
# B3822
	addi x40, x40, 1
...
# B3797
	...
	lw x24, 0(x4)
	lw x24, 6(x24)
	beq	x24, zero, trace_diffuse_rays_bneelse_b3828
...
# B3928
	lw x22, 0(x24)
	lw x95, 0(x22)
	beq	x95, x28, trace_diffuse_rays_bneelse_b4127
# B3930
	bne	x95, x26, trace_diffuse_rays_beqelse_b3932
# B3931
	addi x22, x22, 1
	mv x96, x94
	mv x95, x22
...
# B3933
	lw x22, 0(x95)
	beq	x22, x28, trace_diffuse_rays_bneelse_b4126
# B3935
	add x4, x29, x22
	lw x22, 0(x4)
	addi x97, x22, 0
...
# B3936
	lw x22, 0(x101)
	lw x97, 0(x98)
	beq	x97, x28, trace_diffuse_rays_bneelse_b4009
# B3938
	add x4, x12, x97
	lw x102, 0(x4)
	lw x103, 10(x102)
	...
	lw x107, 0(x4)
	lw x108, 1(x102)
	bne	x108, x100, trace_diffuse_rays_beqelse_b3940
# B3939
	lw x103, 0(x101)
	lw x108, 0(x107)
	fsub x108, x108, x104
	...
	lw x110, 1(x110)
	fle x109, x110, x109
	bne	x109, zero, trace_diffuse_rays_beqelse_b3946
# B3942
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B3944
	...
	mv x110, x109
# B3945
	bne	x110, zero, trace_diffuse_rays_beqelse_b3947
...
# B3946
	...
	lw x110, 0(x110)
	fle x109, x110, x109
	bne	x109, zero, trace_diffuse_rays_beqelse_b3953
# B3949
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B3951
	...
	mv x110, x109
# B3952
	bne	x110, zero, trace_diffuse_rays_beqelse_b3954
...
# B3956
	...
	lw x102, 1(x102)
	fle x102, x102, x103
	bne	x102, zero, trace_diffuse_rays_beqelse_b3960
# B3958
	lw x102, 5(x107)
	feq x102, x102, zero
	xori x102, x102, 1
	mv x103, x102
# B3959
	bne	x103, zero, trace_diffuse_rays_beqelse_b3961
...
# B3940
	bne	x108, x11, trace_diffuse_rays_beqelse_b3963
# B3962
	lw x102, 0(x107)
	fle x102, zero, x102
	beq	x102, zero, trace_diffuse_rays_bneelse_b3965
# B3964
	mv x102, zero
	addi x98, x98, 1
	j trace_diffuse_rays_cont_b3974 # adhoc jump(2)
...
# B3963
	lw x108, 0(x107)
	feq x109, x108, zero
	bne	x109, zero, trace_diffuse_rays_beqelse_b3967
# B3966
	lw x109, 1(x107)
	fmul x104, x109, x104
	lw x109, 2(x107)
	...
	fsub x103, x105, x103
	fle x105, x103, zero
	beq	x105, zero, trace_diffuse_rays_bneelse_b3969
# B3968
	mv x102, zero
	addi x98, x98, 1
	j trace_diffuse_rays_cont_b3974 # adhoc jump(2)
...
# B3969
	lw x102, 6(x102)
	fsqrt x103, x103
	bne	x102, zero, trace_diffuse_rays_beqelse_b3971
# B3970
	fsub x102, x104, x103
	lw x103, 4(x107)
	fmul x102, x102, x103
...
# B3973
	addi x98, x98, 1
	bne	x102, zero, trace_diffuse_rays_beqelse_b3975
	j trace_diffuse_rays_cont_b3974 # adhoc jump(3)
trace_diffuse_rays_beqelse_b3975:
# B3975
	lw x103, 0(x27)
	fle x104, x103, zero
	bne	x104, zero, trace_diffuse_rays_beqelse_b4008
# B3979
	lw x104, 0(x23)
	fle x104, x104, x103
	bne	x104, zero, trace_diffuse_rays_beqelse_b4008
...
# B3982
	lw x106, 0(x107)
	bne	x106, x28, trace_diffuse_rays_beqelse_b3984
# B3983
	mv x111, x100
# B4005
	bne	x111, zero, trace_diffuse_rays_beqelse_b4007
...
# B3984
	...
	fsub x113, x110, x113
	lw x114, 1(x106)
	bne	x114, x100, trace_diffuse_rays_beqelse_b3986
# B3985
	fabs x111, x111
	lw x114, 4(x106)
	lw x114, 0(x114)
	fle x111, x114, x111
	bne	x111, zero, trace_diffuse_rays_beqelse_b3992
# B3988
	fabs x111, x112
	lw x112, 4(x106)
	lw x112, 1(x112)
...
# B3990
	...
	mv x112, x111
# B3991
	bne	x112, zero, trace_diffuse_rays_beqelse_b3993
...
# B3986
	bne	x114, x11, trace_diffuse_rays_beqelse_b3995
# B3994
	lw x114, 4(x106)
	lw x115, 0(x114)
	fmul x111, x115, x111
...
# B3995
	...
	fadd x114, x114, x115
	lw x115, 3(x106)
	bne	x115, zero, trace_diffuse_rays_beqelse_b3997
# B3996
	mv x111, x114
...
# B3998
	lw x112, 1(x106)
	bne	x112, x15, trace_diffuse_rays_beqelse_b4001
# B3999
	fsub x111, x111, x16
...
# B4002
	bne	x106, zero, trace_diffuse_rays_beqelse_b4006
# B4003
	addi x106, x107, 1
	mv x107, x106
...
# B3974
	...
	lw x22, 0(x4)
	lw x22, 6(x22)
	beq	x22, zero, trace_diffuse_rays_bneelse_b4009
...
# B3932
	...
	lw x95, 0(x4)
	lw x102, 1(x96)
	bne	x102, x100, trace_diffuse_rays_beqelse_b4011
# B4010
	lw x97, 0(x94)
	lw x102, 0(x95)
	fsub x102, x102, x98
	...
	lw x104, 1(x104)
	fle x103, x104, x103
	bne	x103, zero, trace_diffuse_rays_beqelse_b4017
# B4013
	lw x103, 2(x97)
	fmul x103, x102, x103
	fadd x103, x103, x101
...
# B4015
	...
	mv x104, x103
# B4016
	bne	x104, zero, trace_diffuse_rays_beqelse_b4018
...
# B4017
	...
	lw x104, 0(x104)
	fle x103, x104, x103
	bne	x103, zero, trace_diffuse_rays_beqelse_b4024
# B4020
	lw x103, 2(x97)
	fmul x103, x102, x103
	fadd x103, x103, x101
...
# B4022
	...
	mv x104, x103
# B4023
	bne	x104, zero, trace_diffuse_rays_beqelse_b4025
...
# B4024
	...
	lw x102, 0(x102)
	fle x98, x102, x98
	bne	x98, zero, trace_diffuse_rays_beqelse_b4031
# B4027
	lw x97, 1(x97)
	fmul x97, x101, x97
	fadd x97, x97, x99
	...
	lw x96, 1(x96)
	fle x96, x96, x97
	bne	x96, zero, trace_diffuse_rays_beqelse_b4031
# B4029
	lw x95, 5(x95)
	feq x95, x95, zero
	xori x95, x95, 1
	mv x96, x95
# B4030
	bne	x96, zero, trace_diffuse_rays_beqelse_b4032
...
# B4011
	bne	x102, x11, trace_diffuse_rays_beqelse_b4034
# B4033
	lw x96, 0(x95)
	fle x96, zero, x96
	bne	x96, zero, trace_diffuse_rays_beqelse_b4045
# B4036
	lw x95, 0(x95)
	lw x96, 3(x97)
	fmul x95, x95, x96
...
# B4034
	lw x102, 0(x95)
	feq x103, x102, zero
	bne	x103, zero, trace_diffuse_rays_beqelse_b4045
# B4037
	lw x103, 1(x95)
	fmul x98, x103, x98
	lw x103, 2(x95)
	...
	fsub x97, x99, x97
	fle x99, x97, zero
	bne	x99, zero, trace_diffuse_rays_beqelse_b4045
# B4040
	lw x96, 6(x96)
	fsqrt x97, x97
	bne	x96, zero, trace_diffuse_rays_beqelse_b4042
# B4041
	fsub x96, x98, x97
	lw x95, 4(x95)
	fmul x95, x96, x95
...
# B4044
	bne	x95, zero, trace_diffuse_rays_beqelse_b4046
...
# B4046
	...
	lw x96, 0(x23)
	fle x95, x96, x95
	bne	x95, zero, trace_diffuse_rays_beqelse_b4126
# B4048
	addi x22, x22, 1
	mv x96, x94
	mv x95, x22
...
# B4052
	lw x22, 0(x101)
	lw x97, 0(x98)
	beq	x97, x28, trace_diffuse_rays_bneelse_b4125
# B4054
	add x4, x12, x97
	lw x102, 0(x4)
	lw x103, 10(x102)
	...
	lw x107, 0(x4)
	lw x108, 1(x102)
	bne	x108, x100, trace_diffuse_rays_beqelse_b4056
# B4055
	lw x103, 0(x101)
	lw x108, 0(x107)
	fsub x108, x108, x104
	...
	lw x110, 1(x110)
	fle x109, x110, x109
	bne	x109, zero, trace_diffuse_rays_beqelse_b4062
# B4058
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B4060
	...
	mv x110, x109
# B4061
	bne	x110, zero, trace_diffuse_rays_beqelse_b4063
...
# B4062
	...
	lw x110, 0(x110)
	fle x109, x110, x109
	bne	x109, zero, trace_diffuse_rays_beqelse_b4069
# B4065
	lw x109, 2(x103)
	fmul x109, x108, x109
	fadd x109, x109, x106
...
# B4067
	...
	mv x110, x109
# B4068
	bne	x110, zero, trace_diffuse_rays_beqelse_b4070
...
# B4072
	...
	lw x102, 1(x102)
	fle x102, x102, x103
	bne	x102, zero, trace_diffuse_rays_beqelse_b4076
# B4074
	lw x102, 5(x107)
	feq x102, x102, zero
	xori x102, x102, 1
	mv x103, x102
# B4075
	bne	x103, zero, trace_diffuse_rays_beqelse_b4077
...
# B4056
	bne	x108, x11, trace_diffuse_rays_beqelse_b4079
# B4078
	lw x102, 0(x107)
	fle x102, zero, x102
	beq	x102, zero, trace_diffuse_rays_bneelse_b4081
# B4080
	mv x102, zero
	addi x98, x98, 1
	j trace_diffuse_rays_cont_b4090 # adhoc jump(2)
...
# B4079
	lw x108, 0(x107)
	feq x109, x108, zero
	bne	x109, zero, trace_diffuse_rays_beqelse_b4083
# B4082
	lw x109, 1(x107)
	fmul x104, x109, x104
	lw x109, 2(x107)
	...
	fsub x103, x105, x103
	fle x105, x103, zero
	beq	x105, zero, trace_diffuse_rays_bneelse_b4085
# B4084
	mv x102, zero
	addi x98, x98, 1
	j trace_diffuse_rays_cont_b4090 # adhoc jump(2)
...
# B4085
	lw x102, 6(x102)
	fsqrt x103, x103
	bne	x102, zero, trace_diffuse_rays_beqelse_b4087
# B4086
	fsub x102, x104, x103
	lw x103, 4(x107)
	fmul x102, x102, x103
...
# B4089
	addi x98, x98, 1
	bne	x102, zero, trace_diffuse_rays_beqelse_b4091
	j trace_diffuse_rays_cont_b4090 # adhoc jump(3)
trace_diffuse_rays_beqelse_b4091:
# B4091
	lw x103, 0(x27)
	fle x104, x103, zero
	bne	x104, zero, trace_diffuse_rays_beqelse_b4124
# B4095
	lw x104, 0(x23)
	fle x104, x104, x103
	bne	x104, zero, trace_diffuse_rays_beqelse_b4124
...
# B4098
	lw x106, 0(x107)
	bne	x106, x28, trace_diffuse_rays_beqelse_b4100
# B4099
	mv x111, x100
# B4121
	bne	x111, zero, trace_diffuse_rays_beqelse_b4123
...
# B4100
	...
	fsub x113, x110, x113
	lw x114, 1(x106)
	bne	x114, x100, trace_diffuse_rays_beqelse_b4102
# B4101
	fabs x111, x111
	lw x114, 4(x106)
	lw x114, 0(x114)
	fle x111, x114, x111
	bne	x111, zero, trace_diffuse_rays_beqelse_b4108
# B4104
	fabs x111, x112
	lw x112, 4(x106)
	lw x112, 1(x112)
...
# B4106
	...
	mv x112, x111
# B4107
	bne	x112, zero, trace_diffuse_rays_beqelse_b4109
...
# B4102
	bne	x114, x11, trace_diffuse_rays_beqelse_b4111
# B4110
	lw x114, 4(x106)
	lw x115, 0(x114)
	fmul x111, x115, x111
...
# B4111
	...
	fadd x114, x114, x115
	lw x115, 3(x106)
	bne	x115, zero, trace_diffuse_rays_beqelse_b4113
# B4112
	mv x111, x114
...
# B4114
	lw x112, 1(x106)
	bne	x112, x15, trace_diffuse_rays_beqelse_b4117
# B4115
	fsub x111, x111, x16
...
# B4118
	bne	x106, zero, trace_diffuse_rays_beqelse_b4122
# B4119
	addi x106, x107, 1
	mv x107, x106
...
# B4090
	...
	lw x22, 0(x4)
	lw x22, 6(x22)
	beq	x22, zero, trace_diffuse_rays_bneelse_b4125
...
# B4127
	lw x22, 0(x23)
	fle x23, x22, x34
	bne	x23, zero, trace_diffuse_rays_beqelse_b4131
# B4129
	fle x22, x35, x22
	xori x22, x22, 1
	mv x23, x22
# B4130
	bne	x23, zero, trace_diffuse_rays_beqelse_b4132
...
# B4132
	...
	lw x17, 0(x17)
	lw x23, 1(x22)
	bne	x23, x100, trace_diffuse_rays_beqelse_b4134
# B4133
	lw x23, 0(x33)
	sw zero, 0(x36)
	sw zero, 1(x36)
	...
	lw x17, 0(x4)
	feq x24, x17, zero
	bne	x24, zero, trace_diffuse_rays_beqelse_b4136
# B4135
	fle x17, x17, zero
	beq	x17, zero, trace_diffuse_rays_bneelse_b4138
# B4137
	mv x17, x38
...
# B4134
	bne	x23, x11, trace_diffuse_rays_beqelse_b4141
# B4140
	lw x17, 4(x22)
	lw x17, 0(x17)
	fsub x17, zero, x17
...
# B4144
	...
	fsqrt x23, x23
	feq x24, x23, zero
	bne	x24, zero, trace_diffuse_rays_beqelse_b4146
# B4145
	bne	x17, zero, trace_diffuse_rays_beqelse_b4148
# B4147
	fdiv x17, x16, x23
...
# B4150
	...
	lw x23, 2(x23)
	sw x23, 2(x39)
	bne	x17, x100, trace_diffuse_rays_beqelse_b4152
# B4151
	lw x17, 0(x31)
	lw x23, 5(x22)
	lw x23, 0(x23)
	...
	fle x23, x65, x23
	xori x23, x23, 1
	bne	x17, zero, trace_diffuse_rays_beqelse_b4154
# B4153
	bne	x23, zero, trace_diffuse_rays_beqelse_b4156
# B4155
	mv x24, x77
...
# B4154
	bne	x23, zero, trace_diffuse_rays_beqelse_b4158
# B4157
	mv x24, zero
	j trace_diffuse_rays_cont_b4159 # adhoc jump(2)
...
# B4152
	bne	x17, x11, trace_diffuse_rays_beqelse_b4161
# B4160
	lw x17, 1(x31)
	fmul x17, x17, x66
	fle x23, x17, zero
...
# B4162
	fle x33, x24, x32
	bne	x33, zero, trace_diffuse_rays_beqelse_b4165
# B4163
	fmul x32, x32, x68
...
# B4166
	fle x17, x67, x35
	beq	x17, zero, trace_diffuse_rays_bneelse_b4171
# B4168
	fle x17, x35, x37
	fdiv x24, x37, x68
	bne	x17, zero, trace_diffuse_rays_beqelse_b4170
# B4169
	fsub x35, x35, x37
	mv x37, x24
...
# B4171
	fle x17, x69, x35
	bne	x17, zero, trace_diffuse_rays_beqelse_b4173
# B4172
	mv x24, x35
...
# B4174
	xor x17, x17, x23
	fle x23, x7, x24
	bne	x23, zero, trace_diffuse_rays_beqelse_b4176
# B4175
	mv x23, x24
...
# B4177
	fle x24, x70, x23
	bne	x24, zero, trace_diffuse_rays_beqelse_b4179
# B4178
	fmul x24, x23, x23
	fmul x32, x24, x73
	fadd x32, x72, x32
...
# B4180
	fle x24, x23, zero
	beq	x17, x24, trace_diffuse_rays_bneelse_b4182
# B4181
	mv x17, x23
...
# B4161
	bne	x17, x15, trace_diffuse_rays_beqelse_b4185
# B4184
	lw x17, 0(x31)
	lw x23, 5(x22)
	lw x23, 0(x23)
...
# B4186
	fle x32, x23, x24
	bne	x32, zero, trace_diffuse_rays_beqelse_b4189
# B4187
	fmul x24, x24, x68
...
# B4190
	fle x17, x67, x33
	beq	x17, zero, trace_diffuse_rays_bneelse_b4195
# B4192
	fle x17, x33, x35
	fdiv x23, x35, x68
	bne	x17, zero, trace_diffuse_rays_beqelse_b4194
# B4193
	fsub x33, x33, x35
	mv x35, x23
...
# B4195
	fle x17, x69, x33
	bne	x17, zero, trace_diffuse_rays_beqelse_b4197
# B4196
	mv x23, x33
...
# B4198
	bne	x17, zero, trace_diffuse_rays_beqelse_b4200
# B4199
	mv x24, x100
...
# B4201
	fle x17, x7, x23
	bne	x17, zero, trace_diffuse_rays_beqelse_b4203
...
# B4204
	xor x17, x17, x24
	fle x24, x70, x23
	bne	x24, zero, trace_diffuse_rays_beqelse_b4206
...
# B4207
	fle x24, x23, zero
	beq	x17, x24, trace_diffuse_rays_bneelse_b4209
# B4208
	mv x17, x23
...
# B4185
	bne	x17, x79, trace_diffuse_rays_beqelse_b4238
# B4211
	lw x17, 0(x31)
	lw x23, 5(x22)
	lw x23, 0(x23)
	...
	fabs x32, x17
	fle x32, x8, x32
	beq	x32, zero, trace_diffuse_rays_bneelse_b4214
# B4213
	fdiv x17, x23, x17
	fabs x17, x17
	fle x23, x17, zero
	...
	fabs x32, x17
	fle x33, x80, x32
	bne	x33, zero, trace_diffuse_rays_beqelse_b4216
# B4215
	fmul x23, x17, x17
	fmul x32, x23, x86
	fadd x32, x85, x32
...
# B4216
	fle x17, x87, x32
	bne	x17, zero, trace_diffuse_rays_beqelse_b4218
# B4217
	fsub x17, x32, x16
	fadd x32, x32, x16
	fdiv x17, x17, x32
...
# B4219
	bne	x23, zero, trace_diffuse_rays_beqelse_b4222
# B4220
	fsub x17, zero, x17
...
# B4223
	...
	fabs x32, x24
	fle x32, x8, x32
	beq	x32, zero, trace_diffuse_rays_bneelse_b4225
# B4224
	fdiv x23, x23, x24
	fabs x23, x23
	fle x24, x23, zero
	...
	fabs x32, x23
	fle x33, x80, x32
	bne	x33, zero, trace_diffuse_rays_beqelse_b4227
# B4226
	fmul x24, x23, x23
	fmul x32, x24, x86
	fadd x32, x85, x32
...
# B4227
	fle x23, x87, x32
	bne	x23, zero, trace_diffuse_rays_beqelse_b4229
# B4228
	fsub x23, x32, x16
	fadd x32, x32, x16
	fdiv x23, x23, x32
...
# B4230
	bne	x24, zero, trace_diffuse_rays_beqelse_b4233
# B4231
	fsub x23, zero, x23
...
# B4234
	...
	fsub x17, x17, x23
	fle x23, zero, x17
	beq	x23, zero, trace_diffuse_rays_bneelse_b4236
# B4235
	mv x24, x17
...
# B4239
	lw x17, 0(x23)
	lw x24, 0(x17)
	beq	x24, x28, trace_diffuse_rays_bneelse_b4465
# B4241
	bne	x24, x26, trace_diffuse_rays_beqelse_b4243
# B4242
	mv x24, x100
...
# B4243
	...
	lw x24, 0(x4)
	lw x37, 1(x25)
	bne	x37, x100, trace_diffuse_rays_beqelse_b4245
# B4244
	lw x37, 0(x90)
	lw x38, 0(x24)
	fsub x38, x38, x32
	...
	lw x6, 1(x6)
	fle x40, x6, x40
	bne	x40, zero, trace_diffuse_rays_beqelse_b4251
# B4247
	lw x40, 2(x37)
	fmul x40, x38, x40
	fadd x40, x40, x35
...
# B4249
	...
	mv x6, x40
# B4250
	bne	x6, zero, trace_diffuse_rays_beqelse_b4252
...
# B4251
	...
	lw x6, 0(x6)
	fle x40, x6, x40
	bne	x40, zero, trace_diffuse_rays_beqelse_b4258
# B4254
	lw x40, 2(x37)
	fmul x40, x38, x40
	fadd x40, x40, x35
...
# B4256
	...
	mv x6, x40
# B4257
	bne	x6, zero, trace_diffuse_rays_beqelse_b4259
...
# B4258
	...
	lw x38, 0(x38)
	fle x32, x38, x32
	bne	x32, zero, trace_diffuse_rays_beqelse_b4265
# B4261
	lw x32, 1(x37)
	fmul x32, x35, x32
	fadd x32, x32, x33
	...
	lw x25, 1(x25)
	fle x25, x25, x32
	bne	x25, zero, trace_diffuse_rays_beqelse_b4265
# B4263
	lw x24, 5(x24)
	feq x24, x24, zero
	xori x24, x24, 1
	mv x25, x24
# B4264
	bne	x25, zero, trace_diffuse_rays_beqelse_b4266
...
# B4245
	bne	x37, x11, trace_diffuse_rays_beqelse_b4268
# B4267
	lw x25, 0(x24)
	fle x25, zero, x25
	bne	x25, zero, trace_diffuse_rays_beqelse_b4285
# B4270
	lw x25, 1(x24)
	fmul x25, x25, x32
	lw x32, 2(x24)
...
# B4268
	lw x37, 0(x24)
	feq x38, x37, zero
	bne	x38, zero, trace_diffuse_rays_beqelse_b4285
# B4271
	lw x38, 1(x24)
	fmul x38, x38, x32
	lw x40, 2(x24)
	...
	fadd x40, x40, x6
	lw x6, 3(x25)
	bne	x6, zero, trace_diffuse_rays_beqelse_b4274
# B4273
	mv x32, x40
...
# B4275
	lw x33, 1(x25)
	bne	x33, x15, trace_diffuse_rays_beqelse_b4278
# B4276
	fsub x32, x32, x16
...
# B4280
	lw x25, 6(x25)
	fsqrt x32, x32
	bne	x25, zero, trace_diffuse_rays_beqelse_b4282
# B4281
	fsub x25, x38, x32
	lw x24, 4(x24)
	fmul x24, x25, x24
...
# B4284
	bne	x24, zero, trace_diffuse_rays_beqelse_b4286
...
# B4286
	lw x24, 0(x27)
	fle x24, x34, x24
	beq	x24, zero, trace_diffuse_rays_bneelse_b4288
# B4287
	addi x23, x23, 1
	j trace_diffuse_rays_cont_b4376 # adhoc jump(2)
...
# B4289
	lw x24, 0(x25)
	beq	x24, x28, trace_diffuse_rays_bneelse_b4373
# B4291
	add x4, x29, x24
	lw x24, 0(x4)
	addi x32, x24, 0
...
# B4292
	lw x24, 0(x33)
	beq	x24, x28, trace_diffuse_rays_bneelse_b4370
# B4294
	lw x24, 0(x33)
	add x4, x12, x24
	lw x32, 0(x4)
	...
	lw x6, 0(x4)
	lw x65, 1(x32)
	bne	x65, x100, trace_diffuse_rays_beqelse_b4296
# B4295
	lw x65, 0(x90)
	lw x66, 0(x6)
	fsub x66, x66, x37
	...
	lw x68, 1(x68)
	fle x67, x68, x67
	bne	x67, zero, trace_diffuse_rays_beqelse_b4302
# B4298
	lw x67, 2(x65)
	fmul x67, x66, x67
	fadd x67, x67, x40
...
# B4300
	...
	mv x68, x67
# B4301
	bne	x68, zero, trace_diffuse_rays_beqelse_b4303
...
# B4302
	...
	lw x68, 0(x68)
	fle x67, x68, x67
	bne	x67, zero, trace_diffuse_rays_beqelse_b4309
# B4305
	lw x67, 2(x65)
	fmul x67, x66, x67
	fadd x67, x67, x40
...
# B4307
	...
	mv x68, x67
# B4308
	bne	x68, zero, trace_diffuse_rays_beqelse_b4310
...
# B4309
	...
	lw x66, 0(x66)
	fle x37, x66, x37
	bne	x37, zero, trace_diffuse_rays_beqelse_b4316
# B4312
	lw x37, 1(x65)
	fmul x37, x40, x37
	fadd x37, x37, x38
	...
	lw x32, 1(x32)
	fle x32, x32, x37
	bne	x32, zero, trace_diffuse_rays_beqelse_b4316
# B4314
	lw x32, 5(x6)
	feq x32, x32, zero
	xori x32, x32, 1
	mv x37, x32
# B4315
	bne	x37, zero, trace_diffuse_rays_beqelse_b4317
...
# B4296
	bne	x65, x11, trace_diffuse_rays_beqelse_b4319
# B4318
	lw x32, 0(x6)
	fle x32, zero, x32
	beq	x32, zero, trace_diffuse_rays_bneelse_b4321
# B4320
	lw x37, 0(x27)
	j trace_diffuse_rays_cont_b4336 # adhoc jump(2)
...
# B4319
	lw x65, 0(x6)
	feq x66, x65, zero
	bne	x66, zero, trace_diffuse_rays_beqelse_b4323
# B4322
	lw x66, 1(x6)
	fmul x66, x66, x37
	lw x67, 2(x6)
	...
	fadd x67, x67, x68
	lw x68, 3(x32)
	bne	x68, zero, trace_diffuse_rays_beqelse_b4325
# B4324
	mv x37, x67
...
# B4326
	lw x38, 1(x32)
	bne	x38, x15, trace_diffuse_rays_beqelse_b4329
# B4327
	fsub x37, x37, x16
...
# B4329
	...
	fsub x37, x38, x37
	fle x38, x37, zero
	beq	x38, zero, trace_diffuse_rays_bneelse_b4331
# B4330
	lw x37, 0(x27)
	j trace_diffuse_rays_cont_b4336 # adhoc jump(2)
...
# B4331
	lw x32, 6(x32)
	fsqrt x37, x37
	bne	x32, zero, trace_diffuse_rays_beqelse_b4333
# B4332
	fsub x32, x66, x37
	lw x37, 4(x6)
	fmul x32, x32, x37
...
# B4335
	lw x37, 0(x27)
	bne	x32, zero, trace_diffuse_rays_beqelse_b4337
...
# B4338
	addi x33, x33, 1
	bne	x32, zero, trace_diffuse_rays_beqelse_b4340
...
# B4343
	lw x24, 0(x40)
	bne	x24, x28, trace_diffuse_rays_beqelse_b4345
# B4344
	mv x32, x100
# B4366
	bne	x32, zero, trace_diffuse_rays_beqelse_b4368
	j trace_diffuse_rays_cont_b4367 # adhoc jump(3)
trace_diffuse_rays_beqelse_b4368:
# B4368
	mv x24, x100
# B4369
	bne	x24, zero, trace_diffuse_rays_beqelse_b4371
	j trace_diffuse_rays_cont_b4370 # adhoc jump(3)
trace_diffuse_rays_beqelse_b4371:
# B4371
	mv x32, x100
# B4372
	bne	x32, zero, trace_diffuse_rays_beqelse_b4374
...
# B4375
	addi x23, x23, 1
	bne	x24, zero, trace_diffuse_rays_beqelse_b4377
...
# B4378
	lw x17, 0(x24)
	beq	x17, x28, trace_diffuse_rays_bneelse_b4462
# B4380
	add x4, x29, x17
	lw x17, 0(x4)
	addi x25, x17, 0
...
# B4381
	lw x17, 0(x32)
	beq	x17, x28, trace_diffuse_rays_bneelse_b4459
# B4383
	lw x17, 0(x32)
	add x4, x12, x17
	lw x25, 0(x4)
	...
	lw x40, 0(x4)
	lw x6, 1(x25)
	bne	x6, x100, trace_diffuse_rays_beqelse_b4385
# B4384
	lw x6, 0(x90)
	lw x65, 0(x40)
	fsub x65, x65, x35
	...
	lw x67, 1(x67)
	fle x66, x67, x66
	bne	x66, zero, trace_diffuse_rays_beqelse_b4391
# B4387
	lw x66, 2(x6)
	fmul x66, x65, x66
	fadd x66, x66, x38
...
# B4389
	...
	mv x67, x66
# B4390
	bne	x67, zero, trace_diffuse_rays_beqelse_b4392
...
# B4391
	...
	lw x67, 0(x67)
	fle x66, x67, x66
	bne	x66, zero, trace_diffuse_rays_beqelse_b4398
# B4394
	lw x66, 2(x6)
	fmul x66, x65, x66
	fadd x66, x66, x38
...
# B4396
	...
	mv x67, x66
# B4397
	bne	x67, zero, trace_diffuse_rays_beqelse_b4399
...
# B4398
	...
	lw x65, 0(x65)
	fle x35, x65, x35
	bne	x35, zero, trace_diffuse_rays_beqelse_b4405
# B4401
	lw x35, 1(x6)
	fmul x35, x38, x35
	fadd x35, x35, x37
	...
	lw x25, 1(x25)
	fle x25, x25, x35
	bne	x25, zero, trace_diffuse_rays_beqelse_b4405
# B4403
	lw x25, 5(x40)
	feq x25, x25, zero
	xori x25, x25, 1
	mv x35, x25
# B4404
	bne	x35, zero, trace_diffuse_rays_beqelse_b4406
...
# B4385
	bne	x6, x11, trace_diffuse_rays_beqelse_b4408
# B4407
	lw x25, 0(x40)
	fle x25, zero, x25
	beq	x25, zero, trace_diffuse_rays_bneelse_b4410
# B4409
	lw x35, 0(x27)
	j trace_diffuse_rays_cont_b4425 # adhoc jump(2)
...
# B4408
	lw x6, 0(x40)
	feq x65, x6, zero
	bne	x65, zero, trace_diffuse_rays_beqelse_b4412
# B4411
	lw x65, 1(x40)
	fmul x65, x65, x35
	lw x66, 2(x40)
	...
	fadd x66, x66, x67
	lw x67, 3(x25)
	bne	x67, zero, trace_diffuse_rays_beqelse_b4414
# B4413
	mv x35, x66
...
# B4415
	lw x37, 1(x25)
	bne	x37, x15, trace_diffuse_rays_beqelse_b4418
# B4416
	fsub x35, x35, x16
...
# B4418
	...
	fsub x35, x37, x35
	fle x37, x35, zero
	beq	x37, zero, trace_diffuse_rays_bneelse_b4420
# B4419
	lw x35, 0(x27)
	j trace_diffuse_rays_cont_b4425 # adhoc jump(2)
...
# B4420
	lw x25, 6(x25)
	fsqrt x35, x35
	bne	x25, zero, trace_diffuse_rays_beqelse_b4422
# B4421
	fsub x25, x65, x35
	lw x35, 4(x40)
	fmul x25, x25, x35
...
# B4424
	lw x35, 0(x27)
	bne	x25, zero, trace_diffuse_rays_beqelse_b4426
...
# B4427
	addi x32, x32, 1
	bne	x25, zero, trace_diffuse_rays_beqelse_b4429
...
# B4432
	lw x17, 0(x38)
	bne	x17, x28, trace_diffuse_rays_beqelse_b4434
# B4433
	mv x25, x100
# B4455
	bne	x25, zero, trace_diffuse_rays_beqelse_b4457
	j trace_diffuse_rays_cont_b4456 # adhoc jump(3)
trace_diffuse_rays_beqelse_b4457:
# B4457
	mv x17, x100
# B4458
	bne	x17, zero, trace_diffuse_rays_beqelse_b4460
...
# B4465
	...
	fsub x17, zero, x17
	fle x23, x17, zero
	beq	x23, zero, trace_diffuse_rays_bneelse_b4468
# B4467
	mv x24, zero
...
# B4434
	...
	fsub x37, x65, x37
	lw x66, 1(x17)
	bne	x66, x100, trace_diffuse_rays_beqelse_b4436
# B4435
	fabs x25, x25
	lw x66, 4(x17)
	lw x66, 0(x66)
	fle x25, x66, x25
	bne	x25, zero, trace_diffuse_rays_beqelse_b4442
# B4438
	fabs x25, x35
	lw x35, 4(x17)
	lw x35, 1(x35)
...
# B4440
	...
	mv x35, x25
# B4441
	bne	x35, zero, trace_diffuse_rays_beqelse_b4443
...
# B4436
	bne	x66, x11, trace_diffuse_rays_beqelse_b4445
# B4444
	lw x66, 4(x17)
	lw x67, 0(x66)
	fmul x25, x67, x25
...
# B4445
	...
	fadd x66, x66, x67
	lw x67, 3(x17)
	bne	x67, zero, trace_diffuse_rays_beqelse_b4447
# B4446
	mv x25, x66
...
# B4448
	lw x35, 1(x17)
	bne	x35, x15, trace_diffuse_rays_beqelse_b4451
# B4449
	fsub x25, x25, x16
...
# B4452
	bne	x17, zero, trace_diffuse_rays_beqelse_b4456
# B4453
	addi x38, x38, 1
...
# B4428
	...
	lw x17, 0(x4)
	lw x17, 6(x17)
	beq	x17, zero, trace_diffuse_rays_bneelse_b4459
...
# B4345
	...
	fsub x38, x66, x38
	lw x67, 1(x24)
	bne	x67, x100, trace_diffuse_rays_beqelse_b4347
# B4346
	fabs x32, x32
	lw x67, 4(x24)
	lw x67, 0(x67)
	fle x32, x67, x32
	bne	x32, zero, trace_diffuse_rays_beqelse_b4353
# B4349
	fabs x32, x37
	lw x37, 4(x24)
	lw x37, 1(x37)
...
# B4351
	...
	mv x37, x32
# B4352
	bne	x37, zero, trace_diffuse_rays_beqelse_b4354
...
# B4347
	bne	x67, x11, trace_diffuse_rays_beqelse_b4356
# B4355
	lw x67, 4(x24)
	lw x68, 0(x67)
	fmul x32, x68, x32
...
# B4356
	...
	fadd x67, x67, x68
	lw x68, 3(x24)
	bne	x68, zero, trace_diffuse_rays_beqelse_b4358
# B4357
	mv x32, x67
...
# B4359
	lw x37, 1(x24)
	bne	x37, x15, trace_diffuse_rays_beqelse_b4362
# B4360
	fsub x32, x32, x16
...
# B4363
	bne	x24, zero, trace_diffuse_rays_beqelse_b4367
# B4364
	addi x40, x40, 1
...
# B4339
	...
	lw x24, 0(x4)
	lw x24, 6(x24)
	beq	x24, zero, trace_diffuse_rays_bneelse_b4370
...
# B4473
	sub x10, x102, x101
	bgt	x101, x102, pretrace_pixels_bleelse_b4475
# B4474
	la x100, min_caml_scan_pitch
	lw x100, 0(x100)
...
# B4484
	...
	beq	x27, x28, pretrace_pixels_bneelse_b4764
# B4486
	bne	x27, x23, pretrace_pixels_beqelse_b4488
# B4487
	addi x22, x22, 1
	mv x27, x22
	mv x35, x26
...
# B4489
	lw x22, 0(x27)
	beq	x22, x28, pretrace_pixels_bneelse_b4763
# B4491
	add x4, x29, x22
	lw x22, 0(x4)
	addi x36, x22, 0
...
# B4492
	lw x22, 0(x37)
	beq	x22, x28, pretrace_pixels_bneelse_b4592
# B4494
	add x4, x110, x22
	lw x36, 0(x4)
	lw x40, 0(x11)
	...
	fsub x65, x65, x66
	lw x66, 1(x36)
	bne	x66, x12, pretrace_pixels_beqelse_b4496
# B4495
	lw x66, 0(x39)
	feq x66, x66, zero
	bne	x66, zero, pretrace_pixels_beqelse_b4507
# B4497
	lw x66, 4(x36)
	lw x67, 6(x36)
	lw x68, 0(x39)
	...
	xor x67, x67, x68
	lw x68, 0(x66)
	bne	x67, zero, pretrace_pixels_beqelse_b4500
# B4499
	fsub x67, zero, x68
...
# B4501
	...
	lw x69, 1(x66)
	fle x68, x69, x68
	bne	x68, zero, pretrace_pixels_beqelse_b4507
# B4503
	lw x68, 2(x39)
	fmul x68, x67, x68
	fadd x68, x68, x65
...
# B4505
	...
	mv x68, x12
# B4506
	bne	x68, zero, pretrace_pixels_beqelse_b4508
pretrace_pixels_beqelse_b4507:
# B4507
	lw x66, 1(x39)
	feq x66, x66, zero
	bne	x66, zero, pretrace_pixels_beqelse_b4519
# B4509
	lw x66, 4(x36)
	lw x67, 6(x36)
	lw x68, 1(x39)
	...
	xor x67, x67, x68
	lw x68, 1(x66)
	bne	x67, zero, pretrace_pixels_beqelse_b4512
# B4511
	fsub x67, zero, x68
...
# B4513
	...
	lw x69, 2(x66)
	fle x68, x69, x68
	bne	x68, zero, pretrace_pixels_beqelse_b4519
# B4515
	lw x68, 0(x39)
	fmul x68, x67, x68
	fadd x68, x68, x40
...
# B4517
	...
	mv x68, x12
# B4518
	bne	x68, zero, pretrace_pixels_beqelse_b4520
pretrace_pixels_beqelse_b4519:
# B4519
	lw x66, 2(x39)
	feq x66, x66, zero
	bne	x66, zero, pretrace_pixels_beqelse_b4531
# B4521
	lw x66, 4(x36)
	lw x36, 6(x36)
	lw x67, 2(x39)
	...
	xor x36, x36, x67
	lw x67, 2(x66)
	bne	x36, zero, pretrace_pixels_beqelse_b4524
# B4523
	fsub x36, zero, x67
...
# B4525
	...
	lw x65, 0(x66)
	fle x40, x65, x40
	bne	x40, zero, pretrace_pixels_beqelse_b4531
# B4527
	lw x40, 1(x39)
	fmul x40, x36, x40
	fadd x40, x40, x6
...
# B4529
	...
	mv x6, x12
# B4530
	bne	x6, zero, pretrace_pixels_beqelse_b4532
...
# B4496
	bne	x66, x107, pretrace_pixels_beqelse_b4534
# B4533
	lw x36, 4(x36)
	lw x66, 0(x39)
	lw x67, 0(x36)
	...
	fadd x66, x66, x67
	fle x67, x66, zero
	beq	x67, zero, pretrace_pixels_bneelse_b4536
# B4535
	mv x36, zero
	addi x37, x37, 1
	j pretrace_pixels_cont_b4557 # adhoc jump(2)
...
# B4534
	...
	fadd x69, x69, x7
	lw x7, 3(x36)
	bne	x7, zero, pretrace_pixels_beqelse_b4538
# B4537
	mv x66, x69
...
# B4539
	feq x67, x66, zero
	bne	x67, zero, pretrace_pixels_beqelse_b4541
# B4540
	lw x67, 0(x39)
	lw x68, 1(x39)
	lw x69, 2(x39)
	...
	fadd x7, x7, x70
	lw x70, 3(x36)
	bne	x70, zero, pretrace_pixels_beqelse_b4543
# B4542
	mv x67, x7
...
# B4544
	...
	fadd x68, x68, x69
	lw x69, 3(x36)
	bne	x69, zero, pretrace_pixels_beqelse_b4546
# B4545
	mv x40, x68
...
# B4547
	lw x6, 1(x36)
	bne	x6, x111, pretrace_pixels_beqelse_b4550
# B4548
	fsub x40, x40, x108
...
# B4550
	...
	fsub x40, x6, x40
	fle x6, x40, zero
	beq	x6, zero, pretrace_pixels_bneelse_b4552
# B4551
	mv x36, zero
	addi x37, x37, 1
	j pretrace_pixels_cont_b4557 # adhoc jump(2)
...
# B4552
	fsqrt x40, x40
	lw x36, 6(x36)
	bne	x36, zero, pretrace_pixels_beqelse_b4554
# B4553
	fsub x36, zero, x40
...
# B4556
	addi x37, x37, 1
	bne	x36, zero, pretrace_pixels_beqelse_b4558
...
# B4558
	lw x40, 0(x24)
	fle x6, x40, zero
	bne	x6, zero, pretrace_pixels_beqelse_b4591
# B4562
	lw x6, 0(x14)
	fle x6, x6, x40
	bne	x6, zero, pretrace_pixels_beqelse_b4591
...
# B4565
	lw x67, 0(x68)
	bne	x67, x28, pretrace_pixels_beqelse_b4567
# B4566
	mv x71, x12
# B4588
	bne	x71, zero, pretrace_pixels_beqelse_b4590
...
# B4567
	...
	fsub x73, x70, x73
	lw x74, 1(x67)
	bne	x74, x12, pretrace_pixels_beqelse_b4569
# B4568
	fabs x71, x71
	lw x74, 4(x67)
	lw x74, 0(x74)
	fle x71, x74, x71
	bne	x71, zero, pretrace_pixels_beqelse_b4575
# B4571
	fabs x71, x72
	lw x72, 4(x67)
	lw x72, 1(x72)
...
# B4573
	...
	mv x72, x71
# B4574
	bne	x72, zero, pretrace_pixels_beqelse_b4576
...
# B4569
	bne	x74, x107, pretrace_pixels_beqelse_b4578
# B4577
	lw x74, 4(x67)
	lw x75, 0(x74)
	fmul x71, x75, x71
...
# B4578
	...
	fadd x74, x74, x75
	lw x75, 3(x67)
	bne	x75, zero, pretrace_pixels_beqelse_b4580
# B4579
	mv x71, x74
...
# B4581
	lw x72, 1(x67)
	bne	x72, x111, pretrace_pixels_beqelse_b4584
# B4582
	fsub x71, x71, x108
...
# B4585
	bne	x67, zero, pretrace_pixels_beqelse_b4589
# B4586
	addi x68, x68, 1
...
# B4488
	...
	fsub x37, x37, x38
	lw x38, 1(x27)
	bne	x38, x12, pretrace_pixels_beqelse_b4594
# B4593
	lw x38, 0(x26)
	feq x38, x38, zero
	bne	x38, zero, pretrace_pixels_beqelse_b4605
# B4595
	lw x38, 4(x27)
	lw x39, 6(x27)
	lw x40, 0(x26)
	...
	xor x39, x39, x40
	lw x40, 0(x38)
	bne	x39, zero, pretrace_pixels_beqelse_b4598
# B4597
	fsub x39, zero, x40
...
# B4599
	...
	lw x6, 1(x38)
	fle x40, x6, x40
	bne	x40, zero, pretrace_pixels_beqelse_b4605
# B4601
	lw x40, 2(x26)
	fmul x40, x39, x40
	fadd x40, x40, x37
...
# B4603
	...
	mv x40, x12
# B4604
	bne	x40, zero, pretrace_pixels_beqelse_b4606
pretrace_pixels_beqelse_b4605:
# B4605
	lw x38, 1(x26)
	feq x38, x38, zero
	bne	x38, zero, pretrace_pixels_beqelse_b4617
# B4607
	lw x38, 4(x27)
	lw x39, 6(x27)
	lw x40, 1(x26)
	...
	xor x39, x39, x40
	lw x40, 1(x38)
	bne	x39, zero, pretrace_pixels_beqelse_b4610
# B4609
	fsub x39, zero, x40
...
# B4611
	...
	lw x6, 2(x38)
	fle x40, x6, x40
	bne	x40, zero, pretrace_pixels_beqelse_b4617
# B4613
	lw x40, 0(x26)
	fmul x40, x39, x40
	fadd x40, x40, x35
...
# B4615
	...
	mv x40, x12
# B4616
	bne	x40, zero, pretrace_pixels_beqelse_b4618
pretrace_pixels_beqelse_b4617:
# B4617
	lw x38, 2(x26)
	feq x38, x38, zero
	bne	x38, zero, pretrace_pixels_beqelse_b4629
# B4619
	lw x38, 4(x27)
	lw x27, 6(x27)
	lw x39, 2(x26)
	...
	xor x27, x27, x39
	lw x39, 2(x38)
	bne	x27, zero, pretrace_pixels_beqelse_b4622
# B4621
	fsub x27, zero, x39
...
# B4623
	...
	lw x37, 0(x38)
	fle x35, x37, x35
	bne	x35, zero, pretrace_pixels_beqelse_b4629
# B4625
	lw x35, 1(x26)
	fmul x35, x27, x35
	fadd x35, x35, x36
...
# B4627
	...
	mv x36, x12
# B4628
	bne	x36, zero, pretrace_pixels_beqelse_b4630
...
# B4594
	bne	x38, x107, pretrace_pixels_beqelse_b4632
# B4631
	lw x27, 4(x27)
	lw x38, 0(x26)
	lw x39, 0(x27)
	...
	fadd x38, x38, x39
	fle x39, x38, zero
	bne	x39, zero, pretrace_pixels_beqelse_b4655
# B4634
	lw x39, 0(x27)
	fmul x35, x39, x35
	lw x39, 1(x27)
...
# B4645
	lw x36, 1(x27)
	bne	x36, x111, pretrace_pixels_beqelse_b4648
# B4646
	fsub x35, x35, x108
...
# B4648
	...
	fsub x35, x36, x35
	fle x36, x35, zero
	bne	x36, zero, pretrace_pixels_beqelse_b4655
# B4650
	fsqrt x35, x35
	lw x27, 6(x27)
	bne	x27, zero, pretrace_pixels_beqelse_b4652
# B4651
	fsub x27, zero, x35
...
# B4654
	bne	x27, zero, pretrace_pixels_beqelse_b4656
...
# B4656
	...
	lw x35, 0(x14)
	fle x27, x35, x27
	bne	x27, zero, pretrace_pixels_beqelse_b4763
# B4658
	addi x22, x22, 1
	mv x27, x22
	mv x35, x26
...
# B4662
	lw x22, 0(x37)
	beq	x22, x28, pretrace_pixels_bneelse_b4762
# B4664
	add x4, x110, x22
	lw x36, 0(x4)
	lw x40, 0(x11)
	...
	fsub x65, x65, x66
	lw x66, 1(x36)
	bne	x66, x12, pretrace_pixels_beqelse_b4666
# B4665
	lw x66, 0(x39)
	feq x66, x66, zero
	bne	x66, zero, pretrace_pixels_beqelse_b4677
# B4667
	lw x66, 4(x36)
	lw x67, 6(x36)
	lw x68, 0(x39)
	...
	xor x67, x67, x68
	lw x68, 0(x66)
	bne	x67, zero, pretrace_pixels_beqelse_b4670
# B4669
	fsub x67, zero, x68
...
# B4671
	...
	lw x69, 1(x66)
	fle x68, x69, x68
	bne	x68, zero, pretrace_pixels_beqelse_b4677
# B4673
	lw x68, 2(x39)
	fmul x68, x67, x68
	fadd x68, x68, x65
...
# B4675
	...
	mv x68, x12
# B4676
	bne	x68, zero, pretrace_pixels_beqelse_b4678
pretrace_pixels_beqelse_b4677:
# B4677
	lw x66, 1(x39)
	feq x66, x66, zero
	bne	x66, zero, pretrace_pixels_beqelse_b4689
# B4679
	lw x66, 4(x36)
	lw x67, 6(x36)
	lw x68, 1(x39)
	...
	xor x67, x67, x68
	lw x68, 1(x66)
	bne	x67, zero, pretrace_pixels_beqelse_b4682
# B4681
	fsub x67, zero, x68
...
# B4683
	...
	lw x69, 2(x66)
	fle x68, x69, x68
	bne	x68, zero, pretrace_pixels_beqelse_b4689
# B4685
	lw x68, 0(x39)
	fmul x68, x67, x68
	fadd x68, x68, x40
...
# B4687
	...
	mv x68, x12
# B4688
	bne	x68, zero, pretrace_pixels_beqelse_b4690
pretrace_pixels_beqelse_b4689:
# B4689
	lw x66, 2(x39)
	feq x66, x66, zero
	bne	x66, zero, pretrace_pixels_beqelse_b4701
# B4691
	lw x66, 4(x36)
	lw x36, 6(x36)
	lw x67, 2(x39)
	...
	xor x36, x36, x67
	lw x67, 2(x66)
	bne	x36, zero, pretrace_pixels_beqelse_b4694
# B4693
	fsub x36, zero, x67
...
# B4695
	...
	lw x65, 0(x66)
	fle x40, x65, x40
	bne	x40, zero, pretrace_pixels_beqelse_b4701
# B4697
	lw x40, 1(x39)
	fmul x40, x36, x40
	fadd x40, x40, x6
...
# B4699
	...
	mv x6, x12
# B4700
	bne	x6, zero, pretrace_pixels_beqelse_b4702
...
# B4666
	bne	x66, x107, pretrace_pixels_beqelse_b4704
# B4703
	lw x36, 4(x36)
	lw x66, 0(x39)
	lw x67, 0(x36)
	...
	fadd x66, x66, x67
	fle x67, x66, zero
	beq	x67, zero, pretrace_pixels_bneelse_b4706
# B4705
	mv x36, zero
	addi x37, x37, 1
	j pretrace_pixels_cont_b4727 # adhoc jump(2)
...
# B4704
	...
	fadd x69, x69, x7
	lw x7, 3(x36)
	bne	x7, zero, pretrace_pixels_beqelse_b4708
# B4707
	mv x66, x69
...
# B4709
	feq x67, x66, zero
	bne	x67, zero, pretrace_pixels_beqelse_b4711
# B4710
	lw x67, 0(x39)
	lw x68, 1(x39)
	lw x69, 2(x39)
	...
	fadd x7, x7, x70
	lw x70, 3(x36)
	bne	x70, zero, pretrace_pixels_beqelse_b4713
# B4712
	mv x67, x7
...
# B4714
	...
	fadd x68, x68, x69
	lw x69, 3(x36)
	bne	x69, zero, pretrace_pixels_beqelse_b4716
# B4715
	mv x40, x68
...
# B4717
	lw x6, 1(x36)
	bne	x6, x111, pretrace_pixels_beqelse_b4720
# B4718
	fsub x40, x40, x108
...
# B4720
	...
	fsub x40, x6, x40
	fle x6, x40, zero
	beq	x6, zero, pretrace_pixels_bneelse_b4722
# B4721
	mv x36, zero
	addi x37, x37, 1
	j pretrace_pixels_cont_b4727 # adhoc jump(2)
...
# B4722
	fsqrt x40, x40
	lw x36, 6(x36)
	bne	x36, zero, pretrace_pixels_beqelse_b4724
# B4723
	fsub x36, zero, x40
...
# B4726
	addi x37, x37, 1
	bne	x36, zero, pretrace_pixels_beqelse_b4728
	j pretrace_pixels_cont_b4727 # adhoc jump(3)
pretrace_pixels_beqelse_b4728:
# B4728
	lw x40, 0(x24)
	fle x6, x40, zero
	bne	x6, zero, pretrace_pixels_beqelse_b4761
# B4732
	lw x6, 0(x14)
	fle x6, x6, x40
	bne	x6, zero, pretrace_pixels_beqelse_b4761
...
# B4735
	lw x67, 0(x68)
	bne	x67, x28, pretrace_pixels_beqelse_b4737
# B4736
	mv x71, x12
# B4758
	bne	x71, zero, pretrace_pixels_beqelse_b4760
...
# B4737
	...
	fsub x73, x70, x73
	lw x74, 1(x67)
	bne	x74, x12, pretrace_pixels_beqelse_b4739
# B4738
	fabs x71, x71
	lw x74, 4(x67)
	lw x74, 0(x74)
	fle x71, x74, x71
	bne	x71, zero, pretrace_pixels_beqelse_b4745
# B4741
	fabs x71, x72
	lw x72, 4(x67)
	lw x72, 1(x72)
...
# B4743
	...
	mv x72, x71
# B4744
	bne	x72, zero, pretrace_pixels_beqelse_b4746
...
# B4739
	bne	x74, x107, pretrace_pixels_beqelse_b4748
# B4747
	lw x74, 4(x67)
	lw x75, 0(x74)
	fmul x71, x75, x71
...
# B4748
	...
	fadd x74, x74, x75
	lw x75, 3(x67)
	bne	x75, zero, pretrace_pixels_beqelse_b4750
# B4749
	mv x71, x74
...
# B4751
	lw x72, 1(x67)
	bne	x72, x111, pretrace_pixels_beqelse_b4754
# B4752
	fsub x71, x71, x108
...
# B4755
	bne	x67, zero, pretrace_pixels_beqelse_b4759
# B4756
	addi x68, x68, 1
...
# B4774
	...
	lw x40, 0(x4)
	feq x6, x40, zero
	bne	x6, zero, pretrace_pixels_beqelse_b4777
# B4776
	fle x40, x40, zero
...
# B4785
	...
	fsqrt x40, x40
	feq x6, x40, zero
	bne	x6, zero, pretrace_pixels_beqelse_b4787
# B4786
...
# B4794
	bne	x6, zero, pretrace_pixels_beqelse_b4797
# B4796
	lui x38, 276464
...
# B4803
	fle x78, x76, x77
	bne	x78, zero, pretrace_pixels_beqelse_b4806
# B4804
	fmul x77, x77, x66
...
# B4815
	xor x38, x38, x6
	fle x6, x68, x65
	bne	x6, zero, pretrace_pixels_beqelse_b4817
# B4816
	mv x6, x65
...
# B4818
	fle x65, x69, x6
	bne	x65, zero, pretrace_pixels_beqelse_b4820
# B4819
	fmul x65, x6, x6
	fmul x66, x65, x71
	fadd x66, x70, x66
...
# B4821
	fle x65, x6, zero
	beq	x38, x65, pretrace_pixels_bneelse_b4823
# B4822
	mv x38, x6
...
# B4827
	fle x77, x6, x76
	bne	x77, zero, pretrace_pixels_beqelse_b4830
# B4828
	fmul x76, x76, x66
...
# B4845
	xor x38, x38, x65
	fle x65, x69, x6
	bne	x65, zero, pretrace_pixels_beqelse_b4847
...
# B4848
	fle x65, x6, zero
	beq	x38, x65, pretrace_pixels_bneelse_b4850
# B4849
	mv x38, x6
...
# B4852
	...
	lui x78, 262592
	lui x79, 270080
	beq	x66, zero, pretrace_pixels_bneelse_b4855
# B4854
	fdiv x38, x6, x38
	fabs x38, x38
	fle x6, x38, zero
	...
	fabs x66, x38
	fle x8, x7, x66
	bne	x8, zero, pretrace_pixels_beqelse_b4857
# B4856
	fmul x6, x38, x38
	fmul x66, x6, x77
	fadd x66, x74, x66
...
# B4860
	bne	x6, zero, pretrace_pixels_beqelse_b4863
# B4861
	fsub x38, zero, x38
...
# B4864
	...
	fabs x66, x65
	fle x66, x67, x66
	beq	x66, zero, pretrace_pixels_bneelse_b4866
# B4865
	fdiv x6, x6, x65
	fabs x6, x6
	fle x65, x6, zero
	...
	fabs x66, x6
	fle x67, x7, x66
	bne	x67, zero, pretrace_pixels_beqelse_b4868
# B4867
	fmul x65, x6, x6
	fmul x66, x65, x77
	fadd x66, x74, x66
...
# B4868
	fle x6, x78, x66
	bne	x6, zero, pretrace_pixels_beqelse_b4870
# B4869
	fsub x6, x66, x108
	fadd x66, x66, x108
	fdiv x6, x6, x66
...
# B4871
	bne	x65, zero, pretrace_pixels_beqelse_b4874
# B4872
	fsub x6, zero, x6
...
# B4879
	...
	lw x38, 0(x38)
	fle x30, x30, x38
	beq	x30, zero, pretrace_pixels_bneelse_b4881
# B4880
	add x4, x22, x15
	sw x12, 0(x4)
	lw x22, 4(x18)
...
# B4883
	...
	lui x66, 779469
	addi x66, x66, -819
	beq	x65, x28, pretrace_pixels_bneelse_b5109
# B4885
...
# B4933
	lw x65, 0(x67)
	beq	x65, x28, pretrace_pixels_bneelse_b5017
# B4935
	add x4, x29, x65
	lw x65, 0(x4)
	addi x68, x65, 0
...
# B4936
	lw x65, 0(x69)
	beq	x65, x28, pretrace_pixels_bneelse_b5014
# B4938
	lw x65, 0(x69)
	add x4, x110, x65
	lw x68, 0(x4)
	...
	lw x73, 0(x4)
	lw x74, 1(x68)
	bne	x74, x12, pretrace_pixels_beqelse_b4940
# B4939
	lw x74, 0(x38)
	lw x75, 0(x73)
	fsub x75, x75, x70
	...
	lw x77, 1(x77)
	fle x76, x77, x76
	bne	x76, zero, pretrace_pixels_beqelse_b4946
# B4942
	lw x76, 2(x74)
	fmul x76, x75, x76
	fadd x76, x76, x72
...
# B4944
	...
	mv x77, x76
# B4945
	bne	x77, zero, pretrace_pixels_beqelse_b4947
...
# B4946
	...
	lw x77, 0(x77)
	fle x76, x77, x76
	bne	x76, zero, pretrace_pixels_beqelse_b4953
# B4949
	lw x76, 2(x74)
	fmul x76, x75, x76
	fadd x76, x76, x72
...
# B4951
	...
	mv x77, x76
# B4952
	bne	x77, zero, pretrace_pixels_beqelse_b4954
...
# B4956
	...
	lw x68, 1(x68)
	fle x68, x68, x70
	bne	x68, zero, pretrace_pixels_beqelse_b4960
# B4958
	lw x68, 5(x73)
	feq x68, x68, zero
	xori x68, x68, 1
	mv x70, x68
# B4959
	bne	x70, zero, pretrace_pixels_beqelse_b4961
...
# B4940
	bne	x74, x107, pretrace_pixels_beqelse_b4963
# B4962
	lw x68, 0(x73)
	fle x68, zero, x68
	beq	x68, zero, pretrace_pixels_bneelse_b4965
# B4964
	lw x70, 0(x24)
	j pretrace_pixels_cont_b4980 # adhoc jump(2)
...
# B4963
	lw x74, 0(x73)
	feq x75, x74, zero
	bne	x75, zero, pretrace_pixels_beqelse_b4967
# B4966
	lw x75, 1(x73)
	fmul x75, x75, x70
	lw x76, 2(x73)
	...
	fadd x76, x76, x77
	lw x77, 3(x68)
	bne	x77, zero, pretrace_pixels_beqelse_b4969
# B4968
	mv x70, x76
...
# B4970
	lw x71, 1(x68)
	bne	x71, x111, pretrace_pixels_beqelse_b4973
# B4971
	fsub x70, x70, x108
...
# B4973
	...
	fsub x70, x71, x70
	fle x71, x70, zero
	beq	x71, zero, pretrace_pixels_bneelse_b4975
# B4974
	lw x70, 0(x24)
	j pretrace_pixels_cont_b4980 # adhoc jump(2)
...
# B4975
	lw x68, 6(x68)
	fsqrt x70, x70
	bne	x68, zero, pretrace_pixels_beqelse_b4977
# B4976
	fsub x68, x75, x70
	lw x70, 4(x73)
	fmul x68, x68, x70
...
# B4979
	lw x70, 0(x24)
	bne	x68, zero, pretrace_pixels_beqelse_b4981
...
# B4982
	addi x69, x69, 1
	bne	x68, zero, pretrace_pixels_beqelse_b4984
...
# B4987
	lw x65, 0(x72)
	bne	x65, x28, pretrace_pixels_beqelse_b4989
# B4988
	mv x68, x12
# B5010
	bne	x68, zero, pretrace_pixels_beqelse_b5012
...
# B5015
	mv x68, x12
# B5016
	bne	x68, zero, pretrace_pixels_beqelse_b5018
...
# B5022
	lw x30, 0(x65)
	beq	x30, x28, pretrace_pixels_bneelse_b5106
# B5024
	add x4, x29, x30
	lw x30, 0(x4)
	addi x67, x30, 0
...
# B5025
	lw x30, 0(x68)
	beq	x30, x28, pretrace_pixels_bneelse_b5103
# B5027
	lw x30, 0(x68)
	add x4, x110, x30
	lw x67, 0(x4)
	...
	lw x72, 0(x4)
	lw x73, 1(x67)
	bne	x73, x12, pretrace_pixels_beqelse_b5029
# B5028
	lw x73, 0(x38)
	lw x74, 0(x72)
	fsub x74, x74, x7
	...
	lw x76, 1(x76)
	fle x75, x76, x75
	bne	x75, zero, pretrace_pixels_beqelse_b5035
# B5031
	lw x75, 2(x73)
	fmul x75, x74, x75
	fadd x75, x75, x71
...
# B5033
	...
	mv x76, x75
# B5034
	bne	x76, zero, pretrace_pixels_beqelse_b5036
...
# B5035
	...
	lw x76, 0(x76)
	fle x75, x76, x75
	bne	x75, zero, pretrace_pixels_beqelse_b5042
# B5038
	lw x75, 2(x73)
	fmul x75, x74, x75
	fadd x75, x75, x71
...
# B5040
	...
	mv x76, x75
# B5041
	bne	x76, zero, pretrace_pixels_beqelse_b5043
...
# B5045
	...
	lw x67, 1(x67)
	fle x67, x67, x7
	bne	x67, zero, pretrace_pixels_beqelse_b5049
# B5047
	lw x67, 5(x72)
	feq x67, x67, zero
	xori x67, x67, 1
	mv x7, x67
# B5048
	bne	x7, zero, pretrace_pixels_beqelse_b5050
...
# B5029
	bne	x73, x107, pretrace_pixels_beqelse_b5052
# B5051
	lw x67, 0(x72)
	fle x67, zero, x67
	beq	x67, zero, pretrace_pixels_bneelse_b5054
# B5053
	lw x7, 0(x24)
	j pretrace_pixels_cont_b5069 # adhoc jump(2)
...
# B5052
	lw x73, 0(x72)
	feq x74, x73, zero
	bne	x74, zero, pretrace_pixels_beqelse_b5056
# B5055
	lw x74, 1(x72)
	fmul x74, x74, x7
	lw x75, 2(x72)
	...
	fadd x75, x75, x76
	lw x76, 3(x67)
	bne	x76, zero, pretrace_pixels_beqelse_b5058
# B5057
	mv x7, x75
...
# B5059
	lw x70, 1(x67)
	bne	x70, x111, pretrace_pixels_beqelse_b5062
# B5060
	fsub x7, x7, x108
...
# B5062
	...
	fsub x7, x70, x7
	fle x70, x7, zero
	beq	x70, zero, pretrace_pixels_bneelse_b5064
# B5063
	lw x7, 0(x24)
	j pretrace_pixels_cont_b5069 # adhoc jump(2)
...
# B5064
	lw x67, 6(x67)
	fsqrt x7, x7
	bne	x67, zero, pretrace_pixels_beqelse_b5066
# B5065
	fsub x67, x74, x7
	lw x7, 4(x72)
	fmul x67, x67, x7
...
# B5068
	lw x7, 0(x24)
	bne	x67, zero, pretrace_pixels_beqelse_b5070
...
# B5071
	addi x68, x68, 1
	bne	x67, zero, pretrace_pixels_beqelse_b5073
...
# B5076
	lw x30, 0(x71)
	bne	x30, x28, pretrace_pixels_beqelse_b5078
# B5077
	mv x67, x12
# B5099
	bne	x67, zero, pretrace_pixels_beqelse_b5101
	j pretrace_pixels_cont_b5100 # adhoc jump(3)
pretrace_pixels_beqelse_b5101:
# B5101
	mv x30, x12
# B5102
	bne	x30, zero, pretrace_pixels_beqelse_b5104
	j pretrace_pixels_cont_b5103 # adhoc jump(3)
pretrace_pixels_beqelse_b5104:
# B5104
	mv x67, x12
# B5105
	bne	x67, zero, pretrace_pixels_beqelse_b5107
...
# B5107
	mv x30, x12
# B5108
	bne	x30, zero, pretrace_pixels_beqelse_b5116
...
# B5109
	...
	fsub x6, zero, x6
	fle x65, x30, zero
	bne	x65, zero, pretrace_pixels_beqelse_b5113
# B5112
	lw x65, 0(x10)
	lw x67, 0(x40)
	fmul x67, x30, x67
...
# B5117
	bgt	zero, x65, pretrace_pixels_bleelse_b5131
# B5118
	add x4, x110, x65
	lw x30, 0(x4)
	lw x67, 10(x30)
	...
	fsub x69, x69, x7
	sw x69, 2(x67)
	bne	x68, x107, pretrace_pixels_beqelse_b5121
# B5120
	lw x30, 4(x30)
	lw x68, 0(x67)
	lw x69, 1(x67)
...
# B5121
	bge	x107, x68, pretrace_pixels_bgtelse_b5130
# B5123
	lw x69, 0(x67)
	lw x7, 1(x67)
	lw x70, 2(x67)
	...
	fadd x71, x71, x72
	lw x72, 3(x30)
	bne	x72, zero, pretrace_pixels_beqelse_b5125
# B5124
	mv x30, x71
...
# B5126
	bne	x68, x111, pretrace_pixels_beqelse_b5129
# B5127
	fsub x30, x30, x108
...
# B5132
	bgt	x6, x65, pretrace_pixels_bleelse_b5576
# B5133
	lw x22, 0(x65)
	lw x30, 1(x22)
	sw x20, 0(x14)
...
# B5135
	lw x37, 0(x7)
	lw x71, 0(x37)
	beq	x71, x28, pretrace_pixels_bneelse_b5334
# B5137
...
# B5140
	lw x37, 0(x71)
	beq	x37, x28, pretrace_pixels_bneelse_b5333
# B5142
	add x4, x29, x37
	lw x37, 0(x4)
	addi x73, x37, 0
...
# B5143
	lw x37, 0(x76)
	lw x73, 0(x74)
	beq	x73, x28, pretrace_pixels_bneelse_b5216
# B5145
	add x4, x110, x73
	lw x77, 0(x4)
	lw x78, 10(x77)
	...
	lw x81, 0(x4)
	lw x82, 1(x77)
	bne	x82, x12, pretrace_pixels_beqelse_b5147
# B5146
	lw x78, 0(x76)
	lw x82, 0(x81)
	fsub x82, x82, x79
	...
	lw x84, 1(x84)
	fle x83, x84, x83
	bne	x83, zero, pretrace_pixels_beqelse_b5153
# B5149
	lw x83, 2(x78)
	fmul x83, x82, x83
	fadd x83, x83, x80
...
# B5151
	...
	mv x84, x83
# B5152
	bne	x84, zero, pretrace_pixels_beqelse_b5154
...
# B5153
	...
	lw x84, 0(x84)
	fle x83, x84, x83
	bne	x83, zero, pretrace_pixels_beqelse_b5160
# B5156
	lw x83, 2(x78)
	fmul x83, x82, x83
	fadd x83, x83, x80
...
# B5158
	...
	mv x84, x83
# B5159
	bne	x84, zero, pretrace_pixels_beqelse_b5161
...
# B5160
	...
	lw x82, 0(x82)
	fle x79, x82, x79
	bne	x79, zero, pretrace_pixels_beqelse_b5167
# B5163
	lw x78, 1(x78)
	fmul x78, x80, x78
	fadd x78, x78, x8
	...
	lw x77, 1(x77)
	fle x77, x77, x78
	bne	x77, zero, pretrace_pixels_beqelse_b5167
# B5165
	lw x77, 5(x81)
	feq x77, x77, zero
	xori x77, x77, 1
	mv x78, x77
# B5166
	bne	x78, zero, pretrace_pixels_beqelse_b5168
...
# B5147
	bne	x82, x107, pretrace_pixels_beqelse_b5170
# B5169
	lw x77, 0(x81)
	fle x77, zero, x77
	beq	x77, zero, pretrace_pixels_bneelse_b5172
# B5171
	mv x77, zero
	addi x74, x74, 1
	j pretrace_pixels_cont_b5181 # adhoc jump(2)
...
# B5170
	lw x82, 0(x81)
	feq x83, x82, zero
	bne	x83, zero, pretrace_pixels_beqelse_b5174
# B5173
	lw x83, 1(x81)
	fmul x79, x83, x79
	lw x83, 2(x81)
	...
	fsub x78, x8, x78
	fle x8, x78, zero
	beq	x8, zero, pretrace_pixels_bneelse_b5176
# B5175
	mv x77, zero
	addi x74, x74, 1
	j pretrace_pixels_cont_b5181 # adhoc jump(2)
...
# B5176
	lw x77, 6(x77)
	fsqrt x78, x78
	bne	x77, zero, pretrace_pixels_beqelse_b5178
# B5177
	fsub x77, x79, x78
	lw x78, 4(x81)
	fmul x77, x77, x78
...
# B5180
	addi x74, x74, 1
	bne	x77, zero, pretrace_pixels_beqelse_b5182
	j pretrace_pixels_cont_b5181 # adhoc jump(3)
pretrace_pixels_beqelse_b5182:
# B5182
	lw x78, 0(x24)
	fle x79, x78, zero
	bne	x79, zero, pretrace_pixels_beqelse_b5215
# B5186
	lw x79, 0(x14)
	fle x79, x79, x78
	bne	x79, zero, pretrace_pixels_beqelse_b5215
...
# B5189
	lw x80, 0(x81)
	bne	x80, x28, pretrace_pixels_beqelse_b5191
# B5190
	mv x85, x12
# B5212
	bne	x85, zero, pretrace_pixels_beqelse_b5214
...
# B5191
	...
	fsub x87, x84, x87
	lw x88, 1(x80)
	bne	x88, x12, pretrace_pixels_beqelse_b5193
# B5192
	fabs x85, x85
	lw x88, 4(x80)
	lw x88, 0(x88)
	fle x85, x88, x85
	bne	x85, zero, pretrace_pixels_beqelse_b5199
# B5195
	fabs x85, x86
	lw x86, 4(x80)
	lw x86, 1(x86)
...
# B5197
	...
	mv x86, x85
# B5198
	bne	x86, zero, pretrace_pixels_beqelse_b5200
...
# B5193
	bne	x88, x107, pretrace_pixels_beqelse_b5202
# B5201
	lw x88, 4(x80)
	lw x89, 0(x88)
	fmul x85, x89, x85
...
# B5202
	...
	fadd x88, x88, x89
	lw x89, 3(x80)
	bne	x89, zero, pretrace_pixels_beqelse_b5204
# B5203
	mv x85, x88
...
# B5205
	lw x86, 1(x80)
	bne	x86, x111, pretrace_pixels_beqelse_b5208
# B5206
	fsub x85, x85, x108
...
# B5209
	bne	x80, zero, pretrace_pixels_beqelse_b5213
# B5210
	addi x81, x81, 1
...
# B5259
	lw x37, 0(x76)
	lw x73, 0(x74)
	beq	x73, x28, pretrace_pixels_bneelse_b5332
# B5261
	add x4, x110, x73
	lw x77, 0(x4)
	lw x78, 10(x77)
	...
	lw x81, 0(x4)
	lw x82, 1(x77)
	bne	x82, x12, pretrace_pixels_beqelse_b5263
# B5262
	lw x78, 0(x76)
	lw x82, 0(x81)
	fsub x82, x82, x79
	...
	lw x84, 1(x84)
	fle x83, x84, x83
	bne	x83, zero, pretrace_pixels_beqelse_b5269
# B5265
	lw x83, 2(x78)
	fmul x83, x82, x83
	fadd x83, x83, x80
...
# B5267
	...
	mv x84, x83
# B5268
	bne	x84, zero, pretrace_pixels_beqelse_b5270
...
# B5269
	...
	lw x84, 0(x84)
	fle x83, x84, x83
	bne	x83, zero, pretrace_pixels_beqelse_b5276
# B5272
	lw x83, 2(x78)
	fmul x83, x82, x83
	fadd x83, x83, x80
...
# B5274
	...
	mv x84, x83
# B5275
	bne	x84, zero, pretrace_pixels_beqelse_b5277
...
# B5276
	...
	lw x82, 0(x82)
	fle x79, x82, x79
	bne	x79, zero, pretrace_pixels_beqelse_b5283
# B5279
	lw x78, 1(x78)
	fmul x78, x80, x78
	fadd x78, x78, x8
	...
	lw x77, 1(x77)
	fle x77, x77, x78
	bne	x77, zero, pretrace_pixels_beqelse_b5283
# B5281
	lw x77, 5(x81)
	feq x77, x77, zero
	xori x77, x77, 1
	mv x78, x77
# B5282
	bne	x78, zero, pretrace_pixels_beqelse_b5284
...
# B5263
	bne	x82, x107, pretrace_pixels_beqelse_b5286
# B5285
	lw x77, 0(x81)
	fle x77, zero, x77
	beq	x77, zero, pretrace_pixels_bneelse_b5288
# B5287
	mv x77, zero
	addi x74, x74, 1
	j pretrace_pixels_cont_b5297 # adhoc jump(2)
...
# B5286
	lw x82, 0(x81)
	feq x83, x82, zero
	bne	x83, zero, pretrace_pixels_beqelse_b5290
# B5289
	lw x83, 1(x81)
	fmul x79, x83, x79
	lw x83, 2(x81)
	...
	fsub x78, x8, x78
	fle x8, x78, zero
	beq	x8, zero, pretrace_pixels_bneelse_b5292
# B5291
	mv x77, zero
	addi x74, x74, 1
	j pretrace_pixels_cont_b5297 # adhoc jump(2)
...
# B5292
	lw x77, 6(x77)
	fsqrt x78, x78
	bne	x77, zero, pretrace_pixels_beqelse_b5294
# B5293
	fsub x77, x79, x78
	lw x78, 4(x81)
	fmul x77, x77, x78
...
# B5296
	addi x74, x74, 1
	bne	x77, zero, pretrace_pixels_beqelse_b5298
	j pretrace_pixels_cont_b5297 # adhoc jump(3)
pretrace_pixels_beqelse_b5298:
# B5298
	lw x78, 0(x24)
	fle x79, x78, zero
	bne	x79, zero, pretrace_pixels_beqelse_b5331
# B5302
	lw x79, 0(x14)
	fle x79, x79, x78
	bne	x79, zero, pretrace_pixels_beqelse_b5331
...
# B5305
	lw x80, 0(x81)
	bne	x80, x28, pretrace_pixels_beqelse_b5307
# B5306
	mv x85, x12
# B5328
	bne	x85, zero, pretrace_pixels_beqelse_b5330
...
# B5307
	...
	fsub x87, x84, x87
	lw x88, 1(x80)
	bne	x88, x12, pretrace_pixels_beqelse_b5309
# B5308
	fabs x85, x85
	lw x88, 4(x80)
	lw x88, 0(x88)
	fle x85, x88, x85
	bne	x85, zero, pretrace_pixels_beqelse_b5315
# B5311
	fabs x85, x86
	lw x86, 4(x80)
	lw x86, 1(x86)
...
# B5313
	...
	mv x86, x85
# B5314
	bne	x86, zero, pretrace_pixels_beqelse_b5316
...
# B5309
	bne	x88, x107, pretrace_pixels_beqelse_b5318
# B5317
	lw x88, 4(x80)
	lw x89, 0(x88)
	fmul x85, x89, x85
...
# B5318
	...
	fadd x88, x88, x89
	lw x89, 3(x80)
	bne	x89, zero, pretrace_pixels_beqelse_b5320
# B5319
	mv x85, x88
...
# B5321
	lw x86, 1(x80)
	bne	x86, x111, pretrace_pixels_beqelse_b5324
# B5322
	fsub x85, x85, x108
...
# B5325
	bne	x80, zero, pretrace_pixels_beqelse_b5329
# B5326
	addi x81, x81, 1
...
# B5334
	lw x37, 0(x14)
	fle x7, x37, x25
	bne	x7, zero, pretrace_pixels_beqelse_b5338
# B5336
	fle x37, x27, x37
	xori x37, x37, 1
	mv x7, x37
# B5337
	bne	x7, zero, pretrace_pixels_beqelse_b5339
...
# B5339
	...
	add x37, x37, x7
	lw x7, 0(x22)
	bne	x37, x7, pretrace_pixels_beqelse_b5575
# B5340
	lw x37, 0(x21)
	addi x37, x37, 0
	mv x7, x37
...
# B5342
	lw x37, 0(x7)
	lw x70, 0(x37)
	beq	x70, x28, pretrace_pixels_bneelse_b5568
# B5344
...
# B5392
	lw x70, 0(x71)
	beq	x70, x28, pretrace_pixels_bneelse_b5476
# B5394
	add x4, x29, x70
	lw x70, 0(x4)
	addi x72, x70, 0
...
# B5395
	lw x70, 0(x73)
	beq	x70, x28, pretrace_pixels_bneelse_b5473
# B5397
	lw x70, 0(x73)
	add x4, x110, x70
	lw x72, 0(x4)
	...
	lw x78, 0(x4)
	lw x79, 1(x72)
	bne	x79, x12, pretrace_pixels_beqelse_b5399
# B5398
	lw x79, 0(x38)
	lw x8, 0(x78)
	fsub x8, x8, x75
	...
	lw x81, 1(x81)
	fle x80, x81, x80
	bne	x80, zero, pretrace_pixels_beqelse_b5405
# B5401
	lw x80, 2(x79)
	fmul x80, x8, x80
	fadd x80, x80, x77
...
# B5403
	...
	mv x81, x80
# B5404
	bne	x81, zero, pretrace_pixels_beqelse_b5406
...
# B5405
	...
	lw x81, 0(x81)
	fle x80, x81, x80
	bne	x80, zero, pretrace_pixels_beqelse_b5412
# B5408
	lw x80, 2(x79)
	fmul x80, x8, x80
	fadd x80, x80, x77
...
# B5410
	...
	mv x81, x80
# B5411
	bne	x81, zero, pretrace_pixels_beqelse_b5413
...
# B5415
	...
	lw x72, 1(x72)
	fle x72, x72, x75
	bne	x72, zero, pretrace_pixels_beqelse_b5419
# B5417
	lw x72, 5(x78)
	feq x72, x72, zero
	xori x72, x72, 1
	mv x75, x72
# B5418
	bne	x75, zero, pretrace_pixels_beqelse_b5420
...
# B5399
	bne	x79, x107, pretrace_pixels_beqelse_b5422
# B5421
	lw x72, 0(x78)
	fle x72, zero, x72
	beq	x72, zero, pretrace_pixels_bneelse_b5424
# B5423
	lw x75, 0(x24)
	j pretrace_pixels_cont_b5439 # adhoc jump(2)
...
# B5422
	lw x79, 0(x78)
	feq x8, x79, zero
	bne	x8, zero, pretrace_pixels_beqelse_b5426
# B5425
	lw x8, 1(x78)
	fmul x8, x8, x75
	lw x80, 2(x78)
	...
	fadd x80, x80, x81
	lw x81, 3(x72)
	bne	x81, zero, pretrace_pixels_beqelse_b5428
# B5427
	mv x75, x80
...
# B5429
	lw x76, 1(x72)
	bne	x76, x111, pretrace_pixels_beqelse_b5432
# B5430
	fsub x75, x75, x108
...
# B5432
	...
	fsub x75, x76, x75
	fle x76, x75, zero
	beq	x76, zero, pretrace_pixels_bneelse_b5434
# B5433
	lw x75, 0(x24)
	j pretrace_pixels_cont_b5439 # adhoc jump(2)
...
# B5434
	lw x72, 6(x72)
	fsqrt x75, x75
	bne	x72, zero, pretrace_pixels_beqelse_b5436
# B5435
	fsub x72, x8, x75
	lw x75, 4(x78)
	fmul x72, x72, x75
...
# B5438
	lw x75, 0(x24)
	bne	x72, zero, pretrace_pixels_beqelse_b5440
...
# B5441
	addi x73, x73, 1
	bne	x72, zero, pretrace_pixels_beqelse_b5443
...
# B5446
	lw x70, 0(x77)
	bne	x70, x28, pretrace_pixels_beqelse_b5448
# B5447
	mv x72, x12
# B5469
	bne	x72, zero, pretrace_pixels_beqelse_b5471
...
# B5474
	mv x72, x12
# B5475
	bne	x72, zero, pretrace_pixels_beqelse_b5477
...
# B5481
	lw x37, 0(x70)
	beq	x37, x28, pretrace_pixels_bneelse_b5565
# B5483
	add x4, x29, x37
	lw x37, 0(x4)
	addi x71, x37, 0
...
# B5484
	lw x37, 0(x72)
	beq	x37, x28, pretrace_pixels_bneelse_b5562
# B5486
	lw x37, 0(x72)
	add x4, x110, x37
	lw x71, 0(x4)
	...
	lw x77, 0(x4)
	lw x78, 1(x71)
	bne	x78, x12, pretrace_pixels_beqelse_b5488
# B5487
	lw x78, 0(x38)
	lw x79, 0(x77)
	fsub x79, x79, x74
	...
	lw x80, 1(x80)
	fle x8, x80, x8
	bne	x8, zero, pretrace_pixels_beqelse_b5494
# B5490
	lw x8, 2(x78)
	fmul x8, x79, x8
	fadd x8, x8, x76
...
# B5492
	...
	mv x80, x8
# B5493
	bne	x80, zero, pretrace_pixels_beqelse_b5495
...
# B5494
	...
	lw x80, 0(x80)
	fle x8, x80, x8
	bne	x8, zero, pretrace_pixels_beqelse_b5501
# B5497
	lw x8, 2(x78)
	fmul x8, x79, x8
	fadd x8, x8, x76
...
# B5499
	...
	mv x80, x8
# B5500
	bne	x80, zero, pretrace_pixels_beqelse_b5502
...
# B5504
	...
	lw x71, 1(x71)
	fle x71, x71, x74
	bne	x71, zero, pretrace_pixels_beqelse_b5508
# B5506
	lw x71, 5(x77)
	feq x71, x71, zero
	xori x71, x71, 1
	mv x74, x71
# B5507
	bne	x74, zero, pretrace_pixels_beqelse_b5509
...
# B5488
	bne	x78, x107, pretrace_pixels_beqelse_b5511
# B5510
	lw x71, 0(x77)
	fle x71, zero, x71
	beq	x71, zero, pretrace_pixels_bneelse_b5513
# B5512
	lw x74, 0(x24)
	j pretrace_pixels_cont_b5528 # adhoc jump(2)
...
# B5511
	lw x78, 0(x77)
	feq x79, x78, zero
	bne	x79, zero, pretrace_pixels_beqelse_b5515
# B5514
	lw x79, 1(x77)
	fmul x79, x79, x74
	lw x8, 2(x77)
	...
	fadd x8, x8, x80
	lw x80, 3(x71)
	bne	x80, zero, pretrace_pixels_beqelse_b5517
# B5516
	mv x74, x8
...
# B5518
	lw x75, 1(x71)
	bne	x75, x111, pretrace_pixels_beqelse_b5521
# B5519
	fsub x74, x74, x108
...
# B5521
	...
	fsub x74, x75, x74
	fle x75, x74, zero
	beq	x75, zero, pretrace_pixels_bneelse_b5523
# B5522
	lw x74, 0(x24)
	j pretrace_pixels_cont_b5528 # adhoc jump(2)
...
# B5523
	lw x71, 6(x71)
	fsqrt x74, x74
	bne	x71, zero, pretrace_pixels_beqelse_b5525
# B5524
	fsub x71, x79, x74
	lw x74, 4(x77)
	fmul x71, x71, x74
...
# B5527
	lw x74, 0(x24)
	bne	x71, zero, pretrace_pixels_beqelse_b5529
...
# B5530
	addi x72, x72, 1
	bne	x71, zero, pretrace_pixels_beqelse_b5532
...
# B5535
	lw x37, 0(x76)
	bne	x37, x28, pretrace_pixels_beqelse_b5537
# B5536
	mv x71, x12
# B5558
	bne	x71, zero, pretrace_pixels_beqelse_b5560
...
# B5563
	mv x71, x12
# B5564
	bne	x71, zero, pretrace_pixels_beqelse_b5566
...
# B5568
	...
	fmul x22, x22, x30
	fle x30, x37, zero
	bne	x30, zero, pretrace_pixels_beqelse_b5572
# B5571
	lw x30, 0(x10)
	lw x7, 0(x40)
	fmul x7, x37, x7
...
# B5572
	fle x30, x22, zero
	bne	x30, zero, pretrace_pixels_beqelse_b5575
# B5574
	fmul x22, x22, x22
	fmul x22, x22, x22
	fmul x22, x22, x69
...
# B5537
	...
	fsub x75, x79, x75
	lw x8, 1(x37)
	bne	x8, x12, pretrace_pixels_beqelse_b5539
# B5538
	fabs x71, x71
	lw x8, 4(x37)
	lw x8, 0(x8)
	fle x71, x8, x71
	bne	x71, zero, pretrace_pixels_beqelse_b5545
# B5541
	fabs x71, x74
	lw x74, 4(x37)
	lw x74, 1(x74)
...
# B5543
	...
	mv x74, x71
# B5544
	bne	x74, zero, pretrace_pixels_beqelse_b5546
...
# B5539
	bne	x8, x107, pretrace_pixels_beqelse_b5548
# B5547
	lw x8, 4(x37)
	lw x80, 0(x8)
	fmul x71, x80, x71
...
# B5548
	...
	fadd x8, x8, x80
	lw x80, 3(x37)
	bne	x80, zero, pretrace_pixels_beqelse_b5550
# B5549
	mv x71, x8
...
# B5551
	lw x74, 1(x37)
	bne	x74, x111, pretrace_pixels_beqelse_b5554
# B5552
	fsub x71, x71, x108
...
# B5448
	...
	fsub x76, x8, x76
	lw x80, 1(x70)
	bne	x80, x12, pretrace_pixels_beqelse_b5450
# B5449
	fabs x72, x72
	lw x80, 4(x70)
	lw x80, 0(x80)
	fle x72, x80, x72
	bne	x72, zero, pretrace_pixels_beqelse_b5456
# B5452
	fabs x72, x75
	lw x75, 4(x70)
	lw x75, 1(x75)
...
# B5454
	...
	mv x75, x72
# B5455
	bne	x75, zero, pretrace_pixels_beqelse_b5457
...
# B5450
	bne	x80, x107, pretrace_pixels_beqelse_b5459
# B5458
	lw x80, 4(x70)
	lw x81, 0(x80)
	fmul x72, x81, x72
...
# B5459
	...
	fadd x80, x80, x81
	lw x81, 3(x70)
	bne	x81, zero, pretrace_pixels_beqelse_b5461
# B5460
	mv x72, x80
...
# B5462
	lw x75, 1(x70)
	bne	x75, x111, pretrace_pixels_beqelse_b5465
# B5463
	fsub x72, x72, x108
...
# B5592
	bgt	zero, x13, pretrace_pixels_bleelse_b5606
# B5593
	add x4, x110, x13
	lw x11, 0(x4)
	lw x14, 10(x11)
	...
	fsub x16, x16, x17
	sw x16, 2(x14)
	bne	x15, x107, pretrace_pixels_beqelse_b5596
# B5595
	lw x11, 4(x11)
	lw x15, 0(x14)
	lw x16, 1(x14)
...
# B5596
	bge	x107, x15, pretrace_pixels_bgtelse_b5605
# B5598
	lw x16, 0(x14)
	lw x17, 1(x14)
	lw x18, 2(x14)
	...
	fadd x19, x19, x20
	lw x20, 3(x11)
	bne	x20, zero, pretrace_pixels_beqelse_b5600
# B5599
	mv x11, x19
...
# B5601
	bne	x15, x111, pretrace_pixels_beqelse_b5604
# B5602
	fsub x11, x11, x108
...
# B5607
	sub x10, x121, x118
	bgt	x118, x121, pretrace_pixels_bleelse_b5613
# B5608
	lw x100, 0(x121)
	lw x100, 0(x100)
	lw x11, 0(x100)
	...
	fadd x100, x11, x100
	fle x11, zero, x100
	beq	x11, zero, pretrace_pixels_bneelse_b5611
# B5610
	lw x5, 0(x121)
	fdiv x65, x100, x119
	addi	x2, x2, 25
...
# B5078
	...
	fsub x70, x74, x70
	lw x75, 1(x30)
	bne	x75, x12, pretrace_pixels_beqelse_b5080
# B5079
	fabs x67, x67
	lw x75, 4(x30)
	lw x75, 0(x75)
	fle x67, x75, x67
	bne	x67, zero, pretrace_pixels_beqelse_b5086
# B5082
	fabs x67, x7
	lw x7, 4(x30)
	lw x7, 1(x7)
...
# B5084
	...
	mv x7, x67
# B5085
	bne	x7, zero, pretrace_pixels_beqelse_b5087
...
# B5080
	bne	x75, x107, pretrace_pixels_beqelse_b5089
# B5088
	lw x75, 4(x30)
	lw x76, 0(x75)
	fmul x67, x76, x67
...
# B5089
	...
	fadd x75, x75, x76
	lw x76, 3(x30)
	bne	x76, zero, pretrace_pixels_beqelse_b5091
# B5090
	mv x67, x75
...
# B5092
	lw x7, 1(x30)
	bne	x7, x111, pretrace_pixels_beqelse_b5095
# B5093
	fsub x67, x67, x108
...
# B5096
	bne	x30, zero, pretrace_pixels_beqelse_b5100
# B5097
	addi x71, x71, 1
...
# B5072
	...
	lw x30, 0(x4)
	lw x30, 6(x30)
	beq	x30, zero, pretrace_pixels_bneelse_b5103
...
# B4989
	...
	fsub x71, x75, x71
	lw x76, 1(x65)
	bne	x76, x12, pretrace_pixels_beqelse_b4991
# B4990
	fabs x68, x68
	lw x76, 4(x65)
	lw x76, 0(x76)
	fle x68, x76, x68
	bne	x68, zero, pretrace_pixels_beqelse_b4997
# B4993
	fabs x68, x70
	lw x70, 4(x65)
	lw x70, 1(x70)
...
# B4995
	...
	mv x70, x68
# B4996
	bne	x70, zero, pretrace_pixels_beqelse_b4998
...
# B4991
	bne	x76, x107, pretrace_pixels_beqelse_b5000
# B4999
	lw x76, 4(x65)
	lw x77, 0(x76)
	fmul x68, x77, x68
...
# B5000
	...
	fadd x76, x76, x77
	lw x77, 3(x65)
	bne	x77, zero, pretrace_pixels_beqelse_b5002
# B5001
	mv x68, x76
...
# B5003
	lw x70, 1(x65)
	bne	x70, x111, pretrace_pixels_beqelse_b5006
# B5004
	fsub x68, x68, x108
...
# B5947
	sub x54, x53, x49
	la x55, min_caml_n_objects
	bgt	x49, x53, main_bleelse_b5954
# B5948
	mv x65, zero
	mv x5, x108
...
main_loop_b5950:
# B5950
	bgt	zero, x56, main_bleelse_b5953
# B5951
	mv x65, zero
	mv x5, x108
...
# B6197
	...
	lui x116, 784384
	lui x117, 258048
	bgt	x49, x113, main_bleelse_b6243
# B6198
	lw x119, 0(x113)
	addi x10, x119, 119
	mv x120, x10
main_loop_b6200:
# B6200
	bgt	x119, x120, main_bleelse_b6242
# B6201
	lw x10, 0(x120)
	lw x100, 0(x55)
	addi x100, x100, -1
...
# B6203
	sub x123, x121, x115
	bgt	x115, x121, main_bleelse_b6241
# B6204
	lw x124, 0(x121)
	lw x50, 1(x122)
	lw x52, 0(x122)
...
# B6244
	sub x120, x113, x115
	bgt	x115, x113, main_bleelse_b6282
# B6245
	lw x121, 0(x113)
	lw x122, 1(x119)
	lw x123, 0(x119)
...
# B6291
	sub x56, x52, x115
	bgt	x115, x52, main_bleelse_b6329
# B6292
	lw x57, 0(x52)
	lw x58, 1(x53)
	lw x59, 0(x53)
...
# B6330
	sub x54, x50, x115
	bgt	x115, x50, main_bleelse_b6368
# B6331
	lw x57, 0(x50)
	lw x58, 1(x53)
	lw x59, 0(x53)
...
# B6369
	sub x50, x123, x115
	bgt	x115, x123, main_bleelse_b6407
# B6370
	lw x52, 0(x123)
	lw x54, 1(x124)
	lw x56, 0(x124)
...
# B6410
	sub x124, x114, x115
	bgt	x115, x114, main_bleelse_b6448
# B6411
	lw x50, 0(x114)
	lw x53, 1(x123)
	lw x54, 0(x123)
...
# B6450
	sub x10, x113, x109
	la x122, min_caml_rgb
	la x123, min_caml_diffuse_ray
	la x124, min_caml_startp_fast
	bgt	x109, x113, main_bleelse_b6542
# B6451
	lw x100, 0(x106)
	lw x11, 0(x104)
	sub x10, x10, x11
...
main_loop_b6458:
# B6458
	bgt	x50, x112, main_bleelse_b6538
# B6459
	lw x10, 2(x122)
	add x4, x10, x50
	lw x10, 0(x4)
...
main_loop_b6465:
# B6465
	bgt	zero, x13, main_bleelse_b6479
# B6466
	add x4, x115, x13
	lw x11, 0(x4)
	lw x14, 10(x11)
	...
	fsub x16, x16, x17
	sw x16, 2(x14)
	bne	x15, x105, main_beqelse_b6469
# B6468
	lw x11, 4(x11)
	lw x15, 0(x14)
	lw x16, 1(x14)
...
main_beqelse_b6469:
# B6469
	bge	x105, x15, main_bgtelse_b6478
# B6471
	lw x16, 0(x14)
	lw x17, 1(x14)
	lw x18, 2(x14)
	...
	fadd x19, x19, x20
	lw x20, 3(x11)
	bne	x20, zero, main_beqelse_b6473
# B6472
	mv x11, x19
...
main_cont_b6474:
# B6474
	bne	x15, x108, main_beqelse_b6477
# B6475
	fsub x11, x11, x118
main_beqelse_b6477:
# B6477
...
# B6480
	sub x10, x56, x52
	bgt	x52, x56, main_bleelse_b6536
# B6481
	lw x100, 0(x56)
	lw x100, 0(x100)
	lw x11, 0(x100)
	...
	fadd x100, x11, x100
	fle x11, zero, x100
	la x59, min_caml_intersected_object_id
	la x60, min_caml_intsec_rectside
	la x61, min_caml_nvector
	la x62, min_caml_texture_color
	beq	x11, zero, main_bneelse_b6484
# B6483
	lw x63, 0(x56)
	fdiv x64, x100, x53
	mv x5, x63
...
# B6487
	...
	lw x10, 0(x4)
	feq x12, x10, zero
	bne	x12, zero, main_beqelse_b6490
# B6489
	fle x10, x10, zero
...
# B6498
	...
	fsqrt x100, x100
	feq x12, x100, zero
	bne	x12, zero, main_beqelse_b6500
# B6499
...
# B6512
	...
	lw x10, 0(x4)
	feq x12, x10, zero
	bne	x12, zero, main_beqelse_b6515
# B6514
	fle x10, x10, zero
...
# B6523
	...
	fsqrt x100, x100
	feq x12, x100, zero
	bne	x12, zero, main_beqelse_b6525
# B6524
...
# B6549
	lw x10, 0(x102)
	bge	x13, x10, main_bgtelse_b6885
# B6551
	add x4, x101, x13
	lw x10, 0(x4)
	lw x10, 0(x10)
	...
	addi x100, x120, 1
	addi x121, x13, 1
	bge	x100, x10, main_bgtelse_b6561
# B6553
	bge	zero, x120, main_bgtelse_b6561
# B6555
	lw x10, 0(x102)
	bge	x121, x10, main_bgtelse_b6561
# B6557
	bgt	x13, zero, main_bleelse_b6562
main_bgtelse_b6561:
# B6561
	add x4, x101, x13
	lw x10, 0(x4)
...
main_loop_b6563:
# B6563
	bgt	x41, x112, main_bleelse_b6704
# B6564
	lw x10, 2(x126)
	add x4, x10, x41
	lw x10, 0(x4)
...
# B6569
	...
	lw x52, 0(x4)
	lui x10, 260096
	beq	x43, zero, main_bneelse_b6587
# B6571
	lw x100, 0(x49)
	lw x11, 0(x52)
	sw x11, 0(x124)
...
main_bneelse_b6587:
# B6587
	beq	x43, x103, main_bneelse_b6605
# B6589
	lw x10, 1(x49)
	lw x100, 0(x52)
	sw x100, 0(x124)
...
main_bneelse_b6605:
# B6605
	beq	x43, x105, main_bneelse_b6623
# B6607
	lw x10, 2(x49)
	lw x100, 0(x52)
	sw x100, 0(x124)
...
main_bneelse_b6623:
# B6623
	beq	x43, x108, main_bneelse_b6641
# B6625
	lw x10, 3(x49)
	lw x100, 0(x52)
	sw x100, 0(x124)
...
main_bneelse_b6641:
# B6641
	beq	x43, x112, main_bneelse_b6659
# B6643
	lw x10, 4(x49)
	lw x100, 0(x52)
	sw x100, 0(x124)
...
# B6661
	add x4, x10, x15
	lw x100, 0(x4)
	bgt	x12, x112, main_bleelse_b6704
# B6662
	lw x13, 2(x100)
	add x4, x13, x12
	lw x13, 0(x4)
	bgt	zero, x13, main_bleelse_b6704
# B6664
	add x4, x10, x15
	lw x13, 0(x4)
	lw x13, 2(x13)
	...
	addi x18, x15, -1
	addi x19, x15, 1
	bne	x17, x13, main_beqelse_b6675
# B6666
	add x4, x11, x15
	lw x17, 0(x4)
	lw x17, 2(x17)
...
# B6676
	...
	add x4, x100, x12
	lw x100, 0(x4)
	beq	x100, zero, main_bneelse_b6703
# B6702
	add x4, x14, x15
	lw x100, 0(x4)
	lw x100, 5(x100)
...
main_loop_b6677:
# B6677
	bgt	x41, x112, main_bleelse_b6700
# B6678
	lw x10, 2(x126)
	add x4, x10, x41
	lw x10, 0(x4)
...
# B6683
	...
	add x4, x11, x41
	lw x52, 0(x4)
	beq	x43, zero, main_bneelse_b6686
# B6685
	lw x5, 0(x49)
	mv x7, x52
	mv x6, x50
...
main_bneelse_b6686:
# B6686
	beq	x43, x103, main_bneelse_b6689
# B6688
	lw x5, 1(x49)
	mv x7, x52
	mv x6, x50
...
main_bneelse_b6689:
# B6689
	beq	x43, x105, main_bneelse_b6692
# B6691
	lw x5, 2(x49)
	mv x7, x52
	mv x6, x50
...
main_bneelse_b6692:
# B6692
	beq	x43, x108, main_bneelse_b6695
# B6694
	lw x5, 3(x49)
	mv x7, x52
	mv x6, x50
...
main_bneelse_b6695:
# B6695
	beq	x43, x112, main_bneelse_b6698
# B6697
	lw x5, 4(x49)
	mv x7, x52
	mv x6, x50
...
main_cont_b6704:
# B6704
	bne	x119, x108, main_beqelse_b6706
main_cont_b6705:
# B6705
	lw x10, 0(x122)
	ftoi x10, x10
