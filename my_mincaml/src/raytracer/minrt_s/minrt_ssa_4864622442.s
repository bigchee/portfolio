...
# B625
	...
	lw x100, 0(x4)
	lw x100, 6(x100)
	beq	x100, zero, judge_intersection_fast_bneelse_b627
# B628
	j	judge_intersection_fast_loop_b587
judge_intersection_fast_bneelse_b627:
# B627
...
# B747
	...
	lw x100, 0(x4)
	lw x100, 6(x100)
	beq	x100, zero, judge_intersection_fast_bneelse_b749
# B750
	j	judge_intersection_fast_loop_b709
judge_intersection_fast_bneelse_b749:
# B749
...
# B1415
	...
	lw x31, 0(x4)
	lw x31, 6(x31)
	beq	x31, zero, trace_ray_bneelse_b1417
# B1418
	j	trace_ray_loop_b1377
trace_ray_bneelse_b1417:
# B1417
...
# B1537
	...
	lw x31, 0(x4)
	lw x31, 6(x31)
	beq	x31, zero, trace_ray_bneelse_b1539
# B1540
	j	trace_ray_loop_b1499
trace_ray_bneelse_b1539:
# B1539
...
# B1890
	...
	lw x11, 0(x4)
	lw x11, 6(x11)
	beq	x11, zero, trace_diffuse_ray_bneelse_b1892
# B1893
	j	trace_diffuse_ray_loop_b1852
trace_diffuse_ray_bneelse_b1892:
# B1892
...
# B2012
	...
	lw x11, 0(x4)
	lw x11, 6(x11)
	beq	x11, zero, trace_diffuse_ray_bneelse_b2014
# B2015
	j	trace_diffuse_ray_loop_b1974
trace_diffuse_ray_bneelse_b2014:
# B2014
...
# B2469
	...
	lw x18, 0(x4)
	lw x18, 6(x18)
	beq	x18, zero, iter_trace_diffuse_rays_bneelse_b2471
# B2472
	j	iter_trace_diffuse_rays_loop_b2431
iter_trace_diffuse_rays_bneelse_b2471:
# B2471
...
# B2591
	...
	lw x18, 0(x4)
	lw x18, 6(x18)
	beq	x18, zero, iter_trace_diffuse_rays_bneelse_b2593
# B2594
	j	iter_trace_diffuse_rays_loop_b2553
iter_trace_diffuse_rays_bneelse_b2593:
# B2593
...
# B3041
	...
	lw x18, 0(x4)
	lw x18, 6(x18)
	beq	x18, zero, iter_trace_diffuse_rays_bneelse_b3043
# B3044
	j	iter_trace_diffuse_rays_loop_b3003
iter_trace_diffuse_rays_bneelse_b3043:
# B3043
...
# B3163
	...
	lw x18, 0(x4)
	lw x18, 6(x18)
	beq	x18, zero, iter_trace_diffuse_rays_bneelse_b3165
# B3166
	j	iter_trace_diffuse_rays_loop_b3125
iter_trace_diffuse_rays_bneelse_b3165:
# B3165
...
# B3636
	...
	lw x20, 0(x4)
	lw x20, 6(x20)
	beq	x20, zero, trace_diffuse_rays_bneelse_b3638
# B3639
	j	trace_diffuse_rays_loop_b3598
trace_diffuse_rays_bneelse_b3638:
# B3638
...
# B3758
	...
	lw x20, 0(x4)
	lw x20, 6(x20)
	beq	x20, zero, trace_diffuse_rays_bneelse_b3760
# B3761
	j	trace_diffuse_rays_loop_b3720
trace_diffuse_rays_bneelse_b3760:
# B3760
...
# B4208
	...
	lw x20, 0(x4)
	lw x20, 6(x20)
	beq	x20, zero, trace_diffuse_rays_bneelse_b4210
# B4211
	j	trace_diffuse_rays_loop_b4170
trace_diffuse_rays_bneelse_b4210:
# B4210
...
# B4330
	...
	lw x20, 0(x4)
	lw x20, 6(x20)
	beq	x20, zero, trace_diffuse_rays_bneelse_b4332
# B4333
	j	trace_diffuse_rays_loop_b4292
trace_diffuse_rays_bneelse_b4332:
# B4332
...
# B4830
	...
	lw x23, 0(x4)
	lw x23, 6(x23)
	beq	x23, zero, pretrace_pixels_bneelse_b4832
# B4833
	j	pretrace_pixels_loop_b4756
pretrace_pixels_bneelse_b4832:
# B4832
...
# B5024
	...
	lw x23, 0(x4)
	lw x23, 6(x23)
	beq	x23, zero, pretrace_pixels_bneelse_b5026
# B5027
	j	pretrace_pixels_loop_b4950
pretrace_pixels_bneelse_b5026:
# B5026
...
# B5502
	...
	lw x5, 0(x4)
	lw x5, 6(x5)
	beq	x5, zero, pretrace_pixels_bneelse_b5504
# B5505
	j	pretrace_pixels_loop_b5464
pretrace_pixels_bneelse_b5504:
# B5504
...
# B5624
	...
	lw x5, 0(x4)
	lw x5, 6(x5)
	beq	x5, zero, pretrace_pixels_bneelse_b5626
# B5627
	j	pretrace_pixels_loop_b5586
pretrace_pixels_bneelse_b5626:
# B5626
