...
read_object_beqelse_b212:	#moved
# B212
	addi x101, x101, 1
read_object_loop_b3:
# B3
...
# B222
	mv x10, x5
	mv x100, x6
shadow_check_one_or_matrix_bneelse_b366:	#moved
# B366
...
# B275
	...
	mv x23, x18
	mv x22, zero
shadow_check_one_or_matrix_beqelse_b326:	#moved
# B326
...
# B370
	...
	mv x12, zero
	mv x17, x11
shadow_check_one_or_matrix_beqelse_b421:	#moved
# B421
...
# B2172
	...
	mv x15, x100
	mv x12, zero
trace_diffuse_ray_bneelse_b2316:	#moved
# B2316
...
# B2225
	...
	mv x27, zero
	mv x28, x24
trace_diffuse_ray_beqelse_b2276:	#moved
# B2276
...
# B2320
	...
	mv x25, x100
	mv x17, zero
trace_diffuse_ray_beqelse_b2371:	#moved
# B2371
...
# B2751
	...
	mv x19, x14
	mv x18, zero
iter_trace_diffuse_rays_bneelse_b2895:	#moved
# B2895
...
# B2804
	...
	mv x33, x28
	mv x32, zero
iter_trace_diffuse_rays_beqelse_b2855:	#moved
# B2855
...
# B2899
	...
	mv x30, x14
	mv x22, zero
iter_trace_diffuse_rays_beqelse_b2950:	#moved
# B2950
...
# B3323
	...
	mv x19, x14
	mv x18, zero
iter_trace_diffuse_rays_bneelse_b3467:	#moved
# B3467
...
# B3376
	...
	mv x32, x27
	mv x31, zero
iter_trace_diffuse_rays_beqelse_b3427:	#moved
# B3427
...
# B3471
	...
	mv x28, x14
	mv x20, zero
iter_trace_diffuse_rays_beqelse_b3522:	#moved
# B3522
...
# B3918
	...
	mv x21, x18
	mv x20, zero
trace_diffuse_rays_bneelse_b4062:	#moved
# B4062
...
# B3971
	...
	mv x35, x30
	mv x34, zero
trace_diffuse_rays_beqelse_b4022:	#moved
# B4022
...
# B4066
	...
	mv x24, zero
	mv x32, x18
trace_diffuse_rays_beqelse_b4117:	#moved
# B4117
...
# B4490
	...
	mv x21, x18
	mv x20, zero
trace_diffuse_rays_bneelse_b4634:	#moved
# B4634
...
# B4543
	...
	mv x34, x29
	mv x33, zero
trace_diffuse_rays_beqelse_b4594:	#moved
# B4594
...
# B4638
	...
	mv x30, x18
	mv x22, zero
trace_diffuse_rays_beqelse_b4689:	#moved
# B4689
...
# B5191
	...
	mv x35, x33
	mv x34, zero
pretrace_pixels_bneelse_b5335:	#moved
# B5335
...
# B5244
	...
	mv x67, zero
	mv x68, x6
pretrace_pixels_beqelse_b5295:	#moved
# B5295
...
# B5339
	...
	mv x38, zero
	mv x65, x33
pretrace_pixels_beqelse_b5390:	#moved
# B5390
...
# B5673
	...
	mv x6, zero
	mv x65, x5
pretrace_pixels_bneelse_b5818:	#moved
# B5818
...
# B5727
	...
	mv x70, zero
	mv x71, x68
pretrace_pixels_beqelse_b5778:	#moved
# B5778
...
# B5822
	...
	mv x66, zero
	mv x69, x5
pretrace_pixels_beqelse_b5873:	#moved
# B5873
