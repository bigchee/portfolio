...
# B50
	fle x15, x13, x14
	bne	x15, zero, read_object_beqelse_b52
# B51
	fmul x14, x14, x12
	j	read_object_loop_b50
read_object_beqelse_b52:
# B52
# B53
	mv x16, x100
	mv x17, x14
...
# B65
	...
	addi x15, x15, -37
	fle x16, x15, x14
	beq	x16, zero, read_object_bneelse_b66
# B67
	fsub x14, x100, x14
read_object_bneelse_b66:
# B66
read_object_cont_b68:
# B68
	beq	x16, zero, read_object_bneelse_b69
# B70
	xori x13, x13, 1
read_object_bneelse_b69:
# B69
...
# B78
	fle x26, x24, x25
	bne	x26, zero, read_object_beqelse_b80
# B79
	fmul x25, x25, x12
	j	read_object_loop_b78
read_object_beqelse_b80:
# B80
# B81
	mv x27, x14
	mv x28, x25
...
# B118
	fle x25, x15, x24
	beq	x25, zero, read_object_bneelse_b119
# B120
	fsub x24, x100, x24
read_object_bneelse_b119:
# B119
read_object_cont_b121:
# B121
	beq	x25, zero, read_object_bneelse_b122
# B123
	xori x17, x17, 1
read_object_bneelse_b122:
# B122
...
# B131
	fle x28, x26, x27
	bne	x28, zero, read_object_beqelse_b133
# B132
	fmul x27, x27, x12
...
# B156
	fle x28, x26, x27
	bne	x28, zero, read_object_beqelse_b158
# B157
	fmul x27, x27, x12
...
# B171
	fle x27, x15, x26
	beq	x27, zero, read_object_bneelse_b172
# B173
	fsub x26, x100, x26
read_object_bneelse_b172:
# B172
read_object_cont_b174:
# B174
	beq	x27, zero, read_object_bneelse_b175
# B176
	xori x25, x25, 1
read_object_bneelse_b175:
# B175
...
# B184
	fle x30, x28, x29
	bne	x30, zero, read_object_beqelse_b186
# B185
	fmul x29, x29, x12
...
# B205
	fle x100, x10, zero
	bne	x11, x100, read_object_beqelse_b206
# B207
	fsub x10, zero, x10
read_object_beqelse_b206:
# B206
...
# B209
	li x100, 1
# B210
	bne	x100, zero, read_object_beqelse_b212
	j read_object_cont_b211 # adhoc jump(3)
read_object_beqelse_b212:
# B212
	addi x101, x101, 1
	j	read_object_loop_b3
read_object_bneelse_b6:
# B6
read_object_cont_b211:
# B211
...
# B226
	li x12, 1
	j shadow_check_one_or_matrix_cont_b365 # adhoc jump(2)
...
# B236
	...
	sw x24, 0(x12)
	li x12, 1
	j shadow_check_one_or_matrix_cont_b268 # adhoc jump(2)
...
# B267
	li x12, 1
shadow_check_one_or_matrix_cont_b268:
# B268
	bne	x12, zero, shadow_check_one_or_matrix_beqelse_b270
	j shadow_check_one_or_matrix_cont_b269 # adhoc jump(3)
shadow_check_one_or_matrix_beqelse_b270:
# B270
	la x12, min_caml_solver_dist
	lw x18, 0(x12)
	lui x19, 777421
...
# B287
	sw x30, 0(x12)
	li x24, 1
	j shadow_check_one_or_matrix_cont_b319 # adhoc jump(2)
...
# B307
	mv x24, zero
shadow_check_one_or_matrix_cont_b319:
# B319
	lw x25, 0(x12)
	bne	x24, zero, shadow_check_one_or_matrix_beqelse_b321
# B320
	mv x24, zero
	j shadow_check_one_or_matrix_cont_b322 # adhoc jump(2)
shadow_check_one_or_matrix_beqelse_b321:
# B321
	lui x24, 779469
	addi x24, x24, -819
	fle x24, x24, x25
	xori x24, x24, 1
shadow_check_one_or_matrix_cont_b322:
# B322
	addi x22, x22, 1
...
# B323
	...
	lw x18, 0(x4)
	lw x18, 6(x18)
	bne	x18, zero, shadow_check_one_or_matrix_beqelse_b326
# B325
	j shadow_check_one_or_matrix_cont_b360 # adhoc jump(2)
shadow_check_one_or_matrix_beqelse_b326:
# B326
...
# B327
	add x4, x27, x24
	lw x18, 0(x4)
	bne	x18, x14, shadow_check_one_or_matrix_beqelse_b329
# B328
	li x24, 1
# B356
	bne	x24, zero, shadow_check_one_or_matrix_beqelse_b358
	j shadow_check_one_or_matrix_cont_b357 # adhoc jump(3)
...
# B353
	bne	x18, zero, shadow_check_one_or_matrix_beqelse_b355
# B354
	addi x24, x24, 1
	j	shadow_check_one_or_matrix_loop_b327
shadow_check_one_or_matrix_beqelse_b355:
# B355
...
# B269
	mv x12, zero
shadow_check_one_or_matrix_cont_b365:
# B365
	addi x10, x10, 1
	beq	x12, zero, shadow_check_one_or_matrix_bneelse_b366
# B367
	mv x15, x13
	mv x16, x11
...
# B414
	la x21, min_caml_solver_dist
	lw x21, 0(x21)
	bne	x18, zero, shadow_check_one_or_matrix_beqelse_b416
# B415
	mv x18, zero
	j shadow_check_one_or_matrix_cont_b417 # adhoc jump(2)
shadow_check_one_or_matrix_beqelse_b416:
# B416
	lui x18, 779469
	addi x18, x18, -819
	fle x18, x18, x21
	xori x18, x18, 1
shadow_check_one_or_matrix_cont_b417:
# B417
	addi x12, x12, 1
...
# B418
	...
	lw x11, 0(x4)
	lw x11, 6(x11)
	bne	x11, zero, shadow_check_one_or_matrix_beqelse_b421
# B420
	j shadow_check_one_or_matrix_cont_b455 # adhoc jump(2)
shadow_check_one_or_matrix_beqelse_b421:
# B421
...
# B422
	add x4, x19, x18
	lw x11, 0(x4)
	bne	x11, x14, shadow_check_one_or_matrix_beqelse_b424
# B423
	li x18, 1
# B451
	bne	x18, zero, shadow_check_one_or_matrix_beqelse_b453
	j shadow_check_one_or_matrix_cont_b452 # adhoc jump(3)
shadow_check_one_or_matrix_beqelse_b453:
# B453
	mv x11, x13
# B454
...
# B448
	bne	x11, zero, shadow_check_one_or_matrix_beqelse_b450
# B449
	addi x18, x18, 1
	j	shadow_check_one_or_matrix_loop_b422
shadow_check_one_or_matrix_beqelse_b450:
# B450
...
shadow_check_one_or_matrix_bneelse_b366:
# B366
	j	shadow_check_one_or_matrix_loop_b223
...
# B478
	...
	li x23, 1
# B479
	bne	x23, zero, solve_each_element_beqelse_b481
	j solve_each_element_cont_b480 # adhoc jump(3)
solve_each_element_beqelse_b481:
# B481
	li x17, 1
	j solve_each_element_cont_b535 # adhoc jump(2)
...
# B493
	...
	li x23, 1
# B494
	bne	x23, zero, solve_each_element_beqelse_b496
	j solve_each_element_cont_b495 # adhoc jump(3)
solve_each_element_beqelse_b496:
# B496
	li x17, 2
	j solve_each_element_cont_b535 # adhoc jump(2)
...
# B508
	...
	li x18, 1
# B509
	bne	x18, zero, solve_each_element_beqelse_b511
	j solve_each_element_cont_b510 # adhoc jump(3)
...
# B520
	mv x17, zero
solve_each_element_cont_b535:
# B535
	addi x10, x10, 1
	bne	x17, zero, solve_each_element_beqelse_b537
# B536
	add x4, x16, x12
	lw x12, 0(x4)
	lw x12, 6(x12)
...
# B544
	add x4, x24, x23
	lw x28, 0(x4)
	bne	x28, x14, solve_each_element_beqelse_b546
# B545
	li x14, 1
# B573
	bne	x14, zero, solve_each_element_beqelse_b575
	j solve_each_element_cont_b574 # adhoc jump(3)
solve_each_element_beqelse_b575:
# B575
	sw x18, 0(x19)
...
solve_each_element_beqelse_b546:
# B546
	add x4, x16, x28
	lw x28, 0(x4)
	lw x29, 5(x28)
...
# B570
	bne	x28, zero, solve_each_element_beqelse_b572
# B571
	addi x23, x23, 1
	j	solve_each_element_loop_b544
solve_each_element_beqelse_b572:
# B572
solve_each_element_cont_b574:
# B574
...
# B598
	...
	sw x36, 0(x30)
	li x30, 1
	j judge_intersection_fast_cont_b624 # adhoc jump(2)
...
# B618
	mv x30, zero
judge_intersection_fast_cont_b624:
# B624
	addi x14, x14, 1
	bne	x30, zero, judge_intersection_fast_beqelse_b626
# B625
	add x4, x29, x28
	lw x100, 0(x4)
	lw x100, 6(x100)
...
# B627
	j judge_intersection_fast_cont_b666 # adhoc jump(2)
...
# B633
	add x4, x35, x33
	lw x39, 0(x4)
	bne	x39, x16, judge_intersection_fast_beqelse_b635
# B634
	li x33, 1
# B662
	bne	x33, zero, judge_intersection_fast_beqelse_b664
	j judge_intersection_fast_cont_b663 # adhoc jump(3)
judge_intersection_fast_beqelse_b664:
# B664
	sw x31, 0(x10)
	sw x32, 0(x21)
	sw x34, 1(x21)
...
judge_intersection_fast_beqelse_b635:
# B635
	add x4, x29, x39
	lw x39, 0(x4)
	lw x40, 5(x39)
...
# B659
	bne	x39, zero, judge_intersection_fast_beqelse_b661
# B660
	addi x33, x33, 1
	j	judge_intersection_fast_loop_b633
judge_intersection_fast_beqelse_b661:
# B661
...
# B720
	sw x35, 0(x19)
	li x29, 1
	j judge_intersection_fast_cont_b746 # adhoc jump(2)
...
# B740
	mv x29, zero
judge_intersection_fast_cont_b746:
# B746
	addi x14, x14, 1
	bne	x29, zero, judge_intersection_fast_beqelse_b748
# B747
	add x4, x17, x27
	lw x100, 0(x4)
	lw x100, 6(x100)
...
# B749
	j judge_intersection_fast_cont_b788 # adhoc jump(2)
...
# B755
	add x4, x34, x32
	lw x38, 0(x4)
	bne	x38, x16, judge_intersection_fast_beqelse_b757
# B756
	li x34, 1
# B784
	bne	x34, zero, judge_intersection_fast_beqelse_b786
	j judge_intersection_fast_cont_b785 # adhoc jump(3)
judge_intersection_fast_beqelse_b786:
# B786
	sw x30, 0(x10)
	sw x31, 0(x21)
	sw x33, 1(x21)
...
judge_intersection_fast_beqelse_b757:
# B757
	add x4, x17, x38
	lw x38, 0(x4)
	lw x39, 5(x38)
...
# B781
	bne	x38, zero, judge_intersection_fast_beqelse_b783
# B782
	addi x32, x32, 1
	j	judge_intersection_fast_loop_b755
judge_intersection_fast_beqelse_b783:
# B783
...
# B806
	fle x27, x12, x13
	bne	x27, zero, utexture_beqelse_b808
# B807
	fmul x13, x13, x15
...
# B833
	fle x27, x12, x13
	bne	x27, zero, utexture_beqelse_b835
# B834
	fmul x13, x13, x15
	j	utexture_loop_b833
utexture_beqelse_b835:
# B835
# B836
	mv x28, x10
	mv x29, x13
...
# B898
	add x4, x116, x115
	lw x10, 0(x4)
	beq	x10, x114, trace_ray_bneelse_b899
# B900
...
# B976
	add x4, x116, x115
	lw x10, 0(x4)
	beq	x10, x114, trace_ray_bneelse_b977
# B978
	la x100, min_caml_and_net
	add x4, x100, x10
	lw x6, 0(x4)
...
# B1019
	fle x6, x28, x5
	bne	x6, zero, trace_ray_beqelse_b1021
# B1020
	fmul x5, x5, x30
	j	trace_ray_loop_b1019
trace_ray_beqelse_b1021:
# B1021
# B1022
	mv x65, x12
	mv x66, x5
...
# B1046
	fle x5, x16, x28
	bne	x5, zero, trace_ray_beqelse_b1048
# B1047
	fmul x28, x28, x30
	j	trace_ray_loop_b1046
trace_ray_beqelse_b1048:
# B1048
# B1049
	mv x6, x12
	mv x65, x28
...
# B1061
	fle x12, x32, x16
	beq	x12, zero, trace_ray_bneelse_b1062
# B1063
	fsub x16, x31, x16
trace_ray_bneelse_b1062:
# B1062
...
# B1108
	li x20, 1
	j trace_ray_cont_b1247 # adhoc jump(2)
...
# B1118
	...
	sw x36, 0(x20)
	li x20, 1
	j trace_ray_cont_b1150 # adhoc jump(2)
...
# B1149
	li x20, 1
trace_ray_cont_b1150:
# B1150
	bne	x20, zero, trace_ray_beqelse_b1152
	j trace_ray_cont_b1151 # adhoc jump(3)
trace_ray_beqelse_b1152:
# B1152
	la x20, min_caml_solver_dist
	lw x31, 0(x20)
	fle x31, x100, x31
...
# B1169
	sw x6, 0(x20)
	li x36, 1
	j trace_ray_cont_b1201 # adhoc jump(2)
...
# B1189
	mv x36, zero
trace_ray_cont_b1201:
# B1201
	lw x37, 0(x20)
	bne	x36, zero, trace_ray_beqelse_b1203
# B1202
	mv x36, zero
	j trace_ray_cont_b1204 # adhoc jump(2)
trace_ray_beqelse_b1203:
# B1203
	lui x36, 779469
	addi x36, x36, -819
	fle x36, x36, x37
	xori x36, x36, 1
trace_ray_cont_b1204:
# B1204
	addi x34, x34, 1
...
# B1205
	...
	lw x31, 0(x4)
	lw x31, 6(x31)
	bne	x31, zero, trace_ray_beqelse_b1208
# B1207
	j trace_ray_cont_b1242 # adhoc jump(2)
trace_ray_beqelse_b1208:
# B1208
...
# B1209
	add x4, x39, x36
	lw x31, 0(x4)
	bne	x31, x28, trace_ray_beqelse_b1211
# B1210
	li x36, 1
# B1238
	bne	x36, zero, trace_ray_beqelse_b1240
	j trace_ray_cont_b1239 # adhoc jump(3)
trace_ray_beqelse_b1240:
# B1240
	mv x31, x11
# B1241
...
# B1235
	bne	x31, zero, trace_ray_beqelse_b1237
# B1236
	addi x36, x36, 1
	j	trace_ray_loop_b1209
trace_ray_beqelse_b1237:
# B1237
trace_ray_cont_b1239:
# B1239
	j	trace_ray_loop_b1158
...
# B1247
	addi x16, x16, 1
	beq	x20, zero, trace_ray_bneelse_b1248
# B1249
	mv x31, x15
	mv x30, x11
...
# B1264
	...
	sw x39, 0(x33)
	li x33, 1
	j trace_ray_cont_b1296 # adhoc jump(2)
...
# B1284
	mv x33, zero
trace_ray_cont_b1296:
# B1296
	la x34, min_caml_solver_dist
	lw x34, 0(x34)
	bne	x33, zero, trace_ray_beqelse_b1298
# B1297
	mv x33, zero
	j trace_ray_cont_b1299 # adhoc jump(2)
...
# B1300
	...
	lw x15, 0(x4)
	lw x15, 6(x15)
	bne	x15, zero, trace_ray_beqelse_b1303
# B1302
	j trace_ray_cont_b1337 # adhoc jump(2)
trace_ray_beqelse_b1303:
# B1303
...
# B1304
	add x4, x36, x35
	lw x15, 0(x4)
	bne	x15, x28, trace_ray_beqelse_b1306
# B1305
	li x33, 1
# B1333
	bne	x33, zero, trace_ray_beqelse_b1335
	j trace_ray_cont_b1334 # adhoc jump(3)
...
# B1330
	bne	x15, zero, trace_ray_beqelse_b1332
# B1331
	addi x35, x35, 1
	j	trace_ray_loop_b1304
trace_ray_beqelse_b1332:
# B1332
...
# B1388
	...
	sw x72, 0(x67)
	li x67, 1
	j trace_ray_cont_b1414 # adhoc jump(2)
...
# B1408
	mv x67, zero
trace_ray_cont_b1414:
# B1414
	addi x35, x35, 1
	bne	x67, zero, trace_ray_beqelse_b1416
# B1415
	add x4, x13, x66
	lw x31, 0(x4)
	lw x31, 6(x31)
...
# B1417
	j trace_ray_cont_b1456 # adhoc jump(2)
trace_ray_beqelse_b1418:
# B1418
	j	trace_ray_loop_b1377
trace_ray_beqelse_b1416:
# B1416
	lw x68, 0(x38)
	fle x69, x68, zero
...
# B1423
	add x4, x71, x70
	lw x75, 0(x4)
	bne	x75, x36, trace_ray_beqelse_b1425
# B1424
	li x71, 1
# B1452
	bne	x71, zero, trace_ray_beqelse_b1454
	j trace_ray_cont_b1453 # adhoc jump(3)
...
# B1449
	bne	x75, zero, trace_ray_beqelse_b1451
# B1450
	addi x70, x70, 1
	j	trace_ray_loop_b1423
trace_ray_beqelse_b1451:
# B1451
trace_ray_cont_b1453:
# B1453
...
# B1510
	sw x71, 0(x38)
	li x66, 1
	j trace_ray_cont_b1536 # adhoc jump(2)
...
# B1530
	mv x66, zero
trace_ray_cont_b1536:
# B1536
	addi x35, x35, 1
	bne	x66, zero, trace_ray_beqelse_b1538
# B1537
	add x4, x13, x65
	lw x31, 0(x4)
	lw x31, 6(x31)
...
# B1539
	j trace_ray_cont_b1578 # adhoc jump(2)
trace_ray_beqelse_b1540:
# B1540
	j	trace_ray_loop_b1499
trace_ray_beqelse_b1538:
# B1538
	lw x67, 0(x38)
	fle x68, x67, zero
...
# B1545
	add x4, x70, x7
	lw x74, 0(x4)
	bne	x74, x36, trace_ray_beqelse_b1547
# B1546
	li x70, 1
# B1574
	bne	x70, zero, trace_ray_beqelse_b1576
	j trace_ray_cont_b1575 # adhoc jump(3)
...
# B1571
	bne	x74, zero, trace_ray_beqelse_b1573
# B1572
	addi x7, x7, 1
	j	trace_ray_loop_b1545
trace_ray_beqelse_b1573:
# B1573
...
# B1591
	li x34, 1
	j trace_ray_cont_b1730 # adhoc jump(2)
...
# B1601
	...
	sw x5, 0(x34)
	li x34, 1
	j trace_ray_cont_b1633 # adhoc jump(2)
...
# B1632
	li x34, 1
trace_ray_cont_b1633:
# B1633
	bne	x34, zero, trace_ray_beqelse_b1635
	j trace_ray_cont_b1634 # adhoc jump(3)
trace_ray_beqelse_b1635:
# B1635
	la x34, min_caml_solver_dist
	lw x36, 0(x34)
	fle x36, x100, x36
...
# B1684
	lw x6, 0(x34)
	bne	x5, zero, trace_ray_beqelse_b1686
# B1685
	mv x5, zero
	j trace_ray_cont_b1687 # adhoc jump(2)
trace_ray_beqelse_b1686:
# B1686
	lui x5, 779469
	addi x5, x5, -819
	fle x5, x5, x6
	xori x5, x5, 1
trace_ray_cont_b1687:
# B1687
	addi x39, x39, 1
...
# B1688
	...
	lw x36, 0(x4)
	lw x36, 6(x36)
	bne	x36, zero, trace_ray_beqelse_b1691
# B1690
	j trace_ray_cont_b1725 # adhoc jump(2)
trace_ray_beqelse_b1691:
# B1691
...
# B1692
	add x4, x66, x5
	lw x36, 0(x4)
	bne	x36, x12, trace_ray_beqelse_b1694
# B1693
	li x5, 1
# B1721
	bne	x5, zero, trace_ray_beqelse_b1723
	j trace_ray_cont_b1722 # adhoc jump(3)
trace_ray_beqelse_b1723:
# B1723
	mv x36, x11
# B1724
...
# B1718
	bne	x36, zero, trace_ray_beqelse_b1720
# B1719
	addi x5, x5, 1
	j	trace_ray_loop_b1692
trace_ray_beqelse_b1720:
# B1720
trace_ray_cont_b1722:
# B1722
	j	trace_ray_loop_b1641
...
# B1634
	mv x34, zero
trace_ray_cont_b1730:
# B1730
	addi x32, x32, 1
	beq	x34, zero, trace_ray_bneelse_b1731
# B1732
	mv x36, x31
	mv x35, x11
...
# B1747
	...
	sw x66, 0(x38)
	li x38, 1
	j trace_ray_cont_b1779 # adhoc jump(2)
...
# B1767
	mv x38, zero
trace_ray_cont_b1779:
# B1779
	la x39, min_caml_solver_dist
	lw x39, 0(x39)
	bne	x38, zero, trace_ray_beqelse_b1781
# B1780
	mv x38, zero
	j trace_ray_cont_b1782 # adhoc jump(2)
trace_ray_beqelse_b1781:
# B1781
	lui x38, 779469
	addi x38, x38, -819
	fle x38, x38, x39
	xori x38, x38, 1
trace_ray_cont_b1782:
# B1782
	addi x34, x34, 1
...
# B1783
	...
	lw x31, 0(x4)
	lw x31, 6(x31)
	bne	x31, zero, trace_ray_beqelse_b1786
# B1785
	j trace_ray_cont_b1820 # adhoc jump(2)
trace_ray_beqelse_b1786:
# B1786
...
# B1787
	add x4, x5, x38
	lw x31, 0(x4)
	bne	x31, x12, trace_ray_beqelse_b1789
# B1788
	li x38, 1
# B1816
	bne	x38, zero, trace_ray_beqelse_b1818
	j trace_ray_cont_b1817 # adhoc jump(3)
trace_ray_beqelse_b1818:
# B1818
	mv x31, x11
# B1819
...
# B1813
	bne	x31, zero, trace_ray_beqelse_b1815
# B1814
	addi x38, x38, 1
	j	trace_ray_loop_b1787
trace_ray_beqelse_b1815:
# B1815
trace_ray_cont_b1817:
# B1817
	j	trace_ray_loop_b1736
...
# B1839
	bne	x22, x14, trace_ray_beqelse_b1841
# B1840
	lw x100, 7(x21)
	lw x100, 0(x100)
	fsub x100, x16, x100
...
# B1863
	...
	sw x37, 0(x31)
	li x31, 1
	j trace_diffuse_ray_cont_b1889 # adhoc jump(2)
...
# B1883
	mv x31, zero
trace_diffuse_ray_cont_b1889:
# B1889
	addi x15, x15, 1
	bne	x31, zero, trace_diffuse_ray_beqelse_b1891
# B1890
	add x4, x18, x25
	lw x11, 0(x4)
	lw x11, 6(x11)
...
trace_diffuse_ray_beqelse_b1891:
# B1891
	lw x32, 0(x26)
	fle x33, x32, zero
...
# B1898
	add x4, x36, x34
	lw x40, 0(x4)
	bne	x40, x17, trace_diffuse_ray_beqelse_b1900
# B1899
	li x36, 1
# B1927
	bne	x36, zero, trace_diffuse_ray_beqelse_b1929
	j trace_diffuse_ray_cont_b1928 # adhoc jump(3)
...
# B1924
	bne	x40, zero, trace_diffuse_ray_beqelse_b1926
# B1925
	addi x34, x34, 1
...
# B1985
	sw x38, 0(x26)
	li x32, 1
	j trace_diffuse_ray_cont_b2011 # adhoc jump(2)
...
# B2005
	mv x32, zero
trace_diffuse_ray_cont_b2011:
# B2011
	addi x15, x15, 1
	bne	x32, zero, trace_diffuse_ray_beqelse_b2013
# B2012
	add x4, x18, x30
	lw x11, 0(x4)
	lw x11, 6(x11)
...
# B2014
	j trace_diffuse_ray_cont_b2053 # adhoc jump(2)
trace_diffuse_ray_beqelse_b2015:
# B2015
	j	trace_diffuse_ray_loop_b1974
trace_diffuse_ray_beqelse_b2013:
# B2013
	lw x33, 0(x26)
	fle x34, x33, zero
...
# B2020
	add x4, x37, x35
	lw x6, 0(x4)
	bne	x6, x17, trace_diffuse_ray_beqelse_b2022
# B2021
	li x37, 1
# B2049
	bne	x37, zero, trace_diffuse_ray_beqelse_b2051
	j trace_diffuse_ray_cont_b2050 # adhoc jump(3)
trace_diffuse_ray_beqelse_b2051:
# B2051
	sw x33, 0(x10)
	sw x34, 0(x20)
	sw x36, 1(x20)
...
# B2046
	bne	x6, zero, trace_diffuse_ray_beqelse_b2048
# B2047
	addi x35, x35, 1
	j	trace_diffuse_ray_loop_b2020
trace_diffuse_ray_beqelse_b2048:
# B2048
...
# B2090
	fle x35, x17, x23
	bne	x35, zero, trace_diffuse_ray_beqelse_b2092
# B2091
	fmul x23, x23, x22
	j	trace_diffuse_ray_loop_b2090
trace_diffuse_ray_beqelse_b2092:
# B2092
# B2093
	mv x37, x23
	mv x36, x12
...
# B2117
	fle x23, x15, x17
	bne	x23, zero, trace_diffuse_ray_beqelse_b2119
# B2118
	fmul x17, x17, x22
...
# B2132
	fle x12, x26, x15
	beq	x12, zero, trace_diffuse_ray_bneelse_b2133
# B2134
	fsub x15, x25, x15
...
# B2176
	li x17, 1
	j trace_diffuse_ray_cont_b2315 # adhoc jump(2)
...
# B2186
	...
	sw x29, 0(x17)
	li x17, 1
	j trace_diffuse_ray_cont_b2218 # adhoc jump(2)
...
# B2217
	li x17, 1
trace_diffuse_ray_cont_b2218:
# B2218
	bne	x17, zero, trace_diffuse_ray_beqelse_b2220
	j trace_diffuse_ray_cont_b2219 # adhoc jump(3)
...
# B2237
	sw x35, 0(x17)
	li x29, 1
	j trace_diffuse_ray_cont_b2269 # adhoc jump(2)
...
# B2257
	mv x29, zero
trace_diffuse_ray_cont_b2269:
# B2269
	lw x30, 0(x17)
	bne	x29, zero, trace_diffuse_ray_beqelse_b2271
# B2270
	mv x29, zero
	j trace_diffuse_ray_cont_b2272 # adhoc jump(2)
trace_diffuse_ray_beqelse_b2271:
# B2271
	lui x29, 779469
	addi x29, x29, -819
	fle x29, x29, x30
	xori x29, x29, 1
trace_diffuse_ray_cont_b2272:
# B2272
	addi x27, x27, 1
...
# B2273
	...
	lw x24, 0(x4)
	lw x24, 6(x24)
	bne	x24, zero, trace_diffuse_ray_beqelse_b2276
# B2275
	j trace_diffuse_ray_cont_b2310 # adhoc jump(2)
trace_diffuse_ray_beqelse_b2276:
# B2276
...
# B2277
	add x4, x32, x29
	lw x24, 0(x4)
	bne	x24, x21, trace_diffuse_ray_beqelse_b2279
# B2278
	li x29, 1
# B2306
	bne	x29, zero, trace_diffuse_ray_beqelse_b2308
	j trace_diffuse_ray_cont_b2307 # adhoc jump(3)
trace_diffuse_ray_beqelse_b2308:
# B2308
	mv x24, x16
# B2309
...
# B2314
	mv x17, x16
	j trace_diffuse_ray_cont_b2315 # adhoc jump(2)
trace_diffuse_ray_beqelse_b2279:
# B2279
	add x4, x18, x24
	lw x24, 0(x4)
	lw x30, 5(x24)
...
# B2303
	bne	x24, zero, trace_diffuse_ray_beqelse_b2305
# B2304
	addi x29, x29, 1
	j	trace_diffuse_ray_loop_b2277
trace_diffuse_ray_beqelse_b2305:
# B2305
trace_diffuse_ray_cont_b2307:
# B2307
	j	trace_diffuse_ray_loop_b2226
...
# B2219
	mv x17, zero
trace_diffuse_ray_cont_b2315:
# B2315
	addi x12, x12, 1
	beq	x17, zero, trace_diffuse_ray_bneelse_b2316
# B2317
	mv x23, x16
	mv x24, x100
...
# B2332
	...
	sw x32, 0(x26)
	li x26, 1
	j trace_diffuse_ray_cont_b2364 # adhoc jump(2)
...
# B2352
	mv x26, zero
trace_diffuse_ray_cont_b2364:
# B2364
	la x27, min_caml_solver_dist
	lw x27, 0(x27)
	bne	x26, zero, trace_diffuse_ray_beqelse_b2366
# B2365
	mv x26, zero
	j trace_diffuse_ray_cont_b2367 # adhoc jump(2)
trace_diffuse_ray_beqelse_b2366:
# B2366
	lui x26, 779469
	addi x26, x26, -819
	fle x26, x26, x27
	xori x26, x26, 1
trace_diffuse_ray_cont_b2367:
# B2367
	addi x17, x17, 1
...
# B2368
	...
	lw x100, 0(x4)
	lw x100, 6(x100)
	bne	x100, zero, trace_diffuse_ray_beqelse_b2371
# B2370
	j trace_diffuse_ray_cont_b2405 # adhoc jump(2)
trace_diffuse_ray_beqelse_b2371:
# B2371
...
# B2372
	add x4, x29, x28
	lw x100, 0(x4)
	bne	x100, x21, trace_diffuse_ray_beqelse_b2374
# B2373
	li x26, 1
# B2401
	bne	x26, zero, trace_diffuse_ray_beqelse_b2403
	j trace_diffuse_ray_cont_b2402 # adhoc jump(3)
trace_diffuse_ray_beqelse_b2403:
# B2403
	mv x100, x16
# B2404
...
# B2412
	ret
trace_diffuse_ray_beqelse_b2374:
# B2374
	add x4, x18, x100
	lw x100, 0(x4)
	lw x26, 5(x100)
...
# B2398
	bne	x100, zero, trace_diffuse_ray_beqelse_b2400
# B2399
	addi x28, x28, 1
	j	trace_diffuse_ray_loop_b2372
trace_diffuse_ray_beqelse_b2400:
# B2400
trace_diffuse_ray_cont_b2402:
# B2402
	j	trace_diffuse_ray_loop_b2321
...
trace_diffuse_ray_bneelse_b2316:
# B2316
	j	trace_diffuse_ray_loop_b2173
...
# B2442
	...
	sw x99, 0(x93)
	li x93, 1
	j iter_trace_diffuse_rays_cont_b2468 # adhoc jump(2)
...
# B2462
	mv x93, zero
iter_trace_diffuse_rays_cont_b2468:
# B2468
	addi x84, x84, 1
	bne	x93, zero, iter_trace_diffuse_rays_beqelse_b2470
# B2469
	add x4, x20, x88
	lw x18, 0(x4)
	lw x18, 6(x18)
...
iter_trace_diffuse_rays_beqelse_b2472:
# B2472
...
# B2477
	add x4, x98, x96
	lw x103, 0(x4)
	bne	x103, x85, iter_trace_diffuse_rays_beqelse_b2479
# B2478
	li x98, 1
# B2506
	bne	x98, zero, iter_trace_diffuse_rays_beqelse_b2508
	j iter_trace_diffuse_rays_cont_b2507 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b2508:
# B2508
	sw x94, 0(x17)
	sw x95, 0(x21)
	sw x97, 1(x21)
...
iter_trace_diffuse_rays_beqelse_b2479:
# B2479
	add x4, x20, x103
	lw x103, 0(x4)
	lw x104, 5(x103)
...
# B2503
	bne	x103, zero, iter_trace_diffuse_rays_beqelse_b2505
# B2504
	addi x96, x96, 1
...
# B2564
	sw x102, 0(x89)
	li x95, 1
	j iter_trace_diffuse_rays_cont_b2590 # adhoc jump(2)
...
# B2584
	mv x95, zero
iter_trace_diffuse_rays_cont_b2590:
# B2590
	addi x84, x84, 1
	bne	x95, zero, iter_trace_diffuse_rays_beqelse_b2592
# B2591
	add x4, x88, x94
	lw x18, 0(x4)
	lw x18, 6(x18)
...
# B2599
	add x4, x101, x98
	lw x105, 0(x4)
	bne	x105, x85, iter_trace_diffuse_rays_beqelse_b2601
# B2600
	li x101, 1
# B2628
	bne	x101, zero, iter_trace_diffuse_rays_beqelse_b2630
	j iter_trace_diffuse_rays_cont_b2629 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b2630:
# B2630
	sw x96, 0(x17)
	sw x97, 0(x21)
	sw x99, 1(x21)
...
iter_trace_diffuse_rays_beqelse_b2601:
# B2601
	add x4, x88, x105
	lw x105, 0(x4)
	lw x106, 5(x105)
...
# B2625
	bne	x105, zero, iter_trace_diffuse_rays_beqelse_b2627
# B2626
	addi x98, x98, 1
	j	iter_trace_diffuse_rays_loop_b2599
iter_trace_diffuse_rays_beqelse_b2627:
# B2627
iter_trace_diffuse_rays_cont_b2629:
# B2629
...
# B2669
	fle x25, x22, x23
	bne	x25, zero, iter_trace_diffuse_rays_beqelse_b2671
# B2670
	fmul x23, x23, x35
	j	iter_trace_diffuse_rays_loop_b2669
iter_trace_diffuse_rays_beqelse_b2671:
# B2671
# B2672
	mv x27, x14
	mv x28, x23
...
# B2696
	fle x23, x18, x22
	bne	x23, zero, iter_trace_diffuse_rays_beqelse_b2698
# B2697
	fmul x22, x22, x35
...
# B2711
	fle x14, x37, x18
	beq	x14, zero, iter_trace_diffuse_rays_bneelse_b2712
# B2713
	fsub x18, x36, x18
iter_trace_diffuse_rays_bneelse_b2712:
# B2712
...
# B2755
	li x22, 1
	j iter_trace_diffuse_rays_cont_b2894 # adhoc jump(2)
...
# B2765
	...
	sw x34, 0(x22)
	li x22, 1
	j iter_trace_diffuse_rays_cont_b2797 # adhoc jump(2)
...
# B2796
	li x22, 1
iter_trace_diffuse_rays_cont_b2797:
# B2797
	bne	x22, zero, iter_trace_diffuse_rays_beqelse_b2799
	j iter_trace_diffuse_rays_cont_b2798 # adhoc jump(3)
...
# B2816
	sw x40, 0(x22)
	li x34, 1
	j iter_trace_diffuse_rays_cont_b2848 # adhoc jump(2)
...
# B2836
	mv x34, zero
iter_trace_diffuse_rays_cont_b2848:
# B2848
	lw x35, 0(x22)
	bne	x34, zero, iter_trace_diffuse_rays_beqelse_b2850
# B2849
	mv x34, zero
	j iter_trace_diffuse_rays_cont_b2851 # adhoc jump(2)
...
# B2850
	...
	fle x34, x34, x35
	xori x34, x34, 1
iter_trace_diffuse_rays_cont_b2851:
# B2851
	addi x32, x32, 1
...
# B2852
	...
	lw x28, 0(x4)
	lw x28, 6(x28)
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b2855
# B2854
...
# B2856
	add x4, x37, x34
	lw x28, 0(x4)
	bne	x28, x23, iter_trace_diffuse_rays_beqelse_b2858
# B2857
	li x34, 1
# B2885
	bne	x34, zero, iter_trace_diffuse_rays_beqelse_b2887
	j iter_trace_diffuse_rays_cont_b2886 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b2887:
# B2887
	mv x28, x15
# B2888
...
# B2882
	bne	x28, zero, iter_trace_diffuse_rays_beqelse_b2884
# B2883
	addi x34, x34, 1
	j	iter_trace_diffuse_rays_loop_b2856
iter_trace_diffuse_rays_beqelse_b2884:
# B2884
...
# B2798
	mv x22, zero
iter_trace_diffuse_rays_cont_b2894:
# B2894
	addi x18, x18, 1
	beq	x22, zero, iter_trace_diffuse_rays_bneelse_b2895
# B2896
	mv x27, x15
	mv x28, x14
...
# B2911
	...
	sw x37, 0(x31)
	li x31, 1
	j iter_trace_diffuse_rays_cont_b2943 # adhoc jump(2)
...
# B2931
	mv x31, zero
iter_trace_diffuse_rays_cont_b2943:
# B2943
	la x32, min_caml_solver_dist
	lw x32, 0(x32)
	bne	x31, zero, iter_trace_diffuse_rays_beqelse_b2945
# B2944
	mv x31, zero
	j iter_trace_diffuse_rays_cont_b2946 # adhoc jump(2)
...
# B2945
	...
	fle x31, x31, x32
	xori x31, x31, 1
iter_trace_diffuse_rays_cont_b2946:
# B2946
	addi x22, x22, 1
...
# B2947
	...
	lw x14, 0(x4)
	lw x14, 6(x14)
	bne	x14, zero, iter_trace_diffuse_rays_beqelse_b2950
# B2949
...
# B2951
	add x4, x34, x33
	lw x14, 0(x4)
	bne	x14, x23, iter_trace_diffuse_rays_beqelse_b2953
# B2952
	li x31, 1
# B2980
	bne	x31, zero, iter_trace_diffuse_rays_beqelse_b2982
	j iter_trace_diffuse_rays_cont_b2981 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b2982:
# B2982
	mv x14, x15
# B2983
...
iter_trace_diffuse_rays_beqelse_b2953:
# B2953
	add x4, x20, x14
	lw x14, 0(x4)
	lw x31, 5(x14)
...
# B2977
	bne	x14, zero, iter_trace_diffuse_rays_beqelse_b2979
# B2978
	addi x33, x33, 1
	j	iter_trace_diffuse_rays_loop_b2951
iter_trace_diffuse_rays_beqelse_b2979:
# B2979
...
iter_trace_diffuse_rays_bneelse_b2895:
# B2895
	j	iter_trace_diffuse_rays_loop_b2752
...
# B3014
	...
	sw x101, 0(x94)
	li x94, 1
	j iter_trace_diffuse_rays_cont_b3040 # adhoc jump(2)
...
# B3034
	mv x94, zero
iter_trace_diffuse_rays_cont_b3040:
# B3040
	addi x84, x84, 1
	bne	x94, zero, iter_trace_diffuse_rays_beqelse_b3042
# B3041
	add x4, x86, x89
	lw x18, 0(x4)
	lw x18, 6(x18)
...
# B3043
	j iter_trace_diffuse_rays_cont_b3082 # adhoc jump(2)
iter_trace_diffuse_rays_beqelse_b3044:
# B3044
...
# B3049
	add x4, x99, x97
	lw x104, 0(x4)
	bne	x104, x85, iter_trace_diffuse_rays_beqelse_b3051
# B3050
	li x99, 1
# B3078
	bne	x99, zero, iter_trace_diffuse_rays_beqelse_b3080
	j iter_trace_diffuse_rays_cont_b3079 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b3080:
# B3080
	sw x95, 0(x17)
	sw x96, 0(x21)
	sw x98, 1(x21)
...
# B3075
	bne	x104, zero, iter_trace_diffuse_rays_beqelse_b3077
# B3076
	addi x97, x97, 1
	j	iter_trace_diffuse_rays_loop_b3049
iter_trace_diffuse_rays_beqelse_b3077:
# B3077
...
# B3136
	sw x101, 0(x9)
	li x94, 1
	j iter_trace_diffuse_rays_cont_b3162 # adhoc jump(2)
...
# B3156
	mv x94, zero
iter_trace_diffuse_rays_cont_b3162:
# B3162
	addi x84, x84, 1
	bne	x94, zero, iter_trace_diffuse_rays_beqelse_b3164
# B3163
	add x4, x20, x93
	lw x18, 0(x4)
	lw x18, 6(x18)
...
iter_trace_diffuse_rays_beqelse_b3166:
# B3166
...
# B3171
	add x4, x99, x97
	lw x104, 0(x4)
	bne	x104, x85, iter_trace_diffuse_rays_beqelse_b3173
# B3172
	li x99, 1
# B3200
	bne	x99, zero, iter_trace_diffuse_rays_beqelse_b3202
	j iter_trace_diffuse_rays_cont_b3201 # adhoc jump(3)
...
iter_trace_diffuse_rays_beqelse_b3173:
# B3173
	add x4, x20, x104
	lw x104, 0(x4)
	lw x105, 5(x104)
...
# B3197
	bne	x104, zero, iter_trace_diffuse_rays_beqelse_b3199
# B3198
	addi x97, x97, 1
	j	iter_trace_diffuse_rays_loop_b3171
iter_trace_diffuse_rays_beqelse_b3199:
# B3199
iter_trace_diffuse_rays_cont_b3201:
# B3201
...
# B3241
	fle x23, x20, x22
	bne	x23, zero, iter_trace_diffuse_rays_beqelse_b3243
# B3242
	fmul x22, x22, x35
...
# B3268
	fle x22, x18, x20
	bne	x22, zero, iter_trace_diffuse_rays_beqelse_b3270
# B3269
	fmul x20, x20, x35
...
iter_trace_diffuse_rays_beqelse_b3276:
# B3276
	fdiv x25, x25, x35
	j	iter_trace_diffuse_rays_loop_b3272
...
# B3283
	fle x14, x37, x18
	beq	x14, zero, iter_trace_diffuse_rays_bneelse_b3284
# B3285
	fsub x18, x36, x18
iter_trace_diffuse_rays_bneelse_b3284:
# B3284
...
# B3327
	li x20, 1
	j iter_trace_diffuse_rays_cont_b3466 # adhoc jump(2)
...
# B3337
	...
	sw x33, 0(x20)
	li x20, 1
	j iter_trace_diffuse_rays_cont_b3369 # adhoc jump(2)
...
# B3368
	li x20, 1
iter_trace_diffuse_rays_cont_b3369:
# B3369
	bne	x20, zero, iter_trace_diffuse_rays_beqelse_b3371
	j iter_trace_diffuse_rays_cont_b3370 # adhoc jump(3)
...
# B3388
	sw x39, 0(x20)
	li x33, 1
	j iter_trace_diffuse_rays_cont_b3420 # adhoc jump(2)
...
# B3408
	mv x33, zero
iter_trace_diffuse_rays_cont_b3420:
# B3420
	lw x34, 0(x20)
	bne	x33, zero, iter_trace_diffuse_rays_beqelse_b3422
# B3421
	mv x33, zero
	j iter_trace_diffuse_rays_cont_b3423 # adhoc jump(2)
...
# B3422
	...
	fle x33, x33, x34
	xori x33, x33, 1
iter_trace_diffuse_rays_cont_b3423:
# B3423
	addi x31, x31, 1
...
# B3424
	...
	lw x27, 0(x4)
	lw x27, 6(x27)
	bne	x27, zero, iter_trace_diffuse_rays_beqelse_b3427
# B3426
...
# B3428
	add x4, x36, x33
	lw x27, 0(x4)
	bne	x27, x22, iter_trace_diffuse_rays_beqelse_b3430
# B3429
	li x33, 1
# B3457
	bne	x33, zero, iter_trace_diffuse_rays_beqelse_b3459
	j iter_trace_diffuse_rays_cont_b3458 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b3459:
# B3459
	mv x27, x15
# B3460
...
# B3465
	mv x20, x15
	j iter_trace_diffuse_rays_cont_b3466 # adhoc jump(2)
iter_trace_diffuse_rays_beqelse_b3430:
# B3430
	add x4, x86, x27
	lw x27, 0(x4)
	lw x34, 5(x27)
...
# B3454
	bne	x27, zero, iter_trace_diffuse_rays_beqelse_b3456
# B3455
	addi x33, x33, 1
	j	iter_trace_diffuse_rays_loop_b3428
iter_trace_diffuse_rays_beqelse_b3456:
# B3456
...
# B3370
	mv x20, zero
iter_trace_diffuse_rays_cont_b3466:
# B3466
	addi x18, x18, 1
	beq	x20, zero, iter_trace_diffuse_rays_bneelse_b3467
# B3468
	mv x25, x15
	mv x27, x14
...
# B3483
	...
	sw x36, 0(x30)
	li x30, 1
	j iter_trace_diffuse_rays_cont_b3515 # adhoc jump(2)
...
# B3503
	mv x30, zero
iter_trace_diffuse_rays_cont_b3515:
# B3515
	la x31, min_caml_solver_dist
	lw x31, 0(x31)
	bne	x30, zero, iter_trace_diffuse_rays_beqelse_b3517
# B3516
	mv x30, zero
	j iter_trace_diffuse_rays_cont_b3518 # adhoc jump(2)
...
# B3517
	...
	fle x30, x30, x31
	xori x30, x30, 1
iter_trace_diffuse_rays_cont_b3518:
# B3518
	addi x20, x20, 1
...
# B3519
	...
	lw x14, 0(x4)
	lw x14, 6(x14)
	bne	x14, zero, iter_trace_diffuse_rays_beqelse_b3522
# B3521
...
# B3523
	add x4, x33, x32
	lw x14, 0(x4)
	bne	x14, x22, iter_trace_diffuse_rays_beqelse_b3525
# B3524
	li x30, 1
# B3552
	bne	x30, zero, iter_trace_diffuse_rays_beqelse_b3554
	j iter_trace_diffuse_rays_cont_b3553 # adhoc jump(3)
iter_trace_diffuse_rays_beqelse_b3554:
# B3554
	mv x14, x15
# B3555
...
# B3563
	j iter_trace_diffuse_rays_cont_b3567 # adhoc jump(2)
iter_trace_diffuse_rays_beqelse_b3525:
# B3525
	add x4, x86, x14
	lw x14, 0(x4)
	lw x30, 5(x14)
...
# B3549
	bne	x14, zero, iter_trace_diffuse_rays_beqelse_b3551
# B3550
	addi x32, x32, 1
	j	iter_trace_diffuse_rays_loop_b3523
iter_trace_diffuse_rays_beqelse_b3551:
# B3551
...
iter_trace_diffuse_rays_bneelse_b3467:
# B3467
	j	iter_trace_diffuse_rays_loop_b3324
...
# B3635
	addi x86, x86, 1
	bne	x95, zero, trace_diffuse_rays_beqelse_b3637
# B3636
	add x4, x22, x9
	lw x20, 0(x4)
	lw x20, 6(x20)
...
trace_diffuse_rays_beqelse_b3639:
# B3639
...
# B3644
	add x4, x101, x99
	lw x105, 0(x4)
	bne	x105, x87, trace_diffuse_rays_beqelse_b3646
# B3645
	li x101, 1
# B3673
	bne	x101, zero, trace_diffuse_rays_beqelse_b3675
	j trace_diffuse_rays_cont_b3674 # adhoc jump(3)
trace_diffuse_rays_beqelse_b3675:
# B3675
	sw x96, 0(x19)
	sw x97, 0(x23)
	sw x98, 1(x23)
...
trace_diffuse_rays_beqelse_b3646:
# B3646
	add x4, x22, x105
	lw x105, 0(x4)
	lw x106, 5(x105)
...
# B3670
	bne	x105, zero, trace_diffuse_rays_beqelse_b3672
# B3671
	addi x99, x99, 1
	j	trace_diffuse_rays_loop_b3644
trace_diffuse_rays_beqelse_b3672:
# B3672
trace_diffuse_rays_cont_b3674:
# B3674
...
# B3757
	addi x86, x86, 1
	bne	x96, zero, trace_diffuse_rays_beqelse_b3759
# B3758
	add x4, x12, x95
	lw x20, 0(x4)
	lw x20, 6(x20)
...
# B3767
	li x102, 1
# B3795
	bne	x102, zero, trace_diffuse_rays_beqelse_b3797
	j trace_diffuse_rays_cont_b3796 # adhoc jump(3)
trace_diffuse_rays_beqelse_b3797:
# B3797
	sw x97, 0(x19)
	sw x98, 0(x23)
	sw x99, 1(x23)
...
# B3792
	bne	x106, zero, trace_diffuse_rays_beqelse_b3794
# B3793
	addi x101, x101, 1
	j	trace_diffuse_rays_loop_b3766
trace_diffuse_rays_beqelse_b3794:
# B3794
trace_diffuse_rays_cont_b3796:
# B3796
...
# B3836
	fle x27, x24, x25
	bne	x27, zero, trace_diffuse_rays_beqelse_b3838
# B3837
	fmul x25, x25, x37
	j	trace_diffuse_rays_loop_b3836
trace_diffuse_rays_beqelse_b3838:
# B3838
# B3839
	mv x30, x25
	mv x29, x18
...
trace_diffuse_rays_beqelse_b3844:
# B3844
	fdiv x30, x30, x37
	j	trace_diffuse_rays_loop_b3840
...
# B3863
	fle x25, x20, x24
	bne	x25, zero, trace_diffuse_rays_beqelse_b3865
# B3864
	fmul x24, x24, x37
...
trace_diffuse_rays_beqelse_b3871:
# B3871
	fdiv x29, x29, x37
	j	trace_diffuse_rays_loop_b3867
...
# B3878
	fle x18, x39, x20
	beq	x18, zero, trace_diffuse_rays_bneelse_b3879
# B3880
	fsub x20, x38, x20
trace_diffuse_rays_bneelse_b3879:
# B3879
...
# B3932
	...
	sw x36, 0(x24)
	li x24, 1
	j trace_diffuse_rays_cont_b3964 # adhoc jump(2)
...
# B3963
	li x24, 1
trace_diffuse_rays_cont_b3964:
# B3964
	bne	x24, zero, trace_diffuse_rays_beqelse_b3966
	j trace_diffuse_rays_cont_b3965 # adhoc jump(3)
...
# B3983
	sw x6, 0(x24)
	li x36, 1
	j trace_diffuse_rays_cont_b4015 # adhoc jump(2)
...
# B4003
	mv x36, zero
trace_diffuse_rays_cont_b4015:
# B4015
	lw x37, 0(x24)
	bne	x36, zero, trace_diffuse_rays_beqelse_b4017
# B4016
	mv x36, zero
	j trace_diffuse_rays_cont_b4018 # adhoc jump(2)
...
# B4019
	...
	lw x30, 0(x4)
	lw x30, 6(x30)
	bne	x30, zero, trace_diffuse_rays_beqelse_b4022
# B4021
...
# B4023
	add x4, x39, x36
	lw x30, 0(x4)
	bne	x30, x25, trace_diffuse_rays_beqelse_b4025
# B4024
	li x36, 1
# B4052
	bne	x36, zero, trace_diffuse_rays_beqelse_b4054
	j trace_diffuse_rays_cont_b4053 # adhoc jump(3)
trace_diffuse_rays_beqelse_b4054:
# B4054
	mv x30, x100
# B4055
...
# B4049
	bne	x30, zero, trace_diffuse_rays_beqelse_b4051
# B4050
	addi x36, x36, 1
	j	trace_diffuse_rays_loop_b4023
trace_diffuse_rays_beqelse_b4051:
# B4051
...
# B4061
	addi x20, x20, 1
	beq	x24, zero, trace_diffuse_rays_bneelse_b4062
# B4063
	mv x30, x18
	mv x29, x100
...
# B4078
	...
	sw x39, 0(x33)
	li x33, 1
	j trace_diffuse_rays_cont_b4110 # adhoc jump(2)
...
# B4098
	mv x33, zero
trace_diffuse_rays_cont_b4110:
# B4110
	la x34, min_caml_solver_dist
	lw x34, 0(x34)
	bne	x33, zero, trace_diffuse_rays_beqelse_b4112
# B4111
	mv x33, zero
	j trace_diffuse_rays_cont_b4113 # adhoc jump(2)
...
# B4114
	...
	lw x18, 0(x4)
	lw x18, 6(x18)
	bne	x18, zero, trace_diffuse_rays_beqelse_b4117
# B4116
...
# B4118
	add x4, x36, x35
	lw x18, 0(x4)
	bne	x18, x25, trace_diffuse_rays_beqelse_b4120
# B4119
	li x33, 1
# B4147
	bne	x33, zero, trace_diffuse_rays_beqelse_b4149
	j trace_diffuse_rays_cont_b4148 # adhoc jump(3)
trace_diffuse_rays_beqelse_b4149:
# B4149
	mv x18, x100
# B4150
...
trace_diffuse_rays_beqelse_b4120:
# B4120
	add x4, x22, x18
	lw x18, 0(x4)
	lw x33, 5(x18)
...
# B4144
	bne	x18, zero, trace_diffuse_rays_beqelse_b4146
# B4145
	addi x35, x35, 1
...
trace_diffuse_rays_bneelse_b4062:
# B4062
	j	trace_diffuse_rays_loop_b3919
...
# B4207
	addi x86, x86, 1
	bne	x96, zero, trace_diffuse_rays_beqelse_b4209
# B4208
	add x4, x88, x90
	lw x20, 0(x4)
	lw x20, 6(x20)
...
# B4210
	j trace_diffuse_rays_cont_b4249 # adhoc jump(2)
trace_diffuse_rays_beqelse_b4211:
# B4211
...
# B4217
	li x102, 1
# B4245
	bne	x102, zero, trace_diffuse_rays_beqelse_b4247
	j trace_diffuse_rays_cont_b4246 # adhoc jump(3)
trace_diffuse_rays_beqelse_b4247:
# B4247
	sw x97, 0(x19)
	sw x98, 0(x23)
	sw x99, 1(x23)
...
# B4242
	bne	x106, zero, trace_diffuse_rays_beqelse_b4244
# B4243
	addi x101, x101, 1
	j	trace_diffuse_rays_loop_b4216
trace_diffuse_rays_beqelse_b4244:
# B4244
trace_diffuse_rays_cont_b4246:
# B4246
...
# B4329
	addi x86, x86, 1
	bne	x96, zero, trace_diffuse_rays_beqelse_b4331
# B4330
	add x4, x22, x95
	lw x20, 0(x4)
	lw x20, 6(x20)
...
# B4339
	li x102, 1
# B4367
	bne	x102, zero, trace_diffuse_rays_beqelse_b4369
	j trace_diffuse_rays_cont_b4368 # adhoc jump(3)
...
# B4364
	bne	x106, zero, trace_diffuse_rays_beqelse_b4366
# B4365
	addi x101, x101, 1
	j	trace_diffuse_rays_loop_b4338
trace_diffuse_rays_beqelse_b4366:
# B4366
trace_diffuse_rays_cont_b4368:
# B4368
...
# B4408
	fle x25, x22, x24
	bne	x25, zero, trace_diffuse_rays_beqelse_b4410
# B4409
	fmul x24, x24, x37
	j	trace_diffuse_rays_loop_b4408
trace_diffuse_rays_beqelse_b4410:
# B4410
# B4411
	mv x27, x18
	mv x29, x24
...
trace_diffuse_rays_beqelse_b4416:
# B4416
	fdiv x29, x29, x37
	j	trace_diffuse_rays_loop_b4412
...
# B4435
	fle x24, x20, x22
	bne	x24, zero, trace_diffuse_rays_beqelse_b4437
# B4436
	fmul x22, x22, x37
	j	trace_diffuse_rays_loop_b4435
trace_diffuse_rays_beqelse_b4437:
# B4437
# B4438
	mv x27, x22
	mv x25, x18
...
# B4450
	fle x18, x39, x20
	beq	x18, zero, trace_diffuse_rays_bneelse_b4451
# B4452
	fsub x20, x38, x20
trace_diffuse_rays_bneelse_b4451:
# B4451
...
# B4494
	li x22, 1
	j trace_diffuse_rays_cont_b4633 # adhoc jump(2)
...
# B4504
	...
	sw x35, 0(x22)
	li x22, 1
	j trace_diffuse_rays_cont_b4536 # adhoc jump(2)
...
# B4535
	li x22, 1
trace_diffuse_rays_cont_b4536:
# B4536
	bne	x22, zero, trace_diffuse_rays_beqelse_b4538
	j trace_diffuse_rays_cont_b4537 # adhoc jump(3)
...
# B4555
	sw x5, 0(x22)
	li x35, 1
	j trace_diffuse_rays_cont_b4587 # adhoc jump(2)
...
# B4575
	mv x35, zero
trace_diffuse_rays_cont_b4587:
# B4587
	lw x36, 0(x22)
	bne	x35, zero, trace_diffuse_rays_beqelse_b4589
# B4588
	mv x35, zero
	j trace_diffuse_rays_cont_b4590 # adhoc jump(2)
...
# B4591
	...
	lw x29, 0(x4)
	lw x29, 6(x29)
	bne	x29, zero, trace_diffuse_rays_beqelse_b4594
# B4593
...
# B4595
	add x4, x38, x35
	lw x29, 0(x4)
	bne	x29, x24, trace_diffuse_rays_beqelse_b4597
# B4596
	li x35, 1
# B4624
	bne	x35, zero, trace_diffuse_rays_beqelse_b4626
	j trace_diffuse_rays_cont_b4625 # adhoc jump(3)
trace_diffuse_rays_beqelse_b4626:
# B4626
	mv x29, x100
# B4627
...
# B4632
	mv x22, x100
	j trace_diffuse_rays_cont_b4633 # adhoc jump(2)
trace_diffuse_rays_beqelse_b4597:
# B4597
	add x4, x88, x29
	lw x29, 0(x4)
	lw x36, 5(x29)
...
# B4621
	bne	x29, zero, trace_diffuse_rays_beqelse_b4623
# B4622
	addi x35, x35, 1
	j	trace_diffuse_rays_loop_b4595
trace_diffuse_rays_beqelse_b4623:
# B4623
...
# B4537
	mv x22, zero
trace_diffuse_rays_cont_b4633:
# B4633
	addi x20, x20, 1
	beq	x22, zero, trace_diffuse_rays_bneelse_b4634
# B4635
	mv x27, x100
	mv x29, x18
...
# B4650
	...
	sw x38, 0(x32)
	li x32, 1
	j trace_diffuse_rays_cont_b4682 # adhoc jump(2)
...
# B4670
	mv x32, zero
trace_diffuse_rays_cont_b4682:
# B4682
	la x33, min_caml_solver_dist
	lw x33, 0(x33)
	bne	x32, zero, trace_diffuse_rays_beqelse_b4684
# B4683
	mv x32, zero
	j trace_diffuse_rays_cont_b4685 # adhoc jump(2)
...
# B4686
	...
	lw x18, 0(x4)
	lw x18, 6(x18)
	bne	x18, zero, trace_diffuse_rays_beqelse_b4689
# B4688
...
# B4690
	add x4, x35, x34
	lw x18, 0(x4)
	bne	x18, x24, trace_diffuse_rays_beqelse_b4692
# B4691
	li x32, 1
# B4719
	bne	x32, zero, trace_diffuse_rays_beqelse_b4721
	j trace_diffuse_rays_cont_b4720 # adhoc jump(3)
trace_diffuse_rays_beqelse_b4721:
# B4721
	mv x18, x100
# B4722
...
# B4730
	j trace_diffuse_rays_cont_b4734 # adhoc jump(2)
trace_diffuse_rays_beqelse_b4692:
# B4692
	add x4, x88, x18
	lw x18, 0(x4)
	lw x32, 5(x18)
...
# B4716
	bne	x18, zero, trace_diffuse_rays_beqelse_b4718
# B4717
	addi x34, x34, 1
	j	trace_diffuse_rays_loop_b4690
trace_diffuse_rays_beqelse_b4718:
# B4718
...
trace_diffuse_rays_bneelse_b4634:
# B4634
	j	trace_diffuse_rays_loop_b4491
...
# B4772
	...
	li x68, 1
# B4773
	bne	x68, zero, pretrace_pixels_beqelse_b4775
	j pretrace_pixels_cont_b4774 # adhoc jump(3)
pretrace_pixels_beqelse_b4775:
# B4775
	li x35, 1
	j pretrace_pixels_cont_b4829 # adhoc jump(2)
...
# B4787
	...
	li x68, 1
# B4788
	bne	x68, zero, pretrace_pixels_beqelse_b4790
	j pretrace_pixels_cont_b4789 # adhoc jump(3)
pretrace_pixels_beqelse_b4790:
# B4790
	li x35, 2
	j pretrace_pixels_cont_b4829 # adhoc jump(2)
...
# B4802
	...
	li x6, 1
# B4803
	bne	x6, zero, pretrace_pixels_beqelse_b4805
	j pretrace_pixels_cont_b4804 # adhoc jump(3)
...
# B4814
	mv x35, zero
pretrace_pixels_cont_b4829:
# B4829
	addi x27, x27, 1
	bne	x35, zero, pretrace_pixels_beqelse_b4831
# B4830
	add x4, x29, x23
	lw x23, 0(x4)
	lw x23, 6(x23)
...
pretrace_pixels_beqelse_b4833:
# B4833
	j	pretrace_pixels_loop_b4756
pretrace_pixels_beqelse_b4831:
# B4831
	lw x6, 0(x37)
	fle x65, x6, zero
...
# B4838
	add x4, x69, x68
	lw x72, 0(x4)
	bne	x72, x28, pretrace_pixels_beqelse_b4840
# B4839
	li x69, 1
# B4867
	bne	x69, zero, pretrace_pixels_beqelse_b4869
	j pretrace_pixels_cont_b4868 # adhoc jump(3)
...
# B4864
	bne	x72, zero, pretrace_pixels_beqelse_b4866
# B4865
	addi x68, x68, 1
	j	pretrace_pixels_loop_b4838
pretrace_pixels_beqelse_b4866:
# B4866
pretrace_pixels_cont_b4868:
# B4868
...
# B4966
	...
	li x68, 1
# B4967
	bne	x68, zero, pretrace_pixels_beqelse_b4969
	j pretrace_pixels_cont_b4968 # adhoc jump(3)
pretrace_pixels_beqelse_b4969:
# B4969
	li x5, 1
	j pretrace_pixels_cont_b5023 # adhoc jump(2)
...
# B4996
	...
	li x6, 1
# B4997
	bne	x6, zero, pretrace_pixels_beqelse_b4999
	j pretrace_pixels_cont_b4998 # adhoc jump(3)
...
# B5008
	mv x5, zero
pretrace_pixels_cont_b5023:
# B5023
	addi x27, x27, 1
	bne	x5, zero, pretrace_pixels_beqelse_b5025
# B5024
	add x4, x29, x23
	lw x23, 0(x4)
	lw x23, 6(x23)
...
# B5026
	j pretrace_pixels_cont_b5065 # adhoc jump(2)
pretrace_pixels_beqelse_b5027:
# B5027
...
# B5032
	add x4, x69, x68
	lw x72, 0(x4)
	bne	x72, x28, pretrace_pixels_beqelse_b5034
# B5033
	li x69, 1
# B5061
	bne	x69, zero, pretrace_pixels_beqelse_b5063
	j pretrace_pixels_cont_b5062 # adhoc jump(3)
pretrace_pixels_beqelse_b5063:
# B5063
	sw x6, 0(x20)
	sw x65, 0(x30)
	sw x66, 1(x30)
...
# B5058
	bne	x72, zero, pretrace_pixels_beqelse_b5060
# B5059
	addi x68, x68, 1
	j	pretrace_pixels_loop_b5032
pretrace_pixels_beqelse_b5060:
# B5060
pretrace_pixels_cont_b5062:
# B5062
...
# B5106
	fle x73, x38, x72
	bne	x73, zero, pretrace_pixels_beqelse_b5108
# B5107
	fmul x72, x72, x40
	j	pretrace_pixels_loop_b5106
pretrace_pixels_beqelse_b5108:
# B5108
# B5109
	mv x75, x72
	mv x74, x34
...
# B5148
	fle x34, x6, x35
	beq	x34, zero, pretrace_pixels_bneelse_b5149
# B5150
	fsub x35, x5, x35
pretrace_pixels_bneelse_b5149:
# B5149
...
# B5195
	li x38, 1
	j pretrace_pixels_cont_b5334 # adhoc jump(2)
...
# B5205
	...
	sw x69, 0(x38)
	li x38, 1
	j pretrace_pixels_cont_b5237 # adhoc jump(2)
...
# B5236
	li x38, 1
pretrace_pixels_cont_b5237:
# B5237
	bne	x38, zero, pretrace_pixels_beqelse_b5239
	j pretrace_pixels_cont_b5238 # adhoc jump(3)
...
# B5288
	lw x7, 0(x38)
	bne	x69, zero, pretrace_pixels_beqelse_b5290
# B5289
	mv x69, zero
	j pretrace_pixels_cont_b5291 # adhoc jump(2)
...
# B5292
	...
	lw x6, 0(x4)
	lw x6, 6(x6)
	bne	x6, zero, pretrace_pixels_beqelse_b5295
# B5294
	j pretrace_pixels_cont_b5329 # adhoc jump(2)
pretrace_pixels_beqelse_b5295:
# B5295
...
# B5296
	add x4, x71, x69
	lw x6, 0(x4)
	bne	x6, x39, pretrace_pixels_beqelse_b5298
# B5297
	li x69, 1
# B5325
	bne	x69, zero, pretrace_pixels_beqelse_b5327
	j pretrace_pixels_cont_b5326 # adhoc jump(3)
...
# B5322
	bne	x6, zero, pretrace_pixels_beqelse_b5324
# B5323
	addi x69, x69, 1
	j	pretrace_pixels_loop_b5296
pretrace_pixels_beqelse_b5324:
# B5324
pretrace_pixels_cont_b5326:
# B5326
	j	pretrace_pixels_loop_b5245
...
# B5238
	mv x38, zero
pretrace_pixels_cont_b5334:
# B5334
	addi x34, x34, 1
	beq	x38, zero, pretrace_pixels_bneelse_b5335
# B5336
	mv x5, x12
	mv x6, x33
...
# B5351
	...
	sw x71, 0(x66)
	li x66, 1
	j pretrace_pixels_cont_b5383 # adhoc jump(2)
...
# B5371
	mv x66, zero
pretrace_pixels_cont_b5383:
# B5383
	la x67, min_caml_solver_dist
	lw x67, 0(x67)
	bne	x66, zero, pretrace_pixels_beqelse_b5385
# B5384
	mv x66, zero
...
# B5387
	...
	lw x33, 0(x4)
	lw x33, 6(x33)
	bne	x33, zero, pretrace_pixels_beqelse_b5390
# B5389
	j pretrace_pixels_cont_b5424 # adhoc jump(2)
pretrace_pixels_beqelse_b5390:
# B5390
...
# B5391
	add x4, x69, x68
	lw x33, 0(x4)
	bne	x33, x39, pretrace_pixels_beqelse_b5393
# B5392
	li x66, 1
# B5420
	bne	x66, zero, pretrace_pixels_beqelse_b5422
	j pretrace_pixels_cont_b5421 # adhoc jump(3)
...
# B5417
	bne	x33, zero, pretrace_pixels_beqelse_b5419
# B5418
	addi x68, x68, 1
	j	pretrace_pixels_loop_b5391
pretrace_pixels_beqelse_b5419:
# B5419
pretrace_pixels_cont_b5421:
# B5421
	j	pretrace_pixels_loop_b5340
...
# B5475
	...
	sw x81, 0(x76)
	li x76, 1
	j pretrace_pixels_cont_b5501 # adhoc jump(2)
...
# B5495
	mv x76, zero
pretrace_pixels_cont_b5501:
# B5501
	addi x67, x67, 1
	bne	x76, zero, pretrace_pixels_beqelse_b5503
# B5502
	add x4, x29, x75
	lw x5, 0(x4)
	lw x5, 6(x5)
...
# B5504
	j pretrace_pixels_cont_b5543 # adhoc jump(2)
pretrace_pixels_beqelse_b5505:
# B5505
	j	pretrace_pixels_loop_b5464
pretrace_pixels_beqelse_b5503:
# B5503
	lw x77, 0(x7)
	fle x78, x77, zero
...
# B5510
	add x4, x80, x8
	lw x84, 0(x4)
	bne	x84, x68, pretrace_pixels_beqelse_b5512
# B5511
	li x80, 1
# B5539
	bne	x80, zero, pretrace_pixels_beqelse_b5541
	j pretrace_pixels_cont_b5540 # adhoc jump(3)
pretrace_pixels_beqelse_b5541:
# B5541
	sw x77, 0(x20)
	sw x78, 0(x30)
	sw x79, 1(x30)
...
# B5536
	bne	x84, zero, pretrace_pixels_beqelse_b5538
# B5537
	addi x8, x8, 1
	j	pretrace_pixels_loop_b5510
pretrace_pixels_beqelse_b5538:
# B5538
pretrace_pixels_cont_b5540:
# B5540
...
# B5597
	sw x80, 0(x7)
	li x75, 1
	j pretrace_pixels_cont_b5623 # adhoc jump(2)
...
# B5617
	mv x75, zero
pretrace_pixels_cont_b5623:
# B5623
	addi x67, x67, 1
	bne	x75, zero, pretrace_pixels_beqelse_b5625
# B5624
	add x4, x29, x74
	lw x5, 0(x4)
	lw x5, 6(x5)
...
# B5626
	j pretrace_pixels_cont_b5665 # adhoc jump(2)
pretrace_pixels_beqelse_b5627:
# B5627
	j	pretrace_pixels_loop_b5586
pretrace_pixels_beqelse_b5625:
# B5625
	lw x76, 0(x7)
	fle x77, x76, zero
...
# B5632
	add x4, x8, x79
	lw x83, 0(x4)
	bne	x83, x68, pretrace_pixels_beqelse_b5634
# B5633
	li x8, 1
# B5661
	bne	x8, zero, pretrace_pixels_beqelse_b5663
	j pretrace_pixels_cont_b5662 # adhoc jump(3)
pretrace_pixels_beqelse_b5663:
# B5663
	sw x76, 0(x20)
	sw x77, 0(x30)
	sw x78, 1(x30)
...
# B5658
	bne	x83, zero, pretrace_pixels_beqelse_b5660
# B5659
	addi x79, x79, 1
	j	pretrace_pixels_loop_b5632
pretrace_pixels_beqelse_b5660:
# B5660
pretrace_pixels_cont_b5662:
# B5662
...
# B5678
	li x66, 1
	j pretrace_pixels_cont_b5817 # adhoc jump(2)
...
# B5688
	...
	sw x72, 0(x66)
	li x66, 1
	j pretrace_pixels_cont_b5720 # adhoc jump(2)
...
# B5719
	li x66, 1
pretrace_pixels_cont_b5720:
# B5720
	bne	x66, zero, pretrace_pixels_beqelse_b5722
	j pretrace_pixels_cont_b5721 # adhoc jump(3)
pretrace_pixels_beqelse_b5722:
# B5722
	la x66, min_caml_solver_dist
	lw x68, 0(x66)
	fle x68, x24, x68
...
# B5739
	sw x78, 0(x66)
	li x72, 1
	j pretrace_pixels_cont_b5771 # adhoc jump(2)
...
# B5759
	mv x72, zero
pretrace_pixels_cont_b5771:
# B5771
	lw x73, 0(x66)
	bne	x72, zero, pretrace_pixels_beqelse_b5773
# B5772
	mv x72, zero
	j pretrace_pixels_cont_b5774 # adhoc jump(2)
pretrace_pixels_beqelse_b5773:
# B5773
	lui x72, 779469
	addi x72, x72, -819
	fle x72, x72, x73
	xori x72, x72, 1
pretrace_pixels_cont_b5774:
# B5774
	addi x70, x70, 1
...
# B5775
	...
	lw x68, 0(x4)
	lw x68, 6(x68)
	bne	x68, zero, pretrace_pixels_beqelse_b5778
# B5777
	j pretrace_pixels_cont_b5812 # adhoc jump(2)
pretrace_pixels_beqelse_b5778:
# B5778
...
# B5779
	add x4, x75, x72
	lw x68, 0(x4)
	bne	x68, x23, pretrace_pixels_beqelse_b5781
# B5780
	li x72, 1
# B5808
	bne	x72, zero, pretrace_pixels_beqelse_b5810
	j pretrace_pixels_cont_b5809 # adhoc jump(3)
...
# B5805
	bne	x68, zero, pretrace_pixels_beqelse_b5807
# B5806
	addi x72, x72, 1
	j	pretrace_pixels_loop_b5779
pretrace_pixels_beqelse_b5807:
# B5807
pretrace_pixels_cont_b5809:
# B5809
	j	pretrace_pixels_loop_b5728
...
# B5721
	mv x66, zero
pretrace_pixels_cont_b5817:
# B5817
	addi x6, x6, 1
	beq	x66, zero, pretrace_pixels_bneelse_b5818
# B5819
	mv x67, x12
	mv x68, x5
...
# B5834
	...
	sw x75, 0(x7)
	li x7, 1
	j pretrace_pixels_cont_b5866 # adhoc jump(2)
...
# B5854
	mv x7, zero
pretrace_pixels_cont_b5866:
# B5866
	la x70, min_caml_solver_dist
	lw x70, 0(x70)
	bne	x7, zero, pretrace_pixels_beqelse_b5868
# B5867
	mv x7, zero
	j pretrace_pixels_cont_b5869 # adhoc jump(2)
pretrace_pixels_beqelse_b5868:
# B5868
	lui x7, 779469
	addi x7, x7, -819
	fle x7, x7, x70
	xori x7, x7, 1
pretrace_pixels_cont_b5869:
# B5869
	addi x66, x66, 1
...
# B5870
	...
	lw x5, 0(x4)
	lw x5, 6(x5)
	bne	x5, zero, pretrace_pixels_beqelse_b5873
# B5872
	j pretrace_pixels_cont_b5907 # adhoc jump(2)
pretrace_pixels_beqelse_b5873:
# B5873
...
# B5874
	add x4, x72, x7
	lw x5, 0(x4)
	bne	x5, x23, pretrace_pixels_beqelse_b5876
# B5875
	li x7, 1
# B5903
	bne	x7, zero, pretrace_pixels_beqelse_b5905
	j pretrace_pixels_cont_b5904 # adhoc jump(3)
pretrace_pixels_beqelse_b5905:
# B5905
	mv x5, x12
# B5906
...
# B5900
	bne	x5, zero, pretrace_pixels_beqelse_b5902
# B5901
	addi x7, x7, 1
	j	pretrace_pixels_loop_b5874
pretrace_pixels_beqelse_b5902:
# B5902
pretrace_pixels_cont_b5904:
# B5904
	j	pretrace_pixels_loop_b5823
...
# B5926
	bne	x27, x107, pretrace_pixels_beqelse_b5928
# B5927
	lw x100, 7(x25)
	lw x100, 0(x100)
	fsub x100, x108, x100
...
main_loop_b5966:
# B5966
	bgt	zero, x109, main_bleelse_b5968
# B5967
	mv x65, zero
	mv x5, x108
...
main_loop_b5970:
# B5970
	bgt	zero, x111, main_bleelse_b5972
# B5971
	mv x65, zero
	mv x5, x108
...
main_loop_b5974:
# B5974
	bgt	zero, x113, main_bleelse_b5976
# B5975
	mv x65, zero
	mv x5, x108
...
# B5978
	fle x15, x13, x14
	bne	x15, zero, main_beqelse_b5980
# B5979
	fmul x14, x14, x114
	j	main_loop_b5978
main_beqelse_b5980:
...
# B5993
	...
	addi x116, x116, -37
	fle x15, x116, x14
	beq	x15, zero, main_bneelse_b5994
# B5995
	fsub x14, x115, x14
main_bneelse_b5994:
# B5994
main_cont_b5996:
# B5996
	beq	x15, zero, main_bneelse_b5997
# B5998
	xori x13, x13, 1
main_bneelse_b5997:
# B5997
...
# B6006
	fle x17, x14, x15
	bne	x17, zero, main_beqelse_b6008
# B6007
	fmul x15, x15, x114
	j	main_loop_b6006
main_beqelse_b6008:
...
main_cont_b6018:
# B6018
	beq	x12, zero, main_bneelse_b6019
# B6020
	xori x100, x100, 1
main_bneelse_b6019:
# B6019
...
# B6031
	fle x18, x15, x17
	bne	x18, zero, main_beqelse_b6033
# B6032
	fmul x17, x17, x114
	j	main_loop_b6031
main_beqelse_b6033:
...
# B6046
	fle x18, x116, x17
	beq	x18, zero, main_bneelse_b6047
# B6048
	fsub x17, x115, x17
main_bneelse_b6047:
# B6047
main_cont_b6049:
# B6049
	beq	x18, zero, main_bneelse_b6050
# B6051
	xori x15, x15, 1
main_bneelse_b6050:
# B6050
...
# B6059
	fle x19, x17, x18
	bne	x19, zero, main_beqelse_b6061
# B6060
	fmul x18, x18, x114
	j	main_loop_b6059
main_beqelse_b6061:
...
main_cont_b6071:
# B6071
	beq	x14, zero, main_bneelse_b6072
# B6073
	xori x12, x12, 1
main_bneelse_b6072:
# B6072
...
# B6084
	fle x14, x12, x13
	bne	x14, zero, main_beqelse_b6086
# B6085
	fmul x13, x13, x114
	j	main_loop_b6084
main_beqelse_b6086:
...
main_cont_b6096:
# B6096
	beq	x12, zero, main_bneelse_b6097
# B6098
	xori x100, x100, 1
main_bneelse_b6097:
# B6097
...
# B6109
	fle x13, x11, x12
	bne	x13, zero, main_beqelse_b6111
# B6110
	fmul x12, x12, x114
	j	main_loop_b6109
main_beqelse_b6111:
...
# B6124
	fle x12, x116, x11
	beq	x12, zero, main_bneelse_b6125
# B6126
	fsub x11, x115, x11
main_bneelse_b6125:
# B6125
main_cont_b6127:
# B6127
	beq	x12, zero, main_bneelse_b6128
# B6129
	xori x10, x10, 1
main_bneelse_b6128:
# B6128
...
# B6137
	fle x14, x12, x13
	bne	x14, zero, main_beqelse_b6139
# B6138
	fmul x13, x13, x114
	j	main_loop_b6137
main_beqelse_b6139:
...
main_cont_b6149:
# B6149
	beq	x12, zero, main_bneelse_b6150
# B6151
	xori x11, x11, 1
main_bneelse_b6150:
# B6150
...
# B6162
	fle x11, x12, x13
	bne	x11, zero, main_beqelse_b6164
# B6163
	fmul x13, x13, x114
	j	main_loop_b6162
main_beqelse_b6164:
...
# B6177
	fle x12, x116, x11
	beq	x12, zero, main_bneelse_b6178
# B6179
	fsub x11, x115, x11
main_bneelse_b6178:
# B6178
main_cont_b6180:
# B6180
	beq	x12, zero, main_bneelse_b6181
# B6182
	xori x100, x100, 1
main_bneelse_b6181:
# B6181
...
# B6190
	...
	lw x10, 0(x5)
	li x100, -1
	beq	x10, x100, main_bneelse_b6191
# B6192
	la x10, min_caml_and_net
	add x4, x10, x42
	sw x5, 0(x4)
...
main_loop_b6197:
# B6197
	bgt	x13, x10, main_bleelse_b6199
# B6198
	slli x12, x13, 3
	slli x14, x13, 1
	add x12, x12, x14
...
main_loop_b6201:
# B6201
	bge	x15, x14, main_bgtelse_b6202
# B6203
	slli x10, x15, 3
	slli x13, x15, 1
	add x15, x10, x13
...
main_loop_b6205:
# B6205
	bge	zero, x11, main_bgtelse_b6206
# B6207
	li x10, 48
	out8 x10
	addi x11, x11, -1
...
# B6211
	add x11, x15, x13
	bgt	x11, x10, main_bleelse_b6213
# B6212
	addi x14, x14, 1
	mv x15, x11
	j	main_loop_b6211
...
main_loop_b6215:
# B6215
	beq	x18, zero, main_bneelse_b6216
# B6217
	add x17, x17, x15
	addi x18, x18, -1
	j	main_loop_b6215
...
main_loop_b6220:
# B6220
	bgt	x13, x10, main_bleelse_b6222
# B6221
	slli x12, x13, 3
	slli x14, x13, 1
	add x12, x12, x14
...
main_loop_b6224:
# B6224
	bge	x15, x14, main_bgtelse_b6225
# B6226
	slli x10, x15, 3
	slli x13, x15, 1
	add x15, x10, x13
...
main_loop_b6228:
# B6228
	bge	zero, x11, main_bgtelse_b6229
# B6230
	li x10, 48
	out8 x10
	addi x11, x11, -1
...
main_loop_b6246:
# B6246
	bgt	x13, x10, main_bleelse_b6248
# B6247
	slli x12, x13, 3
	slli x14, x13, 1
	add x12, x12, x14
...
main_loop_b6250:
# B6250
	bge	x15, x14, main_bgtelse_b6251
# B6252
	slli x10, x15, 3
	slli x13, x15, 1
	add x15, x10, x13
...
main_loop_b6254:
# B6254
	bge	zero, x11, main_bgtelse_b6255
# B6256
	li x10, 48
	out8 x10
	addi x11, x11, -1
...
# B6260
	add x11, x15, x13
	bgt	x11, x10, main_bleelse_b6262
# B6261
	addi x14, x14, 1
	mv x15, x11
	j	main_loop_b6260
...
main_loop_b6264:
# B6264
	beq	x18, zero, main_bneelse_b6265
# B6266
	add x17, x17, x15
	addi x18, x18, -1
	j	main_loop_b6264
...
main_loop_b6269:
# B6269
	bgt	x13, x10, main_bleelse_b6271
# B6270
	slli x12, x13, 3
	slli x14, x13, 1
	add x12, x12, x14
...
main_loop_b6273:
# B6273
	bge	x15, x14, main_bgtelse_b6274
# B6275
	slli x10, x15, 3
	slli x13, x15, 1
	add x15, x10, x13
...
main_loop_b6277:
# B6277
	bge	zero, x11, main_bgtelse_b6278
# B6279
	li x10, 48
	out8 x10
	addi x11, x11, -1
...
main_loop_b6293:
# B6293
	bgt	x13, x11, main_bleelse_b6295
# B6294
	slli x12, x13, 3
	slli x14, x13, 1
	add x12, x12, x14
...
main_loop_b6297:
# B6297
	bge	x15, x14, main_bgtelse_b6298
# B6299
	slli x11, x15, 3
	slli x13, x15, 1
	add x15, x11, x13
...
main_loop_b6301:
# B6301
	bge	zero, x11, main_bgtelse_b6302
# B6303
	li x100, 48
	out8 x100
	addi x11, x11, -1
...
main_loop_b6319:
# B6319
	bgt	zero, x49, main_bleelse_b6321
# B6320
	mv x65, zero
	mv x5, x108
...
# B6467
	fle x37, x28, x30
	bne	x37, zero, main_beqelse_b6469
# B6468
	fmul x30, x30, x114
	j	main_loop_b6467
main_beqelse_b6469:
...
main_cont_b6479:
# B6479
	beq	x28, zero, main_bneelse_b6480
# B6481
	xori x23, x23, 1
main_bneelse_b6480:
# B6480
...
# B6492
	fle x37, x28, x30
	bne	x37, zero, main_beqelse_b6494
# B6493
	fmul x30, x30, x114
	j	main_loop_b6492
main_beqelse_b6494:
...
# B6507
	fle x30, x116, x28
	beq	x30, zero, main_bneelse_b6508
# B6509
	fsub x28, x115, x28
main_bneelse_b6508:
# B6508
main_cont_b6510:
# B6510
	beq	x30, zero, main_bneelse_b6511
# B6512
	xori x22, x22, 1
main_bneelse_b6511:
# B6511
...
# B6528
	fle x31, x29, x30
	bne	x31, zero, main_beqelse_b6530
# B6529
	fmul x30, x30, x114
	j	main_loop_b6528
main_beqelse_b6530:
...
main_cont_b6540:
# B6540
	beq	x29, zero, main_bneelse_b6541
# B6542
	xori x28, x28, 1
main_bneelse_b6541:
# B6541
...
# B6553
	fle x31, x29, x30
	bne	x31, zero, main_beqelse_b6555
# B6554
	fmul x30, x30, x114
	j	main_loop_b6553
main_beqelse_b6555:
...
# B6568
	fle x30, x116, x29
	beq	x30, zero, main_bneelse_b6569
# B6570
	fsub x29, x115, x29
main_bneelse_b6569:
# B6569
main_cont_b6571:
# B6571
	beq	x30, zero, main_bneelse_b6572
# B6573
	xori x23, x23, 1
main_bneelse_b6572:
# B6572
...
# B6577
	fle x29, x20, zero
	bne	x23, x29, main_beqelse_b6578
# B6579
	fsub x20, zero, x20
main_beqelse_b6578:
# B6578
...
# B6341
	fle x38, x29, x31
	bne	x38, zero, main_beqelse_b6343
# B6342
	fmul x31, x31, x114
	j	main_loop_b6341
main_beqelse_b6343:
...
main_cont_b6353:
# B6353
	beq	x29, zero, main_bneelse_b6354
# B6355
	xori x28, x28, 1
main_bneelse_b6354:
# B6354
...
# B6366
	fle x38, x29, x31
	bne	x38, zero, main_beqelse_b6368
# B6367
	fmul x31, x31, x114
	j	main_loop_b6366
main_beqelse_b6368:
...
# B6381
	fle x31, x116, x29
	beq	x31, zero, main_bneelse_b6382
# B6383
	fsub x29, x115, x29
main_bneelse_b6382:
# B6382
main_cont_b6384:
# B6384
	beq	x31, zero, main_bneelse_b6385
# B6386
	xori x27, x27, 1
main_bneelse_b6385:
# B6385
...
# B6402
	fle x31, x29, x30
	bne	x31, zero, main_beqelse_b6404
# B6403
	fmul x30, x30, x114
	j	main_loop_b6402
main_beqelse_b6404:
...
main_cont_b6414:
# B6414
	beq	x29, zero, main_bneelse_b6415
# B6416
	xori x28, x28, 1
main_bneelse_b6415:
# B6415
...
# B6427
	fle x31, x29, x30
	bne	x31, zero, main_beqelse_b6429
# B6428
	fmul x30, x30, x114
	j	main_loop_b6427
main_beqelse_b6429:
...
# B6442
	fle x30, x116, x29
	beq	x30, zero, main_bneelse_b6443
# B6444
	fsub x29, x115, x29
main_bneelse_b6443:
# B6443
main_cont_b6445:
# B6445
	beq	x30, zero, main_bneelse_b6446
# B6447
	xori x27, x27, 1
main_bneelse_b6446:
# B6446
...
# B6451
	fle x29, x22, zero
	bne	x27, x29, main_beqelse_b6452
# B6453
	fsub x22, zero, x22
main_beqelse_b6452:
# B6452
...
# B7004
	bge	zero, x10, main_bgtelse_b7005
# B7006
	li x11, 1
# B7007
	bne	x11, zero, main_beqelse_b7009
	j main_cont_b7008 # adhoc jump(3)
main_beqelse_b7009:
# B7009
	mv x15, x119
	mv x14, x118
...
# B7119
	li x11, 1
	j main_cont_b7121 # adhoc jump(2)
main_beqelse_b7120:
# B7120
	mv x11, zero
	j main_cont_b7121 # adhoc jump(2)
...
# B7121
	la x123, min_caml_diffuse_ray
	bne	x11, zero, main_beqelse_b7123
# B7122
	add x4, x14, x100
	lw x10, 0(x4)
	mv x125, x10
...
main_loop_b7162:
# B7162
	bgt	x13, x100, main_bleelse_b7164
# B7163
	slli x12, x13, 3
	slli x14, x13, 1
	add x12, x12, x14
...
main_loop_b7166:
# B7166
	bge	x15, x14, main_bgtelse_b7167
# B7168
	slli x100, x15, 3
	slli x13, x15, 1
	add x15, x100, x13
...
main_loop_b7170:
# B7170
	bge	zero, x11, main_bgtelse_b7171
# B7172
	li x100, 48
	out8 x100
	addi x11, x11, -1
...
# B7176
	add x11, x15, x13
	bgt	x11, x100, main_bleelse_b7178
# B7177
	addi x14, x14, 1
	mv x15, x11
	j	main_loop_b7176
...
main_loop_b7180:
# B7180
	beq	x18, zero, main_bneelse_b7181
# B7182
	add x17, x17, x15
	addi x18, x18, -1
	j	main_loop_b7180
...
main_loop_b7185:
# B7185
	bgt	x13, x10, main_bleelse_b7187
# B7186
	slli x12, x13, 3
	slli x14, x13, 1
	add x12, x12, x14
...
main_loop_b7189:
# B7189
	bge	x15, x14, main_bgtelse_b7190
# B7191
	slli x10, x15, 3
	slli x13, x15, 1
	add x15, x10, x13
...
main_loop_b7193:
# B7193
	bge	zero, x11, main_bgtelse_b7194
# B7195
	li x10, 48
	out8 x10
	addi x11, x11, -1
...
main_loop_b7216:
# B7216
	bgt	x13, x100, main_bleelse_b7218
# B7217
	slli x12, x13, 3
	slli x14, x13, 1
	add x12, x12, x14
...
main_loop_b7220:
# B7220
	bge	x15, x14, main_bgtelse_b7221
# B7222
	slli x100, x15, 3
	slli x13, x15, 1
	add x15, x100, x13
...
main_loop_b7224:
# B7224
	bge	zero, x11, main_bgtelse_b7225
# B7226
	li x100, 48
	out8 x100
	addi x11, x11, -1
...
# B7230
	add x11, x15, x13
	bgt	x11, x100, main_bleelse_b7232
# B7231
	addi x14, x14, 1
	mv x15, x11
	j	main_loop_b7230
...
main_loop_b7234:
# B7234
	beq	x18, zero, main_bneelse_b7235
# B7236
	add x17, x17, x15
	addi x18, x18, -1
	j	main_loop_b7234
...
main_loop_b7239:
# B7239
	bgt	x13, x10, main_bleelse_b7241
# B7240
	slli x12, x13, 3
	slli x14, x13, 1
	add x12, x12, x14
...
main_loop_b7243:
# B7243
	bge	x15, x14, main_bgtelse_b7244
# B7245
	slli x10, x15, 3
	slli x13, x15, 1
	add x15, x10, x13
...
main_loop_b7247:
# B7247
	bge	zero, x11, main_bgtelse_b7248
# B7249
	li x10, 48
	out8 x10
	addi x11, x11, -1
...
main_loop_b7270:
# B7270
	bgt	x13, x100, main_bleelse_b7272
# B7271
	slli x12, x13, 3
	slli x14, x13, 1
	add x12, x12, x14
...
main_loop_b7274:
# B7274
	bge	x15, x14, main_bgtelse_b7275
# B7276
	slli x100, x15, 3
	slli x13, x15, 1
	add x15, x100, x13
...
main_loop_b7278:
# B7278
	bge	zero, x11, main_bgtelse_b7279
# B7280
	li x100, 48
	out8 x100
	addi x11, x11, -1
...
# B7284
	add x11, x15, x13
	bgt	x11, x100, main_bleelse_b7286
# B7285
	addi x14, x14, 1
	mv x15, x11
	j	main_loop_b7284
...
main_loop_b7288:
# B7288
	beq	x18, zero, main_bneelse_b7289
# B7290
	add x17, x17, x15
	addi x18, x18, -1
	j	main_loop_b7288
...
main_loop_b7293:
# B7293
	bgt	x13, x10, main_bleelse_b7295
# B7294
	slli x12, x13, 3
	slli x14, x13, 1
	add x12, x12, x14
...
main_loop_b7297:
# B7297
	bge	x15, x14, main_bgtelse_b7298
# B7299
	slli x10, x15, 3
	slli x13, x15, 1
	add x15, x10, x13
...
main_loop_b7301:
# B7301
	bge	zero, x11, main_bgtelse_b7302
# B7303
	li x10, 48
	out8 x10
	addi x11, x11, -1
...
# B7307
	add x11, x15, x13
	bgt	x11, x10, main_bleelse_b7309
# B7308
	addi x14, x14, 1
	mv x15, x11
	j	main_loop_b7307
...
main_loop_b7311:
# B7311
	beq	x18, zero, main_bneelse_b7312
# B7313
	add x17, x17, x15
	addi x18, x18, -1
	j	main_loop_b7311
...
# B7253
	add x11, x15, x13
	bgt	x11, x10, main_bleelse_b7255
# B7254
	addi x14, x14, 1
	mv x15, x11
	j	main_loop_b7253
...
main_loop_b7257:
# B7257
	beq	x18, zero, main_bneelse_b7258
# B7259
	add x17, x17, x15
	addi x18, x18, -1
	j	main_loop_b7257
...
# B7199
	add x11, x15, x13
	bgt	x11, x10, main_bleelse_b7201
# B7200
	addi x14, x14, 1
	mv x15, x11
	j	main_loop_b7199
...
main_loop_b7203:
# B7203
	beq	x18, zero, main_bneelse_b7204
# B7205
	add x17, x17, x15
	addi x18, x18, -1
	j	main_loop_b7203
...
# B6307
	add x11, x15, x13
	bgt	x11, x100, main_bleelse_b6309
# B6308
	addi x14, x14, 1
	mv x15, x11
	j	main_loop_b6307
...
main_loop_b6311:
# B6311
	beq	x18, zero, main_bneelse_b6312
# B6313
	add x17, x17, x15
	addi x18, x18, -1
	j	main_loop_b6311
...
# B6283
	add x11, x15, x13
	bgt	x11, x10, main_bleelse_b6285
# B6284
	addi x14, x14, 1
	mv x15, x11
	j	main_loop_b6283
...
main_loop_b6287:
# B6287
	beq	x18, zero, main_bneelse_b6288
# B6289
	add x17, x17, x15
	addi x18, x18, -1
	j	main_loop_b6287
...
# B6234
	add x11, x15, x13
	bgt	x11, x10, main_bleelse_b6236
# B6235
	addi x14, x14, 1
	mv x15, x11
	j	main_loop_b6234
...
main_loop_b6238:
# B6238
	beq	x18, zero, main_bneelse_b6239
# B6240
	add x17, x17, x15
	addi x18, x18, -1
	j	main_loop_b6238
